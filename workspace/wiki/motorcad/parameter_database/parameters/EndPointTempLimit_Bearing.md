...
parameter_name: EndPointTempLimit_Bearing
category: Transient
input_output: i/p
data_type: double
units: °C
...
aliases:
- EndPointTempLimit_Bearing
- End Point Temp Limit Bearing
- end_point_temp_limit_bearing
- endPointTempLimitBearing
- endpointtemplimit_bearing
related_parameters:
...
## Summary
The maximum allowed temperature of the bearings when the transient end point definition is set to temperature limit
