...
parameter_name: Outlet_Temp_TVent_EWdg_Bore_Shaft_F
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Outlet_Temp_TVent_EWdg_Bore_Shaft_F
- Outlet Temp T Vent E Wdg Bore Shaft F
- outlet_temp_t_vent_e_wdg_bore_shaft_f
- outletTempTVentEWdgBoreShaftF
- outlet_temp_tvent_ewdg_bore_shaft_f
related_parameters:
...
## Summary
Motor-CAD automation parameter `Outlet_Temp_TVent_EWdg_Bore_Shaft_F` in category `TVent_Data`.
