...
parameter_name: Forced_Conv_Notes_Housing_Rear_Fin_Tips
...
aliases:
- Forced_Conv_Notes_Housing_Rear_Fin_Tips
- Forced Conv Notes Housing Rear Fin Tips
- forced_conv_notes_housing_rear_fin_tips
- forcedConvNotesHousingRearFinTips
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of rear housing section (fin tip section) available for cooling to ambient
