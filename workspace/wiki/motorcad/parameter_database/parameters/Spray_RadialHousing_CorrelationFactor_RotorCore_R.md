...
parameter_name: Spray_RadialHousing_CorrelationFactor_RotorCore_R
...
aliases:
- Spray_RadialHousing_CorrelationFactor_RotorCore_R
- Spray Radial Housing Correlation Factor Rotor Core R
- spray_radial_housing_correlation_factor_rotor_core_r
- sprayRadialHousingCorrelationFactorRotorCoreR
- spray_radialhousing_correlationfactor_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the rear rotor core surface
