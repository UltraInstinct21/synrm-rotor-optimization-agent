...
parameter_name: Gap_StatorPlateMount_R_Comment
...
aliases:
- Gap_StatorPlateMount_R_Comment
- Gap Stator Plate Mount R Comment
- gap_stator_plate_mount_r_comment
- gapStatorPlateMountRComment
- gap_statorplatemount_r_comment
related_parameters:
...
## Summary
Details of the radial gap between rear stator plate and bearing mount for single bearing model
