...
parameter_name: Notes_TVent_EndRing_End_F
...
aliases:
- Notes_TVent_EndRing_End_F
- Notes T Vent End Ring End F
- notes_t_vent_end_ring_end_f
- notesTVentEndRingEndF
- notes_tvent_endring_end_f
related_parameters:
...
## Summary
The TVent notes for the end ring End surface [front]
