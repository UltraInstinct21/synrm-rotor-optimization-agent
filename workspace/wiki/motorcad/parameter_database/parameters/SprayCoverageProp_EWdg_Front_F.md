...
parameter_name: SprayCoverageProp_EWdg_Front_F
...
aliases:
- SprayCoverageProp_EWdg_Front_F
- Spray Coverage Prop E Wdg Front F
- spray_coverage_prop_e_wdg_front_f
- sprayCoveragePropEWdgFrontF
- spraycoverageprop_ewdg_front_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/SprayCoverageProp_RotorCore_F|SprayCoverageProp_RotorCore_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Proportion of the total surface area of the EndWinding Front Front that is subjected to Spray Cooling
