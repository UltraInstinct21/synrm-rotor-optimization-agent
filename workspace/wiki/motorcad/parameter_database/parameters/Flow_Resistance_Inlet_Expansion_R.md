...
parameter_name: Flow_Resistance_Inlet_Expansion_R
category: TVent_Data
input_output: o/p
data_type: double
units: kg/m⁷
...
aliases:
- Flow_Resistance_Inlet_Expansion_R
- Flow Resistance Inlet Expansion R
- flow_resistance_inlet_expansion_r
- flowResistanceInletExpansionR
related_parameters:
...
## Summary
Flow Resistance Inlet Expansion
