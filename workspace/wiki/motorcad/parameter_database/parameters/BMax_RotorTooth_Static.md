...
parameter_name: BMax_RotorTooth_Static
category: Magnetics
input_output: o/p
data_type: double
units: Tesla
...
aliases:
- BMax_RotorTooth_Static
- B Max Rotor Tooth Static
- b_max_rotor_tooth_static
- bMaxRotorToothStatic
- bmax_rotortooth_static
related_parameters:
...
## Summary
Maximum flux density at midpoint in the rotor tooth (Initial static solution)
