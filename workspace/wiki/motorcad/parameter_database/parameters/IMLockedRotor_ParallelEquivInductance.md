...
parameter_name: IMLockedRotor_ParallelEquivInductance
category: Magnetics
input_output: o/p
data_type: double
units: Henry
...
aliases:
- IMLockedRotor_ParallelEquivInductance
- IM Locked Rotor Parallel Equiv Inductance
- im_locked_rotor_parallel_equiv_inductance
- imLockedRotorParallelEquivInductance
- imlockedrotor_parallelequivinductance
related_parameters:
...
## Summary
The equivalent inductance in parallel circuit in the Locked Rotor case
