...
parameter_name: Inlet_Temp_TVent_EWdg_Outer_Housing_R
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Inlet_Temp_TVent_EWdg_Outer_Housing_R
- Inlet Temp T Vent E Wdg Outer Housing R
- inlet_temp_t_vent_e_wdg_outer_housing_r
- inletTempTVentEWdgOuterHousingR
- inlet_temp_tvent_ewdg_outer_housing_r
related_parameters:
...
## Summary
Motor-CAD automation parameter `Inlet_Temp_TVent_EWdg_Outer_Housing_R` in category `TVent_Data`.
