...
parameter_name: Vel_Mult_ES_EndRing_Bore_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EndRing_Bore_R
- Vel Mult ES End Ring Bore R
- vel_mult_es_end_ring_bore_r
- velMultEsEndRingBoreR
- vel_mult_es_endring_bore_r
related_parameters:
...
## Summary
The velocity multiplier for end ring bore surface [rear]
