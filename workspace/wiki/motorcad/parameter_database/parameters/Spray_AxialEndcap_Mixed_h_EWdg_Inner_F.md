...
parameter_name: Spray_AxialEndcap_Mixed_h_EWdg_Inner_F
...
aliases:
- Spray_AxialEndcap_Mixed_h_EWdg_Inner_F
- Spray Axial Endcap Mixed h E Wdg Inner F
- spray_axial_endcap_mixed_h_e_wdg_inner_f
- sprayAxialEndcapMixedHEWdgInnerF
- spray_axialendcap_mixed_h_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the front endwinding inner surface
