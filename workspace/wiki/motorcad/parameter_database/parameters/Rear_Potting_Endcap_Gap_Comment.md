...
parameter_name: Rear_Potting_Endcap_Gap_Comment
...
aliases:
- Rear_Potting_Endcap_Gap_Comment
- Rear Potting Endcap Gap Comment
- rear_potting_endcap_gap_comment
- rearPottingEndcapGapComment
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Rear_Potting_Housing_Gap_Comment|Rear_Potting_Housing_Gap_Comment]]'
...
## Summary
Details of the interface gap between potting and endcap (rear of motor)
