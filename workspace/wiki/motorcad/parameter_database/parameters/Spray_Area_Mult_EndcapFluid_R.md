...
parameter_name: Spray_Area_Mult_EndcapFluid_R
...
aliases:
- Spray_Area_Mult_EndcapFluid_R
- Spray Area Mult Endcap Fluid R
- spray_area_mult_endcap_fluid_r
- sprayAreaMultEndcapFluidR
- spray_area_mult_endcapfluid_r
related_parameters:
...
## Summary
Area multiplier for the Endcap Rear section subjected to Spray Cooling
