...
parameter_name: Gap_MaterialConductivity_Comm_Brush
...
aliases:
- Gap_MaterialConductivity_Comm_Brush
- Gap Material Conductivity Comm Brush
- gap_material_conductivity_comm_brush
- gapMaterialConductivityCommBrush
- gap_materialconductivity_comm_brush
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Comm and Brush.
