...
parameter_name: Vel_Mult_ES_EndRing_Outer_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EndRing_Outer_R
- Vel Mult ES End Ring Outer R
- vel_mult_es_end_ring_outer_r
- velMultEsEndRingOuterR
- vel_mult_es_endring_outer_r
related_parameters:
...
## Summary
The velocity multiplier for end ring Outer surface [rear]
