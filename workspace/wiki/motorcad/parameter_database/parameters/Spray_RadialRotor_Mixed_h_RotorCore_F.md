...
parameter_name: Spray_RadialRotor_Mixed_h_RotorCore_F
...
aliases:
- Spray_RadialRotor_Mixed_h_RotorCore_F
- Spray Radial Rotor Mixed h Rotor Core F
- spray_radial_rotor_mixed_h_rotor_core_f
- sprayRadialRotorMixedHRotorCoreF
- spray_radialrotor_mixed_h_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the front rotor core surface
