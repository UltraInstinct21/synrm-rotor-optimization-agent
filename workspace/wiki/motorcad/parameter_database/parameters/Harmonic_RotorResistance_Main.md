...
parameter_name: Harmonic_RotorResistance_Main
category: Magnetics
input_output: o/p
data_type: double
units: Ohms
...
aliases:
- Harmonic_RotorResistance_Main
- Harmonic Rotor Resistance Main
- harmonic_rotor_resistance_main
- harmonicRotorResistanceMain
- harmonic_rotorresistance_main
related_parameters:
...
## Summary
Rotor resistance referred to the main winding for each harmonic order in the IM1PH equivalent circuit
