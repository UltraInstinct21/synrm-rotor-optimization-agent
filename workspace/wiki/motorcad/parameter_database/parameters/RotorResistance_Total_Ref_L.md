...
parameter_name: RotorResistance_Total_Ref_L
category: Magnetics
input_output: o/p
data_type: double
units: Ohms
...
aliases:
- RotorResistance_Total_Ref_L
- Rotor Resistance Total Ref L
- rotor_resistance_total_ref_l
- rotorResistanceTotalRefL
- rotorresistance_total_ref_l
related_parameters:
...
- '[[motorcad/parameter_database/parameters/RotorResistance_Total|RotorResistance_Total]]'
- '[[motorcad/parameter_database/parameters/RotorResistance_Total_Ref|RotorResistance_Total_Ref]]'
- '[[motorcad/parameter_database/parameters/RotorResistance_Referred_BPM|RotorResistance_Referred_BPM]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The total referred rotor Resistance
