...
parameter_name: Spray_RadialRotor_Calc_Input_h_EWdg_Inner_F
...
aliases:
- Spray_RadialRotor_Calc_Input_h_EWdg_Inner_F
- Spray Radial Rotor Calc Input h E Wdg Inner F
- spray_radial_rotor_calc_input_h_e_wdg_inner_f
- sprayRadialRotorCalcInputHEWdgInnerF
- spray_radialrotor_calc_input_h_ewdg_inner_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the front endwinding inner surface is calculated or user input  (0=Calc h, 1=Input h)
