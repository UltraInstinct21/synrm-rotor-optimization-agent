...
parameter_name: Notes_(Bearing_-_Axle_[R])
...
aliases:
- Notes_(Bearing_-_Axle_[R])
- Notes_(Bearing_-_Axle_(R))
- Notes Bearing Axle R
- notes_bearing_axle_r
- notesBearingAxleR
- notes_(bearing_-_axle_[r])
related_parameters:
...
## Summary
Notes - Interface gap between bearing and Axle [rear of motor]
