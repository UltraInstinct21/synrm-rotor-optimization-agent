...
parameter_name: Spray_RadialRotor_Rotational_h_Endcap_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Endcap_R
- Spray Radial Rotor Rotational h Endcap R
- spray_radial_rotor_rotational_h_endcap_r
- sprayRadialRotorRotationalHEndcapR
- spray_radialrotor_rotational_h_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc over the rear endcap surface
