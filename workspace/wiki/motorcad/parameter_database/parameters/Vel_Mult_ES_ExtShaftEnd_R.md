...
parameter_name: Vel_Mult_ES_ExtShaftEnd_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_ExtShaftEnd_R
- Vel Mult ES Ext Shaft End R
- vel_mult_es_ext_shaft_end_r
- velMultEsExtShaftEndR
- vel_mult_es_extshaftend_r
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for shaft extension end [rear]
