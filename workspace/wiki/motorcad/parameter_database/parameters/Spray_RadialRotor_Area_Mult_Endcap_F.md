...
parameter_name: Spray_RadialRotor_Area_Mult_Endcap_F
...
aliases:
- Spray_RadialRotor_Area_Mult_Endcap_F
- Spray Radial Rotor Area Mult Endcap F
- spray_radial_rotor_area_mult_endcap_f
- sprayRadialRotorAreaMultEndcapF
- spray_radialrotor_area_mult_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) front endcap surface area multiplier
