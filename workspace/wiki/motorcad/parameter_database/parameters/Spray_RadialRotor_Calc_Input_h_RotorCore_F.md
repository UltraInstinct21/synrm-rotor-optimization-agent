...
parameter_name: Spray_RadialRotor_Calc_Input_h_RotorCore_F
...
aliases:
- Spray_RadialRotor_Calc_Input_h_RotorCore_F
- Spray Radial Rotor Calc Input h Rotor Core F
- spray_radial_rotor_calc_input_h_rotor_core_f
- sprayRadialRotorCalcInputHRotorCoreF
- spray_radialrotor_calc_input_h_rotorcore_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the front rotor core surface is calculated or user input  (0=Calc h, 1=Input h)
