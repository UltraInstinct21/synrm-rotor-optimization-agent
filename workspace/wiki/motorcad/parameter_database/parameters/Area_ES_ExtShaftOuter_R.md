...
parameter_name: Area_ES_ExtShaftOuter_R
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_ExtShaftOuter_R
- Area ES Ext Shaft Outer R
- area_es_ext_shaft_outer_r
- areaEsExtShaftOuterR
- area_es_extshaftouter_r
related_parameters:
...
## Summary
End Space Cooling - area for shaft extension outer [rear]
