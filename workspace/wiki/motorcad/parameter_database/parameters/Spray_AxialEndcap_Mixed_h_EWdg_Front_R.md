...
parameter_name: Spray_AxialEndcap_Mixed_h_EWdg_Front_R
...
aliases:
- Spray_AxialEndcap_Mixed_h_EWdg_Front_R
- Spray Axial Endcap Mixed h E Wdg Front R
- spray_axial_endcap_mixed_h_e_wdg_front_r
- sprayAxialEndcapMixedHEWdgFrontR
- spray_axialendcap_mixed_h_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the rear endwinding front surface
