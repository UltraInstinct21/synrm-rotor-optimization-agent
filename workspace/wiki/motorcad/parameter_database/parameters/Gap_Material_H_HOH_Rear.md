...
parameter_name: Gap_Material_H_HOH_Rear
...
aliases:
- Gap_Material_H_HOH_Rear
- Gap Material H HOH Rear
- gap_material_h_hoh_rear
- gapMaterialHHohRear
related_parameters:
...
## Summary
Material in the interface gap between the Housing and Housing OHang [R].
