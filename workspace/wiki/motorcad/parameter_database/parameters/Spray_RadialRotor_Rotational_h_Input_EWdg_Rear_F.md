...
parameter_name: Spray_RadialRotor_Rotational_h_Input_EWdg_Rear_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_EWdg_Rear_F
- Spray Radial Rotor Rotational h Input E Wdg Rear F
- spray_radial_rotor_rotational_h_input_e_wdg_rear_f
- sprayRadialRotorRotationalHInputEWdgRearF
- spray_radialrotor_rotational_h_input_ewdg_rear_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the front endwinding rear surface
