...
parameter_name: Spray_RadialRotor_Stationary_h_RotorCore_R
...
aliases:
- Spray_RadialRotor_Stationary_h_RotorCore_R
- Spray Radial Rotor Stationary h Rotor Core R
- spray_radial_rotor_stationary_h_rotor_core_r
- sprayRadialRotorStationaryHRotorCoreR
- spray_radialrotor_stationary_h_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the rear rotor core surface
