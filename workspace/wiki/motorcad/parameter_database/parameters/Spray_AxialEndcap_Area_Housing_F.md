...
parameter_name: Spray_AxialEndcap_Area_Housing_F
...
aliases:
- Spray_AxialEndcap_Area_Housing_F
- Spray Axial Endcap Area Housing F
- spray_axial_endcap_area_housing_f
- sprayAxialEndcapAreaHousingF
- spray_axialendcap_area_housing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front housing surface sprayed area
