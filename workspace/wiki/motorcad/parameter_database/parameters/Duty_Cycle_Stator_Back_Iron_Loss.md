...
parameter_name: Duty_Cycle_Stator_Back_Iron_Loss
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Stator Back Iron Loss
- duty_cycle_stator_back_iron_loss
- dutyCycleStatorBackIronLoss
related_parameters:
...
## Summary
Stator back iron loss for each period of the duty cycle
