...
parameter_name: Spray_RadialRotor_Rotational_h_Input_EWdg_Front_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_EWdg_Front_F
- Spray Radial Rotor Rotational h Input E Wdg Front F
- spray_radial_rotor_rotational_h_input_e_wdg_front_f
- sprayRadialRotorRotationalHInputEWdgFrontF
- spray_radialrotor_rotational_h_input_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the front endwinding front surface
