...
parameter_name: Vel_ES_EndRing_End_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_End_F_Calc
- Vel ES End Ring End F Calc
- vel_es_end_ring_end_f_calc
- velEsEndRingEndFCalc
- vel_es_endring_end_f_calc
related_parameters:
...
## Summary
The calculated velocity over the end ring End surface [front]
