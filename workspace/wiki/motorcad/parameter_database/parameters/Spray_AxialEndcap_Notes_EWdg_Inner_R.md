...
parameter_name: Spray_AxialEndcap_Notes_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_Notes_EWdg_Inner_R
- Spray Axial Endcap Notes E Wdg Inner R
- spray_axial_endcap_notes_e_wdg_inner_r
- sprayAxialEndcapNotesEWdgInnerR
- spray_axialendcap_notes_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) notes for rear endwinding inner surface
