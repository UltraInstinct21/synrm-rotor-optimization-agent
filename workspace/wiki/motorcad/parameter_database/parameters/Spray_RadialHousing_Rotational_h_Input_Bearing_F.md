...
parameter_name: Spray_RadialHousing_Rotational_h_Input_Bearing_F
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_Bearing_F
- Spray Radial Housing Rotational h Input Bearing F
- spray_radial_housing_rotational_h_input_bearing_f
- sprayRadialHousingRotationalHInputBearingF
- spray_radialhousing_rotational_h_input_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the front bearing surface
