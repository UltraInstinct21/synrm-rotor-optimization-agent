...
parameter_name: Rt_ES_EndRing_ExtInter_F
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_EndRing_ExtInter_F
- Rt ES End Ring Ext Inter F
- rt_es_end_ring_ext_inter_f
- rtEsEndRingExtInterF
- rt_es_endring_extinter_f
related_parameters:
...
## Summary
The thermal resistance end ring Ext Inter surface [front]
