...
parameter_name: Flow_Area_Inlet_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Exp_Downstream
- Flow Area Inlet Exp Downstream
- flow_area_inlet_exp_downstream
- flowAreaInletExpDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Expansion Downstream
