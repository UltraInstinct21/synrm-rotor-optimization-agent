...
parameter_name: Spray_RadialRotor_Area_Mult_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_Area_Mult_EWdg_Outer_R
- Spray Radial Rotor Area Mult E Wdg Outer R
- spray_radial_rotor_area_mult_e_wdg_outer_r
- sprayRadialRotorAreaMultEWdgOuterR
- spray_radialrotor_area_mult_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear endwinding outer surface area multiplier
