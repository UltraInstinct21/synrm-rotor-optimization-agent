...
parameter_name: Calc_Input_h_TVent_Magnet_F
...
aliases:
- Calc_Input_h_TVent_Magnet_F
- Calc Input h T Vent Magnet F
- calc_input_h_t_vent_magnet_f
- calcInputHTVentMagnetF
- calc_input_h_tvent_magnet_f
related_parameters:
...
## Summary
The TVent calculated or input set value for htc from flow over the Magnet surface [front] (0=Calc h, 1=Input h)
