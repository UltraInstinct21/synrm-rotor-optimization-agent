...
parameter_name: Spray_AxialEndcap_Mixed_h_Housing_R
...
aliases:
- Spray_AxialEndcap_Mixed_h_Housing_R
- Spray Axial Endcap Mixed h Housing R
- spray_axial_endcap_mixed_h_housing_r
- sprayAxialEndcapMixedHHousingR
- spray_axialendcap_mixed_h_housing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the rear housing surface
