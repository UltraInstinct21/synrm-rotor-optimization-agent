...
parameter_name: Rt_ES_EndRing_Bore_F_Total
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_EndRing_Bore_F_Total
- Rt ES End Ring Bore F Total
- rt_es_end_ring_bore_f_total
- rtEsEndRingBoreFTotal
- rt_es_endring_bore_f_total
related_parameters:
...
## Summary
The thermal resistance end ring Bore surface (incl ext) [front]
