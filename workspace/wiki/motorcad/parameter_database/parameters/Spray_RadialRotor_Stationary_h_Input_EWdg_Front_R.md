...
parameter_name: Spray_RadialRotor_Stationary_h_Input_EWdg_Front_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_EWdg_Front_R
- Spray Radial Rotor Stationary h Input E Wdg Front R
- spray_radial_rotor_stationary_h_input_e_wdg_front_r
- sprayRadialRotorStationaryHInputEWdgFrontR
- spray_radialrotor_stationary_h_input_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the rear endwinding front surface
