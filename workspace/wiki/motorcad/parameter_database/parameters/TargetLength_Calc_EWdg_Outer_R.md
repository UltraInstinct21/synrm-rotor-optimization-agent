...
parameter_name: TargetLength_Calc_EWdg_Outer_R
...
aliases:
- TargetLength_Calc_EWdg_Outer_R
- Target Length Calc E Wdg Outer R
- target_length_calc_e_wdg_outer_r
- targetLengthCalcEWdgOuterR
- targetlength_calc_ewdg_outer_r
related_parameters:
...
## Summary
This is the calculated length of spray target on outer surface of Rear endwinding
