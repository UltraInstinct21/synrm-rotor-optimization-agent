...
parameter_name: Spray_AxialEndcap_Notes_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_Notes_EWdg_Outer_F
- Spray Axial Endcap Notes E Wdg Outer F
- spray_axial_endcap_notes_e_wdg_outer_f
- sprayAxialEndcapNotesEWdgOuterF
- spray_axialendcap_notes_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) notes for front endwinding outer surface
