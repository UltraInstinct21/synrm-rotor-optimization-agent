...
parameter_name: Spray_AxialEndcap_Stationary_h_EWdg_Outer_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_EWdg_Outer_R
- Spray Axial Endcap Stationary h E Wdg Outer R
- spray_axial_endcap_stationary_h_e_wdg_outer_r
- sprayAxialEndcapStationaryHEWdgOuterR
- spray_axialendcap_stationary_h_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the rear endwinding outer surface
