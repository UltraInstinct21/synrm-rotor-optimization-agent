...
parameter_name: Spray_AxialEndcap_Mixed_h_Bearing_R
...
aliases:
- Spray_AxialEndcap_Mixed_h_Bearing_R
- Spray Axial Endcap Mixed h Bearing R
- spray_axial_endcap_mixed_h_bearing_r
- sprayAxialEndcapMixedHBearingR
- spray_axialendcap_mixed_h_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the rear bearing surface
