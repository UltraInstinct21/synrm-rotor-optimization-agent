...
parameter_name: Vel_ES_EWdg_Front_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EWdg_Front_R_Calc
- Vel ES E Wdg Front R Calc
- vel_es_e_wdg_front_r_calc
- velEsEWdgFrontRCalc
- vel_es_ewdg_front_r_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for EWdg Front surface [Rear]
