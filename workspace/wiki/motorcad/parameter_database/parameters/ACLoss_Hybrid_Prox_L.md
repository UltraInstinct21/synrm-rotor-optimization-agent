...
parameter_name: ACLoss_Hybrid_Prox_L
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- ACLoss_Hybrid_Prox_L
- AC Loss Hybrid Prox L
- ac_loss_hybrid_prox_l
- acLossHybridProxL
- acloss_hybrid_prox_l
related_parameters:
...
## Summary
AC proximity losses of full machine per cuboid (Hybrid) (Left)
