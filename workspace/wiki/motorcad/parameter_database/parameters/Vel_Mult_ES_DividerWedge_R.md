...
parameter_name: Vel_Mult_ES_DividerWedge_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_DividerWedge_R
- Vel Mult ES Divider Wedge R
- vel_mult_es_divider_wedge_r
- velMultEsDividerWedgeR
- vel_mult_es_dividerwedge_r
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for Divider/Wedge [rear]
