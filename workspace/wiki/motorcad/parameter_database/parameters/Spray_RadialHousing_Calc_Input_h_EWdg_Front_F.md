...
parameter_name: Spray_RadialHousing_Calc_Input_h_EWdg_Front_F
...
aliases:
- Spray_RadialHousing_Calc_Input_h_EWdg_Front_F
- Spray Radial Housing Calc Input h E Wdg Front F
- spray_radial_housing_calc_input_h_e_wdg_front_f
- sprayRadialHousingCalcInputHEWdgFrontF
- spray_radialhousing_calc_input_h_ewdg_front_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the front endwinding front surface is calculated or user input  (0=Calc h, 1=Input h)
