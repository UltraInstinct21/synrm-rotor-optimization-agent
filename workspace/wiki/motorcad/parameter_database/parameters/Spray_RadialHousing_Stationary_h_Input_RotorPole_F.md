...
parameter_name: Spray_RadialHousing_Stationary_h_Input_RotorPole_F
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_RotorPole_F
- Spray Radial Housing Stationary h Input Rotor Pole F
- spray_radial_housing_stationary_h_input_rotor_pole_f
- sprayRadialHousingStationaryHInputRotorPoleF
- spray_radialhousing_stationary_h_input_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the front rotor pole surface
