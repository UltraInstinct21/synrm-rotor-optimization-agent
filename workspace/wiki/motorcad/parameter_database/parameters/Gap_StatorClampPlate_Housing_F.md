...
parameter_name: Gap_StatorClampPlate_Housing_F
...
aliases:
- Gap_StatorClampPlate_Housing_F
- Gap Stator Clamp Plate Housing F
- gap_stator_clamp_plate_housing_f
- gapStatorClampPlateHousingF
- gap_statorclampplate_housing_f
related_parameters:
...
## Summary
The effective gap between the stator clamp plate and the housing [Front]
