...
parameter_name: Vel_Mult_TVent_EndRing_Outer_R
...
aliases:
- Vel_Mult_TVent_EndRing_Outer_R
- Vel Mult T Vent End Ring Outer R
- vel_mult_t_vent_end_ring_outer_r
- velMultTVentEndRingOuterR
- vel_mult_tvent_endring_outer_r
related_parameters:
...
## Summary
The TVent velocity multiplier over the end ring Outer surface [rear]
