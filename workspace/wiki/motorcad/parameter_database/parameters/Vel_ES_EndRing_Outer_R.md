...
parameter_name: Vel_ES_EndRing_Outer_R
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_Outer_R
- Vel ES End Ring Outer R
- vel_es_end_ring_outer_r
- velEsEndRingOuterR
- vel_es_endring_outer_r
related_parameters:
...
## Summary
The velocity over the end ring Outer surface [rear]
