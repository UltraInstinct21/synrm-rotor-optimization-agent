...
parameter_name: Spray_RadialHousing_Notes_RotorPole_R
...
aliases:
- Spray_RadialHousing_Notes_RotorPole_R
- Spray Radial Housing Notes Rotor Pole R
- spray_radial_housing_notes_rotor_pole_r
- sprayRadialHousingNotesRotorPoleR
- spray_radialhousing_notes_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) notes for rear rotor pole surface
