...
parameter_name: Spray_RadialRotor_Area_Mult_EWdg_Inner_F
...
aliases:
- Spray_RadialRotor_Area_Mult_EWdg_Inner_F
- Spray Radial Rotor Area Mult E Wdg Inner F
- spray_radial_rotor_area_mult_e_wdg_inner_f
- sprayRadialRotorAreaMultEWdgInnerF
- spray_radialrotor_area_mult_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) front endwinding inner surface area multiplier
