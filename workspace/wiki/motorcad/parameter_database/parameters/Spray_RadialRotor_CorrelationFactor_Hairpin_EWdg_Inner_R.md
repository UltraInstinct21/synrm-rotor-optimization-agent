...
parameter_name: Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Inner_R
- Spray Radial Rotor Correlation Factor Hairpin E Wdg Inner R
- spray_radial_rotor_correlation_factor_hairpin_e_wdg_inner_r
- sprayRadialRotorCorrelationFactorHairpinEWdgInnerR
- spray_radialrotor_correlationfactor_hairpin_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the hairpin rear endwinding inner surface
