...
parameter_name: InitialTransientWdgTempMethod
...
aliases:
- InitialTransientWdgTempMethod
- Initial Transient Wdg Temp Method
- initial_transient_wdg_temp_method
- initialTransientWdgTempMethod
- initialtransientwdgtempmethod
related_parameters:
...
## Summary
Method used to set initial winding temperatures for thermal transient calculation.
