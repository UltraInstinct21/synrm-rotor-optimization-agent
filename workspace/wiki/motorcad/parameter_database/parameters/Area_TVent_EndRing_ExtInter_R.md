...
parameter_name: Area_TVent_EndRing_ExtInter_R
...
aliases:
- Area_TVent_EndRing_ExtInter_R
- Area T Vent End Ring Ext Inter R
- area_t_vent_end_ring_ext_inter_r
- areaTVentEndRingExtInterR
- area_tvent_endring_extinter_r
related_parameters:
...
## Summary
Surface area of the EndRing ExtInter [Rear] for Through Ventilation
