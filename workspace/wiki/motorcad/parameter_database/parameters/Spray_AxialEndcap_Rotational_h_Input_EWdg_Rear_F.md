...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_EWdg_Rear_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_EWdg_Rear_F
- Spray Axial Endcap Rotational h Input E Wdg Rear F
- spray_axial_endcap_rotational_h_input_e_wdg_rear_f
- sprayAxialEndcapRotationalHInputEWdgRearF
- spray_axialendcap_rotational_h_input_ewdg_rear_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the front endwinding rear surface
