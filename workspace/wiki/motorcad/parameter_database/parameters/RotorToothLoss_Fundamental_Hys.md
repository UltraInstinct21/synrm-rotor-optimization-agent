...
parameter_name: RotorToothLoss_Fundamental_Hys
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- RotorToothLoss_Fundamental_Hys
- Rotor Tooth Loss Fundamental Hys
- rotor_tooth_loss_fundamental_hys
- rotorToothLossFundamentalHys
- rotortoothloss_fundamental_hys
related_parameters:
...
- '[[motorcad/parameter_database/parameters/RotorToothLoss_Eddy_Adj|RotorToothLoss_Eddy_Adj]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Rotor tooth losses from hysteresis
