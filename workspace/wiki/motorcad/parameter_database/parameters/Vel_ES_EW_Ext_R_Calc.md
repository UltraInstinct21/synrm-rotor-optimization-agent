...
parameter_name: Vel_ES_EW_Ext_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EW_Ext_R_Calc
- Vel ES EW Ext R Calc
- vel_es_ew_ext_r_calc
- velEsEwExtRCalc
related_parameters:
...
## Summary
End Space Cooling - calculated air velocity end-winding extension surface [rear]
