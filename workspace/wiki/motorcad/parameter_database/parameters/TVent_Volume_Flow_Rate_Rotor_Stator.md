...
parameter_name: TVent_Volume_Flow_Rate_Rotor_Stator
category: TVent_Data
input_output: o/p
data_type: double
units: m³/s
...
aliases:
- TVent_Volume_Flow_Rate_Rotor_Stator
- T Vent Volume Flow Rate Rotor Stator
- t_vent_volume_flow_rate_rotor_stator
- tVentVolumeFlowRateRotorStator
- tvent_volume_flow_rate_rotor_stator
related_parameters:
...
## Summary
Working flow rate of rotor // stator
