...
parameter_name: Spray_AxialEndcap_Area_Mult_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Area_Mult_RotorPole_F
- Spray Axial Endcap Area Mult Rotor Pole F
- spray_axial_endcap_area_mult_rotor_pole_f
- sprayAxialEndcapAreaMultRotorPoleF
- spray_axialendcap_area_mult_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front rotor pole surface area multiplier
