...
parameter_name: Vel_Mult_ES_EWdg_Inner_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EWdg_Inner_R
- Vel Mult ES E Wdg Inner R
- vel_mult_es_e_wdg_inner_r
- velMultEsEWdgInnerR
- vel_mult_es_ewdg_inner_r
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for EWdg Inner surface [Rear]
