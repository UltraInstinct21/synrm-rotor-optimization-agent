...
parameter_name: Area_Mult_ES_EndRing_ExtInter_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_ExtInter_F
- Area Mult ES End Ring Ext Inter F
- area_mult_es_end_ring_ext_inter_f
- areaMultEsEndRingExtInterF
- area_mult_es_endring_extinter_f
related_parameters:
...
## Summary
Area multiplier for the End Ring Extension Inter [Front] surface for End Space Cooling
