...
parameter_name: Average_Temp_TVent_EndRing_Outer_F
...
aliases:
- Average_Temp_TVent_EndRing_Outer_F
- Average Temp T Vent End Ring Outer F
- average_temp_t_vent_end_ring_outer_f
- averageTempTVentEndRingOuterF
- average_temp_tvent_endring_outer_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Average_Temp_TVent_RotorEnd_R|Average_Temp_TVent_RotorEnd_R]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The TVent average temperature of the outer surface of the endring [front]
