...
parameter_name: Vel_ES_StatorPlate_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_StatorPlate_F_Calc
- Vel ES Stator Plate F Calc
- vel_es_stator_plate_f_calc
- velEsStatorPlateFCalc
- vel_es_statorplate_f_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for stator plate [front]
