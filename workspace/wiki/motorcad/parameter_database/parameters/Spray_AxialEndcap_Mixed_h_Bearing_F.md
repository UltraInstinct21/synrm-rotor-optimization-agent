...
parameter_name: Spray_AxialEndcap_Mixed_h_Bearing_F
...
aliases:
- Spray_AxialEndcap_Mixed_h_Bearing_F
- Spray Axial Endcap Mixed h Bearing F
- spray_axial_endcap_mixed_h_bearing_f
- sprayAxialEndcapMixedHBearingF
- spray_axialendcap_mixed_h_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the front bearing surface
