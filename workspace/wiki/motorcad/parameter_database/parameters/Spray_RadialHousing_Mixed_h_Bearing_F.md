...
parameter_name: Spray_RadialHousing_Mixed_h_Bearing_F
...
aliases:
- Spray_RadialHousing_Mixed_h_Bearing_F
- Spray Radial Housing Mixed h Bearing F
- spray_radial_housing_mixed_h_bearing_f
- sprayRadialHousingMixedHBearingF
- spray_radialhousing_mixed_h_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the front bearing surface
