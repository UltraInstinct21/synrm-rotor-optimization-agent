...
parameter_name: Spray_RadialRotor_Dissipation_Bearing_R
...
aliases:
- Spray_RadialRotor_Dissipation_Bearing_R
- Spray Radial Rotor Dissipation Bearing R
- spray_radial_rotor_dissipation_bearing_r
- sprayRadialRotorDissipationBearingR
- spray_radialrotor_dissipation_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the rear bearing surface
