...
parameter_name: Spray_AxialEndcap_Rotational_h_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_RotorPole_F
- Spray Axial Endcap Rotational h Rotor Pole F
- spray_axial_endcap_rotational_h_rotor_pole_f
- sprayAxialEndcapRotationalHRotorPoleF
- spray_axialendcap_rotational_h_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc over the front rotor pole surface
