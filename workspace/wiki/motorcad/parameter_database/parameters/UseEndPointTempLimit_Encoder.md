...
parameter_name: UseEndPointTempLimit_Encoder
category: Transient
input_output: i/p
data_type: boolean
units: N/A
...
aliases:
- UseEndPointTempLimit_Encoder
- Use End Point Temp Limit Encoder
- use_end_point_temp_limit_encoder
- useEndPointTempLimitEncoder
- useendpointtemplimit_encoder
related_parameters:
...
- '[[motorcad/parameter_database/parameters/UseEndPointTempLimit_FieldWdg|UseEndPointTempLimit_FieldWdg]]'
...
## Summary
When set true the encoder temperature will be considered when the transient end point definition is set to temperature limit
