...
parameter_name: Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Outer_F
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Outer_F
- Spray Radial Rotor Correlation Factor Stranded E Wdg Outer F
- spray_radial_rotor_correlation_factor_stranded_e_wdg_outer_f
- sprayRadialRotorCorrelationFactorStrandedEWdgOuterF
- spray_radialrotor_correlationfactor_stranded_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the stranded front endwinding outer surface
