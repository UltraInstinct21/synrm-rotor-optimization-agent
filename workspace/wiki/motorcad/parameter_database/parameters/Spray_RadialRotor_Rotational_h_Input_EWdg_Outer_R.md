...
parameter_name: Spray_RadialRotor_Rotational_h_Input_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_EWdg_Outer_R
- Spray Radial Rotor Rotational h Input E Wdg Outer R
- spray_radial_rotor_rotational_h_input_e_wdg_outer_r
- sprayRadialRotorRotationalHInputEWdgOuterR
- spray_radialrotor_rotational_h_input_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the rear endwinding outer surface
