...
parameter_name: K_SyncRotorTangential_User_R
...
aliases:
- K_SyncRotorTangential_User_R
- K Sync Rotor Tangential User R
- k_sync_rotor_tangential_user_r
- kSyncRotorTangentialUserR
- k_syncrotortangential_user_r
related_parameters:
...
## Summary
This is the user input thermal conductivity of the sync field winding [rear] in the tangential direction
