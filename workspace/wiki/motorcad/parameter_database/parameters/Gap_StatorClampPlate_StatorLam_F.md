...
parameter_name: Gap_StatorClampPlate_StatorLam_F
...
aliases:
- Gap_StatorClampPlate_StatorLam_F
- Gap Stator Clamp Plate Stator Lam F
- gap_stator_clamp_plate_stator_lam_f
- gapStatorClampPlateStatorLamF
- gap_statorclampplate_statorlam_f
related_parameters:
...
## Summary
The effective gap between the stator clamp plate and the stator laminations [Front]
