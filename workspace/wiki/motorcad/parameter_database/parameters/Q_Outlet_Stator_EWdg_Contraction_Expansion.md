...
parameter_name: Q_Outlet_Stator_EWdg_Contraction_Expansion
category: TVent_Data
input_output: o/p
data_type: double
units: m³/s
...
aliases:
- Q_Outlet_Stator_EWdg_Contraction_Expansion
- Q Outlet Stator E Wdg Contraction Expansion
- q_outlet_stator_e_wdg_contraction_expansion
- qOutletStatorEWdgContractionExpansion
- q_outlet_stator_ewdg_contraction_expansion
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Q_Inlet_Entrance|Q_Inlet_Entrance]]'
- '[[motorcad/parameter_database/parameters/Q_Inlet_Entrance_R|Q_Inlet_Entrance_R]]'
- '[[motorcad/parameter_database/parameters/Q_Inlet_Expansion|Q_Inlet_Expansion]]'
- '[[motorcad/parameter_database/parameters/Q_Inlet_Expansion_R|Q_Inlet_Expansion_R]]'
- '[[motorcad/parameter_database/parameters/Q_Inlet_Stator_Bend|Q_Inlet_Stator_Bend]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Q Outlet Stator EWdg Contraction Expansion
