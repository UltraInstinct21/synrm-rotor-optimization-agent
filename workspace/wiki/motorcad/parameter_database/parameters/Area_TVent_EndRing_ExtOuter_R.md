...
parameter_name: Area_TVent_EndRing_ExtOuter_R
...
aliases:
- Area_TVent_EndRing_ExtOuter_R
- Area T Vent End Ring Ext Outer R
- area_t_vent_end_ring_ext_outer_r
- areaTVentEndRingExtOuterR
- area_tvent_endring_extouter_r
related_parameters:
...
## Summary
Surface area of the EndRing ExtOuter [Rear] for Through Ventilation
