...
parameter_name: Spray_RadialHousing_Rotational_h_Input_RotorCore_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_RotorCore_R
- Spray Radial Housing Rotational h Input Rotor Core R
- spray_radial_housing_rotational_h_input_rotor_core_r
- sprayRadialHousingRotationalHInputRotorCoreR
- spray_radialhousing_rotational_h_input_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the rear rotor core surface
