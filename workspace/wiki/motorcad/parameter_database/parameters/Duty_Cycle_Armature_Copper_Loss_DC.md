...
parameter_name: Duty_Cycle_Armature_Copper_Loss_DC
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Armature Copper Loss DC
- duty_cycle_armature_copper_loss_dc
- dutyCycleArmatureCopperLossDc
related_parameters:
...
## Summary
DC copper loss in the armature winding for each period of the duty cycle
