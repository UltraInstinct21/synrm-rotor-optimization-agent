...
parameter_name: h_Input_TVent_CupCylinderOH
...
aliases:
- h_Input_TVent_CupCylinderOH
- h Input T Vent Cup Cylinder OH
- h_input_t_vent_cup_cylinder_oh
- hInputTVentCupCylinderOh
- h_input_tvent_cupcylinderoh
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the Cup Cylinder Overhang
