...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_EWdg_Outer_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_EWdg_Outer_R
- Spray Axial Endcap Stationary h Input E Wdg Outer R
- spray_axial_endcap_stationary_h_input_e_wdg_outer_r
- sprayAxialEndcapStationaryHInputEWdgOuterR
- spray_axialendcap_stationary_h_input_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the rear endwinding outer surface
