...
parameter_name: Calc_Input_h_TVent_Rotor_Spacer
...
aliases:
- Calc_Input_h_TVent_Rotor_Spacer
- Calc Input h T Vent Rotor Spacer
- calc_input_h_t_vent_rotor_spacer
- calcInputHTVentRotorSpacer
- calc_input_h_tvent_rotor_spacer
related_parameters:
