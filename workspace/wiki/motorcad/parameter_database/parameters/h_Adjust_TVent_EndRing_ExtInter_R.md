...
parameter_name: h_Adjust_TVent_EndRing_ExtInter_R
...
aliases:
- h_Adjust_TVent_EndRing_ExtInter_R
- h Adjust T Vent End Ring Ext Inter R
- h_adjust_t_vent_end_ring_ext_inter_r
- hAdjustTVentEndRingExtInterR
- h_adjust_tvent_endring_extinter_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the end ring ExtInter surface [rear]
