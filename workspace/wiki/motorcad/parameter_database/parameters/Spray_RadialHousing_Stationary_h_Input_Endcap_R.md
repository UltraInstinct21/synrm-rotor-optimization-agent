...
parameter_name: Spray_RadialHousing_Stationary_h_Input_Endcap_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_Endcap_R
- Spray Radial Housing Stationary h Input Endcap R
- spray_radial_housing_stationary_h_input_endcap_r
- sprayRadialHousingStationaryHInputEndcapR
- spray_radialhousing_stationary_h_input_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the rear endcap surface
