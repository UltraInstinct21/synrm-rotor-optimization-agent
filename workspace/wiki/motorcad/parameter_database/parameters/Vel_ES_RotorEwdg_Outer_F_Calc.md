...
parameter_name: Vel_ES_RotorEwdg_Outer_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_RotorEwdg_Outer_F_Calc
- Vel ES Rotor Ewdg Outer F Calc
- vel_es_rotor_ewdg_outer_f_calc
- velEsRotorEwdgOuterFCalc
- vel_es_rotorewdg_outer_f_calc
related_parameters:
...
## Summary
The calculated velocity over the end wdg Outer surface [front]
