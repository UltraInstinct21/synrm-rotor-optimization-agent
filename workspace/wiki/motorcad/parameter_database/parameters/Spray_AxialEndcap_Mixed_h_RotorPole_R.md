...
parameter_name: Spray_AxialEndcap_Mixed_h_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Mixed_h_RotorPole_R
- Spray Axial Endcap Mixed h Rotor Pole R
- spray_axial_endcap_mixed_h_rotor_pole_r
- sprayAxialEndcapMixedHRotorPoleR
- spray_axialendcap_mixed_h_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the rear rotor pole surface
