...
parameter_name: Area_TVent_RotorLam_F
...
aliases:
- Area_TVent_RotorLam_F
- Area T Vent Rotor Lam F
- area_t_vent_rotor_lam_f
- areaTVentRotorLamF
- area_tvent_rotorlam_f
related_parameters:
...
## Summary
Surface area of the Rotor [Front] for Through Ventilation
