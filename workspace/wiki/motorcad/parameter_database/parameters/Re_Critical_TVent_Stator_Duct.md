...
parameter_name: Re_Critical_TVent_Stator_Duct
category: TVent_Data
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Re_Critical_TVent_Stator_Duct
- Re Critical T Vent Stator Duct
- re_critical_t_vent_stator_duct
- reCriticalTVentStatorDuct
- re_critical_tvent_stator_duct
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the stator duct surface
