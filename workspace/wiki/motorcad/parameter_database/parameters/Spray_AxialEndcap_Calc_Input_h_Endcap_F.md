...
parameter_name: Spray_AxialEndcap_Calc_Input_h_Endcap_F
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_Endcap_F
- Spray Axial Endcap Calc Input h Endcap F
- spray_axial_endcap_calc_input_h_endcap_f
- sprayAxialEndcapCalcInputHEndcapF
- spray_axialendcap_calc_input_h_endcap_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the front endcap surface is calculated or user input  (0=Calc h, 1=Input h)
