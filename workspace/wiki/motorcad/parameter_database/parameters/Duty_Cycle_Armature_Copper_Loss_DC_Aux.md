...
parameter_name: Duty_Cycle_Armature_Copper_Loss_DC_Aux
category: Transient
input_output: i/p
data_type: double
units: Watts
...
aliases:
- Duty_Cycle_Armature_Copper_Loss_DC_Aux
- Duty Cycle Armature Copper Loss DC Aux
- duty_cycle_armature_copper_loss_dc_aux
- dutyCycleArmatureCopperLossDcAux
related_parameters:
...
## Summary
DC copper loss in the aux armature winding for each period of the duty cycle
