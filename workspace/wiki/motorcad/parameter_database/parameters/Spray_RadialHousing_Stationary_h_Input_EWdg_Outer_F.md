...
parameter_name: Spray_RadialHousing_Stationary_h_Input_EWdg_Outer_F
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_EWdg_Outer_F
- Spray Radial Housing Stationary h Input E Wdg Outer F
- spray_radial_housing_stationary_h_input_e_wdg_outer_f
- sprayRadialHousingStationaryHInputEWdgOuterF
- spray_radialhousing_stationary_h_input_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the front endwinding outer surface
