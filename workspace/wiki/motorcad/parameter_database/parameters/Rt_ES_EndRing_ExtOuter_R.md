...
parameter_name: Rt_ES_EndRing_ExtOuter_R
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_EndRing_ExtOuter_R
- Rt ES End Ring Ext Outer R
- rt_es_end_ring_ext_outer_r
- rtEsEndRingExtOuterR
- rt_es_endring_extouter_r
related_parameters:
...
## Summary
The thermal resistance end ring Ext Outer surface [rear]
