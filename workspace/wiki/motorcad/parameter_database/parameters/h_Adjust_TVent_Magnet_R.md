...
parameter_name: h_Adjust_TVent_Magnet_R
...
aliases:
- h_Adjust_TVent_Magnet_R
- h Adjust T Vent Magnet R
- h_adjust_t_vent_magnet_r
- hAdjustTVentMagnetR
- h_adjust_tvent_magnet_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the Magnet surface [rear]
