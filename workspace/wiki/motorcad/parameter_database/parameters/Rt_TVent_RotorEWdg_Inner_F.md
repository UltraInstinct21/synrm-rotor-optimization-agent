...
parameter_name: Rt_TVent_RotorEWdg_Inner_F
...
aliases:
- Rt_TVent_RotorEWdg_Inner_F
- Rt T Vent Rotor E Wdg Inner F
- rt_t_vent_rotor_e_wdg_inner_f
- rtTVentRotorEWdgInnerF
- rt_tvent_rotorewdg_inner_f
related_parameters:
...
## Summary
The thermal resistance from the inner surface of front rotor endwinding to the fluid
