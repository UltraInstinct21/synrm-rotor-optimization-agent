...
parameter_name: Gap_MaterialConductivity_EndCap_EncCase
...
aliases:
- Gap_MaterialConductivity_EndCap_EncCase
- Gap Material Conductivity End Cap Enc Case
- gap_material_conductivity_end_cap_enc_case
- gapMaterialConductivityEndCapEncCase
- gap_materialconductivity_endcap_enccase
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Endcap and Encoder.
