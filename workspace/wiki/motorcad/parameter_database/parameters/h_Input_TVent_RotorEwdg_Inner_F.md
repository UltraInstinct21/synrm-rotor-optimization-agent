...
parameter_name: h_Input_TVent_RotorEwdg_Inner_F
...
aliases:
- h_Input_TVent_RotorEwdg_Inner_F
- h Input T Vent Rotor Ewdg Inner F
- h_input_t_vent_rotor_ewdg_inner_f
- hInputTVentRotorEwdgInnerF
- h_input_tvent_rotorewdg_inner_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the EWdg Inner surface [front]
