...
parameter_name: h_ES_RotorEwdg_Outer_R
category: End_Space
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_ES_RotorEwdg_Outer_R
- h ES Rotor Ewdg Outer R
- h_es_rotor_ewdg_outer_r
- hEsRotorEwdgOuterR
- h_es_rotorewdg_outer_r
related_parameters:
...
## Summary
The heat transfer coefficient over the end wdg Outer surface [rear]
