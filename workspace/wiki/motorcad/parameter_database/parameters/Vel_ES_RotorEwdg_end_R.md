...
parameter_name: Vel_ES_RotorEwdg_end_R
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_RotorEwdg_end_R
- Vel ES Rotor Ewdg end R
- vel_es_rotor_ewdg_end_r
- velEsRotorEwdgEndR
- vel_es_rotorewdg_end_r
related_parameters:
...
## Summary
The velocity over the end wdg end surface [rear]
