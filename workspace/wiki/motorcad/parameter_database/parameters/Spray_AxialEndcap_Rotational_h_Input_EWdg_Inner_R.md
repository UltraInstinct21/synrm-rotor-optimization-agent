...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_EWdg_Inner_R
- Spray Axial Endcap Rotational h Input E Wdg Inner R
- spray_axial_endcap_rotational_h_input_e_wdg_inner_r
- sprayAxialEndcapRotationalHInputEWdgInnerR
- spray_axialendcap_rotational_h_input_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the rear endwinding inner surface
