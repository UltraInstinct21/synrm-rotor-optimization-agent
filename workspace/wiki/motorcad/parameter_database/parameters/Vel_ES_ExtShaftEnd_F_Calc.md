...
parameter_name: Vel_ES_ExtShaftEnd_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_ExtShaftEnd_F_Calc
- Vel ES Ext Shaft End F Calc
- vel_es_ext_shaft_end_f_calc
- velEsExtShaftEndFCalc
- vel_es_extshaftend_f_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for shaft extension end [front]
