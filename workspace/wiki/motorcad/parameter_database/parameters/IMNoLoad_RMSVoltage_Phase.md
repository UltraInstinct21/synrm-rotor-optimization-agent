...
parameter_name: IMNoLoad_RMSVoltage_Phase
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- IMNoLoad_RMSVoltage_Phase
- IM No Load RMS Voltage Phase
- im_no_load_rms_voltage_phase
- imNoLoadRmsVoltagePhase
- imnoload_rmsvoltage_phase
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IMNoLoad_PeakPhaseCurrent|IMNoLoad_PeakPhaseCurrent]]'
- '[[motorcad/parameter_database/parameters/IMNoLoad_RMSCurrent_Line|IMNoLoad_RMSCurrent_Line]]'
- '[[motorcad/parameter_database/parameters/IMNoLoad_RMSCurrent_Phase|IMNoLoad_RMSCurrent_Phase]]'
- '[[motorcad/parameter_database/parameters/IMNoLoad_RMSVoltage_Line|IMNoLoad_RMSVoltage_Line]]'
- '[[motorcad/parameter_database/parameters/IMNoLoad_ActivePower_Input|IMNoLoad_ActivePower_Input]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
