...
parameter_name: Spray_RadialRotor_Stationary_h_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_Stationary_h_EWdg_Outer_R
- Spray Radial Rotor Stationary h E Wdg Outer R
- spray_radial_rotor_stationary_h_e_wdg_outer_r
- sprayRadialRotorStationaryHEWdgOuterR
- spray_radialrotor_stationary_h_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the rear endwinding outer surface
