...
parameter_name: AFM_Stator_Length
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
- '[[motorcad/parameter_database/parameters/AFM_NumSlices|AFM_NumSlices]]'
- '[[motorcad/parameter_database/parameters/AFM_SliceRadius_Array|AFM_SliceRadius_Array]]'
- '[[motorcad/parameter_database/parameters/AFM_TopologyType|AFM_TopologyType]]'
- '[[motorcad/parameter_database/parameters/AFM_D_Rotor|AFM_D_Rotor]]'
- '[[motorcad/parameter_database/parameters/AFM_Magnet_Embed_Depth|AFM_Magnet_Embed_Depth]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The axial length of each stator region for Axial Flux machines
