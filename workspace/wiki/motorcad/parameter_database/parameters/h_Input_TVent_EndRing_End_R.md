...
parameter_name: h_Input_TVent_EndRing_End_R
...
aliases:
- h_Input_TVent_EndRing_End_R
- h Input T Vent End Ring End R
- h_input_t_vent_end_ring_end_r
- hInputTVentEndRingEndR
- h_input_tvent_endring_end_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the end ring End surface [rear]
