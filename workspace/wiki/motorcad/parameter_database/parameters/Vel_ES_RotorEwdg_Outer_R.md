...
parameter_name: Vel_ES_RotorEwdg_Outer_R
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_RotorEwdg_Outer_R
- Vel ES Rotor Ewdg Outer R
- vel_es_rotor_ewdg_outer_r
- velEsRotorEwdgOuterR
- vel_es_rotorewdg_outer_r
related_parameters:
...
## Summary
The velocity over the end wdg Outer surface [rear]
