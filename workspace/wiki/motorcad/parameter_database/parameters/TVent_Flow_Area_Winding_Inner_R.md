...
parameter_name: TVent_Flow_Area_Winding_Inner_R
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- TVent_Flow_Area_Winding_Inner_R
- T Vent Flow Area Winding Inner R
- t_vent_flow_area_winding_inner_r
- tVentFlowAreaWindingInnerR
- tvent_flow_area_winding_inner_r
related_parameters:
...
## Summary
TVent Flow Area for the Winding Inner Rear
