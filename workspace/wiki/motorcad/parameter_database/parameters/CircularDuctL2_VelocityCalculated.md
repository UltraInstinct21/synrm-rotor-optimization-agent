...
parameter_name: CircularDuctL2_VelocityCalculated
...
aliases:
- CircularDuctL2_VelocityCalculated
- Circular Duct L2 Velocity Calculated
- circular_duct_l2_velocity_calculated
- circularDuctL2VelocityCalculated
- circularductl2_velocitycalculated
related_parameters:
...
## Summary
This is Fluid Velocity for the Layer 2 duct (calculated before user adjustment)
