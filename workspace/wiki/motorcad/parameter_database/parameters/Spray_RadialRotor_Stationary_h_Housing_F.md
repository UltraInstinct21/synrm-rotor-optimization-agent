...
parameter_name: Spray_RadialRotor_Stationary_h_Housing_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Housing_F
- Spray Radial Rotor Stationary h Housing F
- spray_radial_rotor_stationary_h_housing_f
- sprayRadialRotorStationaryHHousingF
- spray_radialrotor_stationary_h_housing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the front housing surface
