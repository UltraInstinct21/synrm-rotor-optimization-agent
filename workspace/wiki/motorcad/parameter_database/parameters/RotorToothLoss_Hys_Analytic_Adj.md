...
parameter_name: RotorToothLoss_Hys_Analytic_Adj
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- RotorToothLoss_Hys_Analytic_Adj
- Rotor Tooth Loss Hys Analytic Adj
- rotor_tooth_loss_hys_analytic_adj
- rotorToothLossHysAnalyticAdj
- rotortoothloss_hys_analytic_adj
related_parameters:
...
## Summary
Rotor tooth losses from hysteresis (adjusted for build factor)
