...
parameter_name: Spray_RadialHousing_Stationary_h_RotorPole_R
...
aliases:
- Spray_RadialHousing_Stationary_h_RotorPole_R
- Spray Radial Housing Stationary h Rotor Pole R
- spray_radial_housing_stationary_h_rotor_pole_r
- sprayRadialHousingStationaryHRotorPoleR
- spray_radialhousing_stationary_h_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc over the rear rotor pole surface
