...
parameter_name: Area_ES_EndRing_ExtInter_F
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_EndRing_ExtInter_F
- Area ES End Ring Ext Inter F
- area_es_end_ring_ext_inter_f
- areaEsEndRingExtInterF
- area_es_endring_extinter_f
related_parameters:
...
## Summary
The area of the end ring ExtInter surface [front]
