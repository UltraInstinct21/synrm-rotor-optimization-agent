...
parameter_name: Vel_Mult_ES_EndRing_ExtInter_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EndRing_ExtInter_R
- Vel Mult ES End Ring Ext Inter R
- vel_mult_es_end_ring_ext_inter_r
- velMultEsEndRingExtInterR
- vel_mult_es_endring_extinter_r
related_parameters:
...
## Summary
The velocity multiplier for end ring ExtInter surface [rear]
