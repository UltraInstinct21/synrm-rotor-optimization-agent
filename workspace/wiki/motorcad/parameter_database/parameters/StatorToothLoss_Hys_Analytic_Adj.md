...
parameter_name: StatorToothLoss_Hys_Analytic_Adj
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- StatorToothLoss_Hys_Analytic_Adj
- Stator Tooth Loss Hys Analytic Adj
- stator_tooth_loss_hys_analytic_adj
- statorToothLossHysAnalyticAdj
- statortoothloss_hys_analytic_adj
related_parameters:
...
## Summary
Stator tooth losses from hysteresis (adjusted for build factor)
