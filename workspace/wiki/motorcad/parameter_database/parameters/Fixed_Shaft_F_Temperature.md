...
parameter_name: Fixed_Shaft_F_Temperature
...
aliases:
- Fixed_Shaft_F_Temperature
- Fixed Shaft F Temperature
- fixed_shaft_f_temperature
- fixedShaftFTemperature
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Fixed_Axle_R_Temperature|Fixed_Axle_R_Temperature]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Fix shaft[F] temperature at set value (by injecting power into plate)
