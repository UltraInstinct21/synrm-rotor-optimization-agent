...
parameter_name: Rear_Potting_Housing_Gap_Comment
...
aliases:
- Rear_Potting_Housing_Gap_Comment
- Rear Potting Housing Gap Comment
- rear_potting_housing_gap_comment
- rearPottingHousingGapComment
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Rear_Potting_Axle_Gap_Comment|Rear_Potting_Axle_Gap_Comment]]'
- '[[motorcad/parameter_database/parameters/Rear_Potting_Endcap_Gap_Comment|Rear_Potting_Endcap_Gap_Comment]]'
- '[[motorcad/parameter_database/parameters/Rear_Potting_Housing_Gap_Notes|Rear_Potting_Housing_Gap_Notes]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Details of the interface gap between potting and housing (rear of motor)
