...
parameter_name: Flow_Area_Inlet_Airgap_Duct_Cont_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Airgap_Duct_Cont_Upstream
- Flow Area Inlet Airgap Duct Cont Upstream
- flow_area_inlet_airgap_duct_cont_upstream
- flowAreaInletAirgapDuctContUpstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Airgap Duct Contraction Upstream
