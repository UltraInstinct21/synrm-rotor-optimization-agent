...
parameter_name: Rt_ES_EndRing_Bore_R_Total
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_EndRing_Bore_R_Total
- Rt ES End Ring Bore R Total
- rt_es_end_ring_bore_r_total
- rtEsEndRingBoreRTotal
- rt_es_endring_bore_r_total
related_parameters:
...
## Summary
The thermal resistance end ring Bore surface (incl ext) [rear]
