...
parameter_name: Vel_ES_EndRing_Outer_F
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_Outer_F
- Vel ES End Ring Outer F
- vel_es_end_ring_outer_f
- velEsEndRingOuterF
- vel_es_endring_outer_f
related_parameters:
...
## Summary
The velocity over the end ring Outer surface [front]
