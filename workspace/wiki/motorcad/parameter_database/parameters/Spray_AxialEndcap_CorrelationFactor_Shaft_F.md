...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Shaft_F
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Shaft_F
- Spray Axial Endcap Correlation Factor Shaft F
- spray_axial_endcap_correlation_factor_shaft_f
- sprayAxialEndcapCorrelationFactorShaftF
- spray_axialendcap_correlationfactor_shaft_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the front shaft surface
