...
parameter_name: Flow_Area_Winding_Separator_Exp_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Winding_Separator_Exp_Upstream
- Flow Area Winding Separator Exp Upstream
- flow_area_winding_separator_exp_upstream
- flowAreaWindingSeparatorExpUpstream
related_parameters:
...
## Summary
TVent Flow Area for the Winding Separator Expansion Upstream
