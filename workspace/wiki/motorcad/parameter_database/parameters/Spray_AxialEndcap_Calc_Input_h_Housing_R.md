...
parameter_name: Spray_AxialEndcap_Calc_Input_h_Housing_R
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_Housing_R
- Spray Axial Endcap Calc Input h Housing R
- spray_axial_endcap_calc_input_h_housing_r
- sprayAxialEndcapCalcInputHHousingR
- spray_axialendcap_calc_input_h_housing_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the rear housing surface is calculated or user input  (0=Calc h, 1=Input h)
