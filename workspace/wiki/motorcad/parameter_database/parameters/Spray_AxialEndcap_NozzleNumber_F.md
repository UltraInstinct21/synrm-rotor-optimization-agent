...
parameter_name: Spray_AxialEndcap_NozzleNumber_F
...
aliases:
- Spray_AxialEndcap_NozzleNumber_F
- Spray Axial Endcap Nozzle Number F
- spray_axial_endcap_nozzle_number_f
- sprayAxialEndcapNozzleNumberF
- spray_axialendcap_nozzlenumber_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front nozzle number
