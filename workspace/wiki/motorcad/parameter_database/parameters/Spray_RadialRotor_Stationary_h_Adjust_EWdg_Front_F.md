...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_EWdg_Front_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_EWdg_Front_F
- Spray Radial Rotor Stationary h Adjust E Wdg Front F
- spray_radial_rotor_stationary_h_adjust_e_wdg_front_f
- sprayRadialRotorStationaryHAdjustEWdgFrontF
- spray_radialrotor_stationary_h_adjust_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the front endwinding front surface
