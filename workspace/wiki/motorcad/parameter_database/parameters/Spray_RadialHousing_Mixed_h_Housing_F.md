...
parameter_name: Spray_RadialHousing_Mixed_h_Housing_F
...
aliases:
- Spray_RadialHousing_Mixed_h_Housing_F
- Spray Radial Housing Mixed h Housing F
- spray_radial_housing_mixed_h_housing_f
- sprayRadialHousingMixedHHousingF
- spray_radialhousing_mixed_h_housing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the front housing surface
