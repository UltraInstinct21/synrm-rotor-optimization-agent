...
parameter_name: Spray_RadialRotor_Stationary_h_Input_EWdg_Rear_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_EWdg_Rear_F
- Spray Radial Rotor Stationary h Input E Wdg Rear F
- spray_radial_rotor_stationary_h_input_e_wdg_rear_f
- sprayRadialRotorStationaryHInputEWdgRearF
- spray_radialrotor_stationary_h_input_ewdg_rear_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the front endwinding rear surface
