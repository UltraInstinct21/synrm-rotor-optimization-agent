...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_EWdg_Front_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_EWdg_Front_R
- Spray Axial Endcap Rotational h Input E Wdg Front R
- spray_axial_endcap_rotational_h_input_e_wdg_front_r
- sprayAxialEndcapRotationalHInputEWdgFrontR
- spray_axialendcap_rotational_h_input_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the rear endwinding front surface
