...
parameter_name: NumberRadialForceHarmonics_OL
category: Magnetics
input_output: o/p
data_type: integer
units: N/A
...
aliases:
- NumberRadialForceHarmonics_OL
- Number Radial Force Harmonics OL
- number_radial_force_harmonics_ol
- numberRadialForceHarmonicsOl
- numberradialforceharmonics_ol
related_parameters:
...
- '[[motorcad/parameter_database/parameters/NumberRadialForceHarmonics_OC|NumberRadialForceHarmonics_OC]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The number of radial force harmonic orders extracted from On Load force data
