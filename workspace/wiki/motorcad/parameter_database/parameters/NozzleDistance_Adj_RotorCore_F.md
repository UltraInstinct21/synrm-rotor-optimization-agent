...
parameter_name: NozzleDistance_Adj_RotorCore_F
...
aliases:
- NozzleDistance_Adj_RotorCore_F
- Nozzle Distance Adj Rotor Core F
- nozzle_distance_adj_rotor_core_f
- nozzleDistanceAdjRotorCoreF
- nozzledistance_adj_rotorcore_f
related_parameters:
...
## Summary
This is the adjustment to distance of nozzle to front Rotor Core
