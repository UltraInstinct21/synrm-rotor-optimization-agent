...
parameter_name: h_TVent_Axial_RotorEwdg_Outer_R
...
aliases:
- h_TVent_Axial_RotorEwdg_Outer_R
- h T Vent Axial Rotor Ewdg Outer R
- h_t_vent_axial_rotor_ewdg_outer_r
- hTVentAxialRotorEwdgOuterR
- h_tvent_axial_rotorewdg_outer_r
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the EWdg Outer surface [rear]
