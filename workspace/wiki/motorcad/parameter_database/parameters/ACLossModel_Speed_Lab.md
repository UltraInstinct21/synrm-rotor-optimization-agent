...
parameter_name: ACLossModel_Speed_Lab
...
aliases:
- ACLossModel_Speed_Lab
- AC Loss Model Speed Lab
- ac_loss_model_speed_lab
- acLossModelSpeedLab
- aclossmodel_speed_lab
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ACLossModel_Gamma_Lab|ACLossModel_Gamma_Lab]]'
- '[[motorcad/parameter_database/parameters/ACLossModel_Is_Lab|ACLossModel_Is_Lab]]'
- '[[motorcad/parameter_database/parameters/ACLossModel_Ir_Lab|ACLossModel_Ir_Lab]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
