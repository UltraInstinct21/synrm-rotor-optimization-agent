...
parameter_name: SprayCoverageProp_RotorCore_F
...
aliases:
- SprayCoverageProp_RotorCore_F
- Spray Coverage Prop Rotor Core F
- spray_coverage_prop_rotor_core_f
- sprayCoveragePropRotorCoreF
- spraycoverageprop_rotorcore_f
related_parameters:
...
## Summary
Proportion of the total surface area of the Rotor Core Front that is subjected to Spray Cooling
