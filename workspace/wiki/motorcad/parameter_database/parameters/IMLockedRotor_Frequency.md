...
parameter_name: IMLockedRotor_Frequency
category: Magnetics
input_output: o/p
data_type: double
units: Hz
...
aliases:
- IMLockedRotor_Frequency
- IM Locked Rotor Frequency
- im_locked_rotor_frequency
- imLockedRotorFrequency
- imlockedrotor_frequency
related_parameters:
...
## Summary
The drive frequency values used in Locked Rotor case
