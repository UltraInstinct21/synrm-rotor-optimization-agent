...
parameter_name: Flow_Area_Inlet_Entrance_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Entrance_Upstream
- Flow Area Inlet Entrance Upstream
- flow_area_inlet_entrance_upstream
- flowAreaInletEntranceUpstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Entrance Upstream
