...
parameter_name: Spray_RadialRotor_Stationary_h_Shaft_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Shaft_R
- Spray Radial Rotor Stationary h Shaft R
- spray_radial_rotor_stationary_h_shaft_r
- sprayRadialRotorStationaryHShaftR
- spray_radialrotor_stationary_h_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the rear shaft surface
