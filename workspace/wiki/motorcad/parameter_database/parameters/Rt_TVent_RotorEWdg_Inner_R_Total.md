...
parameter_name: Rt_TVent_RotorEWdg_Inner_R_Total
...
aliases:
- Rt_TVent_RotorEWdg_Inner_R_Total
- Rt T Vent Rotor E Wdg Inner R Total
- rt_t_vent_rotor_e_wdg_inner_r_total
- rtTVentRotorEWdgInnerRTotal
- rt_tvent_rotorewdg_inner_r_total
related_parameters:
...
## Summary
The thermal resistance from the inner surface (incl ext) of rear rotor endwinding to the fluid
