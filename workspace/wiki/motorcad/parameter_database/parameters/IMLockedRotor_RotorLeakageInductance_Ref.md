...
parameter_name: IMLockedRotor_RotorLeakageInductance_Ref
category: Magnetics
input_output: o/p
data_type: double
units: Henry
...
aliases:
- IMLockedRotor_RotorLeakageInductance_Ref
- IM Locked Rotor Rotor Leakage Inductance Ref
- im_locked_rotor_rotor_leakage_inductance_ref
- imLockedRotorRotorLeakageInductanceRef
- imlockedrotor_rotorleakageinductance_ref
related_parameters:
...
## Summary
The referred rotor leakage inductance in the Locked Rotor case
