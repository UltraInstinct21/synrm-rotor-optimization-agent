...
parameter_name: Spray_AxialEndcap_Stationary_h_Adjust_EWdg_Front_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Adjust_EWdg_Front_F
- Spray Axial Endcap Stationary h Adjust E Wdg Front F
- spray_axial_endcap_stationary_h_adjust_e_wdg_front_f
- sprayAxialEndcapStationaryHAdjustEWdgFrontF
- spray_axialendcap_stationary_h_adjust_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc adjustment over the front endwinding front surface
