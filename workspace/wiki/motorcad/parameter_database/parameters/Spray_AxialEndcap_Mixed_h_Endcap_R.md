...
parameter_name: Spray_AxialEndcap_Mixed_h_Endcap_R
...
aliases:
- Spray_AxialEndcap_Mixed_h_Endcap_R
- Spray Axial Endcap Mixed h Endcap R
- spray_axial_endcap_mixed_h_endcap_r
- sprayAxialEndcapMixedHEndcapR
- spray_axialendcap_mixed_h_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the rear endcap surface
