...
parameter_name: Flow_Area_Outlet_Airgap_Duct_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Airgap_Duct_Exp_Downstream
- Flow Area Outlet Airgap Duct Exp Downstream
- flow_area_outlet_airgap_duct_exp_downstream
- flowAreaOutletAirgapDuctExpDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Airgap Duct Expansion Downstream
