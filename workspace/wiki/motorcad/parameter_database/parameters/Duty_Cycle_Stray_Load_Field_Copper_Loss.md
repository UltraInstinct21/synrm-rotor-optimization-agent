...
parameter_name: Duty_Cycle_Stray_Load_Field_Copper_Loss
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Stray Load Field Copper Loss
- duty_cycle_stray_load_field_copper_loss
- dutyCycleStrayLoadFieldCopperLoss
related_parameters:
...
## Summary
Stray load loss in the field winding for each period of the duty cycle
