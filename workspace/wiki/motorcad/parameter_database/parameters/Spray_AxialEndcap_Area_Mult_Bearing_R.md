...
parameter_name: Spray_AxialEndcap_Area_Mult_Bearing_R
...
aliases:
- Spray_AxialEndcap_Area_Mult_Bearing_R
- Spray Axial Endcap Area Mult Bearing R
- spray_axial_endcap_area_mult_bearing_r
- sprayAxialEndcapAreaMultBearingR
- spray_axialendcap_area_mult_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear bearing surface area multiplier
