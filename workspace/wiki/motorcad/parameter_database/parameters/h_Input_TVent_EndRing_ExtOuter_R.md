...
parameter_name: h_Input_TVent_EndRing_ExtOuter_R
...
aliases:
- h_Input_TVent_EndRing_ExtOuter_R
- h Input T Vent End Ring Ext Outer R
- h_input_t_vent_end_ring_ext_outer_r
- hInputTVentEndRingExtOuterR
- h_input_tvent_endring_extouter_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the end ring ExtOuter surface [rear]
