...
parameter_name: Default_EndSpace_Correlation
...
aliases:
- Default_EndSpace_Correlation
- Default End Space Correlation
- default_end_space_correlation
- defaultEndSpaceCorrelation
- default_endspace_correlation
related_parameters:
...
## Summary
Default end space convection correlation used in table below
