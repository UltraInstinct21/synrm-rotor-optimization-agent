...
parameter_name: Notes_(Bearing_-_Shaft_[F])
...
aliases:
- Notes_(Bearing_-_Shaft_[F])
- Notes_(Bearing_-_Shaft_(F))
- Notes Bearing Shaft F
- notes_bearing_shaft_f
- notesBearingShaftF
- notes_(bearing_-_shaft_[f])
related_parameters:
...
## Summary
Notes - Interface gap between bearing and shaft [front of motor]
