...
parameter_name: Duty_Cycle_Stray_Load_Rotor_Iron_Loss
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Stray Load Rotor Iron Loss
- duty_cycle_stray_load_rotor_iron_loss
- dutyCycleStrayLoadRotorIronLoss
related_parameters:
...
## Summary
Stray load loss in the rotor iron for each period of the duty cycle
