...
parameter_name: Spray_RadialRotor_Rotational_h_Input_Bearing_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_Bearing_F
- Spray Radial Rotor Rotational h Input Bearing F
- spray_radial_rotor_rotational_h_input_bearing_f
- sprayRadialRotorRotationalHInputBearingF
- spray_radialrotor_rotational_h_input_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the front bearing surface
