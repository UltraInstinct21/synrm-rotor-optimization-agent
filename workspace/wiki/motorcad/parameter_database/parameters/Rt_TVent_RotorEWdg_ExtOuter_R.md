...
parameter_name: Rt_TVent_RotorEWdg_ExtOuter_R
...
aliases:
- Rt_TVent_RotorEWdg_ExtOuter_R
- Rt T Vent Rotor E Wdg Ext Outer R
- rt_t_vent_rotor_e_wdg_ext_outer_r
- rtTVentRotorEWdgExtOuterR
- rt_tvent_rotorewdg_extouter_r
related_parameters:
...
## Summary
The thermal resistance from the ext outer surface of rear rotor endwinding to the fluid
