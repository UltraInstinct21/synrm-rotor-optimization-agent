...
parameter_name: Rt_TVent_EndRing_End_R
...
aliases:
- Rt_TVent_EndRing_End_R
- Rt T Vent End Ring End R
- rt_t_vent_end_ring_end_r
- rtTVentEndRingEndR
- rt_tvent_endring_end_r
related_parameters:
...
## Summary
The thermal resistance from the end surface of rear rotor end ring to the fluid
