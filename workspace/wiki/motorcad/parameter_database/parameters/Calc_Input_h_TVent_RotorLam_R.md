...
parameter_name: Calc_Input_h_TVent_RotorLam_R
...
aliases:
- Calc_Input_h_TVent_RotorLam_R
- Calc Input h T Vent Rotor Lam R
- calc_input_h_t_vent_rotor_lam_r
- calcInputHTVentRotorLamR
- calc_input_h_tvent_rotorlam_r
related_parameters:
...
## Summary
The TVent calculated or input set value for htc from flow over the Rotor lam surface [rear] (0=Calc h, 1=Input h)
