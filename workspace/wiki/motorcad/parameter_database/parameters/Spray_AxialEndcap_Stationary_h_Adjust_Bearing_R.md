...
parameter_name: Spray_AxialEndcap_Stationary_h_Adjust_Bearing_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Adjust_Bearing_R
- Spray Axial Endcap Stationary h Adjust Bearing R
- spray_axial_endcap_stationary_h_adjust_bearing_r
- sprayAxialEndcapStationaryHAdjustBearingR
- spray_axialendcap_stationary_h_adjust_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc adjustment over the rear bearing surface
