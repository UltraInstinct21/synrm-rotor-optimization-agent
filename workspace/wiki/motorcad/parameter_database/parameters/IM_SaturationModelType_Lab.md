...
parameter_name: IM_SaturationModelType_Lab
...
aliases:
- IM_SaturationModelType_Lab
- IM Saturation Model Type Lab
- im_saturation_model_type_lab
- imSaturationModelTypeLab
- im_saturationmodeltype_lab
related_parameters:
...
## Summary
Type of model used for IM magnetizing inductance model
