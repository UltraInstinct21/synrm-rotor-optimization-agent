...
parameter_name: h_Input_TVent_RotorEwdg_Inner_R
...
aliases:
- h_Input_TVent_RotorEwdg_Inner_R
- h Input T Vent Rotor Ewdg Inner R
- h_input_t_vent_rotor_ewdg_inner_r
- hInputTVentRotorEwdgInnerR
- h_input_tvent_rotorewdg_inner_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the EWdg Inner surface [rear]
