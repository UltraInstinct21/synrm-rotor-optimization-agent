...
parameter_name: IMLockedRotor_RotorBarLeakageInductance_Ref
category: Magnetics
input_output: o/p
data_type: double
units: Henry
...
aliases:
- IMLockedRotor_RotorBarLeakageInductance_Ref
- IM Locked Rotor Rotor Bar Leakage Inductance Ref
- im_locked_rotor_rotor_bar_leakage_inductance_ref
- imLockedRotorRotorBarLeakageInductanceRef
- imlockedrotor_rotorbarleakageinductance_ref
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IMLockedRotor_PeakCurrent|IMLockedRotor_PeakCurrent]]'
- '[[motorcad/parameter_database/parameters/IMLockedRotor_Frequency|IMLockedRotor_Frequency]]'
- '[[motorcad/parameter_database/parameters/IMLockedRotor_RotorBarLosses|IMLockedRotor_RotorBarLosses]]'
- '[[motorcad/parameter_database/parameters/IMLockedRotor_StoredMagneticEnergy|IMLockedRotor_StoredMagneticEnergy]]'
- '[[motorcad/parameter_database/parameters/IMLockedRotor_StoredMagneticCoenergy|IMLockedRotor_StoredMagneticCoenergy]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The referred rotor bar leakage inductance in the Locked Rotor case
