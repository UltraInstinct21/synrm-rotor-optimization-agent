...
parameter_name: Spray_RadialRotor_Stationary_h_Input_EWdg_Outer_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_EWdg_Outer_F
- Spray Radial Rotor Stationary h Input E Wdg Outer F
- spray_radial_rotor_stationary_h_input_e_wdg_outer_f
- sprayRadialRotorStationaryHInputEWdgOuterF
- spray_radialrotor_stationary_h_input_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the front endwinding outer surface
