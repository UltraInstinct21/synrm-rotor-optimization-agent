...
parameter_name: Vel_Mult_ES_RotorEwdg_inner_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_RotorEwdg_inner_F
- Vel Mult ES Rotor Ewdg inner F
- vel_mult_es_rotor_ewdg_inner_f
- velMultEsRotorEwdgInnerF
- vel_mult_es_rotorewdg_inner_f
related_parameters:
...
## Summary
The velocity multiplier for end wdg inner surface [front]
