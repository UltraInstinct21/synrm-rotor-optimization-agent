...
parameter_name: Re_Critical_TVent_EndRing_ExtBore_R
...
aliases:
- Re_Critical_TVent_EndRing_ExtBore_R
- Re Critical T Vent End Ring Ext Bore R
- re_critical_t_vent_end_ring_ext_bore_r
- reCriticalTVentEndRingExtBoreR
- re_critical_tvent_endring_extbore_r
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the end ring ExtBore surface [rear]
