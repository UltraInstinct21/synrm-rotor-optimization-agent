...
parameter_name: SyncRotorWindingTempCalc
...
aliases:
- SyncRotorWindingTempCalc
- Sync Rotor Winding Temp Calc
- sync_rotor_winding_temp_calc
- syncRotorWindingTempCalc
- syncrotorwindingtempcalc
related_parameters:
...
## Summary
This determines whether to use the old or improved method of averaging the sync rotor winding temperature.
