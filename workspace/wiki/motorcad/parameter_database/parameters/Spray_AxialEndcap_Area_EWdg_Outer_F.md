...
parameter_name: Spray_AxialEndcap_Area_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_Area_EWdg_Outer_F
- Spray Axial Endcap Area E Wdg Outer F
- spray_axial_endcap_area_e_wdg_outer_f
- sprayAxialEndcapAreaEWdgOuterF
- spray_axialendcap_area_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front endwinding outer surface sprayed area
