...
parameter_name: Outlet_Temp_TVent_EWdg_End_Endcap_F
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Outlet_Temp_TVent_EWdg_End_Endcap_F
- Outlet Temp T Vent E Wdg End Endcap F
- outlet_temp_t_vent_e_wdg_end_endcap_f
- outletTempTVentEWdgEndEndcapF
- outlet_temp_tvent_ewdg_end_endcap_f
related_parameters:
...
## Summary
Motor-CAD automation parameter `Outlet_Temp_TVent_EWdg_End_Endcap_F` in category `TVent_Data`.
