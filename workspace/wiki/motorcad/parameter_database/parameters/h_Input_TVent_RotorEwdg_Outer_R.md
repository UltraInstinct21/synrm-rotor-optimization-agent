...
parameter_name: h_Input_TVent_RotorEwdg_Outer_R
...
aliases:
- h_Input_TVent_RotorEwdg_Outer_R
- h Input T Vent Rotor Ewdg Outer R
- h_input_t_vent_rotor_ewdg_outer_r
- hInputTVentRotorEwdgOuterR
- h_input_tvent_rotorewdg_outer_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the EWdg Outer surface [rear]
