...
parameter_name: Vel_ES_EndRing_ExtOuter_F
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_ExtOuter_F
- Vel ES End Ring Ext Outer F
- vel_es_end_ring_ext_outer_f
- velEsEndRingExtOuterF
- vel_es_endring_extouter_f
related_parameters:
...
## Summary
The velocity over the end ring ExtOuter surface [front]
