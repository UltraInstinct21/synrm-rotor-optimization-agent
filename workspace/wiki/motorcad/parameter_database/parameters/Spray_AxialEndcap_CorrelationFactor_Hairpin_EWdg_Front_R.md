...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Hairpin_EWdg_Front_R
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Hairpin_EWdg_Front_R
- Spray Axial Endcap Correlation Factor Hairpin E Wdg Front R
- spray_axial_endcap_correlation_factor_hairpin_e_wdg_front_r
- sprayAxialEndcapCorrelationFactorHairpinEWdgFrontR
- spray_axialendcap_correlationfactor_hairpin_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the hairpin rear endwinding front surface
