...
parameter_name: Spray_RadialHousing_Dissipation_RotorCore_F
...
aliases:
- Spray_RadialHousing_Dissipation_RotorCore_F
- Spray Radial Housing Dissipation Rotor Core F
- spray_radial_housing_dissipation_rotor_core_f
- sprayRadialHousingDissipationRotorCoreF
- spray_radialhousing_dissipation_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) thermal dissipation from the front rotor core surface
