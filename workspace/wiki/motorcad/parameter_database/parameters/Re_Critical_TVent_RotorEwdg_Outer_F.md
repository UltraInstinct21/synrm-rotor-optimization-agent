...
parameter_name: Re_Critical_TVent_RotorEwdg_Outer_F
...
aliases:
- Re_Critical_TVent_RotorEwdg_Outer_F
- Re Critical T Vent Rotor Ewdg Outer F
- re_critical_t_vent_rotor_ewdg_outer_f
- reCriticalTVentRotorEwdgOuterF
- re_critical_tvent_rotorewdg_outer_f
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the EWdg Outer surface [front]
