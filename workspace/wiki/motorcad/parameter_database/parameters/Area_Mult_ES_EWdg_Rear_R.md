...
parameter_name: Area_Mult_ES_EWdg_Rear_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EWdg_Rear_R
- Area Mult ES E Wdg Rear R
- area_mult_es_e_wdg_rear_r
- areaMultEsEWdgRearR
- area_mult_es_ewdg_rear_r
related_parameters:
...
## Summary
Area multiplier for the End-Winding Rear [Rear] surfaces for End Space Cooling
