...
parameter_name: Spray_AxialEndcap_Rt_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Rt_RotorCore_R
- Spray Axial Endcap Rt Rotor Core R
- spray_axial_endcap_rt_rotor_core_r
- sprayAxialEndcapRtRotorCoreR
- spray_axialendcap_rt_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to rear rotor core surface convective thermal resistance
