...
parameter_name: Spray_RadialHousing_Dissipation_Endcap_F
...
aliases:
- Spray_RadialHousing_Dissipation_Endcap_F
- Spray Radial Housing Dissipation Endcap F
- spray_radial_housing_dissipation_endcap_f
- sprayRadialHousingDissipationEndcapF
- spray_radialhousing_dissipation_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) thermal dissipation from the front endcap surface
