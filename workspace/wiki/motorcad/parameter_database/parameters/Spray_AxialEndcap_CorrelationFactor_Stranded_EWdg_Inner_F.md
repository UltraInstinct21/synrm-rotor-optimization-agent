...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Stranded_EWdg_Inner_F
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Stranded_EWdg_Inner_F
- Spray Axial Endcap Correlation Factor Stranded E Wdg Inner F
- spray_axial_endcap_correlation_factor_stranded_e_wdg_inner_f
- sprayAxialEndcapCorrelationFactorStrandedEWdgInnerF
- spray_axialendcap_correlationfactor_stranded_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the stranded front endwinding inner surface
