...
parameter_name: Spray_RadialHousing_Notes_RotorCore_F
...
aliases:
- Spray_RadialHousing_Notes_RotorCore_F
- Spray Radial Housing Notes Rotor Core F
- spray_radial_housing_notes_rotor_core_f
- sprayRadialHousingNotesRotorCoreF
- spray_radialhousing_notes_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) notes for front rotor core surface
