...
parameter_name: Spray_AxialEndcap_Area_Mult_Endcap_R
...
aliases:
- Spray_AxialEndcap_Area_Mult_Endcap_R
- Spray Axial Endcap Area Mult Endcap R
- spray_axial_endcap_area_mult_endcap_r
- sprayAxialEndcapAreaMultEndcapR
- spray_axialendcap_area_mult_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear endcap surface area multiplier
