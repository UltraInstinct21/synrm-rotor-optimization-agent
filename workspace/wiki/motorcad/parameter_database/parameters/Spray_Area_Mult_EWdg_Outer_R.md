...
parameter_name: Spray_Area_Mult_EWdg_Outer_R
...
aliases:
- Spray_Area_Mult_EWdg_Outer_R
- Spray Area Mult E Wdg Outer R
- spray_area_mult_e_wdg_outer_r
- sprayAreaMultEWdgOuterR
- spray_area_mult_ewdg_outer_r
related_parameters:
...
## Summary
Area multiplier for the EndWinding Outer Rear section subjected to Spray Cooling
