...
parameter_name: Gap_Material_EndCap_Plate
...
aliases:
- Gap_Material_EndCap_Plate
- Gap Material End Cap Plate
- gap_material_end_cap_plate
- gapMaterialEndCapPlate
- gap_material_endcap_plate
related_parameters:
...
## Summary
Material in the interface gap between the Endcap and Plate.
