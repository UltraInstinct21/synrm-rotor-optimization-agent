...
parameter_name: Spray_RadialRotor_Rotational_h_Input_Housing_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_Housing_R
- Spray Radial Rotor Rotational h Input Housing R
- spray_radial_rotor_rotational_h_input_housing_r
- sprayRadialRotorRotationalHInputHousingR
- spray_radialrotor_rotational_h_input_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the rear housing surface
