...
parameter_name: Spray_AxialEndcap_Notes_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Notes_RotorCore_F
- Spray Axial Endcap Notes Rotor Core F
- spray_axial_endcap_notes_rotor_core_f
- sprayAxialEndcapNotesRotorCoreF
- spray_axialendcap_notes_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) notes for front rotor core surface
