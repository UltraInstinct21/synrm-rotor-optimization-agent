...
parameter_name: h_Adjust_TVent_EndRing_Outer_R
...
aliases:
- h_Adjust_TVent_EndRing_Outer_R
- h Adjust T Vent End Ring Outer R
- h_adjust_t_vent_end_ring_outer_r
- hAdjustTVentEndRingOuterR
- h_adjust_tvent_endring_outer_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the end ring Outer surface [rear]
