...
parameter_name: TargetLength_Adj_RotorCore_F
...
aliases:
- TargetLength_Adj_RotorCore_F
- Target Length Adj Rotor Core F
- target_length_adj_rotor_core_f
- targetLengthAdjRotorCoreF
- targetlength_adj_rotorcore_f
related_parameters:
...
## Summary
This is the adjustment to the length of spray target on front Rotor Core
