...
parameter_name: Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Inner_R
- Spray Radial Rotor Correlation Factor Stranded E Wdg Inner R
- spray_radial_rotor_correlation_factor_stranded_e_wdg_inner_r
- sprayRadialRotorCorrelationFactorStrandedEWdgInnerR
- spray_radialrotor_correlationfactor_stranded_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the stranded rear endwinding inner surface
