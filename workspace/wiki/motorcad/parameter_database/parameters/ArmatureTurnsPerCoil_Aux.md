...
parameter_name: ArmatureTurnsPerCoil_Aux
category: Magnetics
input_output: o/p
data_type: double
units: N/A
...
aliases:
- ArmatureTurnsPerCoil_Aux
- Armature Turns Per Coil Aux
- armature_turns_per_coil_aux
- armatureTurnsPerCoilAux
- armatureturnspercoil_aux
related_parameters:
...
## Summary
The average number of turns per coil in the aux winding
