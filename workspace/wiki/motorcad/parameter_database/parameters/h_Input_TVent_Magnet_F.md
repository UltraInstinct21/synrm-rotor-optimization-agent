...
parameter_name: h_Input_TVent_Magnet_F
...
aliases:
- h_Input_TVent_Magnet_F
- h Input T Vent Magnet F
- h_input_t_vent_magnet_f
- hInputTVentMagnetF
- h_input_tvent_magnet_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the Magnet surface [front]
