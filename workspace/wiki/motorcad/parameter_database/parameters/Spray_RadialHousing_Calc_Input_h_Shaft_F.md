...
parameter_name: Spray_RadialHousing_Calc_Input_h_Shaft_F
...
aliases:
- Spray_RadialHousing_Calc_Input_h_Shaft_F
- Spray Radial Housing Calc Input h Shaft F
- spray_radial_housing_calc_input_h_shaft_f
- sprayRadialHousingCalcInputHShaftF
- spray_radialhousing_calc_input_h_shaft_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the front shaft surface is calculated or user input  (0=Calc h, 1=Input h)
