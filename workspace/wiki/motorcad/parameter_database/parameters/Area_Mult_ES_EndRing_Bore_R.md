...
parameter_name: Area_Mult_ES_EndRing_Bore_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_Bore_R
- Area Mult ES End Ring Bore R
- area_mult_es_end_ring_bore_r
- areaMultEsEndRingBoreR
- area_mult_es_endring_bore_r
related_parameters:
...
## Summary
Area multiplier for the End Ring Bore [Rear] surface for End Space Cooling
