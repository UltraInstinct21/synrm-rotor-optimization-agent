...
parameter_name: StatorLoss_Minor_Hys
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- StatorLoss_Minor_Hys
- Stator Loss Minor Hys
- stator_loss_minor_hys
- statorLossMinorHys
- statorloss_minor_hys
related_parameters:
...
- '[[motorcad/parameter_database/parameters/StatorLoss_Eddy_Adj|StatorLoss_Eddy_Adj]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Stator iron losses from hysteresis (minor loops component)
