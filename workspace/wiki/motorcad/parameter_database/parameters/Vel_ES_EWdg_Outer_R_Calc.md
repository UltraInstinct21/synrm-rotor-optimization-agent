...
parameter_name: Vel_ES_EWdg_Outer_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EWdg_Outer_R_Calc
- Vel ES E Wdg Outer R Calc
- vel_es_e_wdg_outer_r_calc
- velEsEWdgOuterRCalc
- vel_es_ewdg_outer_r_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for EWdg Outer surface [Rear]
