...
parameter_name: Spray_RadialRotor_NozzleNumber_R
...
aliases:
- Spray_RadialRotor_NozzleNumber_R
- Spray Radial Rotor Nozzle Number R
- spray_radial_rotor_nozzle_number_r
- sprayRadialRotorNozzleNumberR
- spray_radialrotor_nozzlenumber_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear nozzle number
