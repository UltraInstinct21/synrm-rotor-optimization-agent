...
parameter_name: LabModel_Saturation_StatorCurrent_Peak
...
- Lab Model Saturation Stator Current Peak
- lab_model_saturation_stator_current_peak
- labModelSaturationStatorCurrentPeak
- labmodel_saturation_statorcurrent_peak
related_parameters:
...
- '[[motorcad/parameter_database/parameters/LabModel_Saturation_RotorCurrent|LabModel_Saturation_RotorCurrent]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Maximum stator current used in Lab saturation model build (peak)
