...
parameter_name: Outlet_Temp_TVent_Airgap_Stator_Rotor
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Outlet_Temp_TVent_Airgap_Stator_Rotor
- Outlet Temp T Vent Airgap Stator Rotor
- outlet_temp_t_vent_airgap_stator_rotor
- outletTempTVentAirgapStatorRotor
- outlet_temp_tvent_airgap_stator_rotor
related_parameters:
...
## Summary
Motor-CAD automation parameter `Outlet_Temp_TVent_Airgap_Stator_Rotor` in category `TVent_Data`.
