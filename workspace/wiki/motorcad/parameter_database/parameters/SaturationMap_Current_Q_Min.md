...
parameter_name: SaturationMap_Current_Q_Min
...
aliases:
- SaturationMap_Current_Q_Min
- Saturation Map Current Q Min
- saturation_map_current_q_min
- saturationMapCurrentQMin
- saturationmap_current_q_min
related_parameters:
...
## Summary
Minimum Q axis current used in the saturation map calculation
