...
parameter_name: Spray_RadialRotor_Mixed_h_RotorCore_R
...
aliases:
- Spray_RadialRotor_Mixed_h_RotorCore_R
- Spray Radial Rotor Mixed h Rotor Core R
- spray_radial_rotor_mixed_h_rotor_core_r
- sprayRadialRotorMixedHRotorCoreR
- spray_radialrotor_mixed_h_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the rear rotor core surface
