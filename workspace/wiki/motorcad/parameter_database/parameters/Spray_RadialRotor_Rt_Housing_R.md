...
parameter_name: Spray_RadialRotor_Rt_Housing_R
...
aliases:
- Spray_RadialRotor_Rt_Housing_R
- Spray Radial Rotor Rt Housing R
- spray_radial_rotor_rt_housing_r
- sprayRadialRotorRtHousingR
- spray_radialrotor_rt_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to rear housing surface convective thermal resistance
