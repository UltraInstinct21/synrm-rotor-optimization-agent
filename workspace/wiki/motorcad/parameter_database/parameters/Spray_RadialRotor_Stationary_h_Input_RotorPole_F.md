...
parameter_name: Spray_RadialRotor_Stationary_h_Input_RotorPole_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_RotorPole_F
- Spray Radial Rotor Stationary h Input Rotor Pole F
- spray_radial_rotor_stationary_h_input_rotor_pole_f
- sprayRadialRotorStationaryHInputRotorPoleF
- spray_radialrotor_stationary_h_input_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the front rotor pole surface
