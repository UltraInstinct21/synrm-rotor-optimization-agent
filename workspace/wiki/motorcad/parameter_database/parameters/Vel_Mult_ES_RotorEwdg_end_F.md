...
parameter_name: Vel_Mult_ES_RotorEwdg_end_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_RotorEwdg_end_F
- Vel Mult ES Rotor Ewdg end F
- vel_mult_es_rotor_ewdg_end_f
- velMultEsRotorEwdgEndF
- vel_mult_es_rotorewdg_end_f
related_parameters:
...
## Summary
The velocity multiplier for end wdg end surface [front]
