...
parameter_name: Date_Calculated_IMLookupCurves
category: Magnetics
input_output: i/p
data_type: OleStr
units: N/A
...
aliases:
- Date_Calculated_IMLookupCurves
- Date Calculated IM Lookup Curves
- date_calculated_im_lookup_curves
- dateCalculatedImLookupCurves
- date_calculated_imlookupcurves
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Date_Calculated_MagnetisationCurves|Date_Calculated_MagnetisationCurves]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The date of the last IM saturation model calculation
