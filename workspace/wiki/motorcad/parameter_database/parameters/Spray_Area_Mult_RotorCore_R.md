...
parameter_name: Spray_Area_Mult_RotorCore_R
...
aliases:
- Spray_Area_Mult_RotorCore_R
- Spray Area Mult Rotor Core R
- spray_area_mult_rotor_core_r
- sprayAreaMultRotorCoreR
- spray_area_mult_rotorcore_r
related_parameters:
...
## Summary
Area multiplier for the Rotor Core Rear section subjected to Spray Cooling
