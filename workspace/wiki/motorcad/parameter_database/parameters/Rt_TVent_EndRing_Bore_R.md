...
parameter_name: Rt_TVent_EndRing_Bore_R
...
aliases:
- Rt_TVent_EndRing_Bore_R
- Rt T Vent End Ring Bore R
- rt_t_vent_end_ring_bore_r
- rtTVentEndRingBoreR
- rt_tvent_endring_bore_r
related_parameters:
...
## Summary
The thermal resistance from the bore surface of rear rotor end ring to the fluid
