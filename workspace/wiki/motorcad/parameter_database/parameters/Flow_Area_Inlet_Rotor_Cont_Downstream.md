...
parameter_name: Flow_Area_Inlet_Rotor_Cont_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Rotor_Cont_Downstream
- Flow Area Inlet Rotor Cont Downstream
- flow_area_inlet_rotor_cont_downstream
- flowAreaInletRotorContDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Rotor Contraction Downstream
