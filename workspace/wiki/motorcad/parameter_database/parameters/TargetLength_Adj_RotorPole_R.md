...
parameter_name: TargetLength_Adj_RotorPole_R
...
aliases:
- TargetLength_Adj_RotorPole_R
- Target Length Adj Rotor Pole R
- target_length_adj_rotor_pole_r
- targetLengthAdjRotorPoleR
- targetlength_adj_rotorpole_r
related_parameters:
...
## Summary
This is the adjustment to the length of spray target on Rear Rotor Pole
