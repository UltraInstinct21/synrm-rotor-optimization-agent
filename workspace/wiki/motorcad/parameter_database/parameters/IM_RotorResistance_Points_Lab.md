...
parameter_name: IM_RotorResistance_Points_Lab
...
aliases:
- IM_RotorResistance_Points_Lab
- IM Rotor Resistance Points Lab
- im_rotor_resistance_points_lab
- imRotorResistancePointsLab
- im_rotorresistance_points_lab
related_parameters:
...
## Summary
Number of points to define the rotor resistance frequency model
