...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_Housing_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_Housing_R
- Spray Axial Endcap Rotational h Input Housing R
- spray_axial_endcap_rotational_h_input_housing_r
- sprayAxialEndcapRotationalHInputHousingR
- spray_axialendcap_rotational_h_input_housing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the rear housing surface
