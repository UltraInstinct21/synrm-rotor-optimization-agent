...
parameter_name: Spray_AxialEndcap_Rt_Housing_R
...
aliases:
- Spray_AxialEndcap_Rt_Housing_R
- Spray Axial Endcap Rt Housing R
- spray_axial_endcap_rt_housing_r
- sprayAxialEndcapRtHousingR
- spray_axialendcap_rt_housing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to rear housing surface convective thermal resistance
