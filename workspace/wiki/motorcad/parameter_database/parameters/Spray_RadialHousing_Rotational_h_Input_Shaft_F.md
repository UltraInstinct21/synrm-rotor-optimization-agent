...
parameter_name: Spray_RadialHousing_Rotational_h_Input_Shaft_F
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_Shaft_F
- Spray Radial Housing Rotational h Input Shaft F
- spray_radial_housing_rotational_h_input_shaft_f
- sprayRadialHousingRotationalHInputShaftF
- spray_radialhousing_rotational_h_input_shaft_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the front shaft surface
