...
parameter_name: EndPointTempLimit_Commutator
category: Transient
input_output: i/p
data_type: double
units: °C
...
aliases:
- EndPointTempLimit_Commutator
- End Point Temp Limit Commutator
- end_point_temp_limit_commutator
- endPointTempLimitCommutator
- endpointtemplimit_commutator
related_parameters:
...
- '[[motorcad/parameter_database/parameters/EndPointTempLimit_ArmatureWdg|EndPointTempLimit_ArmatureWdg]]'
...
## Summary
The maximum allowed temperature of the commutator when the transient end point definition is set to temperature limit
