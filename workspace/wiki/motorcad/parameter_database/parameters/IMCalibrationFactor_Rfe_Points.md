...
parameter_name: IMCalibrationFactor_Rfe_Points
category: Magnetics
input_output: i/p
data_type: integer
units: N/A
...
aliases:
- IMCalibrationFactor_Rfe_Points
- IM Calibration Factor Rfe Points
- im_calibration_factor_rfe_points
- imCalibrationFactorRfePoints
- imcalibrationfactor_rfe_points
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IMCalibrationFactor_Lm_Points|IMCalibrationFactor_Lm_Points]]'
- '[[motorcad/parameter_database/parameters/IMCalibrationFactor_Lm|IMCalibrationFactor_Lm]]'
- '[[motorcad/parameter_database/parameters/IMCalibrationFactor_Lm_Current|IMCalibrationFactor_Lm_Current]]'
- '[[motorcad/parameter_database/parameters/IMCalibrationFactor_L1_Points|IMCalibrationFactor_L1_Points]]'
- '[[motorcad/parameter_database/parameters/IMCalibrationFactor_L2_Points|IMCalibrationFactor_L2_Points]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Number of points for which the magnetizing core loss resistance calibration factor is defined
