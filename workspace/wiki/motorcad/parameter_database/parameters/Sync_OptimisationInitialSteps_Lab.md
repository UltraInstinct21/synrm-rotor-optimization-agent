...
parameter_name: Sync_OptimisationInitialSteps_Lab
...
aliases:
- Sync_OptimisationInitialSteps_Lab
- Sync Optimisation Initial Steps Lab
- sync_optimisation_initial_steps_lab
- syncOptimisationInitialStepsLab
- sync_optimisationinitialsteps_lab
related_parameters:
...
## Summary
The number of rotor current steps in the initial sweep when using the improved iteration method
