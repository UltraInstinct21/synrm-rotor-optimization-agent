...
parameter_name: Flow_Area_Inlet_Exp_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Exp_Upstream
- Flow Area Inlet Exp Upstream
- flow_area_inlet_exp_upstream
- flowAreaInletExpUpstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Expansion Upstream
