...
parameter_name: Spray_RadialHousing_Calc_Input_h_EWdg_Outer_R
...
aliases:
- Spray_RadialHousing_Calc_Input_h_EWdg_Outer_R
- Spray Radial Housing Calc Input h E Wdg Outer R
- spray_radial_housing_calc_input_h_e_wdg_outer_r
- sprayRadialHousingCalcInputHEWdgOuterR
- spray_radialhousing_calc_input_h_ewdg_outer_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the rear endwinding outer surface is calculated or user input  (0=Calc h, 1=Input h)
