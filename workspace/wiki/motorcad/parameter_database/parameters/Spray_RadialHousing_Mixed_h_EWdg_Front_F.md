...
parameter_name: Spray_RadialHousing_Mixed_h_EWdg_Front_F
...
aliases:
- Spray_RadialHousing_Mixed_h_EWdg_Front_F
- Spray Radial Housing Mixed h E Wdg Front F
- spray_radial_housing_mixed_h_e_wdg_front_f
- sprayRadialHousingMixedHEWdgFrontF
- spray_radialhousing_mixed_h_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the front endwinding front surface
