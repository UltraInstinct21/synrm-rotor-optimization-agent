...
parameter_name: Gap_MaterialConductivity_Comm_Shaft
...
aliases:
- Gap_MaterialConductivity_Comm_Shaft
- Gap Material Conductivity Comm Shaft
- gap_material_conductivity_comm_shaft
- gapMaterialConductivityCommShaft
- gap_materialconductivity_comm_shaft
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Comm and Shaft.
