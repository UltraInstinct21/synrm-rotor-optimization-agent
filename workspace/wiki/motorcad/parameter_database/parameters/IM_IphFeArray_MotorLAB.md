...
parameter_name: IM_IphFeArray_MotorLAB
...
aliases:
- IM_IphFeArray_MotorLAB
- IM Iph Fe Array Motor LAB
- im_iph_fe_array_motor_lab
- imIphFeArrayMotorLab
- im_iphfearray_motorlab
related_parameters:
...
## Summary
Motor-CAD automation parameter `IM_IphFeArray_MotorLAB` in category `ModelParameters_MotorLAB`.
