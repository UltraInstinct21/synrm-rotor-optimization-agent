...
parameter_name: Spray_AxialEndcap_Dissipation_Endcap_F
...
aliases:
- Spray_AxialEndcap_Dissipation_Endcap_F
- Spray Axial Endcap Dissipation Endcap F
- spray_axial_endcap_dissipation_endcap_f
- sprayAxialEndcapDissipationEndcapF
- spray_axialendcap_dissipation_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the front endcap surface
