...
parameter_name: Spray_AxialEndcap_Calc_Input_h_Shaft_F
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_Shaft_F
- Spray Axial Endcap Calc Input h Shaft F
- spray_axial_endcap_calc_input_h_shaft_f
- sprayAxialEndcapCalcInputHShaftF
- spray_axialendcap_calc_input_h_shaft_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the front shaft surface is calculated or user input  (0=Calc h, 1=Input h)
