...
parameter_name: Spray_AxialEndcap_Stationary_h_Housing_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Housing_F
- Spray Axial Endcap Stationary h Housing F
- spray_axial_endcap_stationary_h_housing_f
- sprayAxialEndcapStationaryHHousingF
- spray_axialendcap_stationary_h_housing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the front housing surface
