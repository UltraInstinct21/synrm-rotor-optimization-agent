...
parameter_name: Comment_Gap_StatorClampPlate_Housing_R
...
aliases:
- Comment_Gap_StatorClampPlate_Housing_R
- Comment Gap Stator Clamp Plate Housing R
- comment_gap_stator_clamp_plate_housing_r
- commentGapStatorClampPlateHousingR
- comment_gap_statorclampplate_housing_r
related_parameters:
...
## Summary
Details of the interface gap between stator clamp plate and the housing [Rear]
