...
parameter_name: Outlet_Temp_TVent_EndRing_Outer_F
...
aliases:
- Outlet_Temp_TVent_EndRing_Outer_F
- Outlet Temp T Vent End Ring Outer F
- outlet_temp_t_vent_end_ring_outer_f
- outletTempTVentEndRingOuterF
- outlet_temp_tvent_endring_outer_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Outlet_Temp_TVent_RotorEnd_R|Outlet_Temp_TVent_RotorEnd_R]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The TVent outlet temperature from the outer surface of the endring [front]
