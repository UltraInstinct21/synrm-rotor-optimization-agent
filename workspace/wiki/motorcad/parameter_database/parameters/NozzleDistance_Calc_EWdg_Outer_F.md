...
parameter_name: NozzleDistance_Calc_EWdg_Outer_F
...
aliases:
- NozzleDistance_Calc_EWdg_Outer_F
- Nozzle Distance Calc E Wdg Outer F
- nozzle_distance_calc_e_wdg_outer_f
- nozzleDistanceCalcEWdgOuterF
- nozzledistance_calc_ewdg_outer_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/NozzleDistance_EWdg_Front_F|NozzleDistance_EWdg_Front_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This is the calculated distance of nozzle to outer surface of front endwinding
