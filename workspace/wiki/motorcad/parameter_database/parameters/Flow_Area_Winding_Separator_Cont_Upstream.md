...
parameter_name: Flow_Area_Winding_Separator_Cont_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Winding_Separator_Cont_Upstream
- Flow Area Winding Separator Cont Upstream
- flow_area_winding_separator_cont_upstream
- flowAreaWindingSeparatorContUpstream
related_parameters:
...
## Summary
TVent Flow Area for the Winding Separator Contraction Upstream
