...
parameter_name: Duty_Cycle_Vehicle_Distance
category: Transient
input_output: o/p
data_type: double
units: m
...
aliases:
- Duty_Cycle_Vehicle_Distance
- Duty Cycle Vehicle Distance
- duty_cycle_vehicle_distance
- dutyCycleVehicleDistance
related_parameters:
...
## Summary
Distance traveled by vehicle in each period of the duty cycle
