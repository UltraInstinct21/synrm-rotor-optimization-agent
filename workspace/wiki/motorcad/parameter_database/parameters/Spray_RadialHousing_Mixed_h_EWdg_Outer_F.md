...
parameter_name: Spray_RadialHousing_Mixed_h_EWdg_Outer_F
...
aliases:
- Spray_RadialHousing_Mixed_h_EWdg_Outer_F
- Spray Radial Housing Mixed h E Wdg Outer F
- spray_radial_housing_mixed_h_e_wdg_outer_f
- sprayRadialHousingMixedHEWdgOuterF
- spray_radialhousing_mixed_h_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the front endwinding outer surface
