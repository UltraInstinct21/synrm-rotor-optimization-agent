...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Endcap_R
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Endcap_R
- Spray Axial Endcap Correlation Factor Endcap R
- spray_axial_endcap_correlation_factor_endcap_r
- sprayAxialEndcapCorrelationFactorEndcapR
- spray_axialendcap_correlationfactor_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the rear endcap surface
