...
parameter_name: Gap_Material_Endcap_Axle_Front
...
aliases:
- Gap_Material_Endcap_Axle_Front
- Gap Material Endcap Axle Front
- gap_material_endcap_axle_front
- gapMaterialEndcapAxleFront
related_parameters:
...
## Summary
Material in the interface gap between the Endcap and Axle [F].
