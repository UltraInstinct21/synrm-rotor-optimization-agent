...
parameter_name: h_ES_EndRing_ExtBore_R
category: End_Space
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_ES_EndRing_ExtBore_R
- h ES End Ring Ext Bore R
- h_es_end_ring_ext_bore_r
- hEsEndRingExtBoreR
- h_es_endring_extbore_r
related_parameters:
...
## Summary
The heat transfer coefficient over the end ring ExtBore surface [rear]
