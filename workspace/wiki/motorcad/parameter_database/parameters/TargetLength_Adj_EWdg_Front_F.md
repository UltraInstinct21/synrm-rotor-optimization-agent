...
parameter_name: TargetLength_Adj_EWdg_Front_F
...
aliases:
- TargetLength_Adj_EWdg_Front_F
- Target Length Adj E Wdg Front F
- target_length_adj_e_wdg_front_f
- targetLengthAdjEWdgFrontF
- targetlength_adj_ewdg_front_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/TargetLength_EWdg_Front_F|TargetLength_EWdg_Front_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This is the adjustment to the length of spray target on front surface of front endwinding
