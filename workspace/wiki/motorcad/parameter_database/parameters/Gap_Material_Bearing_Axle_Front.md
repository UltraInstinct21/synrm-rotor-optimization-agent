...
parameter_name: Gap_Material_Bearing_Axle_Front
...
aliases:
- Gap_Material_Bearing_Axle_Front
- Gap Material Bearing Axle Front
- gap_material_bearing_axle_front
- gapMaterialBearingAxleFront
related_parameters:
...
## Summary
Material in the interface gap between the Bearing and Axle [F].
