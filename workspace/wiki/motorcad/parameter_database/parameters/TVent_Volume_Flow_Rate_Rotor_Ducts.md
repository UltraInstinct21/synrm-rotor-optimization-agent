...
parameter_name: TVent_Volume_Flow_Rate_Rotor_Ducts
category: TVent_Data
input_output: o/p
data_type: double
units: m³/s
...
aliases:
- TVent_Volume_Flow_Rate_Rotor_Ducts
- T Vent Volume Flow Rate Rotor Ducts
- t_vent_volume_flow_rate_rotor_ducts
- tVentVolumeFlowRateRotorDucts
- tvent_volume_flow_rate_rotor_ducts
related_parameters:
...
## Summary
Working flow rate of rotor ducts
