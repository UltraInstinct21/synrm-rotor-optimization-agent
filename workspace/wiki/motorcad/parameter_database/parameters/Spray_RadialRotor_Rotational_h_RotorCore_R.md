...
parameter_name: Spray_RadialRotor_Rotational_h_RotorCore_R
...
aliases:
- Spray_RadialRotor_Rotational_h_RotorCore_R
- Spray Radial Rotor Rotational h Rotor Core R
- spray_radial_rotor_rotational_h_rotor_core_r
- sprayRadialRotorRotationalHRotorCoreR
- spray_radialrotor_rotational_h_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc over the rear rotor core surface
