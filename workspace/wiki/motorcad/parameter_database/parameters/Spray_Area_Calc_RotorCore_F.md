...
parameter_name: Spray_Area_Calc_RotorCore_F
...
aliases:
- Spray_Area_Calc_RotorCore_F
- Spray Area Calc Rotor Core F
- spray_area_calc_rotor_core_f
- sprayAreaCalcRotorCoreF
- spray_area_calc_rotorcore_f
related_parameters:
...
## Summary
Calculated Area of the Rotor Core Front section subjected to Spray Cooling
