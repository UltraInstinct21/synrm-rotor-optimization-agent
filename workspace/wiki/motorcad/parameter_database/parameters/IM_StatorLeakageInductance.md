...
parameter_name: IM_StatorLeakageInductance
category: Magnetics
input_output: o/p
data_type: double
units: Henry
...
aliases:
- IM_StatorLeakageInductance
- IM Stator Leakage Inductance
- im_stator_leakage_inductance
- imStatorLeakageInductance
- im_statorleakageinductance
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IM_MagnetizingInductance|IM_MagnetizingInductance]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The stator winding leakage inductance
