...
parameter_name: Flow_Area_Outlet_Airgap_Duct_Exp_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Airgap_Duct_Exp_Upstream
- Flow Area Outlet Airgap Duct Exp Upstream
- flow_area_outlet_airgap_duct_exp_upstream
- flowAreaOutletAirgapDuctExpUpstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Airgap Duct Expansion Upstream
