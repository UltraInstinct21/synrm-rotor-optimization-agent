...
parameter_name: Re_Critical_TVent_Rotor_Spacer
category: TVent_Data
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Re_Critical_TVent_Rotor_Spacer
- Re Critical T Vent Rotor Spacer
- re_critical_t_vent_rotor_spacer
- reCriticalTVentRotorSpacer
- re_critical_tvent_rotor_spacer
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the rotor spacer surface
