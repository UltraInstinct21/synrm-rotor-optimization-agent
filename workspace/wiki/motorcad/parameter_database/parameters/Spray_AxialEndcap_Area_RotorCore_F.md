...
parameter_name: Spray_AxialEndcap_Area_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Area_RotorCore_F
- Spray Axial Endcap Area Rotor Core F
- spray_axial_endcap_area_rotor_core_f
- sprayAxialEndcapAreaRotorCoreF
- spray_axialendcap_area_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front rotor core surface sprayed area
