...
parameter_name: Spray_RadialHousing_CorrelationFactor_RotorPole_F
...
aliases:
- Spray_RadialHousing_CorrelationFactor_RotorPole_F
- Spray Radial Housing Correlation Factor Rotor Pole F
- spray_radial_housing_correlation_factor_rotor_pole_f
- sprayRadialHousingCorrelationFactorRotorPoleF
- spray_radialhousing_correlationfactor_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the front rotor pole surface
