...
parameter_name: Vel_Mult_TVent_RotorLam_R
...
aliases:
- Vel_Mult_TVent_RotorLam_R
- Vel Mult T Vent Rotor Lam R
- vel_mult_t_vent_rotor_lam_r
- velMultTVentRotorLamR
- vel_mult_tvent_rotorlam_r
related_parameters:
...
## Summary
The TVent velocity multiplier over the Rotor lam surface [rear]
