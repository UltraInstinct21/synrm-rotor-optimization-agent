...
parameter_name: IMOnLoad_RMSCoreLossCurrent_T
category: Magnetics
input_output: o/p
data_type: double
units: Amps
...
aliases:
- IMOnLoad_RMSCoreLossCurrent_T
- IM On Load RMS Core Loss Current T
- im_on_load_rms_core_loss_current_t
- imOnLoadRmsCoreLossCurrentT
- imonload_rmscorelosscurrent_t
related_parameters:
...
## Summary
The on load rms core loss current in T circuit
