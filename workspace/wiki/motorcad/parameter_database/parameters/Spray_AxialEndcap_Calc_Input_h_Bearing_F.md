...
parameter_name: Spray_AxialEndcap_Calc_Input_h_Bearing_F
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_Bearing_F
- Spray Axial Endcap Calc Input h Bearing F
- spray_axial_endcap_calc_input_h_bearing_f
- sprayAxialEndcapCalcInputHBearingF
- spray_axialendcap_calc_input_h_bearing_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the front bearing surface is calculated or user input  (0=Calc h, 1=Input h)
