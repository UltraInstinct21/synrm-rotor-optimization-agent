...
parameter_name: Spray_AxialEndcap_Calc_Input_h_EWdg_Front_R
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_EWdg_Front_R
- Spray Axial Endcap Calc Input h E Wdg Front R
- spray_axial_endcap_calc_input_h_e_wdg_front_r
- sprayAxialEndcapCalcInputHEWdgFrontR
- spray_axialendcap_calc_input_h_ewdg_front_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the rear endwinding front surface is calculated or user input  (0=Calc h, 1=Input h)
