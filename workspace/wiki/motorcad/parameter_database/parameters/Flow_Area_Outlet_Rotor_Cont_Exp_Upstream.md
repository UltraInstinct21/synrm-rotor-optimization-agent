...
parameter_name: Flow_Area_Outlet_Rotor_Cont_Exp_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Rotor_Cont_Exp_Upstream
- Flow Area Outlet Rotor Cont Exp Upstream
- flow_area_outlet_rotor_cont_exp_upstream
- flowAreaOutletRotorContExpUpstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Rotor Contraction Expansion Upstream
