...
parameter_name: LabModel_ACLoss_StatorCurrent_RMS
...
- Lab Model AC Loss Stator Current RMS
- lab_model_ac_loss_stator_current_rms
- labModelAcLossStatorCurrentRms
- labmodel_acloss_statorcurrent_rms
related_parameters:
...
## Summary
Maximum stator current used in Lab AC loss model build (rms)
