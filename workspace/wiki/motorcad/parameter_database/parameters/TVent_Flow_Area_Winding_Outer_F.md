...
parameter_name: TVent_Flow_Area_Winding_Outer_F
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- TVent_Flow_Area_Winding_Outer_F
- T Vent Flow Area Winding Outer F
- t_vent_flow_area_winding_outer_f
- tVentFlowAreaWindingOuterF
- tvent_flow_area_winding_outer_f
related_parameters:
...
## Summary
TVent Flow Area for the Winding Outer Front
