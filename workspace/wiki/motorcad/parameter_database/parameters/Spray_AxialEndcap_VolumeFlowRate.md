...
parameter_name: Spray_AxialEndcap_VolumeFlowRate
...
aliases:
- Spray_AxialEndcap_VolumeFlowRate
- Spray Axial Endcap Volume Flow Rate
- spray_axial_endcap_volume_flow_rate
- sprayAxialEndcapVolumeFlowRate
- spray_axialendcap_volumeflowrate
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid inlet volume flow rate
