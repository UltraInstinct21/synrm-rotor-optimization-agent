...
parameter_name: Spray_RadialHousing_CorrelationFactor_Stranded_EWdg_Inner_F
...
aliases:
- Spray_RadialHousing_CorrelationFactor_Stranded_EWdg_Inner_F
- Spray Radial Housing Correlation Factor Stranded E Wdg Inner F
- spray_radial_housing_correlation_factor_stranded_e_wdg_inner_f
- sprayRadialHousingCorrelationFactorStrandedEWdgInnerF
- spray_radialhousing_correlationfactor_stranded_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the stranded front endwinding inner surface
