...
parameter_name: StatorPlateChannelSpacing_R
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- StatorPlateChannelSpacing_R
- Stator Plate Channel Spacing R
- stator_plate_channel_spacing_r
- statorPlateChannelSpacingR
- statorplatechannelspacing_r
related_parameters:
...
- '[[motorcad/parameter_database/parameters/StatorPlateChannelSpacing_F|StatorPlateChannelSpacing_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The channel spacing of rear stator plate for single bearing model
