...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_RotorPole_R
- Spray Axial Endcap Stationary h Input Rotor Pole R
- spray_axial_endcap_stationary_h_input_rotor_pole_r
- sprayAxialEndcapStationaryHInputRotorPoleR
- spray_axialendcap_stationary_h_input_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the rear rotor pole surface
