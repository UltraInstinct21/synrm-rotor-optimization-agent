...
parameter_name: Spray_RadialHousing_Mixed_h_Endcap_R
...
aliases:
- Spray_RadialHousing_Mixed_h_Endcap_R
- Spray Radial Housing Mixed h Endcap R
- spray_radial_housing_mixed_h_endcap_r
- sprayRadialHousingMixedHEndcapR
- spray_radialhousing_mixed_h_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the rear endcap surface
