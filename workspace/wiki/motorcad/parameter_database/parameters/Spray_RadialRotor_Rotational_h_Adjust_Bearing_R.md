...
parameter_name: Spray_RadialRotor_Rotational_h_Adjust_Bearing_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Adjust_Bearing_R
- Spray Radial Rotor Rotational h Adjust Bearing R
- spray_radial_rotor_rotational_h_adjust_bearing_r
- sprayRadialRotorRotationalHAdjustBearingR
- spray_radialrotor_rotational_h_adjust_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc adjustment over the rear bearing surface
