...
parameter_name: Notes_TVent_EndRing_Outer_R
...
aliases:
- Notes_TVent_EndRing_Outer_R
- Notes T Vent End Ring Outer R
- notes_t_vent_end_ring_outer_r
- notesTVentEndRingOuterR
- notes_tvent_endring_outer_r
related_parameters:
...
## Summary
The TVent notes for the end ring Outer surface [rear]
