...
parameter_name: Rt_TVent_RotorEWdg_Outer_F_Total
...
aliases:
- Rt_TVent_RotorEWdg_Outer_F_Total
- Rt T Vent Rotor E Wdg Outer F Total
- rt_t_vent_rotor_e_wdg_outer_f_total
- rtTVentRotorEWdgOuterFTotal
- rt_tvent_rotorewdg_outer_f_total
related_parameters:
...
## Summary
The thermal resistance from the outer surface (incl ext) of front rotor endwinding to the fluid
