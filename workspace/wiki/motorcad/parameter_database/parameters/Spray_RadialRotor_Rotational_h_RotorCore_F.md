...
parameter_name: Spray_RadialRotor_Rotational_h_RotorCore_F
...
aliases:
- Spray_RadialRotor_Rotational_h_RotorCore_F
- Spray Radial Rotor Rotational h Rotor Core F
- spray_radial_rotor_rotational_h_rotor_core_f
- sprayRadialRotorRotationalHRotorCoreF
- spray_radialrotor_rotational_h_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc over the front rotor core surface
