...
parameter_name: Flow_Area_Inlet_Expansion_R
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Expansion_R
- Flow Area Inlet Expansion R
- flow_area_inlet_expansion_r
- flowAreaInletExpansionR
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Flow_Area_Inlet_Stator_Contraction|Flow_Area_Inlet_Stator_Contraction]]'
...
## Summary
Flow Area Inlet Expansion [Rear]
