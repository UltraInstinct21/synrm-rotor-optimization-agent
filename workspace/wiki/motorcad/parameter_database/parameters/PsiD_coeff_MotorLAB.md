...
parameter_name: PsiD_coeff_MotorLAB
...
aliases:
- PsiD_coeff_MotorLAB
- Psi D coeff Motor LAB
- psi_d_coeff_motor_lab
- psiDCoeffMotorLab
- psid_coeff_motorlab
related_parameters:
...
## Summary
Motor-CAD automation parameter `PsiD_coeff_MotorLAB` in category `ModelParameters_MotorLAB`.
