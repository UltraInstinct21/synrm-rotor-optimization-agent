...
parameter_name: Spray_RadialHousing_Rotational_h_Input_EWdg_Inner_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_EWdg_Inner_R
- Spray Radial Housing Rotational h Input E Wdg Inner R
- spray_radial_housing_rotational_h_input_e_wdg_inner_r
- sprayRadialHousingRotationalHInputEWdgInnerR
- spray_radialhousing_rotational_h_input_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the rear endwinding inner surface
