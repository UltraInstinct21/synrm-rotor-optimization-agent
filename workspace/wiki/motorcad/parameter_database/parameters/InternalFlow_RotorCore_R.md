...
parameter_name: InternalFlow_RotorCore_R
...
aliases:
- InternalFlow_RotorCore_R
- Internal Flow Rotor Core R
- internal_flow_rotor_core_r
- internalFlowRotorCoreR
- internalflow_rotorcore_r
related_parameters:
...
- '[[motorcad/parameter_database/parameters/InternalFlow_RotorPole_F|InternalFlow_RotorPole_F]]'
- '[[motorcad/parameter_database/parameters/InternalFlow_RotorCore_F|InternalFlow_RotorCore_F]]'
- '[[motorcad/parameter_database/parameters/InternalFlow_RotorPole_R|InternalFlow_RotorPole_R]]'
- '[[motorcad/parameter_database/parameters/InternalFlow_Endcap_F|InternalFlow_Endcap_F]]'
- '[[motorcad/parameter_database/parameters/InternalFlow_Housing_F|InternalFlow_Housing_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This is the proportion of spray flowing over rotor core surface
