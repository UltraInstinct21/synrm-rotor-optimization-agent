...
parameter_name: Spray_RadialRotor_Notes_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_Notes_EWdg_Inner_R
- Spray Radial Rotor Notes E Wdg Inner R
- spray_radial_rotor_notes_e_wdg_inner_r
- sprayRadialRotorNotesEWdgInnerR
- spray_radialrotor_notes_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) notes for rear endwinding inner surface
