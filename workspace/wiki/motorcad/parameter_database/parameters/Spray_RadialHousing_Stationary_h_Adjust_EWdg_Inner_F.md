...
parameter_name: Spray_RadialHousing_Stationary_h_Adjust_EWdg_Inner_F
...
aliases:
- Spray_RadialHousing_Stationary_h_Adjust_EWdg_Inner_F
- Spray Radial Housing Stationary h Adjust E Wdg Inner F
- spray_radial_housing_stationary_h_adjust_e_wdg_inner_f
- sprayRadialHousingStationaryHAdjustEWdgInnerF
- spray_radialhousing_stationary_h_adjust_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc adjustment over the front endwinding inner surface
