...
parameter_name: Gap_MaterialConductivity_H_EndCap_Rear
...
aliases:
- Gap_MaterialConductivity_H_EndCap_Rear
- Gap Material Conductivity H End Cap Rear
- gap_material_conductivity_h_end_cap_rear
- gapMaterialConductivityHEndCapRear
- gap_materialconductivity_h_endcap_rear
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between Housing and Endcap [R].
