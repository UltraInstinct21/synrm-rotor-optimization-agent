...
parameter_name: Spray_RadialRotor_Mixed_h_Housing_R
...
aliases:
- Spray_RadialRotor_Mixed_h_Housing_R
- Spray Radial Rotor Mixed h Housing R
- spray_radial_rotor_mixed_h_housing_r
- sprayRadialRotorMixedHHousingR
- spray_radialrotor_mixed_h_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the rear housing surface
