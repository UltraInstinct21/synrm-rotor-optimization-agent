...
parameter_name: Vel_ES_EndRing_ExtOuter_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_ExtOuter_R_Calc
- Vel ES End Ring Ext Outer R Calc
- vel_es_end_ring_ext_outer_r_calc
- velEsEndRingExtOuterRCalc
- vel_es_endring_extouter_r_calc
related_parameters:
...
## Summary
The calc velocity over the end ring ExtOuter surface [rear]
