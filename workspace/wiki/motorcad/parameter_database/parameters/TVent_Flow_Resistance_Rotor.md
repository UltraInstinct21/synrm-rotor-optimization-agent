...
parameter_name: TVent_Flow_Resistance_Rotor
category: TVent_Data
input_output: o/p
data_type: double
units: kg/m⁷
...
aliases:
- TVent_Flow_Resistance_Rotor
- T Vent Flow Resistance Rotor
- t_vent_flow_resistance_rotor
- tVentFlowResistanceRotor
- tvent_flow_resistance_rotor
related_parameters:
