...
parameter_name: BMax_Airgap_Analytic
category: Magnetics
input_output: o/p
data_type: double
units: Tesla
...
aliases:
- BMax_Airgap_Analytic
- B Max Airgap Analytic
- b_max_airgap_analytic
- bMaxAirgapAnalytic
- bmax_airgap_analytic
related_parameters:
...
## Summary
Maximum flux density at midpoint in the airgap (from analytic solution)
