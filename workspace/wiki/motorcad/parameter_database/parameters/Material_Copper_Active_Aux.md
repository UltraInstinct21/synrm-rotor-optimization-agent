...
parameter_name: Material_Copper_Active_Aux
category: Material
input_output: i/p
data_type: OleStr
units: N/A
default_value: Copper (Pure)
source_file: D:/SRM/Agent/workspace/wiki/raw/ActiveXParameters.xlsx
aliases:
- Material_Copper_Active_Aux
- Material Copper Active Aux
- material_copper_active_aux
- materialCopperActiveAux
related_parameters:
...
## Summary
The material of the auxiliary armature conductor (active)
