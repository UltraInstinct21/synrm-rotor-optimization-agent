...
parameter_name: Spray_RadialRotor_Stationary_h_Input_EWdg_Front_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_EWdg_Front_F
- Spray Radial Rotor Stationary h Input E Wdg Front F
- spray_radial_rotor_stationary_h_input_e_wdg_front_f
- sprayRadialRotorStationaryHInputEWdgFrontF
- spray_radialrotor_stationary_h_input_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the front endwinding front surface
