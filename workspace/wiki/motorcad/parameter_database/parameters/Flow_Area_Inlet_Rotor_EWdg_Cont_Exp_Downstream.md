...
parameter_name: Flow_Area_Inlet_Rotor_EWdg_Cont_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Rotor_EWdg_Cont_Exp_Downstream
- Flow Area Inlet Rotor E Wdg Cont Exp Downstream
- flow_area_inlet_rotor_e_wdg_cont_exp_downstream
- flowAreaInletRotorEWdgContExpDownstream
- flow_area_inlet_rotor_ewdg_cont_exp_downstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Rotor EWdg Contraction Expansion Downstream
