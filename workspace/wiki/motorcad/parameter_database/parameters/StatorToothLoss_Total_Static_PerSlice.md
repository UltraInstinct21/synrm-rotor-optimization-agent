...
parameter_name: StatorToothLoss_Total_Static_PerSlice
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- StatorToothLoss_Total_Static_PerSlice
- Stator Tooth Loss Total Static Per Slice
- stator_tooth_loss_total_static_per_slice
- statorToothLossTotalStaticPerSlice
- statortoothloss_total_static_perslice
related_parameters:
...
## Summary
Total Stator tooth losses (per slice)
