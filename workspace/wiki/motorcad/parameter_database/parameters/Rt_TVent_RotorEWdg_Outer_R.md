...
parameter_name: Rt_TVent_RotorEWdg_Outer_R
...
aliases:
- Rt_TVent_RotorEWdg_Outer_R
- Rt T Vent Rotor E Wdg Outer R
- rt_t_vent_rotor_e_wdg_outer_r
- rtTVentRotorEWdgOuterR
- rt_tvent_rotorewdg_outer_r
related_parameters:
...
## Summary
The thermal resistance from the outer surface of rear rotor endwinding to the fluid
