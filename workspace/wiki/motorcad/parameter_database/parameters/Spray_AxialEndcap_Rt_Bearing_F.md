...
parameter_name: Spray_AxialEndcap_Rt_Bearing_F
...
aliases:
- Spray_AxialEndcap_Rt_Bearing_F
- Spray Axial Endcap Rt Bearing F
- spray_axial_endcap_rt_bearing_f
- sprayAxialEndcapRtBearingF
- spray_axialendcap_rt_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to front bearing surface convective thermal resistance
