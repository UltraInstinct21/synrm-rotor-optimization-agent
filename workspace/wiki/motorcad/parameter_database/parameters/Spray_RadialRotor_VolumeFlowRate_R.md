...
parameter_name: Spray_RadialRotor_VolumeFlowRate_R
...
aliases:
- Spray_RadialRotor_VolumeFlowRate_R
- Spray Radial Rotor Volume Flow Rate R
- spray_radial_rotor_volume_flow_rate_r
- sprayRadialRotorVolumeFlowRateR
- spray_radialrotor_volumeflowrate_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear fluid inlet volume flow rate
