...
parameter_name: Rt_TVent_RotorEWdg_ExtInner_F
...
aliases:
- Rt_TVent_RotorEWdg_ExtInner_F
- Rt T Vent Rotor E Wdg Ext Inner F
- rt_t_vent_rotor_e_wdg_ext_inner_f
- rtTVentRotorEWdgExtInnerF
- rt_tvent_rotorewdg_extinner_f
related_parameters:
...
## Summary
The thermal resistance from the ext inner surface of front rotor endwinding to the fluid
