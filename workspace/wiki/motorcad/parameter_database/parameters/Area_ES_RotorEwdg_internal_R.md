...
parameter_name: Area_ES_RotorEwdg_internal_R
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_RotorEwdg_internal_R
- Area ES Rotor Ewdg internal R
- area_es_rotor_ewdg_internal_r
- areaEsRotorEwdgInternalR
- area_es_rotorewdg_internal_r
related_parameters:
...
## Summary
The area of the end wdg internal surface [rear]
