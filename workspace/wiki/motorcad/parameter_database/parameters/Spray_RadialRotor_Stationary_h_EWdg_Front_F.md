...
parameter_name: Spray_RadialRotor_Stationary_h_EWdg_Front_F
...
aliases:
- Spray_RadialRotor_Stationary_h_EWdg_Front_F
- Spray Radial Rotor Stationary h E Wdg Front F
- spray_radial_rotor_stationary_h_e_wdg_front_f
- sprayRadialRotorStationaryHEWdgFrontF
- spray_radialrotor_stationary_h_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the front endwinding front surface
