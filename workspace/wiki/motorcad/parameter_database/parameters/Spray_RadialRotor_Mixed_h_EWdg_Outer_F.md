...
parameter_name: Spray_RadialRotor_Mixed_h_EWdg_Outer_F
...
aliases:
- Spray_RadialRotor_Mixed_h_EWdg_Outer_F
- Spray Radial Rotor Mixed h E Wdg Outer F
- spray_radial_rotor_mixed_h_e_wdg_outer_f
- sprayRadialRotorMixedHEWdgOuterF
- spray_radialrotor_mixed_h_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the front endwinding outer surface
