...
parameter_name: Spray_RadialRotor_CorrelationFactor_Housing_F
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Housing_F
- Spray Radial Rotor Correlation Factor Housing F
- spray_radial_rotor_correlation_factor_housing_f
- sprayRadialRotorCorrelationFactorHousingF
- spray_radialrotor_correlationfactor_housing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the front housing surface
