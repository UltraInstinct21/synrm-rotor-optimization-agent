...
parameter_name: Average_Temp_TVent_Stator_Duct
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Average_Temp_TVent_Stator_Duct
- Average Temp T Vent Stator Duct
- average_temp_t_vent_stator_duct
- averageTempTVentStatorDuct
- average_temp_tvent_stator_duct
related_parameters:
...
## Summary
Motor-CAD automation parameter `Average_Temp_TVent_Stator_Duct` in category `TVent_Data`.
