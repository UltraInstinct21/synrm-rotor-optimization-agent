...
parameter_name: Vel_Mult_ES_DividerWedge_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_DividerWedge_F
- Vel Mult ES Divider Wedge F
- vel_mult_es_divider_wedge_f
- velMultEsDividerWedgeF
- vel_mult_es_dividerwedge_f
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for Divider/Wedge [front]
