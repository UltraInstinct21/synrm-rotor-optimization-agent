...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_RotorPole_F
- Spray Axial Endcap Stationary h Input Rotor Pole F
- spray_axial_endcap_stationary_h_input_rotor_pole_f
- sprayAxialEndcapStationaryHInputRotorPoleF
- spray_axialendcap_stationary_h_input_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the front rotor pole surface
