...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_EWdg_Outer_F
- Spray Axial Endcap Rotational h Input E Wdg Outer F
- spray_axial_endcap_rotational_h_input_e_wdg_outer_f
- sprayAxialEndcapRotationalHInputEWdgOuterF
- spray_axialendcap_rotational_h_input_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the front endwinding outer surface
