...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_EWdg_Front_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_EWdg_Front_R
- Spray Axial Endcap Stationary h Input E Wdg Front R
- spray_axial_endcap_stationary_h_input_e_wdg_front_r
- sprayAxialEndcapStationaryHInputEWdgFrontR
- spray_axialendcap_stationary_h_input_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the rear endwinding front surface
