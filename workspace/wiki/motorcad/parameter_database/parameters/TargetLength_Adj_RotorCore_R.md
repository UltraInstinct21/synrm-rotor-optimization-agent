...
parameter_name: TargetLength_Adj_RotorCore_R
...
aliases:
- TargetLength_Adj_RotorCore_R
- Target Length Adj Rotor Core R
- target_length_adj_rotor_core_r
- targetLengthAdjRotorCoreR
- targetlength_adj_rotorcore_r
related_parameters:
...
## Summary
This is the adjustment to the length of spray target on Rear Rotor Core
