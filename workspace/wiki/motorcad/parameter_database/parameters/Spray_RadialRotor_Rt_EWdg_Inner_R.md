...
parameter_name: Spray_RadialRotor_Rt_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_Rt_EWdg_Inner_R
- Spray Radial Rotor Rt E Wdg Inner R
- spray_radial_rotor_rt_e_wdg_inner_r
- sprayRadialRotorRtEWdgInnerR
- spray_radialrotor_rt_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to rear endwinding inner surface convective thermal resistance
