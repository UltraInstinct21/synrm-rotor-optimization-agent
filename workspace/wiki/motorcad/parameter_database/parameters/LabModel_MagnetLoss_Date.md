...
parameter_name: LabModel_MagnetLoss_Date
...
aliases:
- LabModel_MagnetLoss_Date
- Lab Model Magnet Loss Date
- lab_model_magnet_loss_date
- labModelMagnetLossDate
- labmodel_magnetloss_date
related_parameters:
...
## Summary
Lab magnet loss model build date
