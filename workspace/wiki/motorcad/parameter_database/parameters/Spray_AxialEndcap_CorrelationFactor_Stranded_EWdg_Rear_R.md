...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Stranded_EWdg_Rear_R
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Stranded_EWdg_Rear_R
- Spray Axial Endcap Correlation Factor Stranded E Wdg Rear R
- spray_axial_endcap_correlation_factor_stranded_e_wdg_rear_r
- sprayAxialEndcapCorrelationFactorStrandedEWdgRearR
- spray_axialendcap_correlationfactor_stranded_ewdg_rear_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the stranded rear endwinding rear surface
