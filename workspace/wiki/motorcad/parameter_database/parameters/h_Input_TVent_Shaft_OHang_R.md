...
parameter_name: h_Input_TVent_Shaft_OHang_R
...
aliases:
- h_Input_TVent_Shaft_OHang_R
- h Input T Vent Shaft O Hang R
- h_input_t_vent_shaft_o_hang_r
- hInputTVentShaftOHangR
- h_input_tvent_shaft_ohang_r
related_parameters:
