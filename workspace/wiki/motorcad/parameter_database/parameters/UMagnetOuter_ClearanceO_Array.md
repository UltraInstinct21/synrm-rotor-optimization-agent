...
parameter_name: UMagnetOuter_ClearanceO_Array
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- UMagnetOuter_ClearanceO_Array
- U Magnet Outer Clearance O Array
- u_magnet_outer_clearance_o_array
- uMagnetOuterClearanceOArray
- umagnetouter_clearanceo_array
related_parameters:
...
- '[[motorcad/parameter_database/parameters/UMagnetOuter_ClearanceI_Array|UMagnetOuter_ClearanceI_Array]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The clearance of the U-Layer Outer magnet towards the magnet pole
