...
parameter_name: Spray_RadialHousing_Dissipation_Endcap_R
...
aliases:
- Spray_RadialHousing_Dissipation_Endcap_R
- Spray Radial Housing Dissipation Endcap R
- spray_radial_housing_dissipation_endcap_r
- sprayRadialHousingDissipationEndcapR
- spray_radialhousing_dissipation_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) thermal dissipation from the rear endcap surface
