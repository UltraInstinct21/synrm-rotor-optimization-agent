...
parameter_name: Vel_Mult_TVent_EndRing_ExtBore_F
...
aliases:
- Vel_Mult_TVent_EndRing_ExtBore_F
- Vel Mult T Vent End Ring Ext Bore F
- vel_mult_t_vent_end_ring_ext_bore_f
- velMultTVentEndRingExtBoreF
- vel_mult_tvent_endring_extbore_f
related_parameters:
...
## Summary
The TVent velocity multiplier over the end ring ExtBore surface [front]
