...
parameter_name: Spray_AxialEndcap_Area_Mult_EWdg_Outer_R
...
aliases:
- Spray_AxialEndcap_Area_Mult_EWdg_Outer_R
- Spray Axial Endcap Area Mult E Wdg Outer R
- spray_axial_endcap_area_mult_e_wdg_outer_r
- sprayAxialEndcapAreaMultEWdgOuterR
- spray_axialendcap_area_mult_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear endwinding outer surface area multiplier
