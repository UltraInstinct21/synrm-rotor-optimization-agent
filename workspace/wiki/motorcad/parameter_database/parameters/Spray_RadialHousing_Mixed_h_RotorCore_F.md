...
parameter_name: Spray_RadialHousing_Mixed_h_RotorCore_F
...
aliases:
- Spray_RadialHousing_Mixed_h_RotorCore_F
- Spray Radial Housing Mixed h Rotor Core F
- spray_radial_housing_mixed_h_rotor_core_f
- sprayRadialHousingMixedHRotorCoreF
- spray_radialhousing_mixed_h_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the front rotor core surface
