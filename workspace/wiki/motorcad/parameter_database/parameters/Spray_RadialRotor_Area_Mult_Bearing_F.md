...
parameter_name: Spray_RadialRotor_Area_Mult_Bearing_F
...
aliases:
- Spray_RadialRotor_Area_Mult_Bearing_F
- Spray Radial Rotor Area Mult Bearing F
- spray_radial_rotor_area_mult_bearing_f
- sprayRadialRotorAreaMultBearingF
- spray_radialrotor_area_mult_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) front bearing surface area multiplier
