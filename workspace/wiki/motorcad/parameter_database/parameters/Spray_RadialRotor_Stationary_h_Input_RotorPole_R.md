...
parameter_name: Spray_RadialRotor_Stationary_h_Input_RotorPole_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_RotorPole_R
- Spray Radial Rotor Stationary h Input Rotor Pole R
- spray_radial_rotor_stationary_h_input_rotor_pole_r
- sprayRadialRotorStationaryHInputRotorPoleR
- spray_radialrotor_stationary_h_input_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the rear rotor pole surface
