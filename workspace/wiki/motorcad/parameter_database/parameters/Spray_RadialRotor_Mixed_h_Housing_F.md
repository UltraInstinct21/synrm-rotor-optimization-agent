...
parameter_name: Spray_RadialRotor_Mixed_h_Housing_F
...
aliases:
- Spray_RadialRotor_Mixed_h_Housing_F
- Spray Radial Rotor Mixed h Housing F
- spray_radial_rotor_mixed_h_housing_f
- sprayRadialRotorMixedHHousingF
- spray_radialrotor_mixed_h_housing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the front housing surface
