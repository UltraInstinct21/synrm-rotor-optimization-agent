...
parameter_name: Spray_AxialEndcap_Rotational_h_Endcap_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Endcap_R
- Spray Axial Endcap Rotational h Endcap R
- spray_axial_endcap_rotational_h_endcap_r
- sprayAxialEndcapRotationalHEndcapR
- spray_axialendcap_rotational_h_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc over the rear endcap surface
