...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_Housing_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_Housing_F
- Spray Radial Rotor Stationary h Adjust Housing F
- spray_radial_rotor_stationary_h_adjust_housing_f
- sprayRadialRotorStationaryHAdjustHousingF
- spray_radialrotor_stationary_h_adjust_housing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the front housing surface
