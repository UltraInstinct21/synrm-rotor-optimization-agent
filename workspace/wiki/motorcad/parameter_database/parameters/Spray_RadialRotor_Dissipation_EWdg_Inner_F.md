...
parameter_name: Spray_RadialRotor_Dissipation_EWdg_Inner_F
...
aliases:
- Spray_RadialRotor_Dissipation_EWdg_Inner_F
- Spray Radial Rotor Dissipation E Wdg Inner F
- spray_radial_rotor_dissipation_e_wdg_inner_f
- sprayRadialRotorDissipationEWdgInnerF
- spray_radialrotor_dissipation_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the front endwinding inner surface
