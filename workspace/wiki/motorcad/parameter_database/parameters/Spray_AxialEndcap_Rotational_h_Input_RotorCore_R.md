...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_RotorCore_R
- Spray Axial Endcap Rotational h Input Rotor Core R
- spray_axial_endcap_rotational_h_input_rotor_core_r
- sprayAxialEndcapRotationalHInputRotorCoreR
- spray_axialendcap_rotational_h_input_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the rear rotor core surface
