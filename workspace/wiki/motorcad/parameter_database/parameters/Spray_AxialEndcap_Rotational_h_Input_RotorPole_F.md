...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_RotorPole_F
- Spray Axial Endcap Rotational h Input Rotor Pole F
- spray_axial_endcap_rotational_h_input_rotor_pole_f
- sprayAxialEndcapRotationalHInputRotorPoleF
- spray_axialendcap_rotational_h_input_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the front rotor pole surface
