...
parameter_name: Flow_Area_Outlet_Exit_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Exit_Upstream
- Flow Area Outlet Exit Upstream
- flow_area_outlet_exit_upstream
- flowAreaOutletExitUpstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Exit Upstream
