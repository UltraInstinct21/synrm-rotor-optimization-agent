...
parameter_name: Spray_AxialEndcap_Area_Mult_Shaft_R
...
aliases:
- Spray_AxialEndcap_Area_Mult_Shaft_R
- Spray Axial Endcap Area Mult Shaft R
- spray_axial_endcap_area_mult_shaft_r
- sprayAxialEndcapAreaMultShaftR
- spray_axialendcap_area_mult_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear shaft surface area multiplier
