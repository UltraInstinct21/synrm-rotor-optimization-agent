...
parameter_name: Spray_RadialHousing_CorrelationFactor_Endcap_R
...
aliases:
- Spray_RadialHousing_CorrelationFactor_Endcap_R
- Spray Radial Housing Correlation Factor Endcap R
- spray_radial_housing_correlation_factor_endcap_r
- sprayRadialHousingCorrelationFactorEndcapR
- spray_radialhousing_correlationfactor_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the rear endcap surface
