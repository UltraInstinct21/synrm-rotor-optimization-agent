...
parameter_name: h_ES_EndRing_ExtInter_F
category: End_Space
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_ES_EndRing_ExtInter_F
- h ES End Ring Ext Inter F
- h_es_end_ring_ext_inter_f
- hEsEndRingExtInterF
- h_es_endring_extinter_f
related_parameters:
...
## Summary
The heat transfer coefficient over the end ring ExtInter surface [front]
