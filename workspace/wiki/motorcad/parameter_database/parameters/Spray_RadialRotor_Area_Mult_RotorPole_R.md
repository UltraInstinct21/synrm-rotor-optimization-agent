...
parameter_name: Spray_RadialRotor_Area_Mult_RotorPole_R
...
aliases:
- Spray_RadialRotor_Area_Mult_RotorPole_R
- Spray Radial Rotor Area Mult Rotor Pole R
- spray_radial_rotor_area_mult_rotor_pole_r
- sprayRadialRotorAreaMultRotorPoleR
- spray_radialrotor_area_mult_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear rotor pole surface area multiplier
