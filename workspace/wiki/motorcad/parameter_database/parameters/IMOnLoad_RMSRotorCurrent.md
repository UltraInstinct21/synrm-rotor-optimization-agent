...
parameter_name: IMOnLoad_RMSRotorCurrent
category: Magnetics
input_output: o/p
data_type: double
units: Amps
...
aliases:
- IMOnLoad_RMSRotorCurrent
- IM On Load RMS Rotor Current
- im_on_load_rms_rotor_current
- imOnLoadRmsRotorCurrent
- imonload_rmsrotorcurrent
related_parameters:
...
## Summary
The referred rms on load rotor current (from losses)
