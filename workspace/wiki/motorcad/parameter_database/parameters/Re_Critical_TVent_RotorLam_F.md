...
parameter_name: Re_Critical_TVent_RotorLam_F
...
aliases:
- Re_Critical_TVent_RotorLam_F
- Re Critical T Vent Rotor Lam F
- re_critical_t_vent_rotor_lam_f
- reCriticalTVentRotorLamF
- re_critical_tvent_rotorlam_f
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the Rotor lam surface [front]
