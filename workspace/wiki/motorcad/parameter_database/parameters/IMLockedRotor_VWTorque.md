...
parameter_name: IMLockedRotor_VWTorque
category: Magnetics
input_output: o/p
data_type: double
units: Nm
...
aliases:
- IMLockedRotor_VWTorque
- IM Locked Rotor VW Torque
- im_locked_rotor_vw_torque
- imLockedRotorVwTorque
- imlockedrotor_vwtorque
related_parameters:
...
## Summary
The virtual work torque in the Locked Rotor case
