...
parameter_name: Spray_AxialEndcap_Calc_Input_h_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_RotorPole_R
- Spray Axial Endcap Calc Input h Rotor Pole R
- spray_axial_endcap_calc_input_h_rotor_pole_r
- sprayAxialEndcapCalcInputHRotorPoleR
- spray_axialendcap_calc_input_h_rotorpole_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the rear rotor pole surface is calculated or user input  (0=Calc h, 1=Input h)
