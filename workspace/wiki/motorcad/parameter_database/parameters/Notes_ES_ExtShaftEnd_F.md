...
parameter_name: Notes_ES_ExtShaftEnd_F
category: End_Space
input_output: i/p
data_type: OleStr
units: N/A
default_value: default = shaft end not exposed (k1 = 0)
source_file: D:/SRM/Agent/workspace/wiki/raw/ActiveXParameters.xlsx
aliases:
- Notes_ES_ExtShaftEnd_F
- Notes ES Ext Shaft End F
- notes_es_ext_shaft_end_f
- notesEsExtShaftEndF
- notes_es_extshaftend_f
related_parameters:
...
## Summary
End Space Cooling - notes for shaft extension end [front]
...
- **Units**: N/A
- **Default Value**: default = shaft end not exposed (k1 = 0)
