...
parameter_name: SprayCoverageProp_RotorCore_R
...
aliases:
- SprayCoverageProp_RotorCore_R
- Spray Coverage Prop Rotor Core R
- spray_coverage_prop_rotor_core_r
- sprayCoveragePropRotorCoreR
- spraycoverageprop_rotorcore_r
related_parameters:
...
## Summary
Proportion of the total surface area of the Rotor Core Rear that is subjected to Spray Cooling
