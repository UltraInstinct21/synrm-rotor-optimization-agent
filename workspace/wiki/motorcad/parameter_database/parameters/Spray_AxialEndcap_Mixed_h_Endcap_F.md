...
parameter_name: Spray_AxialEndcap_Mixed_h_Endcap_F
...
aliases:
- Spray_AxialEndcap_Mixed_h_Endcap_F
- Spray Axial Endcap Mixed h Endcap F
- spray_axial_endcap_mixed_h_endcap_f
- sprayAxialEndcapMixedHEndcapF
- spray_axialendcap_mixed_h_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the front endcap surface
