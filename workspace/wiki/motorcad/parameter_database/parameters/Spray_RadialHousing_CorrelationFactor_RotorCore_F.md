...
parameter_name: Spray_RadialHousing_CorrelationFactor_RotorCore_F
...
aliases:
- Spray_RadialHousing_CorrelationFactor_RotorCore_F
- Spray Radial Housing Correlation Factor Rotor Core F
- spray_radial_housing_correlation_factor_rotor_core_f
- sprayRadialHousingCorrelationFactorRotorCoreF
- spray_radialhousing_correlationfactor_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the front rotor core surface
