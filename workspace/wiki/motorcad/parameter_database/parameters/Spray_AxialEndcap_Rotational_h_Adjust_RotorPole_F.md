...
parameter_name: Spray_AxialEndcap_Rotational_h_Adjust_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Adjust_RotorPole_F
- Spray Axial Endcap Rotational h Adjust Rotor Pole F
- spray_axial_endcap_rotational_h_adjust_rotor_pole_f
- sprayAxialEndcapRotationalHAdjustRotorPoleF
- spray_axialendcap_rotational_h_adjust_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc adjustment over the front rotor pole surface
