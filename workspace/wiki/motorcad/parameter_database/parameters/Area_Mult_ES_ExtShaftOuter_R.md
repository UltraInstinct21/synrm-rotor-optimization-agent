...
parameter_name: Area_Mult_ES_ExtShaftOuter_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_ExtShaftOuter_R
- Area Mult ES Ext Shaft Outer R
- area_mult_es_ext_shaft_outer_r
- areaMultEsExtShaftOuterR
- area_mult_es_extshaftouter_r
related_parameters:
...
## Summary
Area multiplier for the Shaft Extension Outer [Rear] surface for End Space Cooling
