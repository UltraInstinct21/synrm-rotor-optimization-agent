...
parameter_name: RotorToothLoss_Eddy_Static_Adj
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- RotorToothLoss_Eddy_Static_Adj
- Rotor Tooth Loss Eddy Static Adj
- rotor_tooth_loss_eddy_static_adj
- rotorToothLossEddyStaticAdj
- rotortoothloss_eddy_static_adj
related_parameters:
