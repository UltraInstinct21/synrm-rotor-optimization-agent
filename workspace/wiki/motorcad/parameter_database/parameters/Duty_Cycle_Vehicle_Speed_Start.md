...
parameter_name: Duty_Cycle_Vehicle_Speed_Start
category: Transient
input_output: i/p
data_type: double
units: km/h
...
- Duty Cycle Vehicle Speed Start
- duty_cycle_vehicle_speed_start
- dutyCycleVehicleSpeedStart
related_parameters:
...
## Summary
Vehicle Speed at the start of each period of the duty cycle
