...
parameter_name: Rt_ES_EndRing_ExtBore_F
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_EndRing_ExtBore_F
- Rt ES End Ring Ext Bore F
- rt_es_end_ring_ext_bore_f
- rtEsEndRingExtBoreF
- rt_es_endring_extbore_f
related_parameters:
...
## Summary
The thermal resistance end ring Ext Bore surface [front]
