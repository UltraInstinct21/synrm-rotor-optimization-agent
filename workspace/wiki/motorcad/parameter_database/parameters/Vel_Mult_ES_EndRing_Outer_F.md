...
parameter_name: Vel_Mult_ES_EndRing_Outer_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EndRing_Outer_F
- Vel Mult ES End Ring Outer F
- vel_mult_es_end_ring_outer_f
- velMultEsEndRingOuterF
- vel_mult_es_endring_outer_f
related_parameters:
...
## Summary
The velocity multiplier for end ring Outer surface [front]
