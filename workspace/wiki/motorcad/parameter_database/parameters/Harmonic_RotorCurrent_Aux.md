...
parameter_name: Harmonic_RotorCurrent_Aux
category: Magnetics
input_output: o/p
data_type: double
units: Amps
...
aliases:
- Harmonic_RotorCurrent_Aux
- Harmonic Rotor Current Aux
- harmonic_rotor_current_aux
- harmonicRotorCurrentAux
- harmonic_rotorcurrent_aux
related_parameters:
...
## Summary
Rotor current referred to the aux winding for each harmonic order in the IM1PH equivalent circuit
