...
parameter_name: Spray_RadialRotor_Area_RotorCore_F
...
aliases:
- Spray_RadialRotor_Area_RotorCore_F
- Spray Radial Rotor Area Rotor Core F
- spray_radial_rotor_area_rotor_core_f
- sprayRadialRotorAreaRotorCoreF
- spray_radialrotor_area_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) front rotor core surface sprayed area
