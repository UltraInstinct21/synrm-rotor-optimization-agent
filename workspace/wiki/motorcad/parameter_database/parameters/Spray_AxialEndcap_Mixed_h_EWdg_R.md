...
parameter_name: Spray_AxialEndcap_Mixed_h_EWdg_R
...
aliases:
- Spray_AxialEndcap_Mixed_h_EWdg_R
- Spray Axial Endcap Mixed h E Wdg R
- spray_axial_endcap_mixed_h_e_wdg_r
- sprayAxialEndcapMixedHEWdgR
- spray_axialendcap_mixed_h_ewdg_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) area average mixed htc over the rear endwinding
