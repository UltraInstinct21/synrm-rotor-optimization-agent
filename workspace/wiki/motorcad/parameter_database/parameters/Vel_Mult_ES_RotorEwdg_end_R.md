...
parameter_name: Vel_Mult_ES_RotorEwdg_end_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_RotorEwdg_end_R
- Vel Mult ES Rotor Ewdg end R
- vel_mult_es_rotor_ewdg_end_r
- velMultEsRotorEwdgEndR
- vel_mult_es_rotorewdg_end_r
related_parameters:
...
## Summary
The velocity multiplier for end wdg end surface [rear]
