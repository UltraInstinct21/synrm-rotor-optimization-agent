...
parameter_name: Spray_AxialEndcap_CorrelationFactor_RotorCore_F
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_RotorCore_F
- Spray Axial Endcap Correlation Factor Rotor Core F
- spray_axial_endcap_correlation_factor_rotor_core_f
- sprayAxialEndcapCorrelationFactorRotorCoreF
- spray_axialendcap_correlationfactor_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the front rotor core surface
