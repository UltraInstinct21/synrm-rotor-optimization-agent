...
parameter_name: Comment_Plate_RotorLam_R
...
aliases:
- Comment_Plate_RotorLam_R
- Comment Plate Rotor Lam R
- comment_plate_rotor_lam_r
- commentPlateRotorLamR
- comment_plate_rotorlam_r
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Comment_Gap_StatorClampPlate_StatorLam_F|Comment_Gap_StatorClampPlate_StatorLam_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Details of the interface gap between rotor plate and the rotor laminations at rear of machine
