...
parameter_name: Spray_RadialHousing_Area_Mult_RotorPole_F
...
aliases:
- Spray_RadialHousing_Area_Mult_RotorPole_F
- Spray Radial Housing Area Mult Rotor Pole F
- spray_radial_housing_area_mult_rotor_pole_f
- sprayRadialHousingAreaMultRotorPoleF
- spray_radialhousing_area_mult_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) front rotor pole surface area multiplier
