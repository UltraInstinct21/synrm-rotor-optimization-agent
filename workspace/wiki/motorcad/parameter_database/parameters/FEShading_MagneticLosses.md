...
parameter_name: FEShading_MagneticLosses
...
aliases:
- FEShading_MagneticLosses
- FE Shading Magnetic Losses
- fe_shading_magnetic_losses
- feShadingMagneticLosses
- feshading_magneticlosses
related_parameters:
...
- '[[motorcad/parameter_database/parameters/FEShading_Thermal|FEShading_Thermal]]'
- '[[motorcad/parameter_database/parameters/FEShading_Magnetic|FEShading_Magnetic]]'
- '[[motorcad/parameter_database/parameters/FEShading_Mechanical|FEShading_Mechanical]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Set FE module shading view for magnetic losses
