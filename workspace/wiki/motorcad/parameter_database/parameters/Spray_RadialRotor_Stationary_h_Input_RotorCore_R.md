...
parameter_name: Spray_RadialRotor_Stationary_h_Input_RotorCore_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_RotorCore_R
- Spray Radial Rotor Stationary h Input Rotor Core R
- spray_radial_rotor_stationary_h_input_rotor_core_r
- sprayRadialRotorStationaryHInputRotorCoreR
- spray_radialrotor_stationary_h_input_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the rear rotor core surface
