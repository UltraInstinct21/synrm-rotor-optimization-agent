...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_Shaft_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_Shaft_R
- Spray Axial Endcap Rotational h Input Shaft R
- spray_axial_endcap_rotational_h_input_shaft_r
- sprayAxialEndcapRotationalHInputShaftR
- spray_axialendcap_rotational_h_input_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the rear shaft surface
