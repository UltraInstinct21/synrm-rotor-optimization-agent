...
parameter_name: Spray_RadialRotor_Rt_Endcap_R
...
aliases:
- Spray_RadialRotor_Rt_Endcap_R
- Spray Radial Rotor Rt Endcap R
- spray_radial_rotor_rt_endcap_r
- sprayRadialRotorRtEndcapR
- spray_radialrotor_rt_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to rear endcap surface convective thermal resistance
