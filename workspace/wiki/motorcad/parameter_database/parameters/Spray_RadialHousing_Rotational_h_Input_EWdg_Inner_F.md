...
parameter_name: Spray_RadialHousing_Rotational_h_Input_EWdg_Inner_F
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_EWdg_Inner_F
- Spray Radial Housing Rotational h Input E Wdg Inner F
- spray_radial_housing_rotational_h_input_e_wdg_inner_f
- sprayRadialHousingRotationalHInputEWdgInnerF
- spray_radialhousing_rotational_h_input_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the front endwinding inner surface
