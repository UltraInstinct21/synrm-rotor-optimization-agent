...
parameter_name: Gap_Axle_Plate_R_Comment
...
aliases:
- Gap_Axle_Plate_R_Comment
- Gap Axle Plate R Comment
- gap_axle_plate_r_comment
- gapAxlePlateRComment
related_parameters:
...
## Summary
Details of the interface gap between axle and cooling plate (BPMOR) [rear of motor]
