...
parameter_name: Spray_RadialHousing_Stationary_h_Input_Housing_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_Housing_R
- Spray Radial Housing Stationary h Input Housing R
- spray_radial_housing_stationary_h_input_housing_r
- sprayRadialHousingStationaryHInputHousingR
- spray_radialhousing_stationary_h_input_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the rear housing surface
