...
parameter_name: Spray_RadialHousing_Rotational_h_Input_Housing_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_Housing_R
- Spray Radial Housing Rotational h Input Housing R
- spray_radial_housing_rotational_h_input_housing_r
- sprayRadialHousingRotationalHInputHousingR
- spray_radialhousing_rotational_h_input_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the rear housing surface
