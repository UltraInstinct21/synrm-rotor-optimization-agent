...
parameter_name: Spray_RadialRotor_CorrelationFactor_Endcap_F
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Endcap_F
- Spray Radial Rotor Correlation Factor Endcap F
- spray_radial_rotor_correlation_factor_endcap_f
- sprayRadialRotorCorrelationFactorEndcapF
- spray_radialrotor_correlationfactor_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the front endcap surface
