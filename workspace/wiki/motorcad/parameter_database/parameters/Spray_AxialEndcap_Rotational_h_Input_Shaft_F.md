...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_Shaft_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_Shaft_F
- Spray Axial Endcap Rotational h Input Shaft F
- spray_axial_endcap_rotational_h_input_shaft_f
- sprayAxialEndcapRotationalHInputShaftF
- spray_axialendcap_rotational_h_input_shaft_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the front shaft surface
