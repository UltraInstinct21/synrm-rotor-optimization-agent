...
parameter_name: Gap_Material_Plate_Magnet_F
...
aliases:
- Gap_Material_Plate_Magnet_F
- Gap Material Plate Magnet F
- gap_material_plate_magnet_f
- gapMaterialPlateMagnetF
related_parameters:
...
## Summary
Material in the interface gap between the Rotor Plate and Magnet [F].
