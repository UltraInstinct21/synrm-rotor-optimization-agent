...
parameter_name: FlowRate_EWdg_Front_R
...
aliases:
- FlowRate_EWdg_Front_R
- Flow Rate E Wdg Front R
- flow_rate_e_wdg_front_r
- flowRateEWdgFrontR
- flowrate_ewdg_front_r
related_parameters:
...
- '[[motorcad/parameter_database/parameters/FlowRate_EWdg_Outer_F|FlowRate_EWdg_Outer_F]]'
- '[[motorcad/parameter_database/parameters/FlowRate_EWdg_Front_F|FlowRate_EWdg_Front_F]]'
- '[[motorcad/parameter_database/parameters/FlowRate_EWdg_Inner_F|FlowRate_EWdg_Inner_F]]'
- '[[motorcad/parameter_database/parameters/FlowRate_EWdg_Rear_F|FlowRate_EWdg_Rear_F]]'
- '[[motorcad/parameter_database/parameters/FlowRate_RotorPole_F|FlowRate_RotorPole_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This is the flow over end winding front surface
