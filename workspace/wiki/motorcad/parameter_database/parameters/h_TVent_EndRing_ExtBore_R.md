...
parameter_name: h_TVent_EndRing_ExtBore_R
...
aliases:
- h_TVent_EndRing_ExtBore_R
- h T Vent End Ring Ext Bore R
- h_t_vent_end_ring_ext_bore_r
- hTVentEndRingExtBoreR
- h_tvent_endring_extbore_r
related_parameters:
...
## Summary
The TVent heat transfer coefficient over the end ring ExtBore surface [rear]
