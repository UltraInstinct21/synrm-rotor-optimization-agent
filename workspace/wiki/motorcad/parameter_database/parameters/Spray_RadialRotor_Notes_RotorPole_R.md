...
parameter_name: Spray_RadialRotor_Notes_RotorPole_R
...
aliases:
- Spray_RadialRotor_Notes_RotorPole_R
- Spray Radial Rotor Notes Rotor Pole R
- spray_radial_rotor_notes_rotor_pole_r
- sprayRadialRotorNotesRotorPoleR
- spray_radialrotor_notes_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) notes for rear rotor pole surface
