...
parameter_name: Vel_Mult_ES_ExtShaftOuter_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_ExtShaftOuter_R
- Vel Mult ES Ext Shaft Outer R
- vel_mult_es_ext_shaft_outer_r
- velMultEsExtShaftOuterR
- vel_mult_es_extshaftouter_r
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for shaft extension outer [rear]
