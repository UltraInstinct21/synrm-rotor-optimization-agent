...
parameter_name: IMCalibrationFactor_L1_Points
category: Magnetics
input_output: i/p
data_type: integer
units: N/A
...
aliases:
- IMCalibrationFactor_L1_Points
- IM Calibration Factor L1 Points
- im_calibration_factor_l1_points
- imCalibrationFactorL1Points
- imcalibrationfactor_l1_points
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IMCalibrationFactor_Rfe_Points|IMCalibrationFactor_Rfe_Points]]'
...
## Summary
Number of points for which the stator leakage inductance calibration factor is defined
