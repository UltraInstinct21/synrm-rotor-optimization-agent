...
parameter_name: Flow_Area_Inlet_Stator_EWdg_Ext_Exp_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Stator_EWdg_Ext_Exp_Upstream
- Flow Area Inlet Stator E Wdg Ext Exp Upstream
- flow_area_inlet_stator_e_wdg_ext_exp_upstream
- flowAreaInletStatorEWdgExtExpUpstream
- flow_area_inlet_stator_ewdg_ext_exp_upstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Stator EWdg Ext Expansion Upstream
