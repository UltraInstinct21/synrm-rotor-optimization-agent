...
parameter_name: Spray_AxialEndcap_Area_Mult_EWdg_Inner_F
...
aliases:
- Spray_AxialEndcap_Area_Mult_EWdg_Inner_F
- Spray Axial Endcap Area Mult E Wdg Inner F
- spray_axial_endcap_area_mult_e_wdg_inner_f
- sprayAxialEndcapAreaMultEWdgInnerF
- spray_axialendcap_area_mult_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front endwinding inner surface area multiplier
