...
parameter_name: Gap_Material_Bearing_EndCap_Front
...
aliases:
- Gap_Material_Bearing_EndCap_Front
- Gap Material Bearing End Cap Front
- gap_material_bearing_end_cap_front
- gapMaterialBearingEndCapFront
- gap_material_bearing_endcap_front
related_parameters:
...
## Summary
Material in the interface gap between the Bearing and Endcap [F].
