...
parameter_name: TVent_Volume_Flow_Rate_Stator
category: TVent_Data
input_output: o/p
data_type: double
units: m³/s
...
aliases:
- TVent_Volume_Flow_Rate_Stator
- T Vent Volume Flow Rate Stator
- t_vent_volume_flow_rate_stator
- tVentVolumeFlowRateStator
- tvent_volume_flow_rate_stator
related_parameters:
