...
parameter_name: Re_Critical_TVent_EndRing_ExtBore_F
...
aliases:
- Re_Critical_TVent_EndRing_ExtBore_F
- Re Critical T Vent End Ring Ext Bore F
- re_critical_t_vent_end_ring_ext_bore_f
- reCriticalTVentEndRingExtBoreF
- re_critical_tvent_endring_extbore_f
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the end ring ExtBore surface [front]
