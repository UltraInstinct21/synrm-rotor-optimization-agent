...
parameter_name: Forced_Conv_Notes_EncCase_Axial
...
aliases:
- Forced_Conv_Notes_EncCase_Axial
- Forced Conv Notes Enc Case Axial
- forced_conv_notes_enc_case_axial
- forcedConvNotesEncCaseAxial
- forced_conv_notes_enccase_axial
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of encoder case (axial section) available for cooling to ambient
