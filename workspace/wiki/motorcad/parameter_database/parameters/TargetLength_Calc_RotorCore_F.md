...
parameter_name: TargetLength_Calc_RotorCore_F
...
aliases:
- TargetLength_Calc_RotorCore_F
- Target Length Calc Rotor Core F
- target_length_calc_rotor_core_f
- targetLengthCalcRotorCoreF
- targetlength_calc_rotorcore_f
related_parameters:
...
## Summary
This is the calculated length of spray target on front Rotor Core
