...
parameter_name: Spray_RadialHousing_Mixed_h_Bearing_R
...
aliases:
- Spray_RadialHousing_Mixed_h_Bearing_R
- Spray Radial Housing Mixed h Bearing R
- spray_radial_housing_mixed_h_bearing_r
- sprayRadialHousingMixedHBearingR
- spray_radialhousing_mixed_h_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the rear bearing surface
