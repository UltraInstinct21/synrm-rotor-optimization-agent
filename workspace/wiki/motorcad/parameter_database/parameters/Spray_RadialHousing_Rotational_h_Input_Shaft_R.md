...
parameter_name: Spray_RadialHousing_Rotational_h_Input_Shaft_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_Shaft_R
- Spray Radial Housing Rotational h Input Shaft R
- spray_radial_housing_rotational_h_input_shaft_r
- sprayRadialHousingRotationalHInputShaftR
- spray_radialhousing_rotational_h_input_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the rear shaft surface
