...
parameter_name: Spray_RadialHousing_Coupling
...
aliases:
- Spray_RadialHousing_Coupling
- Spray Radial Housing Coupling
- spray_radial_housing_coupling
- sprayRadialHousingCoupling
- spray_radialhousing_coupling
related_parameters:
...
## Summary
Specifies the source of fluid flow for Radial (from Housing) spray cooling
