...
parameter_name: Spray_RadialRotor_Rotational_h_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_Rotational_h_EWdg_Outer_R
- Spray Radial Rotor Rotational h E Wdg Outer R
- spray_radial_rotor_rotational_h_e_wdg_outer_r
- sprayRadialRotorRotationalHEWdgOuterR
- spray_radialrotor_rotational_h_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc over the rear endwinding outer surface
