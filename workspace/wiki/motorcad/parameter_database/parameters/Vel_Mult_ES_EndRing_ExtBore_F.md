...
parameter_name: Vel_Mult_ES_EndRing_ExtBore_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EndRing_ExtBore_F
- Vel Mult ES End Ring Ext Bore F
- vel_mult_es_end_ring_ext_bore_f
- velMultEsEndRingExtBoreF
- vel_mult_es_endring_extbore_f
related_parameters:
...
## Summary
The velocity multiplier for end ring ExtBore surface [front]
