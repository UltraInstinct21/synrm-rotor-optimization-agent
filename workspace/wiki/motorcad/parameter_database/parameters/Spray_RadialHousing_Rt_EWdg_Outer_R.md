...
parameter_name: Spray_RadialHousing_Rt_EWdg_Outer_R
...
aliases:
- Spray_RadialHousing_Rt_EWdg_Outer_R
- Spray Radial Housing Rt E Wdg Outer R
- spray_radial_housing_rt_e_wdg_outer_r
- sprayRadialHousingRtEWdgOuterR
- spray_radialhousing_rt_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) fluid to rear endwinding outer surface convective thermal resistance
