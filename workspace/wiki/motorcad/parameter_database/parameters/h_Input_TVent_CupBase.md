...
parameter_name: h_Input_TVent_CupBase
...
aliases:
- h_Input_TVent_CupBase
- h Input T Vent Cup Base
- h_input_t_vent_cup_base
- hInputTVentCupBase
- h_input_tvent_cupbase
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the Cup Base
