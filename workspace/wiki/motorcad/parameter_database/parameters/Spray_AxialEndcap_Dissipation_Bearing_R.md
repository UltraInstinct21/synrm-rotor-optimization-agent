...
parameter_name: Spray_AxialEndcap_Dissipation_Bearing_R
...
aliases:
- Spray_AxialEndcap_Dissipation_Bearing_R
- Spray Axial Endcap Dissipation Bearing R
- spray_axial_endcap_dissipation_bearing_r
- sprayAxialEndcapDissipationBearingR
- spray_axialendcap_dissipation_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the rear bearing surface
