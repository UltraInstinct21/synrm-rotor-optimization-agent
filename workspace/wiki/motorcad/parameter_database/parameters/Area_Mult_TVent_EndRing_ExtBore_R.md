...
parameter_name: Area_Mult_TVent_EndRing_ExtBore_R
...
aliases:
- Area_Mult_TVent_EndRing_ExtBore_R
- Area Mult T Vent End Ring Ext Bore R
- area_mult_t_vent_end_ring_ext_bore_r
- areaMultTVentEndRingExtBoreR
- area_mult_tvent_endring_extbore_r
related_parameters:
