...
parameter_name: Spray_RadialHousing_Rt_RotorCore_R
...
aliases:
- Spray_RadialHousing_Rt_RotorCore_R
- Spray Radial Housing Rt Rotor Core R
- spray_radial_housing_rt_rotor_core_r
- sprayRadialHousingRtRotorCoreR
- spray_radialhousing_rt_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) fluid to rear rotor core surface convective thermal resistance
