...
parameter_name: Flow_Area_Inlet_Stator_Cont_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Stator_Cont_Downstream
- Flow Area Inlet Stator Cont Downstream
- flow_area_inlet_stator_cont_downstream
- flowAreaInletStatorContDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Stator Contraction Downstream
