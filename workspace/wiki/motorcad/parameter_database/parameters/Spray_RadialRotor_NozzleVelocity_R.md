...
parameter_name: Spray_RadialRotor_NozzleVelocity_R
...
aliases:
- Spray_RadialRotor_NozzleVelocity_R
- Spray Radial Rotor Nozzle Velocity R
- spray_radial_rotor_nozzle_velocity_r
- sprayRadialRotorNozzleVelocityR
- spray_radialrotor_nozzlevelocity_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear nozzle velocity
