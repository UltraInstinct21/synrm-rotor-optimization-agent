...
parameter_name: FEAMeasurePath_StartY
category: Magnetics
input_output: i/p
data_type: double
units: mm
...
aliases:
- FEAMeasurePath_StartY
- FEA Measure Path Start Y
- fea_measure_path_start_y
- feaMeasurePathStartY
- feameasurepath_starty
related_parameters:
...
## Summary
Initial Y co-ordinate in straight path used to measure from FEA
