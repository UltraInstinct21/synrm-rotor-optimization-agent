...
parameter_name: Spray_RadialHousing_Stationary_h_Input_Housing_F
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_Housing_F
- Spray Radial Housing Stationary h Input Housing F
- spray_radial_housing_stationary_h_input_housing_f
- sprayRadialHousingStationaryHInputHousingF
- spray_radialhousing_stationary_h_input_housing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the front housing surface
