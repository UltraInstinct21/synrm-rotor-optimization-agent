...
parameter_name: Area_Mult_ES_Rotor_EWdg_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_Rotor_EWdg_F
- Area Mult ES Rotor E Wdg F
- area_mult_es_rotor_e_wdg_f
- areaMultEsRotorEWdgF
- area_mult_es_rotor_ewdg_f
related_parameters:
...
## Summary
Area multiplier for the Rotor End-Winding [Front] surface for End Space Cooling
