...
parameter_name: Vel_Mult_ES_StatorClampPlate_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_StatorClampPlate_R
- Vel Mult ES Stator Clamp Plate R
- vel_mult_es_stator_clamp_plate_r
- velMultEsStatorClampPlateR
- vel_mult_es_statorclampplate_r
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for Stator Clamp Plate [Rear]
