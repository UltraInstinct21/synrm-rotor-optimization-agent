...
parameter_name: h_TVent_EndRing_ExtInter_R
...
aliases:
- h_TVent_EndRing_ExtInter_R
- h T Vent End Ring Ext Inter R
- h_t_vent_end_ring_ext_inter_r
- hTVentEndRingExtInterR
- h_tvent_endring_extinter_r
related_parameters:
...
## Summary
The TVent heat transfer coefficient over the end ring ExtInter surface [rear]
