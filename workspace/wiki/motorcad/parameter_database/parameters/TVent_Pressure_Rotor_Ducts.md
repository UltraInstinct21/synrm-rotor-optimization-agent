...
parameter_name: TVent_Pressure_Rotor_Ducts
category: TVent_Data
input_output: o/p
data_type: double
units: Pa
...
aliases:
- TVent_Pressure_Rotor_Ducts
- T Vent Pressure Rotor Ducts
- t_vent_pressure_rotor_ducts
- tVentPressureRotorDucts
- tvent_pressure_rotor_ducts
related_parameters:
...
## Summary
Working pressure of rotor ducts
