...
parameter_name: Area_Mult_ES_RotorEwdg_internal_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_RotorEwdg_internal_R
- Area Mult ES Rotor Ewdg internal R
- area_mult_es_rotor_ewdg_internal_r
- areaMultEsRotorEwdgInternalR
- area_mult_es_rotorewdg_internal_r
related_parameters:
...
## Summary
Area multiplier for the Rotor End-Winding Internal [Rear] surface for End Space Cooling
