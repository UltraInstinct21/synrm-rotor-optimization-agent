...
parameter_name: Forced_Conv_Notes_Housing_Front_Fin_Base
...
aliases:
- Forced_Conv_Notes_Housing_Front_Fin_Base
- Forced Conv Notes Housing Front Fin Base
- forced_conv_notes_housing_front_fin_base
- forcedConvNotesHousingFrontFinBase
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of active housing section (fin base section) available for cooling to ambient
