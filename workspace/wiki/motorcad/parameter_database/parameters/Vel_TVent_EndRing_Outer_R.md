...
parameter_name: Vel_TVent_EndRing_Outer_R
...
aliases:
- Vel_TVent_EndRing_Outer_R
- Vel T Vent End Ring Outer R
- vel_t_vent_end_ring_outer_r
- velTVentEndRingOuterR
- vel_tvent_endring_outer_r
related_parameters:
...
## Summary
The TVent velocity over the end ring Outer surface [rear]
