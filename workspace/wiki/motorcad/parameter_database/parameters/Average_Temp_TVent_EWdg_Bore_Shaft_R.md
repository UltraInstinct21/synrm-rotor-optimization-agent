...
parameter_name: Average_Temp_TVent_EWdg_Bore_Shaft_R
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Average_Temp_TVent_EWdg_Bore_Shaft_R
- Average Temp T Vent E Wdg Bore Shaft R
- average_temp_t_vent_e_wdg_bore_shaft_r
- averageTempTVentEWdgBoreShaftR
- average_temp_tvent_ewdg_bore_shaft_r
related_parameters:
...
## Summary
Motor-CAD automation parameter `Average_Temp_TVent_EWdg_Bore_Shaft_R` in category `TVent_Data`.
