...
parameter_name: Spray_AxialEndcap_Rt_Endcap_F
...
aliases:
- Spray_AxialEndcap_Rt_Endcap_F
- Spray Axial Endcap Rt Endcap F
- spray_axial_endcap_rt_endcap_f
- sprayAxialEndcapRtEndcapF
- spray_axialendcap_rt_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to front endcap surface convective thermal resistance
