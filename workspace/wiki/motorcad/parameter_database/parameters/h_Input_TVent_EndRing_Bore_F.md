...
parameter_name: h_Input_TVent_EndRing_Bore_F
...
aliases:
- h_Input_TVent_EndRing_Bore_F
- h Input T Vent End Ring Bore F
- h_input_t_vent_end_ring_bore_f
- hInputTVentEndRingBoreF
- h_input_tvent_endring_bore_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the end ring bore surface [front]
