...
parameter_name: Spray_AxialEndcap_Stationary_h_Bearing_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Bearing_R
- Spray Axial Endcap Stationary h Bearing R
- spray_axial_endcap_stationary_h_bearing_r
- sprayAxialEndcapStationaryHBearingR
- spray_axialendcap_stationary_h_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the rear bearing surface
