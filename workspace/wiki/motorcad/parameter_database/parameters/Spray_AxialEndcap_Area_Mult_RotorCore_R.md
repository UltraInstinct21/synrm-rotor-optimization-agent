...
parameter_name: Spray_AxialEndcap_Area_Mult_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Area_Mult_RotorCore_R
- Spray Axial Endcap Area Mult Rotor Core R
- spray_axial_endcap_area_mult_rotor_core_r
- sprayAxialEndcapAreaMultRotorCoreR
- spray_axialendcap_area_mult_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear rotor core surface area multiplier
