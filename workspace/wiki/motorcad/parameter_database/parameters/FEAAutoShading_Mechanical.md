...
parameter_name: FEAAutoShading_Mechanical
...
aliases:
- FEAAutoShading_Mechanical
- FEA Auto Shading Mechanical
- fea_auto_shading_mechanical
- feaAutoShadingMechanical
- feaautoshading_mechanical
related_parameters:
...
- '[[motorcad/parameter_database/parameters/FEAAutoShading_Thermal|FEAAutoShading_Thermal]]'
- '[[motorcad/parameter_database/parameters/FEAAutoShading_Magnetic|FEAAutoShading_Magnetic]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
When enabled the shading scale is set automatically
