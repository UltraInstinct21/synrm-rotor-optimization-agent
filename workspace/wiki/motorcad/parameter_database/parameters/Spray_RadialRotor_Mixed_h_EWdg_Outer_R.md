...
parameter_name: Spray_RadialRotor_Mixed_h_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_Mixed_h_EWdg_Outer_R
- Spray Radial Rotor Mixed h E Wdg Outer R
- spray_radial_rotor_mixed_h_e_wdg_outer_r
- sprayRadialRotorMixedHEWdgOuterR
- spray_radialrotor_mixed_h_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the rear endwinding outer surface
