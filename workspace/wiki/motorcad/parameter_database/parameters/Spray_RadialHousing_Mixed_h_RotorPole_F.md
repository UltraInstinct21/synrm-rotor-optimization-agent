...
parameter_name: Spray_RadialHousing_Mixed_h_RotorPole_F
...
aliases:
- Spray_RadialHousing_Mixed_h_RotorPole_F
- Spray Radial Housing Mixed h Rotor Pole F
- spray_radial_housing_mixed_h_rotor_pole_f
- sprayRadialHousingMixedHRotorPoleF
- spray_radialhousing_mixed_h_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the front rotor pole surface
