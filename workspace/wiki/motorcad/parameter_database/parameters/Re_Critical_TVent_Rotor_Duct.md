...
parameter_name: Re_Critical_TVent_Rotor_Duct
category: TVent_Data
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Re_Critical_TVent_Rotor_Duct
- Re Critical T Vent Rotor Duct
- re_critical_t_vent_rotor_duct
- reCriticalTVentRotorDuct
- re_critical_tvent_rotor_duct
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the rotor duct surface
