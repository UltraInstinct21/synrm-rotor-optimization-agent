...
parameter_name: Spray_RadialRotor_Mixed_h_Endcap_F
...
aliases:
- Spray_RadialRotor_Mixed_h_Endcap_F
- Spray Radial Rotor Mixed h Endcap F
- spray_radial_rotor_mixed_h_endcap_f
- sprayRadialRotorMixedHEndcapF
- spray_radialrotor_mixed_h_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the front endcap surface
