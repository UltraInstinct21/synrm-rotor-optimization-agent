...
parameter_name: Gap_Material_StatorClampPlate_Housing_F
...
aliases:
- Gap_Material_StatorClampPlate_Housing_F
- Gap Material Stator Clamp Plate Housing F
- gap_material_stator_clamp_plate_housing_f
- gapMaterialStatorClampPlateHousingF
- gap_material_statorclampplate_housing_f
related_parameters:
...
## Summary
Material in the interface gap between the Stator Plate and Housing [F].
