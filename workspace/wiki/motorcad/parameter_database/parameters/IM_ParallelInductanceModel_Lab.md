...
parameter_name: IM_ParallelInductanceModel_Lab
...
aliases:
- IM_ParallelInductanceModel_Lab
- IM Parallel Inductance Model Lab
- im_parallel_inductance_model_lab
- imParallelInductanceModelLab
- im_parallelinductancemodel_lab
related_parameters:
...
## Summary
Parallel inductance values Lab (IM rotor leakage inductance model)
