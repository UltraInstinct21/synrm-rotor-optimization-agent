...
parameter_name: Spray_RadialHousing_Rotational_h_Input_EWdg_Front_F
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_EWdg_Front_F
- Spray Radial Housing Rotational h Input E Wdg Front F
- spray_radial_housing_rotational_h_input_e_wdg_front_f
- sprayRadialHousingRotationalHInputEWdgFrontF
- spray_radialhousing_rotational_h_input_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the front endwinding front surface
