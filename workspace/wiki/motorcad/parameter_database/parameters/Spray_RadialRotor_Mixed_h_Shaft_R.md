...
parameter_name: Spray_RadialRotor_Mixed_h_Shaft_R
...
aliases:
- Spray_RadialRotor_Mixed_h_Shaft_R
- Spray Radial Rotor Mixed h Shaft R
- spray_radial_rotor_mixed_h_shaft_r
- sprayRadialRotorMixedHShaftR
- spray_radialrotor_mixed_h_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the rear shaft surface
