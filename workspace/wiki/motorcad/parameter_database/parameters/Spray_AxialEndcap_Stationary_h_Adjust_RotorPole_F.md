...
parameter_name: Spray_AxialEndcap_Stationary_h_Adjust_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Adjust_RotorPole_F
- Spray Axial Endcap Stationary h Adjust Rotor Pole F
- spray_axial_endcap_stationary_h_adjust_rotor_pole_f
- sprayAxialEndcapStationaryHAdjustRotorPoleF
- spray_axialendcap_stationary_h_adjust_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc adjustment over the front rotor pole surface
