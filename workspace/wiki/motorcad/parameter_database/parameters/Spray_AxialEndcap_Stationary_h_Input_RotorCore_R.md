...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_RotorCore_R
- Spray Axial Endcap Stationary h Input Rotor Core R
- spray_axial_endcap_stationary_h_input_rotor_core_r
- sprayAxialEndcapStationaryHInputRotorCoreR
- spray_axialendcap_stationary_h_input_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the rear rotor core surface
