...
parameter_name: ACLoss_Hybrid_SkinEffect
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- ACLoss_Hybrid_SkinEffect
- AC Loss Hybrid Skin Effect
- ac_loss_hybrid_skin_effect
- acLossHybridSkinEffect
- acloss_hybrid_skineffect
related_parameters:
...
## Summary
Skin-effect AC losses (Hybrid method)
