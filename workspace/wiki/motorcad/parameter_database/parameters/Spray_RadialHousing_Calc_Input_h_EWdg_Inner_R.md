...
parameter_name: Spray_RadialHousing_Calc_Input_h_EWdg_Inner_R
...
aliases:
- Spray_RadialHousing_Calc_Input_h_EWdg_Inner_R
- Spray Radial Housing Calc Input h E Wdg Inner R
- spray_radial_housing_calc_input_h_e_wdg_inner_r
- sprayRadialHousingCalcInputHEWdgInnerR
- spray_radialhousing_calc_input_h_ewdg_inner_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the rear endwinding inner surface is calculated or user input  (0=Calc h, 1=Input h)
