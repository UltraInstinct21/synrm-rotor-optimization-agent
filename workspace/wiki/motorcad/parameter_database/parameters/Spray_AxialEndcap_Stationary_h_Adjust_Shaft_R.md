...
parameter_name: Spray_AxialEndcap_Stationary_h_Adjust_Shaft_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Adjust_Shaft_R
- Spray Axial Endcap Stationary h Adjust Shaft R
- spray_axial_endcap_stationary_h_adjust_shaft_r
- sprayAxialEndcapStationaryHAdjustShaftR
- spray_axialendcap_stationary_h_adjust_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc adjustment over the rear shaft surface
