...
parameter_name: Gap_Material_Plate_Magnet_R
...
aliases:
- Gap_Material_Plate_Magnet_R
- Gap Material Plate Magnet R
- gap_material_plate_magnet_r
- gapMaterialPlateMagnetR
related_parameters:
...
## Summary
Material in the interface gap between the Rotor Plate and Magnet [R].
