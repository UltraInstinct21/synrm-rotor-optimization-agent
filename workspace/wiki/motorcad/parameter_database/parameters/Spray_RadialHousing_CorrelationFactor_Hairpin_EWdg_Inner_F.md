...
parameter_name: Spray_RadialHousing_CorrelationFactor_Hairpin_EWdg_Inner_F
...
aliases:
- Spray_RadialHousing_CorrelationFactor_Hairpin_EWdg_Inner_F
- Spray Radial Housing Correlation Factor Hairpin E Wdg Inner F
- spray_radial_housing_correlation_factor_hairpin_e_wdg_inner_f
- sprayRadialHousingCorrelationFactorHairpinEWdgInnerF
- spray_radialhousing_correlationfactor_hairpin_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the hairpin front endwinding inner surface
