...
parameter_name: IMOnLoad_RMSStatorLeakageVoltage_T
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- IMOnLoad_RMSStatorLeakageVoltage_T
- IM On Load RMS Stator Leakage Voltage T
- im_on_load_rms_stator_leakage_voltage_t
- imOnLoadRmsStatorLeakageVoltageT
- imonload_rmsstatorleakagevoltage_t
related_parameters:
...
## Summary
The on load rms stator leakage voltage
