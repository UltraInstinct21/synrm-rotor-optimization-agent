...
parameter_name: Spray_RadialRotor_Rotational_h_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_Rotational_h_EWdg_Inner_R
- Spray Radial Rotor Rotational h E Wdg Inner R
- spray_radial_rotor_rotational_h_e_wdg_inner_r
- sprayRadialRotorRotationalHEWdgInnerR
- spray_radialrotor_rotational_h_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc over the rear endwinding inner surface
