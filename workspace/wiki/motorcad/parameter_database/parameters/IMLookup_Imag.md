...
- '[[motorcad/parameter_database/parameters/IMLookup_Magnetizing_Reactance|IMLookup_Magnetizing_Reactance]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The magnetizing current used to calculate the IM saturation model
