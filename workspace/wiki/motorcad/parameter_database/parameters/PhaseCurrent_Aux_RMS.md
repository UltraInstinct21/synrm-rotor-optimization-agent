...
parameter_name: PhaseCurrent_Aux_RMS
category: Magnetics
input_output: o/p
data_type: double
units: Amps
...
aliases:
- PhaseCurrent_Aux_RMS
- Phase Current Aux RMS
- phase_current_aux_rms
- phaseCurrentAuxRms
- phasecurrent_aux_rms
related_parameters:
...
- '[[motorcad/parameter_database/parameters/PhaseCurrent_Main_RMS|PhaseCurrent_Main_RMS]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The aux winding RMS phase current
