...
parameter_name: Area_Mult_ES_DividerWedge_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_DividerWedge_F
- Area Mult ES Divider Wedge F
- area_mult_es_divider_wedge_f
- areaMultEsDividerWedgeF
- area_mult_es_dividerwedge_f
related_parameters:
...
## Summary
Area multiplier for the Air Divider/Wedge [Front] surface for End Space Cooling
