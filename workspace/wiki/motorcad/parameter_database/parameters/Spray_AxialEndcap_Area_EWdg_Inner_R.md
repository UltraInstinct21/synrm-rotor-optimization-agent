...
parameter_name: Spray_AxialEndcap_Area_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_Area_EWdg_Inner_R
- Spray Axial Endcap Area E Wdg Inner R
- spray_axial_endcap_area_e_wdg_inner_r
- sprayAxialEndcapAreaEWdgInnerR
- spray_axialendcap_area_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear endwinding inner surface sprayed area
