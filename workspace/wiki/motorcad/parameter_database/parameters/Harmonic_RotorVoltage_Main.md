...
parameter_name: Harmonic_RotorVoltage_Main
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- Harmonic_RotorVoltage_Main
- Harmonic Rotor Voltage Main
- harmonic_rotor_voltage_main
- harmonicRotorVoltageMain
- harmonic_rotorvoltage_main
related_parameters:
...
## Summary
Voltage drop across rotor resistance referred to the main winding for each harmonic order in the IM1PH equivalent circuit
