...
parameter_name: LabModel_ACLoss_RotorCurrent
...
- Lab Model AC Loss Rotor Current
- lab_model_ac_loss_rotor_current
- labModelAcLossRotorCurrent
- labmodel_acloss_rotorcurrent
related_parameters:
...
## Summary
Maximum rotor current used in Lab AC loss model build
