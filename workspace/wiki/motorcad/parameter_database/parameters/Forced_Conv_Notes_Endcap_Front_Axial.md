...
parameter_name: Forced_Conv_Notes_Endcap_Front_Axial
...
aliases:
- Forced_Conv_Notes_Endcap_Front_Axial
- Forced Conv Notes Endcap Front Axial
- forced_conv_notes_endcap_front_axial
- forcedConvNotesEndcapFrontAxial
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of front endcap (axial section) available for cooling to ambient
