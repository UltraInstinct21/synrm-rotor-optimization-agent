...
parameter_name: Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Outer_R
- Spray Radial Rotor Correlation Factor Stranded E Wdg Outer R
- spray_radial_rotor_correlation_factor_stranded_e_wdg_outer_r
- sprayRadialRotorCorrelationFactorStrandedEWdgOuterR
- spray_radialrotor_correlationfactor_stranded_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the stranded rear endwinding outer surface
