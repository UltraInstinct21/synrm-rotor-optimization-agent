...
parameter_name: Vel_ES_EndRing_ExtInter_F
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_ExtInter_F
- Vel ES End Ring Ext Inter F
- vel_es_end_ring_ext_inter_f
- velEsEndRingExtInterF
- vel_es_endring_extinter_f
related_parameters:
...
## Summary
The velocity over the end ring ExtInter surface [front]
