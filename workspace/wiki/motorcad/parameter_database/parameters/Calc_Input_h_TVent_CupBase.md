...
parameter_name: Calc_Input_h_TVent_CupBase
...
aliases:
- Calc_Input_h_TVent_CupBase
- Calc Input h T Vent Cup Base
- calc_input_h_t_vent_cup_base
- calcInputHTVentCupBase
- calc_input_h_tvent_cupbase
related_parameters:
...
## Summary
The TVent calculated or input set value for htc from flow over the Cup Base (0=Calc h, 1=Input h)
