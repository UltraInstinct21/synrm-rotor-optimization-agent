...
parameter_name: TVent_Flow_Area_Winding_Inner_F
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- TVent_Flow_Area_Winding_Inner_F
- T Vent Flow Area Winding Inner F
- t_vent_flow_area_winding_inner_f
- tVentFlowAreaWindingInnerF
- tvent_flow_area_winding_inner_f
related_parameters:
...
## Summary
TVent Flow Area for the Winding Inner Front
