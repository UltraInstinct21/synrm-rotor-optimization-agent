...
parameter_name: BMax_StatorTooth_Analytic
category: Magnetics
input_output: o/p
data_type: double
units: Tesla
...
aliases:
- BMax_StatorTooth_Analytic
- B Max Stator Tooth Analytic
- b_max_stator_tooth_analytic
- bMaxStatorToothAnalytic
- bmax_statortooth_analytic
related_parameters:
...
## Summary
Maximum flux density at midpoint in the stator tooth (from analytic solution)
