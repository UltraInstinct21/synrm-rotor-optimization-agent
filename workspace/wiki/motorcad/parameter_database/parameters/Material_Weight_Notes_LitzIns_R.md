...
parameter_name: Material_Weight_Notes_LitzIns_R
...
aliases:
- Material_Weight_Notes_LitzIns_R
- Material Weight Notes Litz Ins R
- material_weight_notes_litz_ins_r
- materialWeightNotesLitzInsR
- material_weight_notes_litzins_r
related_parameters:
...
## Summary
The material notes of the Litz Bundle Insulation Material (Rear)
