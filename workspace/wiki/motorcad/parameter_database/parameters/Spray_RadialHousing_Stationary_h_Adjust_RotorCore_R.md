...
parameter_name: Spray_RadialHousing_Stationary_h_Adjust_RotorCore_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Adjust_RotorCore_R
- Spray Radial Housing Stationary h Adjust Rotor Core R
- spray_radial_housing_stationary_h_adjust_rotor_core_r
- sprayRadialHousingStationaryHAdjustRotorCoreR
- spray_radialhousing_stationary_h_adjust_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc adjustment over the rear rotor core surface
