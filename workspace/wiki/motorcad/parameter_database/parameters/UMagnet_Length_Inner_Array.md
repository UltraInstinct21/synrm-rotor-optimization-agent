...
parameter_name: UMagnet_Length_Inner_Array
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- UMagnet_Length_Inner_Array
- U Magnet Length Inner Array
- u_magnet_length_inner_array
- uMagnetLengthInnerArray
- umagnet_length_inner_array
related_parameters:
...
- '[[motorcad/parameter_database/parameters/UMagnet_Length_Outer_Array|UMagnet_Length_Outer_Array]]'
- '[[motorcad/parameter_database/parameters/UMagnet_Offset_Inner_Array|UMagnet_Offset_Inner_Array]]'
- '[[motorcad/parameter_database/parameters/UMagnet_Offset_Outer_Array|UMagnet_Offset_Outer_Array]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The length of the U Layer Inner magnet
