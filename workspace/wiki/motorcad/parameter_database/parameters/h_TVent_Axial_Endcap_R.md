...
parameter_name: h_TVent_Axial_Endcap_R
category: TVent_Data
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_TVent_Axial_Endcap_R
- h T Vent Axial Endcap R
- h_t_vent_axial_endcap_r
- hTVentAxialEndcapR
- h_tvent_axial_endcap_r
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the endcap [rear]
