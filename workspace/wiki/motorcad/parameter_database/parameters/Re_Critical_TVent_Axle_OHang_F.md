...
parameter_name: Re_Critical_TVent_Axle_OHang_F
category: TVent_Data
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Re_Critical_TVent_Axle_OHang_F
- Re Critical T Vent Axle O Hang F
- re_critical_t_vent_axle_o_hang_f
- reCriticalTVentAxleOHangF
- re_critical_tvent_axle_ohang_f
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the axle overhang front surface
