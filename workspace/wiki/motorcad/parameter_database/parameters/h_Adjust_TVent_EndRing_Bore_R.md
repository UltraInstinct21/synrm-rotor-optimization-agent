...
parameter_name: h_Adjust_TVent_EndRing_Bore_R
...
aliases:
- h_Adjust_TVent_EndRing_Bore_R
- h Adjust T Vent End Ring Bore R
- h_adjust_t_vent_end_ring_bore_r
- hAdjustTVentEndRingBoreR
- h_adjust_tvent_endring_bore_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the end ring bore surface [rear]
