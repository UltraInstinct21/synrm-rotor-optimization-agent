...
parameter_name: Spray_RadialHousing_CorrelationFactor_RotorPole_R
...
aliases:
- Spray_RadialHousing_CorrelationFactor_RotorPole_R
- Spray Radial Housing Correlation Factor Rotor Pole R
- spray_radial_housing_correlation_factor_rotor_pole_r
- sprayRadialHousingCorrelationFactorRotorPoleR
- spray_radialhousing_correlationfactor_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the rear rotor pole surface
