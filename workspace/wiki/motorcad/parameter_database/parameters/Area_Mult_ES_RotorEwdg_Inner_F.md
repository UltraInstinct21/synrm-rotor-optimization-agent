...
parameter_name: Area_Mult_ES_RotorEwdg_Inner_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_RotorEwdg_Inner_F
- Area Mult ES Rotor Ewdg Inner F
- area_mult_es_rotor_ewdg_inner_f
- areaMultEsRotorEwdgInnerF
- area_mult_es_rotorewdg_inner_f
related_parameters:
...
## Summary
Area multiplier for the Rotor End-Winding Inner [Front] surface for End Space Cooling
