...
parameter_name: Flow_Area_Outlet_Stator_EWdg_Cont_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Stator_EWdg_Cont_Exp_Downstream
- Flow Area Outlet Stator E Wdg Cont Exp Downstream
- flow_area_outlet_stator_e_wdg_cont_exp_downstream
- flowAreaOutletStatorEWdgContExpDownstream
- flow_area_outlet_stator_ewdg_cont_exp_downstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Stator EWdg Contraction Expansion Downstream
