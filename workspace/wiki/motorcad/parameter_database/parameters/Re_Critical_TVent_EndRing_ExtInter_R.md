...
parameter_name: Re_Critical_TVent_EndRing_ExtInter_R
...
aliases:
- Re_Critical_TVent_EndRing_ExtInter_R
- Re Critical T Vent End Ring Ext Inter R
- re_critical_t_vent_end_ring_ext_inter_r
- reCriticalTVentEndRingExtInterR
- re_critical_tvent_endring_extinter_r
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the end ring ExtInter surface [rear]
