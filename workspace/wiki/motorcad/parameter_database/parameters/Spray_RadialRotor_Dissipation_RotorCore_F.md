...
parameter_name: Spray_RadialRotor_Dissipation_RotorCore_F
...
aliases:
- Spray_RadialRotor_Dissipation_RotorCore_F
- Spray Radial Rotor Dissipation Rotor Core F
- spray_radial_rotor_dissipation_rotor_core_f
- sprayRadialRotorDissipationRotorCoreF
- spray_radialrotor_dissipation_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the front rotor core surface
