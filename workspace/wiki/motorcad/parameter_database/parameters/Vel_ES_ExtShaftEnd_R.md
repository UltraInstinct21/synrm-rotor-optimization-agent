...
parameter_name: Vel_ES_ExtShaftEnd_R
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_ExtShaftEnd_R
- Vel ES Ext Shaft End R
- vel_es_ext_shaft_end_r
- velEsExtShaftEndR
- vel_es_extshaftend_r
related_parameters:
...
## Summary
End Space Cooling - velocity for shaft extension end [rear]
