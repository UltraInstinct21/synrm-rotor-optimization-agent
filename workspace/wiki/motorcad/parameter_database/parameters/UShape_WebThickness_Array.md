...
parameter_name: UShape_WebThickness_Array
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- UShape_WebThickness_Array
- U Shape Web Thickness Array
- u_shape_web_thickness_array
- uShapeWebThicknessArray
- ushape_webthickness_array
related_parameters:
...
## Summary
The web thickness of the U layer
