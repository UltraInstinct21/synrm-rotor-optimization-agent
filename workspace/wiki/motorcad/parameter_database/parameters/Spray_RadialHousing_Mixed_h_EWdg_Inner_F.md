...
parameter_name: Spray_RadialHousing_Mixed_h_EWdg_Inner_F
...
aliases:
- Spray_RadialHousing_Mixed_h_EWdg_Inner_F
- Spray Radial Housing Mixed h E Wdg Inner F
- spray_radial_housing_mixed_h_e_wdg_inner_f
- sprayRadialHousingMixedHEWdgInnerF
- spray_radialhousing_mixed_h_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the front endwinding inner surface
