...
parameter_name: Rt_TVent_RotorEWdg_R
...
aliases:
- Rt_TVent_RotorEWdg_R
- Rt T Vent Rotor E Wdg R
- rt_t_vent_rotor_e_wdg_r
- rtTVentRotorEWdgR
- rt_tvent_rotorewdg_r
related_parameters:
...
## Summary
The thermal resistance from the surfaces of rear rotor endwinding to the fluid
