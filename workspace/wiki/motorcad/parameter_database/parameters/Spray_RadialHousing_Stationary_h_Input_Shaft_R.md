...
parameter_name: Spray_RadialHousing_Stationary_h_Input_Shaft_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_Shaft_R
- Spray Radial Housing Stationary h Input Shaft R
- spray_radial_housing_stationary_h_input_shaft_r
- sprayRadialHousingStationaryHInputShaftR
- spray_radialhousing_stationary_h_input_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the rear shaft surface
