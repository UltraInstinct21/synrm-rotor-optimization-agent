...
parameter_name: Spray_RadialHousing_Area_Mult_Endcap_R
...
aliases:
- Spray_RadialHousing_Area_Mult_Endcap_R
- Spray Radial Housing Area Mult Endcap R
- spray_radial_housing_area_mult_endcap_r
- sprayRadialHousingAreaMultEndcapR
- spray_radialhousing_area_mult_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rear endcap surface area multiplier
