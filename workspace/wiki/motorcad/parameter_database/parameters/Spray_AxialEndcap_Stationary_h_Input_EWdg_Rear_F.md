...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_EWdg_Rear_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_EWdg_Rear_F
- Spray Axial Endcap Stationary h Input E Wdg Rear F
- spray_axial_endcap_stationary_h_input_e_wdg_rear_f
- sprayAxialEndcapStationaryHInputEWdgRearF
- spray_axialendcap_stationary_h_input_ewdg_rear_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the front endwinding rear surface
