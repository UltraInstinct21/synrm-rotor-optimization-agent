...
parameter_name: IMOnLoad_StatorWindingVoltagePh
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- IMOnLoad_StatorWindingVoltagePh
- IM On Load Stator Winding Voltage Ph
- im_on_load_stator_winding_voltage_ph
- imOnLoadStatorWindingVoltagePh
- imonload_statorwindingvoltageph
related_parameters:
...
## Summary
The on load rms stator winding phase voltage
