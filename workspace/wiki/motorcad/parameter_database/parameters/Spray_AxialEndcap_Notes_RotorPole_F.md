...
parameter_name: Spray_AxialEndcap_Notes_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Notes_RotorPole_F
- Spray Axial Endcap Notes Rotor Pole F
- spray_axial_endcap_notes_rotor_pole_f
- sprayAxialEndcapNotesRotorPoleF
- spray_axialendcap_notes_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) notes for front rotor pole surface
