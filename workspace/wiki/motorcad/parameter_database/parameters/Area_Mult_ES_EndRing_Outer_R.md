...
parameter_name: Area_Mult_ES_EndRing_Outer_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_Outer_R
- Area Mult ES End Ring Outer R
- area_mult_es_end_ring_outer_r
- areaMultEsEndRingOuterR
- area_mult_es_endring_outer_r
related_parameters:
...
## Summary
Area multiplier for the End Ring Outer [Rear] surface for End Space Cooling
