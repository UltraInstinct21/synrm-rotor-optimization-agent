...
parameter_name: Spray_RadialHousing_Dissipation_RotorPole_R
...
aliases:
- Spray_RadialHousing_Dissipation_RotorPole_R
- Spray Radial Housing Dissipation Rotor Pole R
- spray_radial_housing_dissipation_rotor_pole_r
- sprayRadialHousingDissipationRotorPoleR
- spray_radialhousing_dissipation_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) thermal dissipation from the rear rotor pole surface
