...
parameter_name: TVent_Volume_Flow_Rate_Total
category: TVent_Data
input_output: o/p
data_type: double
units: m³/s
...
aliases:
- TVent_Volume_Flow_Rate_Total
- T Vent Volume Flow Rate Total
- t_vent_volume_flow_rate_total
- tVentVolumeFlowRateTotal
- tvent_volume_flow_rate_total
related_parameters:
