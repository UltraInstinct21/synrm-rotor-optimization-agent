...
parameter_name: K_SyncRotorTangential_User_F
...
aliases:
- K_SyncRotorTangential_User_F
- K Sync Rotor Tangential User F
- k_sync_rotor_tangential_user_f
- kSyncRotorTangentialUserF
- k_syncrotortangential_user_f
related_parameters:
...
## Summary
This is the user input thermal conductivity of the sync field winding [front] in the tangential direction
