...
parameter_name: Spray_AxialEndcap_Dissipation_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Dissipation_RotorPole_F
- Spray Axial Endcap Dissipation Rotor Pole F
- spray_axial_endcap_dissipation_rotor_pole_f
- sprayAxialEndcapDissipationRotorPoleF
- spray_axialendcap_dissipation_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the front rotor pole surface
