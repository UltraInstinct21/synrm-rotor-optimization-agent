...
parameter_name: Area_Mult_ES_RotorEwdg_internal_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_RotorEwdg_internal_F
- Area Mult ES Rotor Ewdg internal F
- area_mult_es_rotor_ewdg_internal_f
- areaMultEsRotorEwdgInternalF
- area_mult_es_rotorewdg_internal_f
related_parameters:
...
## Summary
Area multiplier for the Rotor End-Winding Internal [Front] surface for End Space Cooling
