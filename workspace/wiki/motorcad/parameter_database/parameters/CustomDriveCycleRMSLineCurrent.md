...
parameter_name: CustomDriveCycleRMSLineCurrent
category: Magnetics
input_output: o/p
data_type: double
units: Amps
...
aliases:
- CustomDriveCycleRMSLineCurrent
- Custom Drive Cycle RMS Line Current
- custom_drive_cycle_rms_line_current
- customDriveCycleRmsLineCurrent
- customdrivecyclermslinecurrent
related_parameters:
...
- '[[motorcad/parameter_database/parameters/CustomDriveCyclePointReduction|CustomDriveCyclePointReduction]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
RMS amplitude of the custom line current waveform
