...
parameter_name: Material_Weight_Notes_LitzImpreg_F
...
aliases:
- Material_Weight_Notes_LitzImpreg_F
- Material Weight Notes Litz Impreg F
- material_weight_notes_litz_impreg_f
- materialWeightNotesLitzImpregF
- material_weight_notes_litzimpreg_f
related_parameters:
...
## Summary
The material notes of the Litz Bundle Impregnation Material (Front)
