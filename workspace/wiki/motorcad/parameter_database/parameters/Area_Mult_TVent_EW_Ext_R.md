...
parameter_name: Area_Mult_TVent_EW_Ext_R
...
aliases:
- Area_Mult_TVent_EW_Ext_R
- Area Mult T Vent EW Ext R
- area_mult_t_vent_ew_ext_r
- areaMultTVentEwExtR
- area_mult_tvent_ew_ext_r
related_parameters:
...
## Summary
Area multiplier for the EndWinding Ext [Rear] for Through Ventilation
