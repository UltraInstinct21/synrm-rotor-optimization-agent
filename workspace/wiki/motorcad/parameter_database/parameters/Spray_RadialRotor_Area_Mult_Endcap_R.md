...
parameter_name: Spray_RadialRotor_Area_Mult_Endcap_R
...
aliases:
- Spray_RadialRotor_Area_Mult_Endcap_R
- Spray Radial Rotor Area Mult Endcap R
- spray_radial_rotor_area_mult_endcap_r
- sprayRadialRotorAreaMultEndcapR
- spray_radialrotor_area_mult_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear endcap surface area multiplier
