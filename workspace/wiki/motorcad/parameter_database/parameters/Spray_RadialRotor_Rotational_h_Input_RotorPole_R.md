...
parameter_name: Spray_RadialRotor_Rotational_h_Input_RotorPole_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_RotorPole_R
- Spray Radial Rotor Rotational h Input Rotor Pole R
- spray_radial_rotor_rotational_h_input_rotor_pole_r
- sprayRadialRotorRotationalHInputRotorPoleR
- spray_radialrotor_rotational_h_input_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the rear rotor pole surface
