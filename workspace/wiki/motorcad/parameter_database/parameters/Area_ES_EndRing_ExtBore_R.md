...
parameter_name: Area_ES_EndRing_ExtBore_R
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_EndRing_ExtBore_R
- Area ES End Ring Ext Bore R
- area_es_end_ring_ext_bore_r
- areaEsEndRingExtBoreR
- area_es_endring_extbore_r
related_parameters:
...
## Summary
The area of the end ring ExtBore surface [rear]
