...
parameter_name: IMLockedRotor_SeriesEquivResistance
category: Magnetics
input_output: o/p
data_type: double
units: Ohms
...
aliases:
- IMLockedRotor_SeriesEquivResistance
- IM Locked Rotor Series Equiv Resistance
- im_locked_rotor_series_equiv_resistance
- imLockedRotorSeriesEquivResistance
- imlockedrotor_seriesequivresistance
related_parameters:
...
## Summary
The equivalent resistance in series circuit in the Locked Rotor case
