...
parameter_name: RotorIronLoss_Total_Static_Adj
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- RotorIronLoss_Total_Static_Adj
- Rotor Iron Loss Total Static Adj
- rotor_iron_loss_total_static_adj
- rotorIronLossTotalStaticAdj
- rotorironloss_total_static_adj
related_parameters:
...
- '[[motorcad/parameter_database/parameters/RotorIronLoss_Total_Adj_OC|RotorIronLoss_Total_Adj_OC]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
