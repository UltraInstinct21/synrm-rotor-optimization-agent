...
parameter_name: UMagnetInner_ClearanceO_Array
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- UMagnetInner_ClearanceO_Array
- U Magnet Inner Clearance O Array
- u_magnet_inner_clearance_o_array
- uMagnetInnerClearanceOArray
- umagnetinner_clearanceo_array
related_parameters:
...
- '[[motorcad/parameter_database/parameters/UMagnetInner_ClearanceI_Array|UMagnetInner_ClearanceI_Array]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The clearance of the U-Layer Inner magnet towards the magnet pole
