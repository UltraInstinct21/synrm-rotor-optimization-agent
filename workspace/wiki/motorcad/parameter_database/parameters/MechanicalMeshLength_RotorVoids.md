...
parameter_name: MechanicalMeshLength_RotorVoids
...
aliases:
- MechanicalMeshLength_RotorVoids
- Mechanical Mesh Length Rotor Voids
- mechanical_mesh_length_rotor_voids
- mechanicalMeshLengthRotorVoids
- mechanicalmeshlength_rotorvoids
related_parameters:
...
- '[[motorcad/parameter_database/parameters/MechanicalMeshLength_RotorLam|MechanicalMeshLength_RotorLam]]'
- '[[motorcad/parameter_database/parameters/MechanicalMeshLength_Magnets|MechanicalMeshLength_Magnets]]'
- '[[motorcad/parameter_database/parameters/MechanicalMeshLength_RotorBars|MechanicalMeshLength_RotorBars]]'
- '[[motorcad/parameter_database/parameters/MechanicalMeshLength_DamperBars|MechanicalMeshLength_DamperBars]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This specifies the size of mesh elements around the rotor voids. Default = 0.1, 0 = automatic
