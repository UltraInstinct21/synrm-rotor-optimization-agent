...
parameter_name: Area_Mult_ES_Rotor_EWdg_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_Rotor_EWdg_R
- Area Mult ES Rotor E Wdg R
- area_mult_es_rotor_e_wdg_r
- areaMultEsRotorEWdgR
- area_mult_es_rotor_ewdg_r
related_parameters:
...
## Summary
Area multiplier for the Rotor End-Winding [Rear] surface for End Space Cooling
