...
parameter_name: Vel_Inlet_Rotor_EWdg_Bore_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_Inlet_Rotor_EWdg_Bore_Exp_Downstream
- Vel Inlet Rotor E Wdg Bore Exp Downstream
- vel_inlet_rotor_e_wdg_bore_exp_downstream
- velInletRotorEWdgBoreExpDownstream
- vel_inlet_rotor_ewdg_bore_exp_downstream
related_parameters:
...
## Summary
Velocity Inlet Rotor EWdg Bore Expansion Downstream
