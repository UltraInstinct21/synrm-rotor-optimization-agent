...
parameter_name: Spray_RadialRotor_DynamicViscosity_R
...
aliases:
- Spray_RadialRotor_DynamicViscosity_R
- Spray Radial Rotor Dynamic Viscosity R
- spray_radial_rotor_dynamic_viscosity_r
- sprayRadialRotorDynamicViscosityR
- spray_radialrotor_dynamicviscosity_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) Rear fluid dynamic viscosity
