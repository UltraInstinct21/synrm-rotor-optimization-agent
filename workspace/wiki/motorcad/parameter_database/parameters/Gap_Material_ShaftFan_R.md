...
parameter_name: Gap_Material_ShaftFan_R
...
aliases:
- Gap_Material_ShaftFan_R
- Gap Material Shaft Fan R
- gap_material_shaft_fan_r
- gapMaterialShaftFanR
- gap_material_shaftfan_r
related_parameters:
...
## Summary
Material in the interface gap between the Fan and Shaft [R].
