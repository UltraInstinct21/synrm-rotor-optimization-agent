...
parameter_name: Re_Critical_TVent_EndRing_Bore_R
...
aliases:
- Re_Critical_TVent_EndRing_Bore_R
- Re Critical T Vent End Ring Bore R
- re_critical_t_vent_end_ring_bore_r
- reCriticalTVentEndRingBoreR
- re_critical_tvent_endring_bore_r
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the end ring bore surface [rear]
