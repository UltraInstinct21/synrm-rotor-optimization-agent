...
parameter_name: Area_Mult_ES_EndRing_ExtOuter_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_ExtOuter_R
- Area Mult ES End Ring Ext Outer R
- area_mult_es_end_ring_ext_outer_r
- areaMultEsEndRingExtOuterR
- area_mult_es_endring_extouter_r
related_parameters:
...
## Summary
Area multiplier for the End Ring Extension Outer [Rear] surface for End Space Cooling
