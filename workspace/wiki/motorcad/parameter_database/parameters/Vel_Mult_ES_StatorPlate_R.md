...
parameter_name: Vel_Mult_ES_StatorPlate_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_StatorPlate_R
- Vel Mult ES Stator Plate R
- vel_mult_es_stator_plate_r
- velMultEsStatorPlateR
- vel_mult_es_statorplate_r
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for stator plate [rear]
