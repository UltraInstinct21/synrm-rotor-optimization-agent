...
parameter_name: Spray_RadialRotor_Calc_Input_h_Bearing_F
...
aliases:
- Spray_RadialRotor_Calc_Input_h_Bearing_F
- Spray Radial Rotor Calc Input h Bearing F
- spray_radial_rotor_calc_input_h_bearing_f
- sprayRadialRotorCalcInputHBearingF
- spray_radialrotor_calc_input_h_bearing_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the front bearing surface is calculated or user input  (0=Calc h, 1=Input h)
