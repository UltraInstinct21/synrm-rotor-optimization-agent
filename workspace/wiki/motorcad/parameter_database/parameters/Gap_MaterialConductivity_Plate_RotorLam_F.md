...
parameter_name: Gap_MaterialConductivity_Plate_RotorLam_F
...
aliases:
- Gap_MaterialConductivity_Plate_RotorLam_F
- Gap Material Conductivity Plate Rotor Lam F
- gap_material_conductivity_plate_rotor_lam_f
- gapMaterialConductivityPlateRotorLamF
- gap_materialconductivity_plate_rotorlam_f
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Rotor Plate and Rotor Lam [F].
