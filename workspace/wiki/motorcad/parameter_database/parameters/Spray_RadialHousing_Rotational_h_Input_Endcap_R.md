...
parameter_name: Spray_RadialHousing_Rotational_h_Input_Endcap_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_Endcap_R
- Spray Radial Housing Rotational h Input Endcap R
- spray_radial_housing_rotational_h_input_endcap_r
- sprayRadialHousingRotationalHInputEndcapR
- spray_radialhousing_rotational_h_input_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the rear endcap surface
