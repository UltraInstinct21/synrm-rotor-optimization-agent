...
parameter_name: Spray_RadialRotor_Rt_EWdg_Inner_F
...
aliases:
- Spray_RadialRotor_Rt_EWdg_Inner_F
- Spray Radial Rotor Rt E Wdg Inner F
- spray_radial_rotor_rt_e_wdg_inner_f
- sprayRadialRotorRtEWdgInnerF
- spray_radialrotor_rt_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to front endwinding inner surface convective thermal resistance
