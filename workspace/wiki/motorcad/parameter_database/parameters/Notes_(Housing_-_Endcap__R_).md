...
parameter_name: Notes_(Housing_-_Endcap_[R])
...
aliases:
- Notes_(Housing_-_Endcap_[R])
- Notes_(Housing_-_Endcap_(R))
- Notes Housing Endcap R
- notes_housing_endcap_r
- notesHousingEndcapR
- notes_(housing_-_endcap_[r])
related_parameters:
...
## Summary
The notes for the rear interface gap between housing and endcap
