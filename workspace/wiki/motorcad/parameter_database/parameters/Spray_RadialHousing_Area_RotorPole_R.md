...
parameter_name: Spray_RadialHousing_Area_RotorPole_R
...
aliases:
- Spray_RadialHousing_Area_RotorPole_R
- Spray Radial Housing Area Rotor Pole R
- spray_radial_housing_area_rotor_pole_r
- sprayRadialHousingAreaRotorPoleR
- spray_radialhousing_area_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rear rotor pole surface sprayed area
