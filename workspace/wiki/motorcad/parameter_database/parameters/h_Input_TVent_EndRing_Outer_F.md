...
parameter_name: h_Input_TVent_EndRing_Outer_F
...
aliases:
- h_Input_TVent_EndRing_Outer_F
- h Input T Vent End Ring Outer F
- h_input_t_vent_end_ring_outer_f
- hInputTVentEndRingOuterF
- h_input_tvent_endring_outer_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the end ring Outer surface [front]
