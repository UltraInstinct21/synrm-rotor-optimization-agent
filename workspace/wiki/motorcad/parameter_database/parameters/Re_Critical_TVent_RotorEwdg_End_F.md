...
parameter_name: Re_Critical_TVent_RotorEwdg_End_F
...
aliases:
- Re_Critical_TVent_RotorEwdg_End_F
- Re Critical T Vent Rotor Ewdg End F
- re_critical_t_vent_rotor_ewdg_end_f
- reCriticalTVentRotorEwdgEndF
- re_critical_tvent_rotorewdg_end_f
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the EWdg End surface [front]
