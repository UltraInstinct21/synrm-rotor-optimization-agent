...
parameter_name: TVent_Volume_Flow_Rate_Airgap
category: TVent_Data
input_output: o/p
data_type: double
units: m³/s
...
aliases:
- TVent_Volume_Flow_Rate_Airgap
- T Vent Volume Flow Rate Airgap
- t_vent_volume_flow_rate_airgap
- tVentVolumeFlowRateAirgap
- tvent_volume_flow_rate_airgap
related_parameters:
