...
parameter_name: Spray_AxialEndcap_Stationary_h_Endcap_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Endcap_F
- Spray Axial Endcap Stationary h Endcap F
- spray_axial_endcap_stationary_h_endcap_f
- sprayAxialEndcapStationaryHEndcapF
- spray_axialendcap_stationary_h_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the front endcap surface
