...
parameter_name: Spray_RadialHousing_CorrelationFactor_Hairpin_EWdg_Front_R
...
aliases:
- Spray_RadialHousing_CorrelationFactor_Hairpin_EWdg_Front_R
- Spray Radial Housing Correlation Factor Hairpin E Wdg Front R
- spray_radial_housing_correlation_factor_hairpin_e_wdg_front_r
- sprayRadialHousingCorrelationFactorHairpinEWdgFrontR
- spray_radialhousing_correlationfactor_hairpin_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the hairpin rear endwinding front surface
