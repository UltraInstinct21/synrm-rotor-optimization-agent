...
parameter_name: Notes_Plate_RotorLam_R
...
aliases:
- Notes_Plate_RotorLam_R
- Notes Plate Rotor Lam R
- notes_plate_rotor_lam_r
- notesPlateRotorLamR
- notes_plate_rotorlam_r
related_parameters:
...
## Summary
The notes for the effective gap between the clamp plate and the rotor laminations
