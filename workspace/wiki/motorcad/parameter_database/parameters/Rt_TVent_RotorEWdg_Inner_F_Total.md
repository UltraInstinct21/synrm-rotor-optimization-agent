...
parameter_name: Rt_TVent_RotorEWdg_Inner_F_Total
...
aliases:
- Rt_TVent_RotorEWdg_Inner_F_Total
- Rt T Vent Rotor E Wdg Inner F Total
- rt_t_vent_rotor_e_wdg_inner_f_total
- rtTVentRotorEWdgInnerFTotal
- rt_tvent_rotorewdg_inner_f_total
related_parameters:
...
## Summary
The thermal resistance from the inner surface (incl ext) of front rotor endwinding to the fluid
