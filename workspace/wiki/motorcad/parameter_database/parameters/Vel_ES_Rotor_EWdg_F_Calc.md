...
parameter_name: Vel_ES_Rotor_EWdg_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_Rotor_EWdg_F_Calc
- Vel ES Rotor E Wdg F Calc
- vel_es_rotor_e_wdg_f_calc
- velEsRotorEWdgFCalc
- vel_es_rotor_ewdg_f_calc
related_parameters:
...
## Summary
The calculated velocity over the rotor endwinding surface [front]
