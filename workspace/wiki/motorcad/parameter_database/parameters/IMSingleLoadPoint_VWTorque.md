...
parameter_name: IMSingleLoadPoint_VWTorque
category: Magnetics
input_output: o/p
data_type: double
units: Nm
...
aliases:
- IMSingleLoadPoint_VWTorque
- IM Single Load Point VW Torque
- im_single_load_point_vw_torque
- imSingleLoadPointVwTorque
- imsingleloadpoint_vwtorque
related_parameters:
...
## Summary
The virtual work torque in the Single Load Point FEA case
