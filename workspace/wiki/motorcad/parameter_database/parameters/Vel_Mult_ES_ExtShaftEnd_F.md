...
parameter_name: Vel_Mult_ES_ExtShaftEnd_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_ExtShaftEnd_F
- Vel Mult ES Ext Shaft End F
- vel_mult_es_ext_shaft_end_f
- velMultEsExtShaftEndF
- vel_mult_es_extshaftend_f
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for shaft extension end [front]
