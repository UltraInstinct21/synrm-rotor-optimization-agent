...
parameter_name: EndringInductance_LiwschitzGarick
category: Magnetics
input_output: o/p
data_type: double
units: Henry
...
aliases:
- EndringInductance_LiwschitzGarick
- Endring Inductance Liwschitz Garick
- endring_inductance_liwschitz_garick
- endringInductanceLiwschitzGarick
- endringinductance_liwschitzgarick
related_parameters:
...
- '[[motorcad/parameter_database/parameters/EndringInductance_Richter|EndringInductance_Richter]]'
- '[[motorcad/parameter_database/parameters/EndringInductance_Richter_Ref|EndringInductance_Richter_Ref]]'
- '[[motorcad/parameter_database/parameters/EndringInductance_LiwschitzGarick_Ref|EndringInductance_LiwschitzGarick_Ref]]'
- '[[motorcad/parameter_database/parameters/EndringInductance_InterBar|EndringInductance_InterBar]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
End ring inductance using Liwshitz-Garick method
