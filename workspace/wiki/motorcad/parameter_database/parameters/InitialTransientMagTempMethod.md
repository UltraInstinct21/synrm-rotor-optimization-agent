...
parameter_name: InitialTransientMagTempMethod
...
aliases:
- InitialTransientMagTempMethod
- Initial Transient Mag Temp Method
- initial_transient_mag_temp_method
- initialTransientMagTempMethod
- initialtransientmagtempmethod
related_parameters:
...
## Summary
Method used to set initial magnet temperatures for thermal transient calculation.
