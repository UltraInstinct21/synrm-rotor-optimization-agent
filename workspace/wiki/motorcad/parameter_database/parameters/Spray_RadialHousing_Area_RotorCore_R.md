...
parameter_name: Spray_RadialHousing_Area_RotorCore_R
...
aliases:
- Spray_RadialHousing_Area_RotorCore_R
- Spray Radial Housing Area Rotor Core R
- spray_radial_housing_area_rotor_core_r
- sprayRadialHousingAreaRotorCoreR
- spray_radialhousing_area_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rear rotor core surface sprayed area
