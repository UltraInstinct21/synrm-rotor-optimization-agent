...
parameter_name: StatorToothLoss_Hys_Static_PerSlice
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- StatorToothLoss_Hys_Static_PerSlice
- Stator Tooth Loss Hys Static Per Slice
- stator_tooth_loss_hys_static_per_slice
- statorToothLossHysStaticPerSlice
- statortoothloss_hys_static_perslice
related_parameters:
...
## Summary
Stator tooth losses from hysteresis (per slice)
