...
parameter_name: Spray_AxialEndcap_Dissipation_EWdg_Outer_R
...
aliases:
- Spray_AxialEndcap_Dissipation_EWdg_Outer_R
- Spray Axial Endcap Dissipation E Wdg Outer R
- spray_axial_endcap_dissipation_e_wdg_outer_r
- sprayAxialEndcapDissipationEWdgOuterR
- spray_axialendcap_dissipation_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the rear endwinding outer surface
