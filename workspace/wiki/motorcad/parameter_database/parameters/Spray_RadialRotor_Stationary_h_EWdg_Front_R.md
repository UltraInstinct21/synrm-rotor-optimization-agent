...
parameter_name: Spray_RadialRotor_Stationary_h_EWdg_Front_R
...
aliases:
- Spray_RadialRotor_Stationary_h_EWdg_Front_R
- Spray Radial Rotor Stationary h E Wdg Front R
- spray_radial_rotor_stationary_h_e_wdg_front_r
- sprayRadialRotorStationaryHEWdgFrontR
- spray_radialrotor_stationary_h_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the rear endwinding front surface
