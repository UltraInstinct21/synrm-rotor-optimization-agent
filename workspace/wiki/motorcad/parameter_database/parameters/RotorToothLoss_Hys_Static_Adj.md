...
parameter_name: RotorToothLoss_Hys_Static_Adj
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- RotorToothLoss_Hys_Static_Adj
- Rotor Tooth Loss Hys Static Adj
- rotor_tooth_loss_hys_static_adj
- rotorToothLossHysStaticAdj
- rotortoothloss_hys_static_adj
related_parameters:
