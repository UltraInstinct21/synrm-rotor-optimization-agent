...
parameter_name: Spray_AxialEndcap_Stationary_h_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_RotorPole_R
- Spray Axial Endcap Stationary h Rotor Pole R
- spray_axial_endcap_stationary_h_rotor_pole_r
- sprayAxialEndcapStationaryHRotorPoleR
- spray_axialendcap_stationary_h_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the rear rotor pole surface
