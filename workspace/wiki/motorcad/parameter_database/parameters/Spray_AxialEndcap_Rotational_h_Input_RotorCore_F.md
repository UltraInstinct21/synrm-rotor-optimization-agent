...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_RotorCore_F
- Spray Axial Endcap Rotational h Input Rotor Core F
- spray_axial_endcap_rotational_h_input_rotor_core_f
- sprayAxialEndcapRotationalHInputRotorCoreF
- spray_axialendcap_rotational_h_input_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the front rotor core surface
