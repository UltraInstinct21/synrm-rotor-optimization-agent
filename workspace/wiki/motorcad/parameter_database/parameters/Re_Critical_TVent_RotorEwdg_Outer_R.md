...
parameter_name: Re_Critical_TVent_RotorEwdg_Outer_R
...
aliases:
- Re_Critical_TVent_RotorEwdg_Outer_R
- Re Critical T Vent Rotor Ewdg Outer R
- re_critical_t_vent_rotor_ewdg_outer_r
- reCriticalTVentRotorEwdgOuterR
- re_critical_tvent_rotorewdg_outer_r
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the EWdg Outer surface [rear]
