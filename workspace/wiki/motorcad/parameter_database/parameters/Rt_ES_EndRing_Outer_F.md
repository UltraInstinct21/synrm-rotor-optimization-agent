...
parameter_name: Rt_ES_EndRing_Outer_F
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_EndRing_Outer_F
- Rt ES End Ring Outer F
- rt_es_end_ring_outer_f
- rtEsEndRingOuterF
- rt_es_endring_outer_f
related_parameters:
...
## Summary
The thermal resistance end ring Outer surface [front]
