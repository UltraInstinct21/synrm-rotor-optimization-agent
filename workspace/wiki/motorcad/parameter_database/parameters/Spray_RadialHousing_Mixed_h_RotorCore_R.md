...
parameter_name: Spray_RadialHousing_Mixed_h_RotorCore_R
...
aliases:
- Spray_RadialHousing_Mixed_h_RotorCore_R
- Spray Radial Housing Mixed h Rotor Core R
- spray_radial_housing_mixed_h_rotor_core_r
- sprayRadialHousingMixedHRotorCoreR
- spray_radialhousing_mixed_h_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the rear rotor core surface
