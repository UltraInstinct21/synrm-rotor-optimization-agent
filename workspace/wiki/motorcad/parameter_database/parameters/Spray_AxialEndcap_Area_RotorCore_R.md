...
parameter_name: Spray_AxialEndcap_Area_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Area_RotorCore_R
- Spray Axial Endcap Area Rotor Core R
- spray_axial_endcap_area_rotor_core_r
- sprayAxialEndcapAreaRotorCoreR
- spray_axialendcap_area_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear rotor core surface sprayed area
