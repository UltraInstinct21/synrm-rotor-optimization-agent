...
parameter_name: Rt_ES_DividerWedge_F
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_DividerWedge_F
- Rt ES Divider Wedge F
- rt_es_divider_wedge_f
- rtEsDividerWedgeF
- rt_es_dividerwedge_f
related_parameters:
...
## Summary
The thermal resistance between the front endspace and coil divider/wedge
