...
parameter_name: IMLockedRotor_RMSVoltage_Phase
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- IMLockedRotor_RMSVoltage_Phase
- IM Locked Rotor RMS Voltage Phase
- im_locked_rotor_rms_voltage_phase
- imLockedRotorRmsVoltagePhase
- imlockedrotor_rmsvoltage_phase
related_parameters:
...
## Summary
The locked rotor rms phase voltage
