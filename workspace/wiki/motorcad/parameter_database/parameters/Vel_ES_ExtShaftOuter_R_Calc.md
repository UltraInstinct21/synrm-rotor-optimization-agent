...
parameter_name: Vel_ES_ExtShaftOuter_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_ExtShaftOuter_R_Calc
- Vel ES Ext Shaft Outer R Calc
- vel_es_ext_shaft_outer_r_calc
- velEsExtShaftOuterRCalc
- vel_es_extshaftouter_r_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for shaft extension outer [rear]
