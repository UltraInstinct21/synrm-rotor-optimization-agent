...
parameter_name: StatorPlateThickness_F
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- StatorPlateThickness_F
- Stator Plate Thickness F
- stator_plate_thickness_f
- statorPlateThicknessF
- statorplatethickness_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/StatorPlateThickness_R|StatorPlateThickness_R]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The thickness of the front stator plate for single bearing model
