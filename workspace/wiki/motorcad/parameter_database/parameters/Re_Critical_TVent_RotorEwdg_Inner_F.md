...
parameter_name: Re_Critical_TVent_RotorEwdg_Inner_F
...
aliases:
- Re_Critical_TVent_RotorEwdg_Inner_F
- Re Critical T Vent Rotor Ewdg Inner F
- re_critical_t_vent_rotor_ewdg_inner_f
- reCriticalTVentRotorEwdgInnerF
- re_critical_tvent_rotorewdg_inner_f
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the EWdg Inner surface [front]
