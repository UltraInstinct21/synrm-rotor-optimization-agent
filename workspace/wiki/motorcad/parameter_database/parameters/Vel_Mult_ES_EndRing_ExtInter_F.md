...
parameter_name: Vel_Mult_ES_EndRing_ExtInter_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EndRing_ExtInter_F
- Vel Mult ES End Ring Ext Inter F
- vel_mult_es_end_ring_ext_inter_f
- velMultEsEndRingExtInterF
- vel_mult_es_endring_extinter_f
related_parameters:
...
## Summary
The velocity multiplier for end ring ExtInter surface [front]
