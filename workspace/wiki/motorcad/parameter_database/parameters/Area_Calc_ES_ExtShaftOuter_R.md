...
parameter_name: Area_Calc_ES_ExtShaftOuter_R
category: End_Space
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Area_Calc_ES_ExtShaftOuter_R
- Area Calc ES Ext Shaft Outer R
- area_calc_es_ext_shaft_outer_r
- areaCalcEsExtShaftOuterR
- area_calc_es_extshaftouter_r
related_parameters:
...
## Summary
Calculated area of the Shaft Extension Outer [Rear] surface for End Space Cooling
