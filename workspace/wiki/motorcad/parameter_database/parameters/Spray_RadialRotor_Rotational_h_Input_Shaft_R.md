...
parameter_name: Spray_RadialRotor_Rotational_h_Input_Shaft_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_Shaft_R
- Spray Radial Rotor Rotational h Input Shaft R
- spray_radial_rotor_rotational_h_input_shaft_r
- sprayRadialRotorRotationalHInputShaftR
- spray_radialrotor_rotational_h_input_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the rear shaft surface
