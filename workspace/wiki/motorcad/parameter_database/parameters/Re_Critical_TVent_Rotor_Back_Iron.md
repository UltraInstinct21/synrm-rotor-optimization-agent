...
parameter_name: Re_Critical_TVent_Rotor_Back_Iron
category: TVent_Data
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Re_Critical_TVent_Rotor_Back_Iron
- Re Critical T Vent Rotor Back Iron
- re_critical_t_vent_rotor_back_iron
- reCriticalTVentRotorBackIron
- re_critical_tvent_rotor_back_iron
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the rotor back iron surface
