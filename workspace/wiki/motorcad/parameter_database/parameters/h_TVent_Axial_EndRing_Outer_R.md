...
parameter_name: h_TVent_Axial_EndRing_Outer_R
...
aliases:
- h_TVent_Axial_EndRing_Outer_R
- h T Vent Axial End Ring Outer R
- h_t_vent_axial_end_ring_outer_r
- hTVentAxialEndRingOuterR
- h_tvent_axial_endring_outer_r
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the end ring Outer surface [rear]
