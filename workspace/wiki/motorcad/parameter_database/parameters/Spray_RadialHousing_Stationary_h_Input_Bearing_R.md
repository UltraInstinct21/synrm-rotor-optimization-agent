...
parameter_name: Spray_RadialHousing_Stationary_h_Input_Bearing_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_Bearing_R
- Spray Radial Housing Stationary h Input Bearing R
- spray_radial_housing_stationary_h_input_bearing_r
- sprayRadialHousingStationaryHInputBearingR
- spray_radialhousing_stationary_h_input_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the rear bearing surface
