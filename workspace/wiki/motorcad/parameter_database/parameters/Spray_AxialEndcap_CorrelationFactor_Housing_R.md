...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Housing_R
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Housing_R
- Spray Axial Endcap Correlation Factor Housing R
- spray_axial_endcap_correlation_factor_housing_r
- sprayAxialEndcapCorrelationFactorHousingR
- spray_axialendcap_correlationfactor_housing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the rear housing surface
