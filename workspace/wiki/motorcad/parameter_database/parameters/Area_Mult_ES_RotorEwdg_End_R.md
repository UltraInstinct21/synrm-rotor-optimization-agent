...
parameter_name: Area_Mult_ES_RotorEwdg_End_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_RotorEwdg_End_R
- Area Mult ES Rotor Ewdg End R
- area_mult_es_rotor_ewdg_end_r
- areaMultEsRotorEwdgEndR
- area_mult_es_rotorewdg_end_r
related_parameters:
...
## Summary
Area multiplier for the Rotor End-Winding End [Rear] surface for End Space Cooling
