...
parameter_name: Spray_AxialEndcap_Area_Bearing_R
...
aliases:
- Spray_AxialEndcap_Area_Bearing_R
- Spray Axial Endcap Area Bearing R
- spray_axial_endcap_area_bearing_r
- sprayAxialEndcapAreaBearingR
- spray_axialendcap_area_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear bearing surface sprayed area
