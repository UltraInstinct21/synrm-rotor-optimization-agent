...
parameter_name: Gap_Stator_Axle_Comment
category: Interface_Gaps
input_output: i/p
data_type: OleStr
units: N/A
default_value: Lamination-Metal - Average surface Contact
source_file: D:/SRM/Agent/workspace/wiki/raw/ActiveXParameters.xlsx
aliases:
- Gap_Stator_Axle_Comment
- Gap Stator Axle Comment
- gap_stator_axle_comment
- gapStatorAxleComment
related_parameters:
...
## Summary
Details of the interface gap between stator lamination stack and axle
...
- **Units**: N/A
- **Default Value**: Lamination-Metal - Average surface Contact
