...
parameter_name: Velocity_Multiplier_h[WJ]_Front_Housing
...
aliases:
- Velocity_Multiplier_h[WJ]_Front_Housing
- Velocity_Multiplier_h(WJ)_Front_Housing
- Velocity Multiplier h WJ Front Housing
- velocity_multiplier_h_wj_front_housing
- velocityMultiplierHWjFrontHousing
- velocity_multiplier_h[wj]_front_housing
related_parameters:
...
## Summary
Motor-CAD automation parameter `Velocity_Multiplier_h[WJ]_Front_Housing` in category `Water_Jacket_Data`.
