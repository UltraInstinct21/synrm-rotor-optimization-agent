...
parameter_name: LabModel_ACLoss_StatorCurrent_Peak
...
- Lab Model AC Loss Stator Current Peak
- lab_model_ac_loss_stator_current_peak
- labModelAcLossStatorCurrentPeak
- labmodel_acloss_statorcurrent_peak
related_parameters:
...
## Summary
Maximum stator current used in Lab AC loss model build (peak)
