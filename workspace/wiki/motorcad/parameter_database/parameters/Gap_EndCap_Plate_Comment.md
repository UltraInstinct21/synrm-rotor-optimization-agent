...
parameter_name: Gap_EndCap_Plate_Comment
...
aliases:
- Gap_EndCap_Plate_Comment
- Gap End Cap Plate Comment
- gap_end_cap_plate_comment
- gapEndCapPlateComment
- gap_endcap_plate_comment
related_parameters:
...
## Summary
Details of the interface gap between endcap and flange mounted cooling plate
