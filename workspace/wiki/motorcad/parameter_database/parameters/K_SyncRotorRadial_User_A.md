...
parameter_name: K_SyncRotorRadial_User_A
...
aliases:
- K_SyncRotorRadial_User_A
- K Sync Rotor Radial User A
- k_sync_rotor_radial_user_a
- kSyncRotorRadialUserA
- k_syncrotorradial_user_a
related_parameters:
...
## Summary
This is the user input thermal conductivity of the sync field winding [active] in the radial direction
