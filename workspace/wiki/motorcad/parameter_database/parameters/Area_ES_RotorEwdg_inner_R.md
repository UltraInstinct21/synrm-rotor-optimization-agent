...
parameter_name: Area_ES_RotorEwdg_inner_R
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_RotorEwdg_inner_R
- Area ES Rotor Ewdg inner R
- area_es_rotor_ewdg_inner_r
- areaEsRotorEwdgInnerR
- area_es_rotorewdg_inner_r
related_parameters:
...
## Summary
The area of the end wdg inner surface [rear]
