...
parameter_name: Area_Mult_ES_RotorEwdg_End_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_RotorEwdg_End_F
- Area Mult ES Rotor Ewdg End F
- area_mult_es_rotor_ewdg_end_f
- areaMultEsRotorEwdgEndF
- area_mult_es_rotorewdg_end_f
related_parameters:
...
## Summary
Area multiplier for the Rotor End-Winding End [Front] surface for End Space Cooling
