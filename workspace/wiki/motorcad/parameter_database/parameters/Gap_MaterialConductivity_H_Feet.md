...
parameter_name: Gap_MaterialConductivity_H_Feet
...
aliases:
- Gap_MaterialConductivity_H_Feet
- Gap Material Conductivity H Feet
- gap_material_conductivity_h_feet
- gapMaterialConductivityHFeet
- gap_materialconductivity_h_feet
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Housing and Feet.
