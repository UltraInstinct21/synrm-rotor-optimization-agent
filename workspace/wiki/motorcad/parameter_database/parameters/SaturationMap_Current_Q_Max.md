...
parameter_name: SaturationMap_Current_Q_Max
...
aliases:
- SaturationMap_Current_Q_Max
- Saturation Map Current Q Max
- saturation_map_current_q_max
- saturationMapCurrentQMax
- saturationmap_current_q_max
related_parameters:
...
## Summary
Maximum Q axis current used in the saturation map calculation
