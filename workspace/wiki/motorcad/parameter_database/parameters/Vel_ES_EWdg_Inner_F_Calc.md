...
parameter_name: Vel_ES_EWdg_Inner_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EWdg_Inner_F_Calc
- Vel ES E Wdg Inner F Calc
- vel_es_e_wdg_inner_f_calc
- velEsEWdgInnerFCalc
- vel_es_ewdg_inner_f_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for EWdg Inner surface [Front]
