...
parameter_name: Spray_RadialRotor_Rotational_h_Input_EWdg_Inner_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_EWdg_Inner_F
- Spray Radial Rotor Rotational h Input E Wdg Inner F
- spray_radial_rotor_rotational_h_input_e_wdg_inner_f
- sprayRadialRotorRotationalHInputEWdgInnerF
- spray_radialrotor_rotational_h_input_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the front endwinding inner surface
