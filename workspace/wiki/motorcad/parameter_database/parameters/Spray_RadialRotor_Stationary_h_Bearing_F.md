...
parameter_name: Spray_RadialRotor_Stationary_h_Bearing_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Bearing_F
- Spray Radial Rotor Stationary h Bearing F
- spray_radial_rotor_stationary_h_bearing_f
- sprayRadialRotorStationaryHBearingF
- spray_radialrotor_stationary_h_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the front bearing surface
