...
parameter_name: Spray_RadialRotor_Rotational_h_Input_Endcap_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_Endcap_F
- Spray Radial Rotor Rotational h Input Endcap F
- spray_radial_rotor_rotational_h_input_endcap_f
- sprayRadialRotorRotationalHInputEndcapF
- spray_radialrotor_rotational_h_input_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the front endcap surface
