...
parameter_name: Spray_AxialEndcap_Stationary_h_Adjust_Bearing_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Adjust_Bearing_F
- Spray Axial Endcap Stationary h Adjust Bearing F
- spray_axial_endcap_stationary_h_adjust_bearing_f
- sprayAxialEndcapStationaryHAdjustBearingF
- spray_axialendcap_stationary_h_adjust_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc adjustment over the front bearing surface
