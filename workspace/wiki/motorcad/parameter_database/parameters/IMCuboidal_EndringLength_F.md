...
parameter_name: IMCuboidal_EndringLength_F
...
aliases:
- IMCuboidal_EndringLength_F
- IM Cuboidal Endring Length F
- im_cuboidal_endring_length_f
- imCuboidalEndringLengthF
- imcuboidal_endringlength_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IMCuboidal_BarWidth|IMCuboidal_BarWidth]]'
- '[[motorcad/parameter_database/parameters/IMCuboidal_BarHeight|IMCuboidal_BarHeight]]'
- '[[motorcad/parameter_database/parameters/IMCuboidal_BarLength|IMCuboidal_BarLength]]'
- '[[motorcad/parameter_database/parameters/IMCuboidal_EndringWidth_F|IMCuboidal_EndringWidth_F]]'
- '[[motorcad/parameter_database/parameters/IMCuboidal_EndringHeight_F|IMCuboidal_EndringHeight_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This is the length of the endring cuboid
