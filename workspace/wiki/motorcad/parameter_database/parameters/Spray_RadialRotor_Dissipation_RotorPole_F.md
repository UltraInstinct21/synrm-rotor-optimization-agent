...
parameter_name: Spray_RadialRotor_Dissipation_RotorPole_F
...
aliases:
- Spray_RadialRotor_Dissipation_RotorPole_F
- Spray Radial Rotor Dissipation Rotor Pole F
- spray_radial_rotor_dissipation_rotor_pole_f
- sprayRadialRotorDissipationRotorPoleF
- spray_radialrotor_dissipation_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the front rotor pole surface
