...
parameter_name: Vel_Mult_ES_RotorEwdg_internal_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_RotorEwdg_internal_F
- Vel Mult ES Rotor Ewdg internal F
- vel_mult_es_rotor_ewdg_internal_f
- velMultEsRotorEwdgInternalF
- vel_mult_es_rotorewdg_internal_f
related_parameters:
...
## Summary
The velocity multiplier for end wdg internal surface [front]
