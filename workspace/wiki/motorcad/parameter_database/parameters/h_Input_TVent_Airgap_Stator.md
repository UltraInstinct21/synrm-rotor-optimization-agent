...
parameter_name: h_Input_TVent_Airgap_Stator
...
aliases:
- h_Input_TVent_Airgap_Stator
- h Input T Vent Airgap Stator
- h_input_t_vent_airgap_stator
- hInputTVentAirgapStator
- h_input_tvent_airgap_stator
related_parameters:
