...
parameter_name: Spray_AxialEndcap_Calc_Input_h_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_RotorCore_R
- Spray Axial Endcap Calc Input h Rotor Core R
- spray_axial_endcap_calc_input_h_rotor_core_r
- sprayAxialEndcapCalcInputHRotorCoreR
- spray_axialendcap_calc_input_h_rotorcore_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the rear rotor core surface is calculated or user input  (0=Calc h, 1=Input h)
