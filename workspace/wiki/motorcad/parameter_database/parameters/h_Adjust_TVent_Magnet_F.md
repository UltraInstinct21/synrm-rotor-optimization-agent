...
parameter_name: h_Adjust_TVent_Magnet_F
...
aliases:
- h_Adjust_TVent_Magnet_F
- h Adjust T Vent Magnet F
- h_adjust_t_vent_magnet_f
- hAdjustTVentMagnetF
- h_adjust_tvent_magnet_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the Magnet surface [front]
