...
parameter_name: SlotForMagneticCalc_Aux
category: Magnetics
input_output: o/p
data_type: integer
units: N/A
...
aliases:
- SlotForMagneticCalc_Aux
- Slot For Magnetic Calc Aux
- slot_for_magnetic_calc_aux
- slotForMagneticCalcAux
- slotformagneticcalc_aux
related_parameters:
...
- '[[motorcad/parameter_database/parameters/SlotForMagneticCalc_Main|SlotForMagneticCalc_Main]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Winding slot used for aux winding magnetic calculations
