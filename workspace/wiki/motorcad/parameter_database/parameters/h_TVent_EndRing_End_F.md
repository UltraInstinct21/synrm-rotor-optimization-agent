...
parameter_name: h_TVent_EndRing_End_F
...
aliases:
- h_TVent_EndRing_End_F
- h T Vent End Ring End F
- h_t_vent_end_ring_end_f
- hTVentEndRingEndF
- h_tvent_endring_end_f
related_parameters:
...
## Summary
The TVent heat transfer coefficient over the end ring End surface [front]
