...
parameter_name: Spray_AxialEndcap_Mixed_h_EWdg_F
...
aliases:
- Spray_AxialEndcap_Mixed_h_EWdg_F
- Spray Axial Endcap Mixed h E Wdg F
- spray_axial_endcap_mixed_h_e_wdg_f
- sprayAxialEndcapMixedHEWdgF
- spray_axialendcap_mixed_h_ewdg_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) area average mixed htc over the front endwinding
