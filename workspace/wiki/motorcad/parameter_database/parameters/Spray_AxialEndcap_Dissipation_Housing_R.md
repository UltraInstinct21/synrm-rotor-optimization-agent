...
parameter_name: Spray_AxialEndcap_Dissipation_Housing_R
...
aliases:
- Spray_AxialEndcap_Dissipation_Housing_R
- Spray Axial Endcap Dissipation Housing R
- spray_axial_endcap_dissipation_housing_r
- sprayAxialEndcapDissipationHousingR
- spray_axialendcap_dissipation_housing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the rear housing surface
