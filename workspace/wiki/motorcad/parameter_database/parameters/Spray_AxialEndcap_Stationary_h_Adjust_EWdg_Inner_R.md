...
parameter_name: Spray_AxialEndcap_Stationary_h_Adjust_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Adjust_EWdg_Inner_R
- Spray Axial Endcap Stationary h Adjust E Wdg Inner R
- spray_axial_endcap_stationary_h_adjust_e_wdg_inner_r
- sprayAxialEndcapStationaryHAdjustEWdgInnerR
- spray_axialendcap_stationary_h_adjust_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc adjustment over the rear endwinding inner surface
