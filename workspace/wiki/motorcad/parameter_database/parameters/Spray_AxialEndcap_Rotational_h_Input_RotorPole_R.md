...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_RotorPole_R
- Spray Axial Endcap Rotational h Input Rotor Pole R
- spray_axial_endcap_rotational_h_input_rotor_pole_r
- sprayAxialEndcapRotationalHInputRotorPoleR
- spray_axialendcap_rotational_h_input_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the rear rotor pole surface
