...
parameter_name: Forced_Conv_Notes_Axle_Plate_R
...
aliases:
- Forced_Conv_Notes_Axle_Plate_R
- Forced Conv Notes Axle Plate R
- forced_conv_notes_axle_plate_r
- forcedConvNotesAxlePlateR
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of Axle mounted plate [R] available for cooling to ambient
