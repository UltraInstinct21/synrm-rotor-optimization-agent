...
parameter_name: IMOnLoad_RotorVoltage_Ref_T
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- IMOnLoad_RotorVoltage_Ref_T
- IM On Load Rotor Voltage Ref T
- im_on_load_rotor_voltage_ref_t
- imOnLoadRotorVoltageRefT
- imonload_rotorvoltage_ref_t
related_parameters:
