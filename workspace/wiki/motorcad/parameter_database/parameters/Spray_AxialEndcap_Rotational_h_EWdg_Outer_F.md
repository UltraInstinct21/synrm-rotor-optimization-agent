...
parameter_name: Spray_AxialEndcap_Rotational_h_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_EWdg_Outer_F
- Spray Axial Endcap Rotational h E Wdg Outer F
- spray_axial_endcap_rotational_h_e_wdg_outer_f
- sprayAxialEndcapRotationalHEWdgOuterF
- spray_axialendcap_rotational_h_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc over the front endwinding outer surface
