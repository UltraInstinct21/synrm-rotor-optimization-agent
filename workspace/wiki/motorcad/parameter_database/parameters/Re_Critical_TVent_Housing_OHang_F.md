...
parameter_name: Re_Critical_TVent_Housing_OHang_F
category: TVent_Data
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Re_Critical_TVent_Housing_OHang_F
- Re Critical T Vent Housing O Hang F
- re_critical_t_vent_housing_o_hang_f
- reCriticalTVentHousingOHangF
- re_critical_tvent_housing_ohang_f
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the housing overhang front surface
