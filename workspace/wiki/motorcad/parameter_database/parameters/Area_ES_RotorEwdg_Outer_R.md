...
parameter_name: Area_ES_RotorEwdg_Outer_R
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_RotorEwdg_Outer_R
- Area ES Rotor Ewdg Outer R
- area_es_rotor_ewdg_outer_r
- areaEsRotorEwdgOuterR
- area_es_rotorewdg_outer_r
related_parameters:
...
## Summary
The area of the end wdg Outer surface [rear]
