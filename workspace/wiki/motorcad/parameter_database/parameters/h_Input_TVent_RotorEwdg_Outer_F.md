...
parameter_name: h_Input_TVent_RotorEwdg_Outer_F
...
aliases:
- h_Input_TVent_RotorEwdg_Outer_F
- h Input T Vent Rotor Ewdg Outer F
- h_input_t_vent_rotor_ewdg_outer_f
- hInputTVentRotorEwdgOuterF
- h_input_tvent_rotorewdg_outer_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the EWdg Outer surface [front]
