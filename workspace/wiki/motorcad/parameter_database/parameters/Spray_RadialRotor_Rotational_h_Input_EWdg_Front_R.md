...
parameter_name: Spray_RadialRotor_Rotational_h_Input_EWdg_Front_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_EWdg_Front_R
- Spray Radial Rotor Rotational h Input E Wdg Front R
- spray_radial_rotor_rotational_h_input_e_wdg_front_r
- sprayRadialRotorRotationalHInputEWdgFrontR
- spray_radialrotor_rotational_h_input_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the rear endwinding front surface
