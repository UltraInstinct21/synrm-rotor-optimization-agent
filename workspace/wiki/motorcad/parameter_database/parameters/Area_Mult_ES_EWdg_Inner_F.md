...
parameter_name: Area_Mult_ES_EWdg_Inner_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EWdg_Inner_F
- Area Mult ES E Wdg Inner F
- area_mult_es_e_wdg_inner_f
- areaMultEsEWdgInnerF
- area_mult_es_ewdg_inner_f
related_parameters:
...
## Summary
Area multiplier for the End-Winding Inner [Rear] surfaces for End Space Cooling
