...
parameter_name: Forced_Conv_Notes_Housing_Rear_Fin_Base
...
aliases:
- Forced_Conv_Notes_Housing_Rear_Fin_Base
- Forced Conv Notes Housing Rear Fin Base
- forced_conv_notes_housing_rear_fin_base
- forcedConvNotesHousingRearFinBase
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of rear housing section (fin base section) available for cooling to ambient
