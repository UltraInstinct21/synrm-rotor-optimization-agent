...
parameter_name: h_Input_TVent_Rotor_Coil_Base
...
aliases:
- h_Input_TVent_Rotor_Coil_Base
- h Input T Vent Rotor Coil Base
- h_input_t_vent_rotor_coil_base
- hInputTVentRotorCoilBase
- h_input_tvent_rotor_coil_base
related_parameters:
