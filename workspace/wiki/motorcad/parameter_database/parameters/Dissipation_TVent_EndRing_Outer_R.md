...
parameter_name: Dissipation_TVent_EndRing_Outer_R
...
aliases:
- Dissipation_TVent_EndRing_Outer_R
- Dissipation T Vent End Ring Outer R
- dissipation_t_vent_end_ring_outer_r
- dissipationTVentEndRingOuterR
- dissipation_tvent_endring_outer_r
related_parameters:
...
## Summary
The dissipation from the outer surface of rear rotor end ring
