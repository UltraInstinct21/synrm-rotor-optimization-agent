...
parameter_name: IMSingleLoadPoint_InputPower
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- IMSingleLoadPoint_InputPower
- IM Single Load Point Input Power
- im_single_load_point_input_power
- imSingleLoadPointInputPower
- imsingleloadpoint_inputpower
related_parameters:
...
## Summary
Electrical input power in the single load point FEA case
