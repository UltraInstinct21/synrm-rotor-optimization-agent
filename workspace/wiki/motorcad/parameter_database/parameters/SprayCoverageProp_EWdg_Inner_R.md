...
parameter_name: SprayCoverageProp_EWdg_Inner_R
...
aliases:
- SprayCoverageProp_EWdg_Inner_R
- Spray Coverage Prop E Wdg Inner R
- spray_coverage_prop_e_wdg_inner_r
- sprayCoveragePropEWdgInnerR
- spraycoverageprop_ewdg_inner_r
related_parameters:
...
## Summary
Proportion of the total surface area of the EndWinding Inner Rear that is subjected to Spray Cooling
