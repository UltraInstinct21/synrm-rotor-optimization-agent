...
parameter_name: h_ES_RotorEwdg_inner_R
category: End_Space
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_ES_RotorEwdg_inner_R
- h ES Rotor Ewdg inner R
- h_es_rotor_ewdg_inner_r
- hEsRotorEwdgInnerR
- h_es_rotorewdg_inner_r
related_parameters:
...
## Summary
The heat transfer coefficient over the end wdg inner surface [rear]
