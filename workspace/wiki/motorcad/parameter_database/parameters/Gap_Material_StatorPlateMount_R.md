...
parameter_name: Gap_Material_StatorPlateMount_R
...
aliases:
- Gap_Material_StatorPlateMount_R
- Gap Material Stator Plate Mount R
- gap_material_stator_plate_mount_r
- gapMaterialStatorPlateMountR
- gap_material_statorplatemount_r
related_parameters:
...
## Summary
Material in the interface gap between the Plate and Mount [R].
