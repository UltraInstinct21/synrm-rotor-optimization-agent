...
parameter_name: h_ES_EndRing_Outer_R
category: End_Space
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_ES_EndRing_Outer_R
- h ES End Ring Outer R
- h_es_end_ring_outer_r
- hEsEndRingOuterR
- h_es_endring_outer_r
related_parameters:
...
## Summary
The heat transfer coefficient over the end ring Outer surface [rear]
