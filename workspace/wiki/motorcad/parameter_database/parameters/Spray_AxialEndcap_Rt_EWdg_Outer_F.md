...
parameter_name: Spray_AxialEndcap_Rt_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_Rt_EWdg_Outer_F
- Spray Axial Endcap Rt E Wdg Outer F
- spray_axial_endcap_rt_e_wdg_outer_f
- sprayAxialEndcapRtEWdgOuterF
- spray_axialendcap_rt_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to front endwinding outer surface convective thermal resistance
