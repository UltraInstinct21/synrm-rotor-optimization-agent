...
parameter_name: Spray_RadialRotor_Mixed_h_EWdg_R
...
aliases:
- Spray_RadialRotor_Mixed_h_EWdg_R
- Spray Radial Rotor Mixed h E Wdg R
- spray_radial_rotor_mixed_h_e_wdg_r
- sprayRadialRotorMixedHEWdgR
- spray_radialrotor_mixed_h_ewdg_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) area average mixed htc over the rear endwinding
