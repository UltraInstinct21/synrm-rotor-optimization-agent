...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_Bearing_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_Bearing_R
- Spray Axial Endcap Rotational h Input Bearing R
- spray_axial_endcap_rotational_h_input_bearing_r
- sprayAxialEndcapRotationalHInputBearingR
- spray_axialendcap_rotational_h_input_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the rear bearing surface
