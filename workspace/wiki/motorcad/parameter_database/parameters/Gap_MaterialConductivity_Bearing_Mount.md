...
parameter_name: Gap_MaterialConductivity_Bearing_Mount
...
aliases:
- Gap_MaterialConductivity_Bearing_Mount
- Gap Material Conductivity Bearing Mount
- gap_material_conductivity_bearing_mount
- gapMaterialConductivityBearingMount
- gap_materialconductivity_bearing_mount
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Bearing and Mount [F].
