...
parameter_name: Vel_ES_ExtShaftEnd_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_ExtShaftEnd_R_Calc
- Vel ES Ext Shaft End R Calc
- vel_es_ext_shaft_end_r_calc
- velEsExtShaftEndRCalc
- vel_es_extshaftend_r_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for shaft extension end [rear]
