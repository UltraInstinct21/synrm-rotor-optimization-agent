...
parameter_name: Vel_ES_EndRing_ExtInter_R
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_ExtInter_R
- Vel ES End Ring Ext Inter R
- vel_es_end_ring_ext_inter_r
- velEsEndRingExtInterR
- vel_es_endring_extinter_r
related_parameters:
...
## Summary
The velocity over the end ring ExtInter surface [rear]
