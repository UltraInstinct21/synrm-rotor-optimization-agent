...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_Endcap_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_Endcap_R
- Spray Axial Endcap Rotational h Input Endcap R
- spray_axial_endcap_rotational_h_input_endcap_r
- sprayAxialEndcapRotationalHInputEndcapR
- spray_axialendcap_rotational_h_input_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the rear endcap surface
