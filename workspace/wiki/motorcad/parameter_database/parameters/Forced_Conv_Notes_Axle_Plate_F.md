...
parameter_name: Forced_Conv_Notes_Axle_Plate_F
...
aliases:
- Forced_Conv_Notes_Axle_Plate_F
- Forced Conv Notes Axle Plate F
- forced_conv_notes_axle_plate_f
- forcedConvNotesAxlePlateF
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of Axle mounted plate [F] available for cooling to ambient
