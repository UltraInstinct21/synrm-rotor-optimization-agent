...
parameter_name: Spray_AxialEndcap_Notes_EWdg_Outer_R
...
aliases:
- Spray_AxialEndcap_Notes_EWdg_Outer_R
- Spray Axial Endcap Notes E Wdg Outer R
- spray_axial_endcap_notes_e_wdg_outer_r
- sprayAxialEndcapNotesEWdgOuterR
- spray_axialendcap_notes_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) notes for rear endwinding outer surface
