...
parameter_name: LossModelBuildPoints_Lab
...
aliases:
- LossModelBuildPoints_Lab
- Loss Model Build Points Lab
- loss_model_build_points_lab
- lossModelBuildPointsLab
- lossmodelbuildpoints_lab
related_parameters:
...
## Summary
Number of points in Lab FEA map loss model build
