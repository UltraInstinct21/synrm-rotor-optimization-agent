...
parameter_name: Re_Critical_TVent_CupBase
...
aliases:
- Re_Critical_TVent_CupBase
- Re Critical T Vent Cup Base
- re_critical_t_vent_cup_base
- reCriticalTVentCupBase
- re_critical_tvent_cupbase
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the Cup Base
