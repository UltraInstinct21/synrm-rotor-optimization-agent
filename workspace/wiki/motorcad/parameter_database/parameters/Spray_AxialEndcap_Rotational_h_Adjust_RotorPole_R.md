...
parameter_name: Spray_AxialEndcap_Rotational_h_Adjust_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Adjust_RotorPole_R
- Spray Axial Endcap Rotational h Adjust Rotor Pole R
- spray_axial_endcap_rotational_h_adjust_rotor_pole_r
- sprayAxialEndcapRotationalHAdjustRotorPoleR
- spray_axialendcap_rotational_h_adjust_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc adjustment over the rear rotor pole surface
