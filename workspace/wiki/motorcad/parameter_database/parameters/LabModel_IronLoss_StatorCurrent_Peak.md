...
parameter_name: LabModel_IronLoss_StatorCurrent_Peak
...
aliases:
- LabModel_IronLoss_StatorCurrent_Peak
- Lab Model Iron Loss Stator Current Peak
- lab_model_iron_loss_stator_current_peak
- labModelIronLossStatorCurrentPeak
- labmodel_ironloss_statorcurrent_peak
related_parameters:
...
## Summary
Maximum stator current used in Lab iron loss model build (peak)
