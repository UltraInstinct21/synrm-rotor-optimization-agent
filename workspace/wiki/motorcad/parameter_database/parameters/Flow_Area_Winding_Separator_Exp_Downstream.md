...
parameter_name: Flow_Area_Winding_Separator_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Winding_Separator_Exp_Downstream
- Flow Area Winding Separator Exp Downstream
- flow_area_winding_separator_exp_downstream
- flowAreaWindingSeparatorExpDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Winding Separator Expansion Downstream
