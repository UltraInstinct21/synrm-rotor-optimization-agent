...
parameter_name: Vel_Inlet_Rotor_Cont_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_Inlet_Rotor_Cont_Downstream
- Vel Inlet Rotor Cont Downstream
- vel_inlet_rotor_cont_downstream
- velInletRotorContDownstream
related_parameters:
...
## Summary
Velocity Inlet Rotor Contraction Downstream
