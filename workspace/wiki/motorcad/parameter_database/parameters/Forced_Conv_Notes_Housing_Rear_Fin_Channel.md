...
parameter_name: Forced_Conv_Notes_Housing_Rear_Fin_Channel
...
aliases:
- Forced_Conv_Notes_Housing_Rear_Fin_Channel
- Forced Conv Notes Housing Rear Fin Channel
- forced_conv_notes_housing_rear_fin_channel
- forcedConvNotesHousingRearFinChannel
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of rear housing section (fin channel section) available for cooling to ambient
