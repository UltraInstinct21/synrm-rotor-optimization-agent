...
parameter_name: Spray_RadialHousing_NozzleNumber_F
...
aliases:
- Spray_RadialHousing_NozzleNumber_F
- Spray Radial Housing Nozzle Number F
- spray_radial_housing_nozzle_number_f
- sprayRadialHousingNozzleNumberF
- spray_radialhousing_nozzlenumber_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) front nozzle number
