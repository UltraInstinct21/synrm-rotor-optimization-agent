...
parameter_name: Spray_RadialHousing_Rotational_h_Input_EWdg_Outer_F
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_EWdg_Outer_F
- Spray Radial Housing Rotational h Input E Wdg Outer F
- spray_radial_housing_rotational_h_input_e_wdg_outer_f
- sprayRadialHousingRotationalHInputEWdgOuterF
- spray_radialhousing_rotational_h_input_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the front endwinding outer surface
