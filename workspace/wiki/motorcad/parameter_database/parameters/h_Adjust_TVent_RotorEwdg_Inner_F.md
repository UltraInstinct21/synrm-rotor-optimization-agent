...
parameter_name: h_Adjust_TVent_RotorEwdg_Inner_F
...
aliases:
- h_Adjust_TVent_RotorEwdg_Inner_F
- h Adjust T Vent Rotor Ewdg Inner F
- h_adjust_t_vent_rotor_ewdg_inner_f
- hAdjustTVentRotorEwdgInnerF
- h_adjust_tvent_rotorewdg_inner_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the EWdg Inner surface [front]
