...
parameter_name: Spray_RadialRotor_Calc_Input_h_Shaft_F
...
aliases:
- Spray_RadialRotor_Calc_Input_h_Shaft_F
- Spray Radial Rotor Calc Input h Shaft F
- spray_radial_rotor_calc_input_h_shaft_f
- sprayRadialRotorCalcInputHShaftF
- spray_radialrotor_calc_input_h_shaft_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the front shaft surface is calculated or user input  (0=Calc h, 1=Input h)
