...
parameter_name: Rt_TVent_RotorEWdg_Outer_R_Total
...
aliases:
- Rt_TVent_RotorEWdg_Outer_R_Total
- Rt T Vent Rotor E Wdg Outer R Total
- rt_t_vent_rotor_e_wdg_outer_r_total
- rtTVentRotorEWdgOuterRTotal
- rt_tvent_rotorewdg_outer_r_total
related_parameters:
...
## Summary
The thermal resistance from the outer surface (incl ext) of rear rotor endwinding to the fluid
