...
parameter_name: Spray_RadialRotor_Calc_Input_h_RotorCore_R
...
aliases:
- Spray_RadialRotor_Calc_Input_h_RotorCore_R
- Spray Radial Rotor Calc Input h Rotor Core R
- spray_radial_rotor_calc_input_h_rotor_core_r
- sprayRadialRotorCalcInputHRotorCoreR
- spray_radialrotor_calc_input_h_rotorcore_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the rear rotor core surface is calculated or user input  (0=Calc h, 1=Input h)
