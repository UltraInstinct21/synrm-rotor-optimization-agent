...
parameter_name: K2_ES_EndRing_ExtOuter_F
category: End_Space
input_output: i/p
data_type: double
units: N/A
...
aliases:
- K2_ES_EndRing_ExtOuter_F
- K2 ES End Ring Ext Outer F
- k2_es_end_ring_ext_outer_f
- k2EsEndRingExtOuterF
- k2_es_endring_extouter_f
related_parameters:
...
## Summary
The k2 constant for end ring ExtOuter surface [front]
