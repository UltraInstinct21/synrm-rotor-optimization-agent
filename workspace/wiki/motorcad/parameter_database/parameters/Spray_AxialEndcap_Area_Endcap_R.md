...
parameter_name: Spray_AxialEndcap_Area_Endcap_R
...
aliases:
- Spray_AxialEndcap_Area_Endcap_R
- Spray Axial Endcap Area Endcap R
- spray_axial_endcap_area_endcap_r
- sprayAxialEndcapAreaEndcapR
- spray_axialendcap_area_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear endcap surface sprayed area
