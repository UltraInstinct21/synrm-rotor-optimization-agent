...
parameter_name: Calc_Input_h_TVent_Rotor_Duct
...
aliases:
- Calc_Input_h_TVent_Rotor_Duct
- Calc Input h T Vent Rotor Duct
- calc_input_h_t_vent_rotor_duct
- calcInputHTVentRotorDuct
- calc_input_h_tvent_rotor_duct
related_parameters:
