...
parameter_name: Spray_AxialEndcap_Area_Mult_EWdg_Front_F
...
aliases:
- Spray_AxialEndcap_Area_Mult_EWdg_Front_F
- Spray Axial Endcap Area Mult E Wdg Front F
- spray_axial_endcap_area_mult_e_wdg_front_f
- sprayAxialEndcapAreaMultEWdgFrontF
- spray_axialendcap_area_mult_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front endwinding front surface area multiplier
