...
parameter_name: Spray_RadialHousing_CorrelationFactor_Stranded_EWdg_Inner_R
...
aliases:
- Spray_RadialHousing_CorrelationFactor_Stranded_EWdg_Inner_R
- Spray Radial Housing Correlation Factor Stranded E Wdg Inner R
- spray_radial_housing_correlation_factor_stranded_e_wdg_inner_r
- sprayRadialHousingCorrelationFactorStrandedEWdgInnerR
- spray_radialhousing_correlationfactor_stranded_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the stranded rear endwinding inner surface
