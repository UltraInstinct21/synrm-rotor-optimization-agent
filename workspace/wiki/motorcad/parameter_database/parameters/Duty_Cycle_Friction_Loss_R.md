...
parameter_name: Duty_Cycle_Friction_Loss_R
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Friction Loss R
- duty_cycle_friction_loss_r
- dutyCycleFrictionLossR
related_parameters:
...
## Summary
Friction loss in the rear bearing for each period of the duty cycle
