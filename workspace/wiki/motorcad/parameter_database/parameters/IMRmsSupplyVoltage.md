...
parameter_name: IMRmsSupplyVoltage
category: Magnetics
input_output: i/p
data_type: double
units: Volts
...
aliases:
- IMRmsSupplyVoltage
- IM Rms Supply Voltage
- im_rms_supply_voltage
- imRmsSupplyVoltage
- imrmssupplyvoltage
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IMRmsSupplyCurrent|IMRmsSupplyCurrent]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The rms line-line supply voltage
