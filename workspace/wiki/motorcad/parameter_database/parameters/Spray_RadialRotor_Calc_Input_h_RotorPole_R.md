...
parameter_name: Spray_RadialRotor_Calc_Input_h_RotorPole_R
...
aliases:
- Spray_RadialRotor_Calc_Input_h_RotorPole_R
- Spray Radial Rotor Calc Input h Rotor Pole R
- spray_radial_rotor_calc_input_h_rotor_pole_r
- sprayRadialRotorCalcInputHRotorPoleR
- spray_radialrotor_calc_input_h_rotorpole_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the rear rotor pole surface is calculated or user input  (0=Calc h, 1=Input h)
