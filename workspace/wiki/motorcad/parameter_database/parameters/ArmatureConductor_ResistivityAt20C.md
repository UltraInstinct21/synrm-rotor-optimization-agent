...
parameter_name: ArmatureConductor_ResistivityAt20C
category: Magnetics
input_output: i/p
data_type: double
units: Ohm.m
default_value: '1.724E-8'
source_file: D:/SRM/Agent/workspace/wiki/raw/ActiveXParameters.xlsx
aliases:
- ArmatureConductor_ResistivityAt20C
- Armature Conductor Resistivity At20 C
- armature_conductor_resistivity_at20_c
- armatureConductorResistivityAt20C
- armatureconductor_resistivityat20c
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ArmatureConductor_Temperature|ArmatureConductor_Temperature]]'
- '[[motorcad/parameter_database/parameters/ArmatureConductor_Resistivity|ArmatureConductor_Resistivity]]'
- '[[motorcad/parameter_database/parameters/ArmatureConductor_Resistivity_Aux|ArmatureConductor_Resistivity_Aux]]'
- '[[motorcad/parameter_database/parameters/ArmatureConductor_ResistivityAt20C_Aux|ArmatureConductor_ResistivityAt20C_Aux]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The electrical resistivity for the armature conductors at reference temperature
