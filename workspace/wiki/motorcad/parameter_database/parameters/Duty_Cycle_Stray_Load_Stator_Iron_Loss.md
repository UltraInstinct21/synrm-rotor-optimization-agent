...
parameter_name: Duty_Cycle_Stray_Load_Stator_Iron_Loss
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Stray Load Stator Iron Loss
- duty_cycle_stray_load_stator_iron_loss
- dutyCycleStrayLoadStatorIronLoss
related_parameters:
...
## Summary
Stray load loss in the stator iron for each period of the duty cycle
