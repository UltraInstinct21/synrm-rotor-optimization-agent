...
parameter_name: Spray_RadialHousing_Area_Mult_EWdg_Outer_F
...
aliases:
- Spray_RadialHousing_Area_Mult_EWdg_Outer_F
- Spray Radial Housing Area Mult E Wdg Outer F
- spray_radial_housing_area_mult_e_wdg_outer_f
- sprayRadialHousingAreaMultEWdgOuterF
- spray_radialhousing_area_mult_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) front endwinding outer surface area multiplier
