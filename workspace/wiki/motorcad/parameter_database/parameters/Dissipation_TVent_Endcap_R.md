...
parameter_name: Dissipation_TVent_Endcap_R
category: TVent_Data
input_output: o/p
data_type: double
units: Watts
...
aliases:
- Dissipation_TVent_Endcap_R
- Dissipation T Vent Endcap R
- dissipation_t_vent_endcap_r
- dissipationTVentEndcapR
- dissipation_tvent_endcap_r
related_parameters:
...
## Summary
Motor-CAD automation parameter `Dissipation_TVent_Endcap_R` in category `TVent_Data`.
