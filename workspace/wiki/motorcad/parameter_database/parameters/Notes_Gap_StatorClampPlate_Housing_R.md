...
parameter_name: Notes_Gap_StatorClampPlate_Housing_R
...
aliases:
- Notes_Gap_StatorClampPlate_Housing_R
- Notes Gap Stator Clamp Plate Housing R
- notes_gap_stator_clamp_plate_housing_r
- notesGapStatorClampPlateHousingR
- notes_gap_statorclampplate_housing_r
related_parameters:
...
## Summary
The notes for the effective gap between the stator clamp plate and the housing [Rear]
