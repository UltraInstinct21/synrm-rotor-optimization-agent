...
parameter_name: Forced_Conv_Notes_Housing_Rear_Fin_Sides
...
aliases:
- Forced_Conv_Notes_Housing_Rear_Fin_Sides
- Forced Conv Notes Housing Rear Fin Sides
- forced_conv_notes_housing_rear_fin_sides
- forcedConvNotesHousingRearFinSides
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of rear housing section (fin side section) available for cooling to ambient
