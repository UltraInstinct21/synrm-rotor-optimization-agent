...
parameter_name: TargetLength_RotorCore_R
...
aliases:
- TargetLength_RotorCore_R
- Target Length Rotor Core R
- target_length_rotor_core_r
- targetLengthRotorCoreR
- targetlength_rotorcore_r
related_parameters:
...
## Summary
This is the length of spray target on Rear Rotor Core
