...
parameter_name: Vel_Mult_ES_EWdg_Rear_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EWdg_Rear_R
- Vel Mult ES E Wdg Rear R
- vel_mult_es_e_wdg_rear_r
- velMultEsEWdgRearR
- vel_mult_es_ewdg_rear_r
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for EWdg Rear surface [Rear]
