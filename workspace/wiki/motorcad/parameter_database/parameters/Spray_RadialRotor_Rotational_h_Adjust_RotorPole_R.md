...
parameter_name: Spray_RadialRotor_Rotational_h_Adjust_RotorPole_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Adjust_RotorPole_R
- Spray Radial Rotor Rotational h Adjust Rotor Pole R
- spray_radial_rotor_rotational_h_adjust_rotor_pole_r
- sprayRadialRotorRotationalHAdjustRotorPoleR
- spray_radialrotor_rotational_h_adjust_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc adjustment over the rear rotor pole surface
