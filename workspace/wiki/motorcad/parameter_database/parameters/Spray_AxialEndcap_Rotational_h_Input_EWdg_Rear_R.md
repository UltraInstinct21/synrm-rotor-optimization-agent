...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_EWdg_Rear_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_EWdg_Rear_R
- Spray Axial Endcap Rotational h Input E Wdg Rear R
- spray_axial_endcap_rotational_h_input_e_wdg_rear_r
- sprayAxialEndcapRotationalHInputEWdgRearR
- spray_axialendcap_rotational_h_input_ewdg_rear_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the rear endwinding rear surface
