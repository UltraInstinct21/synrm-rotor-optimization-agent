...
parameter_name: SaturationModelInterpolation_Lab
...
- Saturation Model Interpolation Lab
- saturation_model_interpolation_lab
- saturationModelInterpolationLab
- saturationmodelinterpolation_lab
related_parameters:
...
## Summary
Interpolation method used for the flux linkages in the Lab model (linear or cubic spline)
