...
parameter_name: PhaseCurrent_Main_RMS
category: Magnetics
input_output: o/p
data_type: double
units: Amps
...
aliases:
- PhaseCurrent_Main_RMS
- Phase Current Main RMS
- phase_current_main_rms
- phaseCurrentMainRms
- phasecurrent_main_rms
related_parameters:
...
- '[[motorcad/parameter_database/parameters/PhaseCurrent_Aux_RMS|PhaseCurrent_Aux_RMS]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The main winding RMS phase current
