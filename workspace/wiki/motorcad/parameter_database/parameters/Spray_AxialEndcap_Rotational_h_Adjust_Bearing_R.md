...
parameter_name: Spray_AxialEndcap_Rotational_h_Adjust_Bearing_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Adjust_Bearing_R
- Spray Axial Endcap Rotational h Adjust Bearing R
- spray_axial_endcap_rotational_h_adjust_bearing_r
- sprayAxialEndcapRotationalHAdjustBearingR
- spray_axialendcap_rotational_h_adjust_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc adjustment over the rear bearing surface
