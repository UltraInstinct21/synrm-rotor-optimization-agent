...
parameter_name: Spray_RadialHousing_CorrelationFactor_Hairpin_EWdg_Outer_R
...
aliases:
- Spray_RadialHousing_CorrelationFactor_Hairpin_EWdg_Outer_R
- Spray Radial Housing Correlation Factor Hairpin E Wdg Outer R
- spray_radial_housing_correlation_factor_hairpin_e_wdg_outer_r
- sprayRadialHousingCorrelationFactorHairpinEWdgOuterR
- spray_radialhousing_correlationfactor_hairpin_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the hairpin rear endwinding outer surface
