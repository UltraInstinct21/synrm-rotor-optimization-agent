...
parameter_name: FEAMeasurePath_Calculation
category: Magnetics
input_output: i/p
data_type: OleStr
units: N/A
default_value: TorqueCalculation
source_file: D:/SRM/Agent/workspace/wiki/raw/ActiveXParameters.xlsx
aliases:
- FEAMeasurePath_Calculation
- FEA Measure Path Calculation
- fea_measure_path_calculation
- feaMeasurePathCalculation
- feameasurepath_calculation
related_parameters:
...
- '[[motorcad/parameter_database/parameters/FEAMeasurePath_NumPaths|FEAMeasurePath_NumPaths]]'
- '[[motorcad/parameter_database/parameters/FEAMeasurePath_PathName|FEAMeasurePath_PathName]]'
- '[[motorcad/parameter_database/parameters/FEAMeasurePath_Expression|FEAMeasurePath_Expression]]'
- '[[motorcad/parameter_database/parameters/FEAMeasurePath_PathType|FEAMeasurePath_PathType]]'
- '[[motorcad/parameter_database/parameters/FEAMeasurePath_PathLocation|FEAMeasurePath_PathLocation]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Calculation to which path is applied to measure from FEA
...
- **Units**: N/A
- **Default Value**: TorqueCalculation
