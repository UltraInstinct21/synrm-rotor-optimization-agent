...
parameter_name: Spray_AxialEndcap_Mixed_h_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Mixed_h_RotorPole_F
- Spray Axial Endcap Mixed h Rotor Pole F
- spray_axial_endcap_mixed_h_rotor_pole_f
- sprayAxialEndcapMixedHRotorPoleF
- spray_axialendcap_mixed_h_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the front rotor pole surface
