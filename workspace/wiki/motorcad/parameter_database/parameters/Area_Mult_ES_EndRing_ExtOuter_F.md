...
parameter_name: Area_Mult_ES_EndRing_ExtOuter_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_ExtOuter_F
- Area Mult ES End Ring Ext Outer F
- area_mult_es_end_ring_ext_outer_f
- areaMultEsEndRingExtOuterF
- area_mult_es_endring_extouter_f
related_parameters:
...
## Summary
Area multiplier for the End Ring Extension Outer [Front] surface for End Space Cooling
