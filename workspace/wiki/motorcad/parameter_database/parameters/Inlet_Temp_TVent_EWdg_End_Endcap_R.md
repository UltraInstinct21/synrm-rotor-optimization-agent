...
parameter_name: Inlet_Temp_TVent_EWdg_End_Endcap_R
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Inlet_Temp_TVent_EWdg_End_Endcap_R
- Inlet Temp T Vent E Wdg End Endcap R
- inlet_temp_t_vent_e_wdg_end_endcap_r
- inletTempTVentEWdgEndEndcapR
- inlet_temp_tvent_ewdg_end_endcap_r
related_parameters:
...
## Summary
Motor-CAD automation parameter `Inlet_Temp_TVent_EWdg_End_Endcap_R` in category `TVent_Data`.
