...
parameter_name: Spray_RadialRotor_Rt_RotorPole_R
...
aliases:
- Spray_RadialRotor_Rt_RotorPole_R
- Spray Radial Rotor Rt Rotor Pole R
- spray_radial_rotor_rt_rotor_pole_r
- sprayRadialRotorRtRotorPoleR
- spray_radialrotor_rt_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to rear rotor pole surface convective thermal resistance
