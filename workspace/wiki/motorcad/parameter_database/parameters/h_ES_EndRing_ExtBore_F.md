...
parameter_name: h_ES_EndRing_ExtBore_F
category: End_Space
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_ES_EndRing_ExtBore_F
- h ES End Ring Ext Bore F
- h_es_end_ring_ext_bore_f
- hEsEndRingExtBoreF
- h_es_endring_extbore_f
related_parameters:
...
## Summary
The heat transfer coefficient over the end ring ExtBore surface [front]
