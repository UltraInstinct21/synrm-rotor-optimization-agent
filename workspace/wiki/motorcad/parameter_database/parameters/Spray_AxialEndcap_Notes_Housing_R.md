...
parameter_name: Spray_AxialEndcap_Notes_Housing_R
...
aliases:
- Spray_AxialEndcap_Notes_Housing_R
- Spray Axial Endcap Notes Housing R
- spray_axial_endcap_notes_housing_r
- sprayAxialEndcapNotesHousingR
- spray_axialendcap_notes_housing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) notes for rear housing surface
