...
parameter_name: Rt_ES_EndRing_Outer_F_Total
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_EndRing_Outer_F_Total
- Rt ES End Ring Outer F Total
- rt_es_end_ring_outer_f_total
- rtEsEndRingOuterFTotal
- rt_es_endring_outer_f_total
related_parameters:
...
## Summary
The thermal resistance end ring Outer surface (incl ext) [front]
