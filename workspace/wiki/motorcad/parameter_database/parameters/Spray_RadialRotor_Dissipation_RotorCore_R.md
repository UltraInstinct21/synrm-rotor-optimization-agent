...
parameter_name: Spray_RadialRotor_Dissipation_RotorCore_R
...
aliases:
- Spray_RadialRotor_Dissipation_RotorCore_R
- Spray Radial Rotor Dissipation Rotor Core R
- spray_radial_rotor_dissipation_rotor_core_r
- sprayRadialRotorDissipationRotorCoreR
- spray_radialrotor_dissipation_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the rear rotor core surface
