...
parameter_name: Vel_Mult_ES_RotorEwdg_Outer_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_RotorEwdg_Outer_F
- Vel Mult ES Rotor Ewdg Outer F
- vel_mult_es_rotor_ewdg_outer_f
- velMultEsRotorEwdgOuterF
- vel_mult_es_rotorewdg_outer_f
related_parameters:
...
## Summary
The velocity multiplier for end wdg Outer surface [front]
