...
parameter_name: Area_Mult_ES_StatorClampPlate_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_StatorClampPlate_F
- Area Mult ES Stator Clamp Plate F
- area_mult_es_stator_clamp_plate_f
- areaMultEsStatorClampPlateF
- area_mult_es_statorclampplate_f
related_parameters:
...
## Summary
Area multiplier for the Stator Clamp Plate [Front] surface for End Space Cooling
