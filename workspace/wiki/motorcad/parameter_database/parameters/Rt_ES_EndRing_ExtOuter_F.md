...
parameter_name: Rt_ES_EndRing_ExtOuter_F
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_EndRing_ExtOuter_F
- Rt ES End Ring Ext Outer F
- rt_es_end_ring_ext_outer_f
- rtEsEndRingExtOuterF
- rt_es_endring_extouter_f
related_parameters:
...
## Summary
The thermal resistance end ring Ext Outer surface [front]
