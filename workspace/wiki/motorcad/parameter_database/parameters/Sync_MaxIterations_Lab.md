...
parameter_name: Sync_MaxIterations_Lab
...
aliases:
- Sync_MaxIterations_Lab
- Sync Max Iterations Lab
- sync_max_iterations_lab
- syncMaxIterationsLab
- sync_maxiterations_lab
related_parameters:
...
## Summary
Maximum number of iterations allowed in convergence loop in Lab Sync calculations
