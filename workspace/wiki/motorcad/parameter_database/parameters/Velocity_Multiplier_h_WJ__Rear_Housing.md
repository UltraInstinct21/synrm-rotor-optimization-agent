...
parameter_name: Velocity_Multiplier_h[WJ]_Rear_Housing
...
aliases:
- Velocity_Multiplier_h[WJ]_Rear_Housing
- Velocity_Multiplier_h(WJ)_Rear_Housing
- Velocity Multiplier h WJ Rear Housing
- velocity_multiplier_h_wj_rear_housing
- velocityMultiplierHWjRearHousing
- velocity_multiplier_h[wj]_rear_housing
related_parameters:
...
## Summary
Motor-CAD automation parameter `Velocity_Multiplier_h[WJ]_Rear_Housing` in category `Water_Jacket_Data`.
