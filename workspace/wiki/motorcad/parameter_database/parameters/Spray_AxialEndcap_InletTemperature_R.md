...
parameter_name: Spray_AxialEndcap_InletTemperature_R
...
aliases:
- Spray_AxialEndcap_InletTemperature_R
- Spray Axial Endcap Inlet Temperature R
- spray_axial_endcap_inlet_temperature_r
- sprayAxialEndcapInletTemperatureR
- spray_axialendcap_inlettemperature_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) Rear fluid inlet temperature
