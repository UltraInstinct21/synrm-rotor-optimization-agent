...
parameter_name: Vel_ES_StatorClampPlate_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_StatorClampPlate_R_Calc
- Vel ES Stator Clamp Plate R Calc
- vel_es_stator_clamp_plate_r_calc
- velEsStatorClampPlateRCalc
- vel_es_statorclampplate_r_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for Stator Clamp Plate [Rear]
