...
parameter_name: Spray_RadialHousing_Notes_Endcap_R
...
aliases:
- Spray_RadialHousing_Notes_Endcap_R
- Spray Radial Housing Notes Endcap R
- spray_radial_housing_notes_endcap_r
- sprayRadialHousingNotesEndcapR
- spray_radialhousing_notes_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) notes for rear endcap surface
