...
parameter_name: Spray_AxialEndcap_Rotational_h_EWdg_Inner_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_EWdg_Inner_F
- Spray Axial Endcap Rotational h E Wdg Inner F
- spray_axial_endcap_rotational_h_e_wdg_inner_f
- sprayAxialEndcapRotationalHEWdgInnerF
- spray_axialendcap_rotational_h_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc over the front endwinding inner surface
