...
parameter_name: Spray_AxialEndcap_Calc_Input_h_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_RotorPole_F
- Spray Axial Endcap Calc Input h Rotor Pole F
- spray_axial_endcap_calc_input_h_rotor_pole_f
- sprayAxialEndcapCalcInputHRotorPoleF
- spray_axialendcap_calc_input_h_rotorpole_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the front rotor pole surface is calculated or user input  (0=Calc h, 1=Input h)
