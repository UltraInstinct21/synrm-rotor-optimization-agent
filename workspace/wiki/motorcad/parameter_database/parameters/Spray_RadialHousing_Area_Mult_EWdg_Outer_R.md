...
parameter_name: Spray_RadialHousing_Area_Mult_EWdg_Outer_R
...
aliases:
- Spray_RadialHousing_Area_Mult_EWdg_Outer_R
- Spray Radial Housing Area Mult E Wdg Outer R
- spray_radial_housing_area_mult_e_wdg_outer_r
- sprayRadialHousingAreaMultEWdgOuterR
- spray_radialhousing_area_mult_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rear endwinding outer surface area multiplier
