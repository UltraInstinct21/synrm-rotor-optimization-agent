...
parameter_name: UseCustomFEARegions_Mechanical
...
aliases:
- UseCustomFEARegions_Mechanical
- Use Custom FEA Regions Mechanical
- use_custom_fea_regions_mechanical
- useCustomFeaRegionsMechanical
- usecustomfearegions_mechanical
related_parameters:
...
- '[[motorcad/parameter_database/parameters/UseCustomFEARegions_Magnetic|UseCustomFEARegions_Magnetic]]'
- '[[motorcad/parameter_database/parameters/UseCustomFEARegions_ThermalSlot|UseCustomFEARegions_ThermalSlot]]'
- '[[motorcad/parameter_database/parameters/UseCustomFEARegions_ThermalPole|UseCustomFEARegions_ThermalPole]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Use the custom mechanical regions
