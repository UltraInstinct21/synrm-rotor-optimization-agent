...
parameter_name: Spray_RadialRotor_Calc_Input_h_Shaft_R
...
aliases:
- Spray_RadialRotor_Calc_Input_h_Shaft_R
- Spray Radial Rotor Calc Input h Shaft R
- spray_radial_rotor_calc_input_h_shaft_r
- sprayRadialRotorCalcInputHShaftR
- spray_radialrotor_calc_input_h_shaft_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the rear shaft surface is calculated or user input  (0=Calc h, 1=Input h)
