...
parameter_name: Spray_AxialEndcap_Area_Mult_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_Area_Mult_EWdg_Outer_F
- Spray Axial Endcap Area Mult E Wdg Outer F
- spray_axial_endcap_area_mult_e_wdg_outer_f
- sprayAxialEndcapAreaMultEWdgOuterF
- spray_axialendcap_area_mult_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front endwinding outer surface area multiplier
