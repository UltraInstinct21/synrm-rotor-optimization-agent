...
parameter_name: Spray_AxialEndcap_Calc_Input_h_Shaft_R
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_Shaft_R
- Spray Axial Endcap Calc Input h Shaft R
- spray_axial_endcap_calc_input_h_shaft_r
- sprayAxialEndcapCalcInputHShaftR
- spray_axialendcap_calc_input_h_shaft_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the rear shaft surface is calculated or user input  (0=Calc h, 1=Input h)
