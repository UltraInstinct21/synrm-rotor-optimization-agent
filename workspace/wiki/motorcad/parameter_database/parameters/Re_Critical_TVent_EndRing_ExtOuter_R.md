...
parameter_name: Re_Critical_TVent_EndRing_ExtOuter_R
...
aliases:
- Re_Critical_TVent_EndRing_ExtOuter_R
- Re Critical T Vent End Ring Ext Outer R
- re_critical_t_vent_end_ring_ext_outer_r
- reCriticalTVentEndRingExtOuterR
- re_critical_tvent_endring_extouter_r
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the end ring ExtOuter surface [rear]
