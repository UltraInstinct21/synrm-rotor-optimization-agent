...
parameter_name: Spray_RadialRotor_Area_Mult_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_Area_Mult_EWdg_Inner_R
- Spray Radial Rotor Area Mult E Wdg Inner R
- spray_radial_rotor_area_mult_e_wdg_inner_r
- sprayRadialRotorAreaMultEWdgInnerR
- spray_radialrotor_area_mult_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear endwinding inner surface area multiplier
