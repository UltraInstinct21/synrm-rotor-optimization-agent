...
parameter_name: Spray_RadialHousing_Stationary_h_RotorPole_F
...
aliases:
- Spray_RadialHousing_Stationary_h_RotorPole_F
- Spray Radial Housing Stationary h Rotor Pole F
- spray_radial_housing_stationary_h_rotor_pole_f
- sprayRadialHousingStationaryHRotorPoleF
- spray_radialhousing_stationary_h_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc over the front rotor pole surface
