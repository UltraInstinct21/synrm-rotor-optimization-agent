...
parameter_name: DamperERInductance_InterBar
category: Magnetics
input_output: o/p
data_type: double
units: Henry
...
aliases:
- DamperERInductance_InterBar
- Damper ER Inductance Inter Bar
- damper_er_inductance_inter_bar
- damperErInductanceInterBar
- dampererinductance_interbar
related_parameters:
...
## Summary
The end ring inductance between two damper bars
