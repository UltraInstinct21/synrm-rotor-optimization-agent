...
parameter_name: Vel_Mult_TVent_EndRing_ExtBore_R
...
aliases:
- Vel_Mult_TVent_EndRing_ExtBore_R
- Vel Mult T Vent End Ring Ext Bore R
- vel_mult_t_vent_end_ring_ext_bore_r
- velMultTVentEndRingExtBoreR
- vel_mult_tvent_endring_extbore_r
related_parameters:
...
## Summary
The TVent velocity multiplier over the end ring ExtBore surface [rear]
