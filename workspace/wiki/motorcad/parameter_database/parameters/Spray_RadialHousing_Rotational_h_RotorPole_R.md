...
parameter_name: Spray_RadialHousing_Rotational_h_RotorPole_R
...
aliases:
- Spray_RadialHousing_Rotational_h_RotorPole_R
- Spray Radial Housing Rotational h Rotor Pole R
- spray_radial_housing_rotational_h_rotor_pole_r
- sprayRadialHousingRotationalHRotorPoleR
- spray_radialhousing_rotational_h_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rotational htc over the rear rotor pole surface
