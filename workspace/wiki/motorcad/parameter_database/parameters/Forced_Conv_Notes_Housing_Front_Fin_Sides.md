...
parameter_name: Forced_Conv_Notes_Housing_Front_Fin_Sides
...
aliases:
- Forced_Conv_Notes_Housing_Front_Fin_Sides
- Forced Conv Notes Housing Front Fin Sides
- forced_conv_notes_housing_front_fin_sides
- forcedConvNotesHousingFrontFinSides
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of active housing section (fin side section) available for cooling to ambient
