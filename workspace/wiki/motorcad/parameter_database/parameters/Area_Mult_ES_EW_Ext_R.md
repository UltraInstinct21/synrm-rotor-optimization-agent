...
parameter_name: Area_Mult_ES_EW_Ext_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EW_Ext_R
- Area Mult ES EW Ext R
- area_mult_es_ew_ext_r
- areaMultEsEwExtR
related_parameters:
...
## Summary
Area multiplier for the End-Winding Extension [Rear] surface for End Space Cooling
