...
parameter_name: TVent_Stator_Outlet_Temperature
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- TVent_Stator_Outlet_Temperature
- T Vent Stator Outlet Temperature
- t_vent_stator_outlet_temperature
- tVentStatorOutletTemperature
- tvent_stator_outlet_temperature
related_parameters:
...
## Summary
Motor-CAD automation parameter `TVent_Stator_Outlet_Temperature` in category `TVent_Data`.
