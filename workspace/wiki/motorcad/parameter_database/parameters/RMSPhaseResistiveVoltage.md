...
parameter_name: RMSPhaseResistiveVoltage
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
- RMS Phase Resistive Voltage
- rms_phase_resistive_voltage
- rmsPhaseResistiveVoltage
- rmsphaseresistivevoltage
related_parameters:
...
- '[[motorcad/parameter_database/parameters/RMSPhaseCurrentMethod|RMSPhaseCurrentMethod]]'
- '[[motorcad/parameter_database/parameters/RMSPhaseCurrent|RMSPhaseCurrent]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The rms Phase resistive Voltage
