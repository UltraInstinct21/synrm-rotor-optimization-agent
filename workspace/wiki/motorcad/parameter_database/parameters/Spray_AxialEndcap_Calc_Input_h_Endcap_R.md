...
parameter_name: Spray_AxialEndcap_Calc_Input_h_Endcap_R
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_Endcap_R
- Spray Axial Endcap Calc Input h Endcap R
- spray_axial_endcap_calc_input_h_endcap_r
- sprayAxialEndcapCalcInputHEndcapR
- spray_axialendcap_calc_input_h_endcap_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the rear endcap surface is calculated or user input  (0=Calc h, 1=Input h)
