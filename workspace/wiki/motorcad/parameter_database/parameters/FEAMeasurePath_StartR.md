...
parameter_name: FEAMeasurePath_StartR
category: Magnetics
input_output: i/p
data_type: double
units: mm
...
aliases:
- FEAMeasurePath_StartR
- FEA Measure Path Start R
- fea_measure_path_start_r
- feaMeasurePathStartR
- feameasurepath_startr
related_parameters:
...
## Summary
Initial radius in path used to measure from FEA
