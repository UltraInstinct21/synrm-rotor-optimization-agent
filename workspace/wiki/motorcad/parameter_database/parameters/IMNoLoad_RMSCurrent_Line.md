...
parameter_name: IMNoLoad_RMSCurrent_Line
category: Magnetics
input_output: o/p
data_type: double
units: Amps
...
aliases:
- IMNoLoad_RMSCurrent_Line
- IM No Load RMS Current Line
- im_no_load_rms_current_line
- imNoLoadRmsCurrentLine
- imnoload_rmscurrent_line
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IMNoLoad_RMSVoltage_Phase|IMNoLoad_RMSVoltage_Phase]]'
