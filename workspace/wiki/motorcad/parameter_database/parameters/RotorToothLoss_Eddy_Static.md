...
parameter_name: RotorToothLoss_Eddy_Static
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- RotorToothLoss_Eddy_Static
- Rotor Tooth Loss Eddy Static
- rotor_tooth_loss_eddy_static
- rotorToothLossEddyStatic
- rotortoothloss_eddy_static
related_parameters:
...
## Summary
Rotor tooth losses from eddy currents
