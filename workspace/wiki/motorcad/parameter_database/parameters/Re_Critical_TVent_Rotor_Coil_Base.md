...
parameter_name: Re_Critical_TVent_Rotor_Coil_Base
category: TVent_Data
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Re_Critical_TVent_Rotor_Coil_Base
- Re Critical T Vent Rotor Coil Base
- re_critical_t_vent_rotor_coil_base
- reCriticalTVentRotorCoilBase
- re_critical_tvent_rotor_coil_base
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the rotor coil base surface
