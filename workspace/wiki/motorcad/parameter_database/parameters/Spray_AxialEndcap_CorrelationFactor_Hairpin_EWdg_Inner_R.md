...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Hairpin_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Hairpin_EWdg_Inner_R
- Spray Axial Endcap Correlation Factor Hairpin E Wdg Inner R
- spray_axial_endcap_correlation_factor_hairpin_e_wdg_inner_r
- sprayAxialEndcapCorrelationFactorHairpinEWdgInnerR
- spray_axialendcap_correlationfactor_hairpin_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the hairpin rear endwinding inner surface
