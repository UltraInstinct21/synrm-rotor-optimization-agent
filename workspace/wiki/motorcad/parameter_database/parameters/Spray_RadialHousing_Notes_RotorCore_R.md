...
parameter_name: Spray_RadialHousing_Notes_RotorCore_R
...
aliases:
- Spray_RadialHousing_Notes_RotorCore_R
- Spray Radial Housing Notes Rotor Core R
- spray_radial_housing_notes_rotor_core_r
- sprayRadialHousingNotesRotorCoreR
- spray_radialhousing_notes_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) notes for rear rotor core surface
