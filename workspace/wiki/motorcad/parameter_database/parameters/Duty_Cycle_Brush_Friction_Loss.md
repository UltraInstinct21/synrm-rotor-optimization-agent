...
parameter_name: Duty_Cycle_Brush_Friction_Loss
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Brush Friction Loss
- duty_cycle_brush_friction_loss
- dutyCycleBrushFrictionLoss
related_parameters:
...
## Summary
Brush friction loss for each period of the duty cycle
