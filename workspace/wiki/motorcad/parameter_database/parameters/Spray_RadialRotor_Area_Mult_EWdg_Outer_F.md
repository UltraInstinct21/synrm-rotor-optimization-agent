...
parameter_name: Spray_RadialRotor_Area_Mult_EWdg_Outer_F
...
aliases:
- Spray_RadialRotor_Area_Mult_EWdg_Outer_F
- Spray Radial Rotor Area Mult E Wdg Outer F
- spray_radial_rotor_area_mult_e_wdg_outer_f
- sprayRadialRotorAreaMultEWdgOuterF
- spray_radialrotor_area_mult_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) front endwinding outer surface area multiplier
