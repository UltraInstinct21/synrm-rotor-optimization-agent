...
parameter_name: Spray_RadialRotor_Stationary_h_RotorPole_R
...
aliases:
- Spray_RadialRotor_Stationary_h_RotorPole_R
- Spray Radial Rotor Stationary h Rotor Pole R
- spray_radial_rotor_stationary_h_rotor_pole_r
- sprayRadialRotorStationaryHRotorPoleR
- spray_radialrotor_stationary_h_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the rear rotor pole surface
