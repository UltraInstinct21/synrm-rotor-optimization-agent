...
parameter_name: StatorLoss_Minor_Hys_OC
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- StatorLoss_Minor_Hys_OC
- Stator Loss Minor Hys OC
- stator_loss_minor_hys_oc
- statorLossMinorHysOc
- statorloss_minor_hys_oc
related_parameters:
...
## Summary
Stator iron losses from minor loops hysteresis
