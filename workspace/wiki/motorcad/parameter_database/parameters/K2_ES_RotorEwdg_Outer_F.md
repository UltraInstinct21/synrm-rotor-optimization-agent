...
parameter_name: K2_ES_RotorEwdg_Outer_F
category: End_Space
input_output: i/p
data_type: double
units: N/A
...
aliases:
- K2_ES_RotorEwdg_Outer_F
- K2 ES Rotor Ewdg Outer F
- k2_es_rotor_ewdg_outer_f
- k2EsRotorEwdgOuterF
- k2_es_rotorewdg_outer_f
related_parameters:
...
## Summary
The k2 constant for end wdg Outer surface [front]
