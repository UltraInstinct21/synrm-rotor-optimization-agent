...
parameter_name: Vel_ES_EWdg_Outer_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EWdg_Outer_F_Calc
- Vel ES E Wdg Outer F Calc
- vel_es_e_wdg_outer_f_calc
- velEsEWdgOuterFCalc
- vel_es_ewdg_outer_f_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for EWdg Outer surface [Front]
