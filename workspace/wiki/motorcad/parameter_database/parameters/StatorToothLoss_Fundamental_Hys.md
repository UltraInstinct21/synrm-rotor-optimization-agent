...
parameter_name: StatorToothLoss_Fundamental_Hys
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- StatorToothLoss_Fundamental_Hys
- Stator Tooth Loss Fundamental Hys
- stator_tooth_loss_fundamental_hys
- statorToothLossFundamentalHys
- statortoothloss_fundamental_hys
related_parameters:
...
- '[[motorcad/parameter_database/parameters/StatorToothLoss_Eddy|StatorToothLoss_Eddy]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
