...
parameter_name: Area_Mult_ES_EndRing_Bore_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_Bore_F
- Area Mult ES End Ring Bore F
- area_mult_es_end_ring_bore_f
- areaMultEsEndRingBoreF
- area_mult_es_endring_bore_f
related_parameters:
...
## Summary
Area multiplier for the End Ring Bore [Front] surface for End Space Cooling
