...
parameter_name: StatorToothLoss_Hys_Static_Adj
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- StatorToothLoss_Hys_Static_Adj
- Stator Tooth Loss Hys Static Adj
- stator_tooth_loss_hys_static_adj
- statorToothLossHysStaticAdj
- statortoothloss_hys_static_adj
related_parameters:
