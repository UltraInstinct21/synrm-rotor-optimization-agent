...
parameter_name: Spray_RadialRotor_Stationary_h_Input_EWdg_Inner_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_EWdg_Inner_F
- Spray Radial Rotor Stationary h Input E Wdg Inner F
- spray_radial_rotor_stationary_h_input_e_wdg_inner_f
- sprayRadialRotorStationaryHInputEWdgInnerF
- spray_radialrotor_stationary_h_input_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the front endwinding inner surface
