...
parameter_name: Flow_Area_Outlet_Rotor_EWdg_Bore_Cont_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Rotor_EWdg_Bore_Cont_Upstream
- Flow Area Outlet Rotor E Wdg Bore Cont Upstream
- flow_area_outlet_rotor_e_wdg_bore_cont_upstream
- flowAreaOutletRotorEWdgBoreContUpstream
- flow_area_outlet_rotor_ewdg_bore_cont_upstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Rotor EWdg Bore Contraction Upstream
