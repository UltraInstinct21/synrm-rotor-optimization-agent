...
parameter_name: Area_ES_EndRing_ExtOuter_F
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_EndRing_ExtOuter_F
- Area ES End Ring Ext Outer F
- area_es_end_ring_ext_outer_f
- areaEsEndRingExtOuterF
- area_es_endring_extouter_f
related_parameters:
...
## Summary
The area of the end ring ExtOuter surface [front]
