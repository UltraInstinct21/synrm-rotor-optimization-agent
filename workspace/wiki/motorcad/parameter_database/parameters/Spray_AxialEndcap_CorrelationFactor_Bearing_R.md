...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Bearing_R
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Bearing_R
- Spray Axial Endcap Correlation Factor Bearing R
- spray_axial_endcap_correlation_factor_bearing_r
- sprayAxialEndcapCorrelationFactorBearingR
- spray_axialendcap_correlationfactor_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the rear bearing surface
