...
parameter_name: Spray_RadialRotor_CorrelationFactor_Shaft_R
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Shaft_R
- Spray Radial Rotor Correlation Factor Shaft R
- spray_radial_rotor_correlation_factor_shaft_r
- sprayRadialRotorCorrelationFactorShaftR
- spray_radialrotor_correlationfactor_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the rear shaft surface
