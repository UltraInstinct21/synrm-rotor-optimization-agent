...
parameter_name: Spray_RadialRotor_Stationary_h_RotorCore_F
...
aliases:
- Spray_RadialRotor_Stationary_h_RotorCore_F
- Spray Radial Rotor Stationary h Rotor Core F
- spray_radial_rotor_stationary_h_rotor_core_f
- sprayRadialRotorStationaryHRotorCoreF
- spray_radialrotor_stationary_h_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the front rotor core surface
