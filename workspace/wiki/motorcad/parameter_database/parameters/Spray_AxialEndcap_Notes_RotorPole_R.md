...
parameter_name: Spray_AxialEndcap_Notes_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Notes_RotorPole_R
- Spray Axial Endcap Notes Rotor Pole R
- spray_axial_endcap_notes_rotor_pole_r
- sprayAxialEndcapNotesRotorPoleR
- spray_axialendcap_notes_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) notes for rear rotor pole surface
