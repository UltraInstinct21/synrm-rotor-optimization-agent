...
parameter_name: MechanicalMeshLength_Magnets
...
aliases:
- MechanicalMeshLength_Magnets
- Mechanical Mesh Length Magnets
- mechanical_mesh_length_magnets
- mechanicalMeshLengthMagnets
- mechanicalmeshlength_magnets
related_parameters:
...
## Summary
This specifies the size of mesh elements in the magnets. Default = 1, 0 = automatic
