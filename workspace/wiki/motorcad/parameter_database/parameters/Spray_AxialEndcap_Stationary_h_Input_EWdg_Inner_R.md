...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_EWdg_Inner_R
- Spray Axial Endcap Stationary h Input E Wdg Inner R
- spray_axial_endcap_stationary_h_input_e_wdg_inner_r
- sprayAxialEndcapStationaryHInputEWdgInnerR
- spray_axialendcap_stationary_h_input_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the rear endwinding inner surface
