...
parameter_name: Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Inner_F
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Inner_F
- Spray Radial Rotor Correlation Factor Hairpin E Wdg Inner F
- spray_radial_rotor_correlation_factor_hairpin_e_wdg_inner_f
- sprayRadialRotorCorrelationFactorHairpinEWdgInnerF
- spray_radialrotor_correlationfactor_hairpin_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the hairpin front endwinding inner surface
