...
parameter_name: Re_Critical_TVent_Endcap_R
category: TVent_Data
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Re_Critical_TVent_Endcap_R
- Re Critical T Vent Endcap R
- re_critical_t_vent_endcap_r
- reCriticalTVentEndcapR
- re_critical_tvent_endcap_r
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the endcap rear surface
