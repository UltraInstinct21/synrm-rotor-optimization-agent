...
parameter_name: Duty_Cycle_RMS_Current_pu
category: Transient
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Duty_Cycle_RMS_Current_pu
- Duty Cycle RMS Current pu
- duty_cycle_rms_current_pu
- dutyCycleRmsCurrentPu
related_parameters:
...
## Summary
RMS value of current (pu) from the supplied duty cycle
