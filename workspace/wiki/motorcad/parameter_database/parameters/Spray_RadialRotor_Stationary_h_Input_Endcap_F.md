...
parameter_name: Spray_RadialRotor_Stationary_h_Input_Endcap_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_Endcap_F
- Spray Radial Rotor Stationary h Input Endcap F
- spray_radial_rotor_stationary_h_input_endcap_f
- sprayRadialRotorStationaryHInputEndcapF
- spray_radialrotor_stationary_h_input_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the front endcap surface
