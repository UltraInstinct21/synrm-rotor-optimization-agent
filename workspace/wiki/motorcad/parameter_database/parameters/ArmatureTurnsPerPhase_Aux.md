...
parameter_name: ArmatureTurnsPerPhase_Aux
category: Magnetics
input_output: o/p
data_type: integer
units: N/A
...
aliases:
- ArmatureTurnsPerPhase_Aux
- Armature Turns Per Phase Aux
- armature_turns_per_phase_aux
- armatureTurnsPerPhaseAux
- armatureturnsperphase_aux
related_parameters:
...
## Summary
The number of turns in each parallel path of the aux winding
