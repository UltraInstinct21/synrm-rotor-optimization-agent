...
parameter_name: Inlet_Temp_TVent_Stator_Duct
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Inlet_Temp_TVent_Stator_Duct
- Inlet Temp T Vent Stator Duct
- inlet_temp_t_vent_stator_duct
- inletTempTVentStatorDuct
- inlet_temp_tvent_stator_duct
related_parameters:
...
## Summary
Motor-CAD automation parameter `Inlet_Temp_TVent_Stator_Duct` in category `TVent_Data`.
