...
parameter_name: h_Input_TVent_EndRing_Bore_R
...
aliases:
- h_Input_TVent_EndRing_Bore_R
- h Input T Vent End Ring Bore R
- h_input_t_vent_end_ring_bore_r
- hInputTVentEndRingBoreR
- h_input_tvent_endring_bore_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the end ring bore surface [rear]
