...
parameter_name: Spray_AxialEndcap_Calc_Input_h_Bearing_R
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_Bearing_R
- Spray Axial Endcap Calc Input h Bearing R
- spray_axial_endcap_calc_input_h_bearing_r
- sprayAxialEndcapCalcInputHBearingR
- spray_axialendcap_calc_input_h_bearing_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the rear bearing surface is calculated or user input  (0=Calc h, 1=Input h)
