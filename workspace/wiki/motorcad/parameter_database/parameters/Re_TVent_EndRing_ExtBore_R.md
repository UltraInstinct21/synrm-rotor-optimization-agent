...
parameter_name: Re_TVent_EndRing_ExtBore_R
...
aliases:
- Re_TVent_EndRing_ExtBore_R
- Re T Vent End Ring Ext Bore R
- re_t_vent_end_ring_ext_bore_r
- reTVentEndRingExtBoreR
- re_tvent_endring_extbore_r
related_parameters:
...
## Summary
The TVent reynolds number for flow over the end ring ExtBore surface [rear]
