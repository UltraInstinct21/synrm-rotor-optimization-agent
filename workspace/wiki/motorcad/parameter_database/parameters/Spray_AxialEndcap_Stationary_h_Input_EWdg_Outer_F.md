...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_EWdg_Outer_F
- Spray Axial Endcap Stationary h Input E Wdg Outer F
- spray_axial_endcap_stationary_h_input_e_wdg_outer_f
- sprayAxialEndcapStationaryHInputEWdgOuterF
- spray_axialendcap_stationary_h_input_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the front endwinding outer surface
