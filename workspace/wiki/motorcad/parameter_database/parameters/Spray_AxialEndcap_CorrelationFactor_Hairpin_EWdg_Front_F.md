...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Hairpin_EWdg_Front_F
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Hairpin_EWdg_Front_F
- Spray Axial Endcap Correlation Factor Hairpin E Wdg Front F
- spray_axial_endcap_correlation_factor_hairpin_e_wdg_front_f
- sprayAxialEndcapCorrelationFactorHairpinEWdgFrontF
- spray_axialendcap_correlationfactor_hairpin_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the hairpin front endwinding front surface
