...
parameter_name: Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Inner_F
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Inner_F
- Spray Radial Rotor Correlation Factor Stranded E Wdg Inner F
- spray_radial_rotor_correlation_factor_stranded_e_wdg_inner_f
- sprayRadialRotorCorrelationFactorStrandedEWdgInnerF
- spray_radialrotor_correlationfactor_stranded_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the stranded front endwinding inner surface
