...
parameter_name: MagnetizingReactanceSaturated
category: Magnetics
input_output: o/p
data_type: double
units: Ohms
...
aliases:
- MagnetizingReactanceSaturated
- Magnetizing Reactance Saturated
- magnetizing_reactance_saturated
- magnetizingReactanceSaturated
- magnetizingreactancesaturated
related_parameters:
...
- '[[motorcad/parameter_database/parameters/MagnetDepth|MagnetDepth]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The saturated Magnetizing Reactance (including any skewing effects) (on load)
