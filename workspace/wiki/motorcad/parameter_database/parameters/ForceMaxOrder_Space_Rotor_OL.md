...
parameter_name: ForceMaxOrder_Space_Rotor_OL
...
aliases:
- ForceMaxOrder_Space_Rotor_OL
- Force Max Order Space Rotor OL
- force_max_order_space_rotor_ol
- forceMaxOrderSpaceRotorOl
- forcemaxorder_space_rotor_ol
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ForceMaxOrder_Time_OL|ForceMaxOrder_Time_OL]]'
- '[[motorcad/parameter_database/parameters/ForceMaxOrder_Time_OC|ForceMaxOrder_Time_OC]]'
- '[[motorcad/parameter_database/parameters/ForceMaxOrder_Space_Stator_OL|ForceMaxOrder_Space_Stator_OL]]'
- '[[motorcad/parameter_database/parameters/ForceMaxOrder_Space_Stator_OC|ForceMaxOrder_Space_Stator_OC]]'
- '[[motorcad/parameter_database/parameters/ForceMaxOrder_Space_Rotor_OC|ForceMaxOrder_Space_Rotor_OC]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Set the maximum rotor spatial harmonic order for on load force harmonic analysis
