...
parameter_name: Spray_RadialRotor_Rotational_h_Input_Bearing_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_Bearing_R
- Spray Radial Rotor Rotational h Input Bearing R
- spray_radial_rotor_rotational_h_input_bearing_r
- sprayRadialRotorRotationalHInputBearingR
- spray_radialrotor_rotational_h_input_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the rear bearing surface
