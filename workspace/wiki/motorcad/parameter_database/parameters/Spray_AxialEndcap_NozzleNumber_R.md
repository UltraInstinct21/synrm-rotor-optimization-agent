...
parameter_name: Spray_AxialEndcap_NozzleNumber_R
...
aliases:
- Spray_AxialEndcap_NozzleNumber_R
- Spray Axial Endcap Nozzle Number R
- spray_axial_endcap_nozzle_number_r
- sprayAxialEndcapNozzleNumberR
- spray_axialendcap_nozzlenumber_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear nozzle number
