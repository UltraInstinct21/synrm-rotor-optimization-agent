...
parameter_name: Spray_AxialEndcap_Rotational_h_Endcap_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Endcap_F
- Spray Axial Endcap Rotational h Endcap F
- spray_axial_endcap_rotational_h_endcap_f
- sprayAxialEndcapRotationalHEndcapF
- spray_axialendcap_rotational_h_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc over the front endcap surface
