...
parameter_name: Spray_RadialHousing_Rotational_h_Input_EWdg_Outer_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_EWdg_Outer_R
- Spray Radial Housing Rotational h Input E Wdg Outer R
- spray_radial_housing_rotational_h_input_e_wdg_outer_r
- sprayRadialHousingRotationalHInputEWdgOuterR
- spray_radialhousing_rotational_h_input_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the rear endwinding outer surface
