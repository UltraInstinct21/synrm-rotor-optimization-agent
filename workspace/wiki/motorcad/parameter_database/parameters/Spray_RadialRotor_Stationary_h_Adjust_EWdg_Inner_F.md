...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_EWdg_Inner_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_EWdg_Inner_F
- Spray Radial Rotor Stationary h Adjust E Wdg Inner F
- spray_radial_rotor_stationary_h_adjust_e_wdg_inner_f
- sprayRadialRotorStationaryHAdjustEWdgInnerF
- spray_radialrotor_stationary_h_adjust_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the front endwinding inner surface
