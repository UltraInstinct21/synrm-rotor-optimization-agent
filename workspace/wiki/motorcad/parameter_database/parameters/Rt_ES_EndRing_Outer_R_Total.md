...
parameter_name: Rt_ES_EndRing_Outer_R_Total
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_EndRing_Outer_R_Total
- Rt ES End Ring Outer R Total
- rt_es_end_ring_outer_r_total
- rtEsEndRingOuterRTotal
- rt_es_endring_outer_r_total
related_parameters:
...
## Summary
The thermal resistance end ring Outer surface (incl ext) [rear]
