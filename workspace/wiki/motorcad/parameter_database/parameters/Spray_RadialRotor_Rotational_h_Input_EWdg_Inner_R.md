...
parameter_name: Spray_RadialRotor_Rotational_h_Input_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_EWdg_Inner_R
- Spray Radial Rotor Rotational h Input E Wdg Inner R
- spray_radial_rotor_rotational_h_input_e_wdg_inner_r
- sprayRadialRotorRotationalHInputEWdgInnerR
- spray_radialrotor_rotational_h_input_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the rear endwinding inner surface
