...
parameter_name: Vel_TVent_RotorLam_F
...
aliases:
- Vel_TVent_RotorLam_F
- Vel T Vent Rotor Lam F
- vel_t_vent_rotor_lam_f
- velTVentRotorLamF
- vel_tvent_rotorlam_f
related_parameters:
...
## Summary
The TVent velocity over the over the Rotor lam surface [front]
