...
parameter_name: Vel_Mult_ES_EndRing_End_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EndRing_End_F
- Vel Mult ES End Ring End F
- vel_mult_es_end_ring_end_f
- velMultEsEndRingEndF
- vel_mult_es_endring_end_f
related_parameters:
...
## Summary
The velocity multiplier for end ring End surface [front]
