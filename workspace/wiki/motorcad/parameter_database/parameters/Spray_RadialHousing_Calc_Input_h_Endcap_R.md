...
parameter_name: Spray_RadialHousing_Calc_Input_h_Endcap_R
...
aliases:
- Spray_RadialHousing_Calc_Input_h_Endcap_R
- Spray Radial Housing Calc Input h Endcap R
- spray_radial_housing_calc_input_h_endcap_r
- sprayRadialHousingCalcInputHEndcapR
- spray_radialhousing_calc_input_h_endcap_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the rear endcap surface is calculated or user input  (0=Calc h, 1=Input h)
