...
parameter_name: Spray_RadialRotor_Mixed_h_Bearing_F
...
aliases:
- Spray_RadialRotor_Mixed_h_Bearing_F
- Spray Radial Rotor Mixed h Bearing F
- spray_radial_rotor_mixed_h_bearing_f
- sprayRadialRotorMixedHBearingF
- spray_radialrotor_mixed_h_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the front bearing surface
