...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_Bearing_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_Bearing_R
- Spray Radial Rotor Stationary h Adjust Bearing R
- spray_radial_rotor_stationary_h_adjust_bearing_r
- sprayRadialRotorStationaryHAdjustBearingR
- spray_radialrotor_stationary_h_adjust_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the rear bearing surface
