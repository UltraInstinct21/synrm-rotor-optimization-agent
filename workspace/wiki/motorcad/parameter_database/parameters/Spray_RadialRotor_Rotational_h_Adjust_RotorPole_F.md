...
parameter_name: Spray_RadialRotor_Rotational_h_Adjust_RotorPole_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Adjust_RotorPole_F
- Spray Radial Rotor Rotational h Adjust Rotor Pole F
- spray_radial_rotor_rotational_h_adjust_rotor_pole_f
- sprayRadialRotorRotationalHAdjustRotorPoleF
- spray_radialrotor_rotational_h_adjust_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc adjustment over the front rotor pole surface
