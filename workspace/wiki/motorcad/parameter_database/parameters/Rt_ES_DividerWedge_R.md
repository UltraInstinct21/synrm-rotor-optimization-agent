...
parameter_name: Rt_ES_DividerWedge_R
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_DividerWedge_R
- Rt ES Divider Wedge R
- rt_es_divider_wedge_r
- rtEsDividerWedgeR
- rt_es_dividerwedge_r
related_parameters:
...
## Summary
The thermal resistance between the rear endspace and coil divider/wedge
