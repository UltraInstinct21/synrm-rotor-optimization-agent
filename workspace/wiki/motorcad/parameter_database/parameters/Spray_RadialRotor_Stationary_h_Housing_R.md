...
parameter_name: Spray_RadialRotor_Stationary_h_Housing_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Housing_R
- Spray Radial Rotor Stationary h Housing R
- spray_radial_rotor_stationary_h_housing_r
- sprayRadialRotorStationaryHHousingR
- spray_radialrotor_stationary_h_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the rear housing surface
