...
parameter_name: Spray_RadialRotor_Rotational_h_RotorPole_R
...
aliases:
- Spray_RadialRotor_Rotational_h_RotorPole_R
- Spray Radial Rotor Rotational h Rotor Pole R
- spray_radial_rotor_rotational_h_rotor_pole_r
- sprayRadialRotorRotationalHRotorPoleR
- spray_radialrotor_rotational_h_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc over the rear rotor pole surface
