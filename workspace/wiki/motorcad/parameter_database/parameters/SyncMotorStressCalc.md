...
parameter_name: SyncMotorStressCalc
...
aliases:
- SyncMotorStressCalc
- Sync Motor Stress Calc
- sync_motor_stress_calc
- syncMotorStressCalc
- syncmotorstresscalc
related_parameters:
...
## Summary
When enabled the field liner will be separated from the rotor pole regions
