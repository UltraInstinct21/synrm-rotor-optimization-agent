...
parameter_name: ArmatureEWdgMLT_Multiplier
category: Magnetics
input_output: i/p
data_type: double
units: N/A
...
aliases:
- ArmatureEWdgMLT_Multiplier
- Armature E Wdg MLT Multiplier
- armature_e_wdg_mlt_multiplier
- armatureEWdgMltMultiplier
- armatureewdgmlt_multiplier
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ArmatureEWdgMLT_Aux_Calculated|ArmatureEWdgMLT_Aux_Calculated]]'
- '[[motorcad/parameter_database/parameters/ArmatureEWdgMLT_Aux_Multiplier|ArmatureEWdgMLT_Aux_Multiplier]]'
- '[[motorcad/parameter_database/parameters/ArmatureEWdgMLT_Calculated|ArmatureEWdgMLT_Calculated]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Multiplier used to adjust mean length per turn of armature endwindings
