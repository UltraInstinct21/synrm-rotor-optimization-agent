...
parameter_name: Re_TVent_Shaft_OHang_R
category: TVent_Data
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Re_TVent_Shaft_OHang_R
- Re T Vent Shaft O Hang R
- re_t_vent_shaft_o_hang_r
- reTVentShaftOHangR
- re_tvent_shaft_ohang_r
related_parameters:
...
## Summary
The TVent reynolds number for flow over the shaft overhang rear surface
