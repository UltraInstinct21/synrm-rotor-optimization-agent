...
parameter_name: Spray_RadialHousing_Rotational_h_Adjust_RotorPole_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Adjust_RotorPole_R
- Spray Radial Housing Rotational h Adjust Rotor Pole R
- spray_radial_housing_rotational_h_adjust_rotor_pole_r
- sprayRadialHousingRotationalHAdjustRotorPoleR
- spray_radialhousing_rotational_h_adjust_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rotational htc adjustment over the rear rotor pole surface
