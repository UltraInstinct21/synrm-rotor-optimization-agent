...
parameter_name: Re_Critical_TVent_RotorEwdg_Inner_R
...
aliases:
- Re_Critical_TVent_RotorEwdg_Inner_R
- Re Critical T Vent Rotor Ewdg Inner R
- re_critical_t_vent_rotor_ewdg_inner_r
- reCriticalTVentRotorEwdgInnerR
- re_critical_tvent_rotorewdg_inner_r
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the EWdg Inner surface [rear]
