...
parameter_name: Re_Critical_TVent_RotorEwdg_End_R
...
aliases:
- Re_Critical_TVent_RotorEwdg_End_R
- Re Critical T Vent Rotor Ewdg End R
- re_critical_t_vent_rotor_ewdg_end_r
- reCriticalTVentRotorEwdgEndR
- re_critical_tvent_rotorewdg_end_r
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the EWdg End surface [rear]
