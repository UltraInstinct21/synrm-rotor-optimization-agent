...
parameter_name: IronLossBuildFactorDefinition
category: Magnetics
input_output: i/p
data_type: integer
units: N/A
...
- Iron Loss Build Factor Definition
- iron_loss_build_factor_definition
- ironLossBuildFactorDefinition
- ironlossbuildfactordefinition
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IronLossCalculationType|IronLossCalculationType]]'
- '[[motorcad/parameter_database/parameters/IronLossCoefficientDataPoints|IronLossCoefficientDataPoints]]'
- '[[motorcad/parameter_database/parameters/IronLossFactorWithLossVariationTempLoad|IronLossFactorWithLossVariationTempLoad]]'
- '[[motorcad/parameter_database/parameters/Iron_loss_Flux_To_Power_Ratio|Iron_loss_Flux_To_Power_Ratio]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Definition of iron loss build factors
