...
parameter_name: Spray_RadialRotor_NozzleVelocity_F
...
aliases:
- Spray_RadialRotor_NozzleVelocity_F
- Spray Radial Rotor Nozzle Velocity F
- spray_radial_rotor_nozzle_velocity_f
- sprayRadialRotorNozzleVelocityF
- spray_radialrotor_nozzlevelocity_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) front nozzle velocity
