...
parameter_name: Flow_Area_Inlet_Entrance_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Entrance_Downstream
- Flow Area Inlet Entrance Downstream
- flow_area_inlet_entrance_downstream
- flowAreaInletEntranceDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Entrance Downstream
