...
parameter_name: TVent_Outlet_Temperature
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- TVent_Outlet_Temperature
- T Vent Outlet Temperature
- t_vent_outlet_temperature
- tVentOutletTemperature
- tvent_outlet_temperature
related_parameters:
...
## Summary
Motor-CAD automation parameter `TVent_Outlet_Temperature` in category `TVent_Data`.
