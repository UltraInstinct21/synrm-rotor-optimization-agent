...
parameter_name: CustomModelPoints_Array_CurrentPU_Lab
...
aliases:
- CustomModelPoints_Array_CurrentPU_Lab
- Custom Model Points Array Current PU Lab
- custom_model_points_array_current_pu_lab
- customModelPointsArrayCurrentPuLab
- custommodelpoints_array_currentpu_lab
related_parameters:
...
## Summary
Array of stator current (per unit) points for custom resolution of Lab model build
