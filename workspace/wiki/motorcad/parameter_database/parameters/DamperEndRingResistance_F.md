...
parameter_name: DamperEndRingResistance_F
category: Magnetics
input_output: o/p
data_type: double
units: Ohms
...
aliases:
- DamperEndRingResistance_F
- Damper End Ring Resistance F
- damper_end_ring_resistance_f
- damperEndRingResistanceF
- damperendringresistance_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/DamperEndRingResistance_R|DamperEndRingResistance_R]]'
- '[[motorcad/parameter_database/parameters/DamperEndRingResistance_Ref|DamperEndRingResistance_Ref]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The front end ring resistance per damper bar
