...
parameter_name: Average_Temp_TVent_EWdg_Outer_Housing_R
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Average_Temp_TVent_EWdg_Outer_Housing_R
- Average Temp T Vent E Wdg Outer Housing R
- average_temp_t_vent_e_wdg_outer_housing_r
- averageTempTVentEWdgOuterHousingR
- average_temp_tvent_ewdg_outer_housing_r
related_parameters:
...
## Summary
Motor-CAD automation parameter `Average_Temp_TVent_EWdg_Outer_Housing_R` in category `TVent_Data`.
