...
parameter_name: Spray_RadialHousing_Rotational_h_Input_EWdg_Front_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_EWdg_Front_R
- Spray Radial Housing Rotational h Input E Wdg Front R
- spray_radial_housing_rotational_h_input_e_wdg_front_r
- sprayRadialHousingRotationalHInputEWdgFrontR
- spray_radialhousing_rotational_h_input_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the rear endwinding front surface
