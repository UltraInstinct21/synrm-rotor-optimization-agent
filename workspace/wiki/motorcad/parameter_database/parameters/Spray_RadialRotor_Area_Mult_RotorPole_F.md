...
parameter_name: Spray_RadialRotor_Area_Mult_RotorPole_F
...
aliases:
- Spray_RadialRotor_Area_Mult_RotorPole_F
- Spray Radial Rotor Area Mult Rotor Pole F
- spray_radial_rotor_area_mult_rotor_pole_f
- sprayRadialRotorAreaMultRotorPoleF
- spray_radialrotor_area_mult_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) front rotor pole surface area multiplier
