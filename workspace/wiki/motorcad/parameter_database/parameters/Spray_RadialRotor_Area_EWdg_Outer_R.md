...
parameter_name: Spray_RadialRotor_Area_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_Area_EWdg_Outer_R
- Spray Radial Rotor Area E Wdg Outer R
- spray_radial_rotor_area_e_wdg_outer_r
- sprayRadialRotorAreaEWdgOuterR
- spray_radialrotor_area_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear endwinding outer surface sprayed area
