...
parameter_name: Spray_AxialEndcap_CorrelationFactor_RotorCore_R
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_RotorCore_R
- Spray Axial Endcap Correlation Factor Rotor Core R
- spray_axial_endcap_correlation_factor_rotor_core_r
- sprayAxialEndcapCorrelationFactorRotorCoreR
- spray_axialendcap_correlationfactor_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the rear rotor core surface
