...
parameter_name: Spray_RadialRotor_NozzleDiameter_R
...
aliases:
- Spray_RadialRotor_NozzleDiameter_R
- Spray Radial Rotor Nozzle Diameter R
- spray_radial_rotor_nozzle_diameter_r
- sprayRadialRotorNozzleDiameterR
- spray_radialrotor_nozzlediameter_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear nozzle diameter
