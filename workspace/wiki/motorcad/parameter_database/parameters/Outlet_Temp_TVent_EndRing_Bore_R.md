...
parameter_name: Outlet_Temp_TVent_EndRing_Bore_R
...
aliases:
- Outlet_Temp_TVent_EndRing_Bore_R
- Outlet Temp T Vent End Ring Bore R
- outlet_temp_t_vent_end_ring_bore_r
- outletTempTVentEndRingBoreR
- outlet_temp_tvent_endring_bore_r
related_parameters:
...
## Summary
The TVent outlet temperature from the Bore surface of the endring [rear]
