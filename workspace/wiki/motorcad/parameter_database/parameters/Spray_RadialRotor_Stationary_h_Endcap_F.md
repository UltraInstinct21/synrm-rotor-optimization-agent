...
parameter_name: Spray_RadialRotor_Stationary_h_Endcap_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Endcap_F
- Spray Radial Rotor Stationary h Endcap F
- spray_radial_rotor_stationary_h_endcap_f
- sprayRadialRotorStationaryHEndcapF
- spray_radialrotor_stationary_h_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the front endcap surface
