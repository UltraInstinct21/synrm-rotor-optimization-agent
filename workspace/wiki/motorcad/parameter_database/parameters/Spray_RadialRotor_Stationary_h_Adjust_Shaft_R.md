...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_Shaft_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_Shaft_R
- Spray Radial Rotor Stationary h Adjust Shaft R
- spray_radial_rotor_stationary_h_adjust_shaft_r
- sprayRadialRotorStationaryHAdjustShaftR
- spray_radialrotor_stationary_h_adjust_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the rear shaft surface
