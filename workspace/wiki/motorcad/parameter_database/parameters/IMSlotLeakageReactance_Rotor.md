...
parameter_name: IMSlotLeakageReactance_Rotor
category: Magnetics
input_output: o/p
data_type: double
units: Ohms
...
aliases:
- IMSlotLeakageReactance_Rotor
- IM Slot Leakage Reactance Rotor
- im_slot_leakage_reactance_rotor
- imSlotLeakageReactanceRotor
- imslotleakagereactance_rotor
related_parameters:
...
## Summary
The rotor slot leakage reactance
