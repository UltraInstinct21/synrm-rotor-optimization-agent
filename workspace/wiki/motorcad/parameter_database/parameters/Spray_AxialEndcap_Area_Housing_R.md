...
parameter_name: Spray_AxialEndcap_Area_Housing_R
...
aliases:
- Spray_AxialEndcap_Area_Housing_R
- Spray Axial Endcap Area Housing R
- spray_axial_endcap_area_housing_r
- sprayAxialEndcapAreaHousingR
- spray_axialendcap_area_housing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear housing surface sprayed area
