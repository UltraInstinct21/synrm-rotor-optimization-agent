...
parameter_name: End_Space_Velocity_Multiplier_F
category: End_Space
input_output: i/p
data_type: double
units: N/A
...
aliases:
- End_Space_Velocity_Multiplier_F
- End Space Velocity Multiplier F
- end_space_velocity_multiplier_f
- endSpaceVelocityMultiplierF
related_parameters:
...
- '[[motorcad/parameter_database/parameters/End_Space_Velocity_Multiplier_R|End_Space_Velocity_Multiplier_R]]'
- '[[motorcad/parameter_database/parameters/End_Space_Reference_Velocity_F|End_Space_Reference_Velocity_F]]'
- '[[motorcad/parameter_database/parameters/End_Space_Reference_Velocity_R|End_Space_Reference_Velocity_R]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Multiplier used in calc of Ref Velocity used in calculation of End Space Cooling of non rotating surfaces
