...
parameter_name: Vel_ES_EndRing_ExtOuter_R
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_ExtOuter_R
- Vel ES End Ring Ext Outer R
- vel_es_end_ring_ext_outer_r
- velEsEndRingExtOuterR
- vel_es_endring_extouter_r
related_parameters:
...
## Summary
The velocity over the end ring ExtOuter surface [rear]
