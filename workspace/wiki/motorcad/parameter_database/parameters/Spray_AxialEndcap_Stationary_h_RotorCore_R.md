...
parameter_name: Spray_AxialEndcap_Stationary_h_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_RotorCore_R
- Spray Axial Endcap Stationary h Rotor Core R
- spray_axial_endcap_stationary_h_rotor_core_r
- sprayAxialEndcapStationaryHRotorCoreR
- spray_axialendcap_stationary_h_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the rear rotor core surface
