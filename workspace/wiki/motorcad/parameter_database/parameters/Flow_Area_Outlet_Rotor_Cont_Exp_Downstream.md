...
parameter_name: Flow_Area_Outlet_Rotor_Cont_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Rotor_Cont_Exp_Downstream
- Flow Area Outlet Rotor Cont Exp Downstream
- flow_area_outlet_rotor_cont_exp_downstream
- flowAreaOutletRotorContExpDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Rotor Contraction Expansion Downstream
