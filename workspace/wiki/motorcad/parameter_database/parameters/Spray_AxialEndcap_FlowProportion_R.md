...
parameter_name: Spray_AxialEndcap_FlowProportion_R
...
aliases:
- Spray_AxialEndcap_FlowProportion_R
- Spray Axial Endcap Flow Proportion R
- spray_axial_endcap_flow_proportion_r
- sprayAxialEndcapFlowProportionR
- spray_axialendcap_flowproportion_r
related_parameters:
...
## Summary
Rear Spray Cooling (Axial from Endcap) fluid flow proportion
