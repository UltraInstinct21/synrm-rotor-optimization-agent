...
parameter_name: Vel_ES_EndRing_Bore_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_Bore_R_Calc
- Vel ES End Ring Bore R Calc
- vel_es_end_ring_bore_r_calc
- velEsEndRingBoreRCalc
- vel_es_endring_bore_r_calc
related_parameters:
...
## Summary
The calculated velocity over the end ring bore surface [rear]
