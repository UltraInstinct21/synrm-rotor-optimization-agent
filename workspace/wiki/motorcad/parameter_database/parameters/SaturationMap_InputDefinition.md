...
parameter_name: SaturationMap_InputDefinition
...
aliases:
- SaturationMap_InputDefinition
- Saturation Map Input Definition
- saturation_map_input_definition
- saturationMapInputDefinition
- saturationmap_inputdefinition
related_parameters:
...
- '[[motorcad/parameter_database/parameters/SaturationMap_StatorCurrentStep|SaturationMap_StatorCurrentStep]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
How the input parameters are defined for the saturation map calculation
