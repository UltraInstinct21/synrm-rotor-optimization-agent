...
parameter_name: Flow_Area_Outlet_Stator_Cont_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Stator_Cont_Exp_Downstream
- Flow Area Outlet Stator Cont Exp Downstream
- flow_area_outlet_stator_cont_exp_downstream
- flowAreaOutletStatorContExpDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Stator Contraction Expansion Downstream
