...
parameter_name: Gap_Material_Plate_RotorLam_R
...
aliases:
- Gap_Material_Plate_RotorLam_R
- Gap Material Plate Rotor Lam R
- gap_material_plate_rotor_lam_r
- gapMaterialPlateRotorLamR
- gap_material_plate_rotorlam_r
related_parameters:
...
## Summary
Material in the interface gap between the Rotor Plate and Rotor Lam [R].
