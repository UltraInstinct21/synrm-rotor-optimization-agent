...
parameter_name: DamperERInductance_F_Richter
category: Magnetics
input_output: o/p
data_type: double
units: Henry
...
aliases:
- DamperERInductance_F_Richter
- Damper ER Inductance F Richter
- damper_er_inductance_f_richter
- damperErInductanceFRichter
- dampererinductance_f_richter
related_parameters:
...
- '[[motorcad/parameter_database/parameters/DamperERInductance_F_InterBar|DamperERInductance_F_InterBar]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The front damper end ring inductance using Richter method
