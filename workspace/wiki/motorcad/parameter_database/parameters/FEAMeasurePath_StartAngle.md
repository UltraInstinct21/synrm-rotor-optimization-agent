...
parameter_name: FEAMeasurePath_StartAngle
category: Magnetics
input_output: i/p
data_type: double
units: MDeg
...
aliases:
- FEAMeasurePath_StartAngle
- FEA Measure Path Start Angle
- fea_measure_path_start_angle
- feaMeasurePathStartAngle
- feameasurepath_startangle
related_parameters:
...
- '[[motorcad/parameter_database/parameters/FEAMeasurePath_Calculation|FEAMeasurePath_Calculation]]'
...
## Summary
Initial angle (degrees) in path used to measure from FEA
