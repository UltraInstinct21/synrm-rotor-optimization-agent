...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_EWdg_Inner_R
- Spray Radial Rotor Stationary h Adjust E Wdg Inner R
- spray_radial_rotor_stationary_h_adjust_e_wdg_inner_r
- sprayRadialRotorStationaryHAdjustEWdgInnerR
- spray_radialrotor_stationary_h_adjust_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the rear endwinding inner surface
