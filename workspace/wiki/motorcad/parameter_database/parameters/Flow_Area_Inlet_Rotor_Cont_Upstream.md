...
parameter_name: Flow_Area_Inlet_Rotor_Cont_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Rotor_Cont_Upstream
- Flow Area Inlet Rotor Cont Upstream
- flow_area_inlet_rotor_cont_upstream
- flowAreaInletRotorContUpstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Rotor Contraction Upstream
