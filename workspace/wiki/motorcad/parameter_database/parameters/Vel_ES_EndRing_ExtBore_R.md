...
parameter_name: Vel_ES_EndRing_ExtBore_R
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_ExtBore_R
- Vel ES End Ring Ext Bore R
- vel_es_end_ring_ext_bore_r
- velEsEndRingExtBoreR
- vel_es_endring_extbore_r
related_parameters:
...
## Summary
The velocity over the end ring ExtBore surface [rear]
