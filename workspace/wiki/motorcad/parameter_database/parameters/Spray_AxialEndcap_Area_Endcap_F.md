...
parameter_name: Spray_AxialEndcap_Area_Endcap_F
...
aliases:
- Spray_AxialEndcap_Area_Endcap_F
- Spray Axial Endcap Area Endcap F
- spray_axial_endcap_area_endcap_f
- sprayAxialEndcapAreaEndcapF
- spray_axialendcap_area_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front endcap surface sprayed area
