...
parameter_name: Spray_AxialEndcap_Area_EWdg_Outer_R
...
aliases:
- Spray_AxialEndcap_Area_EWdg_Outer_R
- Spray Axial Endcap Area E Wdg Outer R
- spray_axial_endcap_area_e_wdg_outer_r
- sprayAxialEndcapAreaEWdgOuterR
- spray_axialendcap_area_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear endwinding outer surface sprayed area
