...
parameter_name: Vel_ES_RotorEwdg_inner_R
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_RotorEwdg_inner_R
- Vel ES Rotor Ewdg inner R
- vel_es_rotor_ewdg_inner_r
- velEsRotorEwdgInnerR
- vel_es_rotorewdg_inner_r
related_parameters:
...
## Summary
The velocity over the end wdg inner surface [rear]
