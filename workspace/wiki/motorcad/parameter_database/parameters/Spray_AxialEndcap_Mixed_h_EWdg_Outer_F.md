...
parameter_name: Spray_AxialEndcap_Mixed_h_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_Mixed_h_EWdg_Outer_F
- Spray Axial Endcap Mixed h E Wdg Outer F
- spray_axial_endcap_mixed_h_e_wdg_outer_f
- sprayAxialEndcapMixedHEWdgOuterF
- spray_axialendcap_mixed_h_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the front endwinding outer surface
