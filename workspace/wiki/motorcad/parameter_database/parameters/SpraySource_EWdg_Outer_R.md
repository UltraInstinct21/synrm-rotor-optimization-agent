...
parameter_name: SpraySource_EWdg_Outer_R
...
aliases:
- SpraySource_EWdg_Outer_R
- Spray Source E Wdg Outer R
- spray_source_e_wdg_outer_r
- spraySourceEWdgOuterR
- spraysource_ewdg_outer_r
related_parameters:
...
- '[[motorcad/parameter_database/parameters/SpraySource_EWdg_Outer_F|SpraySource_EWdg_Outer_F]]'
- '[[motorcad/parameter_database/parameters/SpraySource_EWdg_Front_F|SpraySource_EWdg_Front_F]]'
- '[[motorcad/parameter_database/parameters/SpraySource_EWdg_Inner_F|SpraySource_EWdg_Inner_F]]'
- '[[motorcad/parameter_database/parameters/SpraySource_EWdg_Rear_F|SpraySource_EWdg_Rear_F]]'
- '[[motorcad/parameter_database/parameters/SpraySource_RotorPole_F|SpraySource_RotorPole_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This is the source of spray pointed at end winding outer surface
