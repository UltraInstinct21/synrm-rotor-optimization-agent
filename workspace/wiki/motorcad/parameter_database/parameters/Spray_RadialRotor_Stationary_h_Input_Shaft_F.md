...
parameter_name: Spray_RadialRotor_Stationary_h_Input_Shaft_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_Shaft_F
- Spray Radial Rotor Stationary h Input Shaft F
- spray_radial_rotor_stationary_h_input_shaft_f
- sprayRadialRotorStationaryHInputShaftF
- spray_radialrotor_stationary_h_input_shaft_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the front shaft surface
