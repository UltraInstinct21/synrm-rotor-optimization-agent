...
parameter_name: Spray_RadialRotor_Mixed_h_RotorPole_F
...
aliases:
- Spray_RadialRotor_Mixed_h_RotorPole_F
- Spray Radial Rotor Mixed h Rotor Pole F
- spray_radial_rotor_mixed_h_rotor_pole_f
- sprayRadialRotorMixedHRotorPoleF
- spray_radialrotor_mixed_h_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the front rotor pole surface
