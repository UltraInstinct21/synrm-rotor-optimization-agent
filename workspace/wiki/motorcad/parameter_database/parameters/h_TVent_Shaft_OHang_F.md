...
parameter_name: h_TVent_Shaft_OHang_F
category: TVent_Data
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_TVent_Shaft_OHang_F
- h T Vent Shaft O Hang F
- h_t_vent_shaft_o_hang_f
- hTVentShaftOHangF
- h_tvent_shaft_ohang_f
related_parameters:
...
## Summary
Motor-CAD automation parameter `h_TVent_Shaft_OHang_F` in category `TVent_Data`.
