...
parameter_name: Forced_Conv_Notes_EncCase_Radial
...
aliases:
- Forced_Conv_Notes_EncCase_Radial
- Forced Conv Notes Enc Case Radial
- forced_conv_notes_enc_case_radial
- forcedConvNotesEncCaseRadial
- forced_conv_notes_enccase_radial
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of encoder case (radial section) available for cooling to ambient
