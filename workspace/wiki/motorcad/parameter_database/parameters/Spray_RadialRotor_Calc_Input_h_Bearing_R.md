...
parameter_name: Spray_RadialRotor_Calc_Input_h_Bearing_R
...
aliases:
- Spray_RadialRotor_Calc_Input_h_Bearing_R
- Spray Radial Rotor Calc Input h Bearing R
- spray_radial_rotor_calc_input_h_bearing_r
- sprayRadialRotorCalcInputHBearingR
- spray_radialrotor_calc_input_h_bearing_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the rear bearing surface is calculated or user input  (0=Calc h, 1=Input h)
