...
parameter_name: Harmonic_RotorCurrent_Main
category: Magnetics
input_output: o/p
data_type: double
units: Amps
...
aliases:
- Harmonic_RotorCurrent_Main
- Harmonic Rotor Current Main
- harmonic_rotor_current_main
- harmonicRotorCurrentMain
- harmonic_rotorcurrent_main
related_parameters:
...
## Summary
Rotor current referred to the main winding for each harmonic order in the IM1PH equivalent circuit
