...
parameter_name: Spray_RadialRotor_Notes_Housing_R
...
aliases:
- Spray_RadialRotor_Notes_Housing_R
- Spray Radial Rotor Notes Housing R
- spray_radial_rotor_notes_housing_r
- sprayRadialRotorNotesHousingR
- spray_radialrotor_notes_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) notes for rear housing surface
