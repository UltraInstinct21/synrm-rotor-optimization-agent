...
parameter_name: Duty_Cycle_Field_Copper_Loss_DC
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Field Copper Loss DC
- duty_cycle_field_copper_loss_dc
- dutyCycleFieldCopperLossDc
related_parameters:
...
## Summary
DC copper loss in the field winding for each period of the duty cycle
