...
parameter_name: RotorSlotFilletRadius
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- RotorSlotFilletRadius
- Rotor Slot Fillet Radius
- rotor_slot_fillet_radius
- rotorSlotFilletRadius
- rotorslotfilletradius
related_parameters:
...
- '[[motorcad/parameter_database/parameters/RotorGridOuterDiameter|RotorGridOuterDiameter]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The radius of the rotor slot fillets
