...
parameter_name: TVent_InletExpansion_CSA
...
aliases:
- TVent_InletExpansion_CSA
- T Vent Inlet Expansion CSA
- t_vent_inlet_expansion_csa
- tVentInletExpansionCsa
- tvent_inletexpansion_csa
related_parameters:
...
- '[[motorcad/parameter_database/parameters/TVent_IncludeEndspaceRotationEffects|TVent_IncludeEndspaceRotationEffects]]'
- '[[motorcad/parameter_database/parameters/TVent_SlotWJ_Connection|TVent_SlotWJ_Connection]]'
- '[[motorcad/parameter_database/parameters/TVent_SlotWJ_Connection_Method|TVent_SlotWJ_Connection_Method]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The calculation method for Through Ventilated inlet expansion cross section area with stator plate or Lam-H divider
