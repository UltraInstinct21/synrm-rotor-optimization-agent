...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_EWdg_Front_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_EWdg_Front_F
- Spray Axial Endcap Rotational h Input E Wdg Front F
- spray_axial_endcap_rotational_h_input_e_wdg_front_f
- sprayAxialEndcapRotationalHInputEWdgFrontF
- spray_axialendcap_rotational_h_input_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the front endwinding front surface
