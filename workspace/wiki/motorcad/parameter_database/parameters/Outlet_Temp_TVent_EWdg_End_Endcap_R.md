...
parameter_name: Outlet_Temp_TVent_EWdg_End_Endcap_R
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Outlet_Temp_TVent_EWdg_End_Endcap_R
- Outlet Temp T Vent E Wdg End Endcap R
- outlet_temp_t_vent_e_wdg_end_endcap_r
- outletTempTVentEWdgEndEndcapR
- outlet_temp_tvent_ewdg_end_endcap_r
related_parameters:
...
## Summary
Motor-CAD automation parameter `Outlet_Temp_TVent_EWdg_End_Endcap_R` in category `TVent_Data`.
