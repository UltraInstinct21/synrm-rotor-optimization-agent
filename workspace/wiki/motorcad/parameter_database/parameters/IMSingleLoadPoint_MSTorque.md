...
parameter_name: IMSingleLoadPoint_MSTorque
category: Magnetics
input_output: o/p
data_type: double
units: Nm
...
aliases:
- IMSingleLoadPoint_MSTorque
- IM Single Load Point MS Torque
- im_single_load_point_ms_torque
- imSingleLoadPointMsTorque
- imsingleloadpoint_mstorque
related_parameters:
...
## Summary
The Maxwell stress torque in the Single Load Point FEA case
