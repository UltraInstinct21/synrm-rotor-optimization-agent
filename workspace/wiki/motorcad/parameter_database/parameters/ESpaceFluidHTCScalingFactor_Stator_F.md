...
parameter_name: ESpaceFluidHTCScalingFactor_Stator_F
category: End_Space
input_output: o/p
data_type: double
units: N/A
...
aliases:
- ESpaceFluidHTCScalingFactor_Stator_F
- E Space Fluid HTC Scaling Factor Stator F
- e_space_fluid_htc_scaling_factor_stator_f
- eSpaceFluidHtcScalingFactorStatorF
- espacefluidhtcscalingfactor_stator_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ESpaceFluidHTCScalingFactor_Rotor_F|ESpaceFluidHTCScalingFactor_Rotor_F]]'
- '[[motorcad/parameter_database/parameters/ESpaceFluidHTCScalingFactor_Stator_R|ESpaceFluidHTCScalingFactor_Stator_R]]'
- '[[motorcad/parameter_database/parameters/ESpaceFluidHTCScalingFactor_Rotor_R|ESpaceFluidHTCScalingFactor_Rotor_R]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Scaling factor for internal fluid type when calculating the front stator endspace htcs.
