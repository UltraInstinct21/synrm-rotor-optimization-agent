...
parameter_name: Rt_ES_EndRing_Outer_R
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_EndRing_Outer_R
- Rt ES End Ring Outer R
- rt_es_end_ring_outer_r
- rtEsEndRingOuterR
- rt_es_endring_outer_r
related_parameters:
...
## Summary
The thermal resistance end ring Outer surface [rear]
