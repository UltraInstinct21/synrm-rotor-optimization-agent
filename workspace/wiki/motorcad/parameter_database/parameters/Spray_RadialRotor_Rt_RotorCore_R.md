...
parameter_name: Spray_RadialRotor_Rt_RotorCore_R
...
aliases:
- Spray_RadialRotor_Rt_RotorCore_R
- Spray Radial Rotor Rt Rotor Core R
- spray_radial_rotor_rt_rotor_core_r
- sprayRadialRotorRtRotorCoreR
- spray_radialrotor_rt_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to rear rotor core surface convective thermal resistance
