...
parameter_name: Spray_AxialEndcap_Area_Bearing_F
...
aliases:
- Spray_AxialEndcap_Area_Bearing_F
- Spray Axial Endcap Area Bearing F
- spray_axial_endcap_area_bearing_f
- sprayAxialEndcapAreaBearingF
- spray_axialendcap_area_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front bearing surface sprayed area
