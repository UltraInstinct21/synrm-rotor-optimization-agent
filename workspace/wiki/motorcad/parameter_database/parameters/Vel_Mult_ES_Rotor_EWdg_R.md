...
parameter_name: Vel_Mult_ES_Rotor_EWdg_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_Rotor_EWdg_R
- Vel Mult ES Rotor E Wdg R
- vel_mult_es_rotor_e_wdg_r
- velMultEsRotorEWdgR
- vel_mult_es_rotor_ewdg_r
related_parameters:
...
## Summary
The velocity multiplier for rotor endwinding surface [rear]
