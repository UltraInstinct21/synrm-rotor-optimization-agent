...
parameter_name: CircularDuctL3_VelocityCalculated
...
aliases:
- CircularDuctL3_VelocityCalculated
- Circular Duct L3 Velocity Calculated
- circular_duct_l3_velocity_calculated
- circularDuctL3VelocityCalculated
- circularductl3_velocitycalculated
related_parameters:
...
## Summary
This is Fluid Velocity for the Layer 3 duct (calculated before user adjustment)
