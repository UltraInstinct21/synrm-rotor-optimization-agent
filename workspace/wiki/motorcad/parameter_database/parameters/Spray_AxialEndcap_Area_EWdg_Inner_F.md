...
parameter_name: Spray_AxialEndcap_Area_EWdg_Inner_F
...
aliases:
- Spray_AxialEndcap_Area_EWdg_Inner_F
- Spray Axial Endcap Area E Wdg Inner F
- spray_axial_endcap_area_e_wdg_inner_f
- sprayAxialEndcapAreaEWdgInnerF
- spray_axialendcap_area_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front endwinding inner surface sprayed area
