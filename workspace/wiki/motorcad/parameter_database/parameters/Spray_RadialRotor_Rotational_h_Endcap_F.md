...
parameter_name: Spray_RadialRotor_Rotational_h_Endcap_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Endcap_F
- Spray Radial Rotor Rotational h Endcap F
- spray_radial_rotor_rotational_h_endcap_f
- sprayRadialRotorRotationalHEndcapF
- spray_radialrotor_rotational_h_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc over the front endcap surface
