...
parameter_name: Flow_Area_Outlet_Rotor_Duct_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Rotor_Duct_Exp_Downstream
- Flow Area Outlet Rotor Duct Exp Downstream
- flow_area_outlet_rotor_duct_exp_downstream
- flowAreaOutletRotorDuctExpDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Rotor Duct Expansion Downstream
