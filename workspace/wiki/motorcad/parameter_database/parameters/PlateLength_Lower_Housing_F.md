...
parameter_name: PlateLength_Lower_Housing_F
...
aliases:
- PlateLength_Lower_Housing_F
- Plate Length Lower Housing F
- plate_length_lower_housing_f
- plateLengthLowerHousingF
- platelength_lower_housing_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/PlateLength_Upper_Endcap_F|PlateLength_Upper_Endcap_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The spray cooling lower plate length for the front housing
