...
parameter_name: K3_ES_RotorEwdg_inner_F
category: End_Space
input_output: i/p
data_type: double
units: N/A
...
aliases:
- K3_ES_RotorEwdg_inner_F
- K3 ES Rotor Ewdg inner F
- k3_es_rotor_ewdg_inner_f
- k3EsRotorEwdgInnerF
- k3_es_rotorewdg_inner_f
related_parameters:
...
## Summary
The k3 constant for end wdg inner surface [front]
