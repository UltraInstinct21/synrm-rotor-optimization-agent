...
parameter_name: h_Input_TVent_RotorEwdg_End_R
...
aliases:
- h_Input_TVent_RotorEwdg_End_R
- h Input T Vent Rotor Ewdg End R
- h_input_t_vent_rotor_ewdg_end_r
- hInputTVentRotorEwdgEndR
- h_input_tvent_rotorewdg_end_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the EWdg End surface [rear]
