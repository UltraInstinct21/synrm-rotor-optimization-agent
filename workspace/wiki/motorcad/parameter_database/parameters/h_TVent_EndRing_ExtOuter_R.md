...
parameter_name: h_TVent_EndRing_ExtOuter_R
...
aliases:
- h_TVent_EndRing_ExtOuter_R
- h T Vent End Ring Ext Outer R
- h_t_vent_end_ring_ext_outer_r
- hTVentEndRingExtOuterR
- h_tvent_endring_extouter_r
related_parameters:
...
## Summary
The TVent heat transfer coefficient over the end ring ExtOuter surface [rear]
