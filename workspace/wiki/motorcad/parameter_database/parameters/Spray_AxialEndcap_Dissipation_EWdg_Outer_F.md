...
parameter_name: Spray_AxialEndcap_Dissipation_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_Dissipation_EWdg_Outer_F
- Spray Axial Endcap Dissipation E Wdg Outer F
- spray_axial_endcap_dissipation_e_wdg_outer_f
- sprayAxialEndcapDissipationEWdgOuterF
- spray_axialendcap_dissipation_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the front endwinding outer surface
