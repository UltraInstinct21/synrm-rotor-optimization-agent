...
parameter_name: Spray_RadialHousing_Rt_EWdg_Inner_R
...
aliases:
- Spray_RadialHousing_Rt_EWdg_Inner_R
- Spray Radial Housing Rt E Wdg Inner R
- spray_radial_housing_rt_e_wdg_inner_r
- sprayRadialHousingRtEWdgInnerR
- spray_radialhousing_rt_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) fluid to rear endwinding inner surface convective thermal resistance
