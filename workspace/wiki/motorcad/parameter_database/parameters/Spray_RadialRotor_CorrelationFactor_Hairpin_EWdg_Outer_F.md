...
parameter_name: Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Outer_F
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Outer_F
- Spray Radial Rotor Correlation Factor Hairpin E Wdg Outer F
- spray_radial_rotor_correlation_factor_hairpin_e_wdg_outer_f
- sprayRadialRotorCorrelationFactorHairpinEWdgOuterF
- spray_radialrotor_correlationfactor_hairpin_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the hairpin front endwinding outer surface
