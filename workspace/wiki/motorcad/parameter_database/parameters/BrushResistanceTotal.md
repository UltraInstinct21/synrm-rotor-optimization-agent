...
parameter_name: BrushResistanceTotal
category: Magnetics
input_output: o/p
data_type: double
units: Ohms
...
aliases:
- BrushResistanceTotal
- Brush Resistance Total
- brush_resistance_total
- brushResistanceTotal
- brushresistancetotal
related_parameters:
...
- '[[motorcad/parameter_database/parameters/BrushContactVoltageDrop|BrushContactVoltageDrop]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The total ohmic resistance of the brushes
