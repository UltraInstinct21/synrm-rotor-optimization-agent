...
parameter_name: Area_Mult_ES_RotorEwdg_Outer_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_RotorEwdg_Outer_F
- Area Mult ES Rotor Ewdg Outer F
- area_mult_es_rotor_ewdg_outer_f
- areaMultEsRotorEwdgOuterF
- area_mult_es_rotorewdg_outer_f
related_parameters:
...
## Summary
Area multiplier for the Rotor End-Winding Outer [Front] surface for End Space Cooling
