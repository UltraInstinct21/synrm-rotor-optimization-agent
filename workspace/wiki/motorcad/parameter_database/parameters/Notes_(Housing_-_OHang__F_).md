...
parameter_name: Notes_(Housing_-_OHang_[F])
...
aliases:
- Notes_(Housing_-_OHang_[F])
- Notes_(Housing_-_OHang_(F))
- Notes Housing O Hang F
- notes_housing_o_hang_f
- notesHousingOHangF
- notes_(housing_-_ohang_[f])
related_parameters:
...
## Summary
The notes for the front gap between housing and endcap
