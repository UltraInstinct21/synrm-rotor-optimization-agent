...
parameter_name: Vel_ES_RotorEwdg_end_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_RotorEwdg_end_F_Calc
- Vel ES Rotor Ewdg end F Calc
- vel_es_rotor_ewdg_end_f_calc
- velEsRotorEwdgEndFCalc
- vel_es_rotorewdg_end_f_calc
related_parameters:
...
## Summary
The calculated velocity over the end wdg end surface [front]
