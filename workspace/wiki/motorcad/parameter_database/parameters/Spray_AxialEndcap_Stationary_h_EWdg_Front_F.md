...
parameter_name: Spray_AxialEndcap_Stationary_h_EWdg_Front_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_EWdg_Front_F
- Spray Axial Endcap Stationary h E Wdg Front F
- spray_axial_endcap_stationary_h_e_wdg_front_f
- sprayAxialEndcapStationaryHEWdgFrontF
- spray_axialendcap_stationary_h_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the front endwinding front surface
