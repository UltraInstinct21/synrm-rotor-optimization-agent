...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_Endcap_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_Endcap_R
- Spray Radial Rotor Stationary h Adjust Endcap R
- spray_radial_rotor_stationary_h_adjust_endcap_r
- sprayRadialRotorStationaryHAdjustEndcapR
- spray_radialrotor_stationary_h_adjust_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the rear endcap surface
