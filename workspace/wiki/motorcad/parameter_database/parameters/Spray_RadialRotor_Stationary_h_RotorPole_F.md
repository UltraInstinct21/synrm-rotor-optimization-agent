...
parameter_name: Spray_RadialRotor_Stationary_h_RotorPole_F
...
aliases:
- Spray_RadialRotor_Stationary_h_RotorPole_F
- Spray Radial Rotor Stationary h Rotor Pole F
- spray_radial_rotor_stationary_h_rotor_pole_f
- sprayRadialRotorStationaryHRotorPoleF
- spray_radialrotor_stationary_h_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the front rotor pole surface
