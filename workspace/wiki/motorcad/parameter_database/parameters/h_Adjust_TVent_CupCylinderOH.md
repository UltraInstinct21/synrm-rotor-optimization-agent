...
parameter_name: h_Adjust_TVent_CupCylinderOH
...
aliases:
- h_Adjust_TVent_CupCylinderOH
- h Adjust T Vent Cup Cylinder OH
- h_adjust_t_vent_cup_cylinder_oh
- hAdjustTVentCupCylinderOh
- h_adjust_tvent_cupcylinderoh
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the Cup Cylinder Overhang
