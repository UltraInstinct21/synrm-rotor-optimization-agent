...
parameter_name: Spray_AxialEndcap_Capacitance_R
...
aliases:
- Spray_AxialEndcap_Capacitance_R
- Spray Axial Endcap Capacitance R
- spray_axial_endcap_capacitance_r
- sprayAxialEndcapCapacitanceR
- spray_axialendcap_capacitance_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid rear capacitance
