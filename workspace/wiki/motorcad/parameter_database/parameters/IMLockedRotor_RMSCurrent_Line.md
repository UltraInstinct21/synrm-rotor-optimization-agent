...
parameter_name: IMLockedRotor_RMSCurrent_Line
category: Magnetics
input_output: o/p
data_type: double
units: Amps
...
aliases:
- IMLockedRotor_RMSCurrent_Line
- IM Locked Rotor RMS Current Line
- im_locked_rotor_rms_current_line
- imLockedRotorRmsCurrentLine
- imlockedrotor_rmscurrent_line
related_parameters:
...
## Summary
The locked rotor rms line current
