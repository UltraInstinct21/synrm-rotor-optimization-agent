...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_Bearing_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_Bearing_R
- Spray Axial Endcap Stationary h Input Bearing R
- spray_axial_endcap_stationary_h_input_bearing_r
- sprayAxialEndcapStationaryHInputBearingR
- spray_axialendcap_stationary_h_input_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the rear bearing surface
