...
parameter_name: Nozzles_EWdg_Outer_F
...
aliases:
- Nozzles_EWdg_Outer_F
- Nozzles E Wdg Outer F
- nozzles_e_wdg_outer_f
- nozzlesEWdgOuterF
- nozzles_ewdg_outer_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Nozzles_EWdg_Front_F|Nozzles_EWdg_Front_F]]'
- '[[motorcad/parameter_database/parameters/Nozzles_EWdg_Inner_F|Nozzles_EWdg_Inner_F]]'
- '[[motorcad/parameter_database/parameters/Nozzles_EWdg_Rear_F|Nozzles_EWdg_Rear_F]]'
- '[[motorcad/parameter_database/parameters/Nozzles_RotorPole_F|Nozzles_RotorPole_F]]'
- '[[motorcad/parameter_database/parameters/Nozzles_Rotor Core_F|Nozzles_Rotor Core_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This is the number of nozzles pointed at outer surface of front endwinding
