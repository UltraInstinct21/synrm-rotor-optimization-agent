...
parameter_name: Spray_RadialHousing_Area_Endcap_R
...
aliases:
- Spray_RadialHousing_Area_Endcap_R
- Spray Radial Housing Area Endcap R
- spray_radial_housing_area_endcap_r
- sprayRadialHousingAreaEndcapR
- spray_radialhousing_area_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rear endcap surface sprayed area
