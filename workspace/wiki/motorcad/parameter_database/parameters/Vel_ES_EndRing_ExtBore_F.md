...
parameter_name: Vel_ES_EndRing_ExtBore_F
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_ExtBore_F
- Vel ES End Ring Ext Bore F
- vel_es_end_ring_ext_bore_f
- velEsEndRingExtBoreF
- vel_es_endring_extbore_f
related_parameters:
...
## Summary
The velocity over the end ring ExtBore surface [front]
