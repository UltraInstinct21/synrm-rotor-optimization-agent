...
parameter_name: Spray_AxialEndcap_Stationary_h_EWdg_Front_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_EWdg_Front_R
- Spray Axial Endcap Stationary h E Wdg Front R
- spray_axial_endcap_stationary_h_e_wdg_front_r
- sprayAxialEndcapStationaryHEWdgFrontR
- spray_axialendcap_stationary_h_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the rear endwinding front surface
