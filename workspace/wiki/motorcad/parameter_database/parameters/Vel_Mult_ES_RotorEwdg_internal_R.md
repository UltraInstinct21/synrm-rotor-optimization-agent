...
parameter_name: Vel_Mult_ES_RotorEwdg_internal_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_RotorEwdg_internal_R
- Vel Mult ES Rotor Ewdg internal R
- vel_mult_es_rotor_ewdg_internal_r
- velMultEsRotorEwdgInternalR
- vel_mult_es_rotorewdg_internal_r
related_parameters:
...
## Summary
The velocity multiplier for end wdg internal surface [rear]
