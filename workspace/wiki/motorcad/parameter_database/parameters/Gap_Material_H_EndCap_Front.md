...
parameter_name: Gap_Material_H_EndCap_Front
...
aliases:
- Gap_Material_H_EndCap_Front
- Gap Material H End Cap Front
- gap_material_h_end_cap_front
- gapMaterialHEndCapFront
- gap_material_h_endcap_front
related_parameters:
...
## Summary
Material in the interface gap between Housing and Endcap [F].
