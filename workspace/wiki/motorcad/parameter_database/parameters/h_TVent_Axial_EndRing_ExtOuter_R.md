...
parameter_name: h_TVent_Axial_EndRing_ExtOuter_R
...
aliases:
- h_TVent_Axial_EndRing_ExtOuter_R
- h T Vent Axial End Ring Ext Outer R
- h_t_vent_axial_end_ring_ext_outer_r
- hTVentAxialEndRingExtOuterR
- h_tvent_axial_endring_extouter_r
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the end ring ExtOuter surface [rear]
