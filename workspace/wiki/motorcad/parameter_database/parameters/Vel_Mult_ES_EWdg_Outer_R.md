...
parameter_name: Vel_Mult_ES_EWdg_Outer_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EWdg_Outer_R
- Vel Mult ES E Wdg Outer R
- vel_mult_es_e_wdg_outer_r
- velMultEsEWdgOuterR
- vel_mult_es_ewdg_outer_r
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for EWdg Outer surface [Rear]
