...
parameter_name: h_Adjust_TVent_EndRing_ExtInter_F
...
aliases:
- h_Adjust_TVent_EndRing_ExtInter_F
- h Adjust T Vent End Ring Ext Inter F
- h_adjust_t_vent_end_ring_ext_inter_f
- hAdjustTVentEndRingExtInterF
- h_adjust_tvent_endring_extinter_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the end ring ExtInter surface [front]
