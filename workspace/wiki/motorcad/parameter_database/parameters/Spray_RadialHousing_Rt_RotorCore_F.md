...
parameter_name: Spray_RadialHousing_Rt_RotorCore_F
...
aliases:
- Spray_RadialHousing_Rt_RotorCore_F
- Spray Radial Housing Rt Rotor Core F
- spray_radial_housing_rt_rotor_core_f
- sprayRadialHousingRtRotorCoreF
- spray_radialhousing_rt_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) fluid to front rotor core surface convective thermal resistance
