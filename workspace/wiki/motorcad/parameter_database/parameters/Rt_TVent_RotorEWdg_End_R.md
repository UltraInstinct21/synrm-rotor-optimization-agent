...
parameter_name: Rt_TVent_RotorEWdg_End_R
...
aliases:
- Rt_TVent_RotorEWdg_End_R
- Rt T Vent Rotor E Wdg End R
- rt_t_vent_rotor_e_wdg_end_r
- rtTVentRotorEWdgEndR
- rt_tvent_rotorewdg_end_r
related_parameters:
...
## Summary
The thermal resistance from the end surface of rear rotor endwinding to the fluid
