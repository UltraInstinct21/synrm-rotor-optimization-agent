...
parameter_name: Re_Critical_TVent_Shaft_OHang_F
category: TVent_Data
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Re_Critical_TVent_Shaft_OHang_F
- Re Critical T Vent Shaft O Hang F
- re_critical_t_vent_shaft_o_hang_f
- reCriticalTVentShaftOHangF
- re_critical_tvent_shaft_ohang_f
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the shaft overhang front surface
