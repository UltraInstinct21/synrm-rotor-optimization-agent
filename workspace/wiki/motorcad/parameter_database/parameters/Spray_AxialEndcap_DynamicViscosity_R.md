...
parameter_name: Spray_AxialEndcap_DynamicViscosity_R
...
aliases:
- Spray_AxialEndcap_DynamicViscosity_R
- Spray Axial Endcap Dynamic Viscosity R
- spray_axial_endcap_dynamic_viscosity_r
- sprayAxialEndcapDynamicViscosityR
- spray_axialendcap_dynamicviscosity_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) Rear fluid dynamic viscosity
