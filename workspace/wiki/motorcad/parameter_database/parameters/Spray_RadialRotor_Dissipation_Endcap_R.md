...
parameter_name: Spray_RadialRotor_Dissipation_Endcap_R
...
aliases:
- Spray_RadialRotor_Dissipation_Endcap_R
- Spray Radial Rotor Dissipation Endcap R
- spray_radial_rotor_dissipation_endcap_r
- sprayRadialRotorDissipationEndcapR
- spray_radialrotor_dissipation_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the rear endcap surface
