...
parameter_name: Vel_ES_RotorEwdg_end_F
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_RotorEwdg_end_F
- Vel ES Rotor Ewdg end F
- vel_es_rotor_ewdg_end_f
- velEsRotorEwdgEndF
- vel_es_rotorewdg_end_f
related_parameters:
...
## Summary
The velocity over the end wdg end surface [front]
