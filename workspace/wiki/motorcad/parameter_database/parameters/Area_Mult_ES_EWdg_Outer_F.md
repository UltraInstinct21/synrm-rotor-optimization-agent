...
parameter_name: Area_Mult_ES_EWdg_Outer_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EWdg_Outer_F
- Area Mult ES E Wdg Outer F
- area_mult_es_e_wdg_outer_f
- areaMultEsEWdgOuterF
- area_mult_es_ewdg_outer_f
related_parameters:
...
## Summary
Area multiplier for the End-Winding Outer [Rear] surfaces for End Space Cooling
