...
parameter_name: EndPointTempLimit_Magnet
category: Transient
input_output: i/p
data_type: double
units: °C
...
aliases:
- EndPointTempLimit_Magnet
- End Point Temp Limit Magnet
- end_point_temp_limit_magnet
- endPointTempLimitMagnet
- endpointtemplimit_magnet
related_parameters:
...
## Summary
The maximum allowed temperature of the magnet when the transient end point definition is set to temperature limit
