...
parameter_name: SyncLinerAreaCalculation
...
aliases:
- SyncLinerAreaCalculation
- Sync Liner Area Calculation
- sync_liner_area_calculation
- syncLinerAreaCalculation
- synclinerareacalculation
related_parameters:
...
## Summary
Method to use for the sync rotor liner area calculation.
