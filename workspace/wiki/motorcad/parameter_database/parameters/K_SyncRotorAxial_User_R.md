...
parameter_name: K_SyncRotorAxial_User_R
...
aliases:
- K_SyncRotorAxial_User_R
- K Sync Rotor Axial User R
- k_sync_rotor_axial_user_r
- kSyncRotorAxialUserR
- k_syncrotoraxial_user_r
related_parameters:
...
## Summary
This is the user input thermal conductivity of the sync field winding [rear] in the axial direction
