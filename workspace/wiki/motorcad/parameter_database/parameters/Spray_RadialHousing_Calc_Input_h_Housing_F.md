...
parameter_name: Spray_RadialHousing_Calc_Input_h_Housing_F
...
aliases:
- Spray_RadialHousing_Calc_Input_h_Housing_F
- Spray Radial Housing Calc Input h Housing F
- spray_radial_housing_calc_input_h_housing_f
- sprayRadialHousingCalcInputHHousingF
- spray_radialhousing_calc_input_h_housing_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the front housing surface is calculated or user input  (0=Calc h, 1=Input h)
