...
parameter_name: Vel_Outlet_Stator_EWdg_Cont_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_Outlet_Stator_EWdg_Cont_Exp_Downstream
- Vel Outlet Stator E Wdg Cont Exp Downstream
- vel_outlet_stator_e_wdg_cont_exp_downstream
- velOutletStatorEWdgContExpDownstream
- vel_outlet_stator_ewdg_cont_exp_downstream
related_parameters:
...
## Summary
Velocity Outlet Stator EWdg Contraction Expansion Downstream
