...
parameter_name: Spray_AxialEndcap_Dissipation_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Dissipation_RotorCore_R
- Spray Axial Endcap Dissipation Rotor Core R
- spray_axial_endcap_dissipation_rotor_core_r
- sprayAxialEndcapDissipationRotorCoreR
- spray_axialendcap_dissipation_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the rear rotor core surface
