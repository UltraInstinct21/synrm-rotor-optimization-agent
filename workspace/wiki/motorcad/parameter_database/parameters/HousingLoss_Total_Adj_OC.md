...
parameter_name: HousingLoss_Total_Adj_OC
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- HousingLoss_Total_Adj_OC
- Housing Loss Total Adj OC
- housing_loss_total_adj_oc
- housingLossTotalAdjOc
- housingloss_total_adj_oc
related_parameters:
...
- '[[motorcad/parameter_database/parameters/HousingLoss_Eddy_OC|HousingLoss_Eddy_OC]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Housing losses adjusted to take into account build factor
