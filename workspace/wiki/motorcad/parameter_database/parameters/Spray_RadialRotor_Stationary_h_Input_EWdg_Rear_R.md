...
parameter_name: Spray_RadialRotor_Stationary_h_Input_EWdg_Rear_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_EWdg_Rear_R
- Spray Radial Rotor Stationary h Input E Wdg Rear R
- spray_radial_rotor_stationary_h_input_e_wdg_rear_r
- sprayRadialRotorStationaryHInputEWdgRearR
- spray_radialrotor_stationary_h_input_ewdg_rear_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the rear endwinding rear surface
