...
parameter_name: Duty_Cycle_Windage_Loss_Ext_Fan
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Windage Loss Ext Fan
- duty_cycle_windage_loss_ext_fan
- dutyCycleWindageLossExtFan
related_parameters:
...
## Summary
Exterior fan windage loss for each period of the duty cycle
