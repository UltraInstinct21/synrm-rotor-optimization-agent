...
parameter_name: Area_ES_ExtShaftEnd_F
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_ExtShaftEnd_F
- Area ES Ext Shaft End F
- area_es_ext_shaft_end_f
- areaEsExtShaftEndF
- area_es_extshaftend_f
related_parameters:
...
## Summary
End Space Cooling - area for shaft extension end [front]
