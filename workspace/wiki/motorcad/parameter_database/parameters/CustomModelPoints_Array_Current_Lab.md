...
parameter_name: CustomModelPoints_Array_Current_Lab
...
aliases:
- CustomModelPoints_Array_Current_Lab
- Custom Model Points Array Current Lab
- custom_model_points_array_current_lab
- customModelPointsArrayCurrentLab
- custommodelpoints_array_current_lab
related_parameters:
...
## Summary
Array of stator current peak points for custom resolution of Lab model build
