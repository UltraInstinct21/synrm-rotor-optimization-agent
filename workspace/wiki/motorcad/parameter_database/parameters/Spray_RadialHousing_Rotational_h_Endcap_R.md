...
parameter_name: Spray_RadialHousing_Rotational_h_Endcap_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Endcap_R
- Spray Radial Housing Rotational h Endcap R
- spray_radial_housing_rotational_h_endcap_r
- sprayRadialHousingRotationalHEndcapR
- spray_radialhousing_rotational_h_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rotational htc over the rear endcap surface
