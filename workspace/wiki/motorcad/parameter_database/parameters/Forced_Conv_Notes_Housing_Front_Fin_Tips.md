...
parameter_name: Forced_Conv_Notes_Housing_Front_Fin_Tips
...
aliases:
- Forced_Conv_Notes_Housing_Front_Fin_Tips
- Forced Conv Notes Housing Front Fin Tips
- forced_conv_notes_housing_front_fin_tips
- forcedConvNotesHousingFrontFinTips
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of active housing section (fin tip section) available for cooling to ambient
