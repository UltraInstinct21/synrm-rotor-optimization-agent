...
parameter_name: MechanicalMeshLength_DamperBars
...
aliases:
- MechanicalMeshLength_DamperBars
- Mechanical Mesh Length Damper Bars
- mechanical_mesh_length_damper_bars
- mechanicalMeshLengthDamperBars
- mechanicalmeshlength_damperbars
related_parameters:
...
- '[[motorcad/parameter_database/parameters/MechanicalMeshLength_RotorVoids|MechanicalMeshLength_RotorVoids]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This specifies the size of mesh elements around the damper bars. Default = 0.1, 0 = automatic
