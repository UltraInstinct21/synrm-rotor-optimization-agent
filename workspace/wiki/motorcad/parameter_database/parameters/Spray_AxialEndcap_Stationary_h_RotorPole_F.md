...
parameter_name: Spray_AxialEndcap_Stationary_h_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_RotorPole_F
- Spray Axial Endcap Stationary h Rotor Pole F
- spray_axial_endcap_stationary_h_rotor_pole_f
- sprayAxialEndcapStationaryHRotorPoleF
- spray_axialendcap_stationary_h_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the front rotor pole surface
