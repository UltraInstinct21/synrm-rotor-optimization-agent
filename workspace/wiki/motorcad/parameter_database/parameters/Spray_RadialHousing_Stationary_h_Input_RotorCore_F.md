...
parameter_name: Spray_RadialHousing_Stationary_h_Input_RotorCore_F
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_RotorCore_F
- Spray Radial Housing Stationary h Input Rotor Core F
- spray_radial_housing_stationary_h_input_rotor_core_f
- sprayRadialHousingStationaryHInputRotorCoreF
- spray_radialhousing_stationary_h_input_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the front rotor core surface
