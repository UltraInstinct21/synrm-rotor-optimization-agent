...
parameter_name: PlateLength_Upper_Housing_A
...
aliases:
- PlateLength_Upper_Housing_A
- Plate Length Upper Housing A
- plate_length_upper_housing_a
- plateLengthUpperHousingA
- platelength_upper_housing_a
related_parameters:
...
- '[[motorcad/parameter_database/parameters/PlateLength_Lower_Endcap_F|PlateLength_Lower_Endcap_F]]'
- '[[motorcad/parameter_database/parameters/PlateLength_Lower_Endcap_R|PlateLength_Lower_Endcap_R]]'
- '[[motorcad/parameter_database/parameters/PlateLength_Lower_Housing_F|PlateLength_Lower_Housing_F]]'
- '[[motorcad/parameter_database/parameters/PlateLength_Lower_Housing_A|PlateLength_Lower_Housing_A]]'
- '[[motorcad/parameter_database/parameters/PlateLength_Lower_Housing_R|PlateLength_Lower_Housing_R]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The spray cooling upper plate length for the active housing
