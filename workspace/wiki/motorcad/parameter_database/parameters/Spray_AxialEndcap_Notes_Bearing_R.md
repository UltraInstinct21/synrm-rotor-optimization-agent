...
parameter_name: Spray_AxialEndcap_Notes_Bearing_R
...
aliases:
- Spray_AxialEndcap_Notes_Bearing_R
- Spray Axial Endcap Notes Bearing R
- spray_axial_endcap_notes_bearing_r
- sprayAxialEndcapNotesBearingR
- spray_axialendcap_notes_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) notes for rear bearing surface
