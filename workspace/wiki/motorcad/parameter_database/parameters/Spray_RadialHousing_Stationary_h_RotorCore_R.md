...
parameter_name: Spray_RadialHousing_Stationary_h_RotorCore_R
...
aliases:
- Spray_RadialHousing_Stationary_h_RotorCore_R
- Spray Radial Housing Stationary h Rotor Core R
- spray_radial_housing_stationary_h_rotor_core_r
- sprayRadialHousingStationaryHRotorCoreR
- spray_radialhousing_stationary_h_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc over the rear rotor core surface
