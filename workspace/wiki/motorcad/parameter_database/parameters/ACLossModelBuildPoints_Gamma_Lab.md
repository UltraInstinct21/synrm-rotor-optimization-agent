...
parameter_name: ACLossModelBuildPoints_Gamma_Lab
...
aliases:
- ACLossModelBuildPoints_Gamma_Lab
- AC Loss Model Build Points Gamma Lab
- ac_loss_model_build_points_gamma_lab
- acLossModelBuildPointsGammaLab
- aclossmodelbuildpoints_gamma_lab
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ACLossModelBuildPoints_Current_Lab|ACLossModelBuildPoints_Current_Lab]]'
- '[[motorcad/parameter_database/parameters/ACLossModelBuildPoints_Speed_Lab|ACLossModelBuildPoints_Speed_Lab]]'
- '[[motorcad/parameter_database/parameters/ACLossModelBuildPoints_Lab|ACLossModelBuildPoints_Lab]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Number of phase advance points in Lab full FEA AC loss model build
