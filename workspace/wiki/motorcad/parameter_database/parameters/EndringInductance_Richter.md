...
parameter_name: EndringInductance_Richter
category: Magnetics
input_output: o/p
data_type: double
units: Henry
...
aliases:
- EndringInductance_Richter
- Endring Inductance Richter
- endring_inductance_richter
- endringInductanceRichter
- endringinductance_richter
related_parameters:
...
- '[[motorcad/parameter_database/parameters/EndringInductance_LiwschitzGarick|EndringInductance_LiwschitzGarick]]'
...
## Summary
End ring inductance using Richter method
