...
parameter_name: Spray_RadialHousing_Stationary_h_Input_Bearing_F
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_Bearing_F
- Spray Radial Housing Stationary h Input Bearing F
- spray_radial_housing_stationary_h_input_bearing_f
- sprayRadialHousingStationaryHInputBearingF
- spray_radialhousing_stationary_h_input_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the front bearing surface
