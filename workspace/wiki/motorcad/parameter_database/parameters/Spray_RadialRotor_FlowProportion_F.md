...
parameter_name: Spray_RadialRotor_FlowProportion_F
...
aliases:
- Spray_RadialRotor_FlowProportion_F
- Spray Radial Rotor Flow Proportion F
- spray_radial_rotor_flow_proportion_f
- sprayRadialRotorFlowProportionF
- spray_radialrotor_flowproportion_f
related_parameters:
...
## Summary
Front Spray Cooling (Radial from Rotor) fluid flow proportion
