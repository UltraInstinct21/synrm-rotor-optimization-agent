...
parameter_name: Spray_RadialRotor_Rotational_h_Input_Endcap_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_Endcap_R
- Spray Radial Rotor Rotational h Input Endcap R
- spray_radial_rotor_rotational_h_input_endcap_r
- sprayRadialRotorRotationalHInputEndcapR
- spray_radialrotor_rotational_h_input_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the rear endcap surface
