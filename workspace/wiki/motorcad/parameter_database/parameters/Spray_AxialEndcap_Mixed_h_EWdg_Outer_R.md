...
parameter_name: Spray_AxialEndcap_Mixed_h_EWdg_Outer_R
...
aliases:
- Spray_AxialEndcap_Mixed_h_EWdg_Outer_R
- Spray Axial Endcap Mixed h E Wdg Outer R
- spray_axial_endcap_mixed_h_e_wdg_outer_r
- sprayAxialEndcapMixedHEWdgOuterR
- spray_axialendcap_mixed_h_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the rear endwinding outer surface
