...
parameter_name: Vel_ES_EndRing_ExtBore_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_ExtBore_F_Calc
- Vel ES End Ring Ext Bore F Calc
- vel_es_end_ring_ext_bore_f_calc
- velEsEndRingExtBoreFCalc
- vel_es_endring_extbore_f_calc
related_parameters:
...
## Summary
The calculated velocity over the end ring ExtBore surface [front]
