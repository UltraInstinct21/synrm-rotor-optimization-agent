...
parameter_name: h_Adjust_TVent_EndRing_End_F
...
aliases:
- h_Adjust_TVent_EndRing_End_F
- h Adjust T Vent End Ring End F
- h_adjust_t_vent_end_ring_end_f
- hAdjustTVentEndRingEndF
- h_adjust_tvent_endring_end_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the end ring End surface [front]
