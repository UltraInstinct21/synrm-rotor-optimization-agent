...
parameter_name: h_Input_TVent_EndRing_ExtOuter_F
...
aliases:
- h_Input_TVent_EndRing_ExtOuter_F
- h Input T Vent End Ring Ext Outer F
- h_input_t_vent_end_ring_ext_outer_f
- hInputTVentEndRingExtOuterF
- h_input_tvent_endring_extouter_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the end ring ExtOuter surface [front]
