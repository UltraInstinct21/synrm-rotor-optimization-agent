...
parameter_name: BMax_RotorBackIron_Analytic
category: Magnetics
input_output: o/p
data_type: double
units: Tesla
...
aliases:
- BMax_RotorBackIron_Analytic
- B Max Rotor Back Iron Analytic
- b_max_rotor_back_iron_analytic
- bMaxRotorBackIronAnalytic
- bmax_rotorbackiron_analytic
related_parameters:
...
- '[[motorcad/parameter_database/parameters/BMax_Airgap|BMax_Airgap]]'
- '[[motorcad/parameter_database/parameters/BMax_StatorTooth|BMax_StatorTooth]]'
- '[[motorcad/parameter_database/parameters/BMax_StatorTooth_PerSlice|BMax_StatorTooth_PerSlice]]'
- '[[motorcad/parameter_database/parameters/BMax_RotorTooth|BMax_RotorTooth]]'
- '[[motorcad/parameter_database/parameters/BMax_StatorBackIron|BMax_StatorBackIron]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Maximum flux density at midpoint in the rotor back iron (from analytic solution)
