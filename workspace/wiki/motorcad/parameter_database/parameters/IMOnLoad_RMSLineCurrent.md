...
parameter_name: IMOnLoad_RMSLineCurrent
category: Magnetics
input_output: o/p
data_type: double
units: Amps
...
aliases:
- IMOnLoad_RMSLineCurrent
- IM On Load RMS Line Current
- im_on_load_rms_line_current
- imOnLoadRmsLineCurrent
- imonload_rmslinecurrent
related_parameters:
...
## Summary
The on load rms stator line current
