...
parameter_name: Spray_AxialEndcap_Rt_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Rt_RotorPole_R
- Spray Axial Endcap Rt Rotor Pole R
- spray_axial_endcap_rt_rotor_pole_r
- sprayAxialEndcapRtRotorPoleR
- spray_axialendcap_rt_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to rear rotor pole surface convective thermal resistance
