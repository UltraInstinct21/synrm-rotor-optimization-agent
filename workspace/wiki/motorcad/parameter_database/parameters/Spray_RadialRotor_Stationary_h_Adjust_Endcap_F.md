...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_Endcap_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_Endcap_F
- Spray Radial Rotor Stationary h Adjust Endcap F
- spray_radial_rotor_stationary_h_adjust_endcap_f
- sprayRadialRotorStationaryHAdjustEndcapF
- spray_radialrotor_stationary_h_adjust_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the front endcap surface
