...
parameter_name: Spray_RadialHousing_Rt_Endcap_R
...
aliases:
- Spray_RadialHousing_Rt_Endcap_R
- Spray Radial Housing Rt Endcap R
- spray_radial_housing_rt_endcap_r
- sprayRadialHousingRtEndcapR
- spray_radialhousing_rt_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) fluid to rear endcap surface convective thermal resistance
