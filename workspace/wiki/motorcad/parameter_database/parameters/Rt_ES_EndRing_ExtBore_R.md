...
parameter_name: Rt_ES_EndRing_ExtBore_R
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_EndRing_ExtBore_R
- Rt ES End Ring Ext Bore R
- rt_es_end_ring_ext_bore_r
- rtEsEndRingExtBoreR
- rt_es_endring_extbore_r
related_parameters:
...
## Summary
The thermal resistance end ring Ext Bore surface [rear]
