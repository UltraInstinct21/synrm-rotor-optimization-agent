...
parameter_name: Area_Mult_ES_RotorEwdg_Inner_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_RotorEwdg_Inner_R
- Area Mult ES Rotor Ewdg Inner R
- area_mult_es_rotor_ewdg_inner_r
- areaMultEsRotorEwdgInnerR
- area_mult_es_rotorewdg_inner_r
related_parameters:
...
## Summary
Area multiplier for the Rotor End-Winding Inner [Rear] surface for End Space Cooling
