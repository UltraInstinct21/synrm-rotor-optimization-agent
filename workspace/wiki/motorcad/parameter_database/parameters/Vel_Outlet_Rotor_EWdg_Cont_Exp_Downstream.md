...
parameter_name: Vel_Outlet_Rotor_EWdg_Cont_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_Outlet_Rotor_EWdg_Cont_Exp_Downstream
- Vel Outlet Rotor E Wdg Cont Exp Downstream
- vel_outlet_rotor_e_wdg_cont_exp_downstream
- velOutletRotorEWdgContExpDownstream
- vel_outlet_rotor_ewdg_cont_exp_downstream
related_parameters:
...
## Summary
Velocity Outlet Rotor EWdg Contraction Expansion Downstream
