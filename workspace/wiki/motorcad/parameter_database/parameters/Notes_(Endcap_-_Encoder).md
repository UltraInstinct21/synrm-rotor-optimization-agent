...
parameter_name: Notes_(Endcap_-_Encoder)
...
aliases:
- Notes_(Endcap_-_Encoder)
- Notes Endcap Encoder
- notes_endcap_encoder
- notesEndcapEncoder
- notes_(endcap_-_encoder)
related_parameters:
...
## Summary
Notes - Interface gap between endcap and encoder case
