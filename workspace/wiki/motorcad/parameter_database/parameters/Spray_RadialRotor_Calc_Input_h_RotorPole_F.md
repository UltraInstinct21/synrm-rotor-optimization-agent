...
parameter_name: Spray_RadialRotor_Calc_Input_h_RotorPole_F
...
aliases:
- Spray_RadialRotor_Calc_Input_h_RotorPole_F
- Spray Radial Rotor Calc Input h Rotor Pole F
- spray_radial_rotor_calc_input_h_rotor_pole_f
- sprayRadialRotorCalcInputHRotorPoleF
- spray_radialrotor_calc_input_h_rotorpole_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the front rotor pole surface is calculated or user input  (0=Calc h, 1=Input h)
