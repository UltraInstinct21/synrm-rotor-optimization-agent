...
parameter_name: Spray_AxialEndcap_Rt_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_Rt_EWdg_Inner_R
- Spray Axial Endcap Rt E Wdg Inner R
- spray_axial_endcap_rt_e_wdg_inner_r
- sprayAxialEndcapRtEWdgInnerR
- spray_axialendcap_rt_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to rear endwinding inner surface convective thermal resistance
