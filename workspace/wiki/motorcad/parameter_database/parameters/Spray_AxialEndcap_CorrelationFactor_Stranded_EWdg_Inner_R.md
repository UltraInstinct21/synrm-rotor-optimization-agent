...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Stranded_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Stranded_EWdg_Inner_R
- Spray Axial Endcap Correlation Factor Stranded E Wdg Inner R
- spray_axial_endcap_correlation_factor_stranded_e_wdg_inner_r
- sprayAxialEndcapCorrelationFactorStrandedEWdgInnerR
- spray_axialendcap_correlationfactor_stranded_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the stranded rear endwinding inner surface
