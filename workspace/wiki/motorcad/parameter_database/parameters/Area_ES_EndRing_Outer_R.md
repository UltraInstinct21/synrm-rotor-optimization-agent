...
parameter_name: Area_ES_EndRing_Outer_R
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_EndRing_Outer_R
- Area ES End Ring Outer R
- area_es_end_ring_outer_r
- areaEsEndRingOuterR
- area_es_endring_outer_r
related_parameters:
...
## Summary
The area of the end ring Outer surface [rear]
