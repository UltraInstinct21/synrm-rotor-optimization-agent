...
parameter_name: Spray_RadialRotor_Mixed_h_Bearing_R
...
aliases:
- Spray_RadialRotor_Mixed_h_Bearing_R
- Spray Radial Rotor Mixed h Bearing R
- spray_radial_rotor_mixed_h_bearing_r
- sprayRadialRotorMixedHBearingR
- spray_radialrotor_mixed_h_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the rear bearing surface
