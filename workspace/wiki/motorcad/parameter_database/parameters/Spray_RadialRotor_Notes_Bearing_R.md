...
parameter_name: Spray_RadialRotor_Notes_Bearing_R
...
aliases:
- Spray_RadialRotor_Notes_Bearing_R
- Spray Radial Rotor Notes Bearing R
- spray_radial_rotor_notes_bearing_r
- sprayRadialRotorNotesBearingR
- spray_radialrotor_notes_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) notes for rear bearing surface
