...
parameter_name: TVent_htc_Recalc
...
## Summary
The calculation method for whether the Through Ventilated velocities and htc values should be recalculated while solving the thermal circuit
