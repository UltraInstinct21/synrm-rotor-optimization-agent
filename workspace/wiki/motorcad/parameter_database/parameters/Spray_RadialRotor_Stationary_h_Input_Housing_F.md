...
parameter_name: Spray_RadialRotor_Stationary_h_Input_Housing_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_Housing_F
- Spray Radial Rotor Stationary h Input Housing F
- spray_radial_rotor_stationary_h_input_housing_f
- sprayRadialRotorStationaryHInputHousingF
- spray_radialrotor_stationary_h_input_housing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the front housing surface
