...
parameter_name: IMLockedRotor_Power_Input
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- IMLockedRotor_Power_Input
- IM Locked Rotor Power Input
- im_locked_rotor_power_input
- imLockedRotorPowerInput
- imlockedrotor_power_input
related_parameters:
