...
parameter_name: Spray_RadialHousing_Stationary_h_Adjust_RotorPole_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Adjust_RotorPole_R
- Spray Radial Housing Stationary h Adjust Rotor Pole R
- spray_radial_housing_stationary_h_adjust_rotor_pole_r
- sprayRadialHousingStationaryHAdjustRotorPoleR
- spray_radialhousing_stationary_h_adjust_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc adjustment over the rear rotor pole surface
