...
parameter_name: Flow_Area_Outlet_Rotor_EWdg_Cont_Exp_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Rotor_EWdg_Cont_Exp_Upstream
- Flow Area Outlet Rotor E Wdg Cont Exp Upstream
- flow_area_outlet_rotor_e_wdg_cont_exp_upstream
- flowAreaOutletRotorEWdgContExpUpstream
- flow_area_outlet_rotor_ewdg_cont_exp_upstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Rotor EWdg Contraction Expansion Upstream
