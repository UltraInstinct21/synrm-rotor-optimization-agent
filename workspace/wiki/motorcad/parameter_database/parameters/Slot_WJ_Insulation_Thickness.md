...
parameter_name: Slot_WJ_Insulation_Thickness
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- Slot_WJ_Insulation_Thickness
- Slot WJ Insulation Thickness
- slot_wj_insulation_thickness
- slotWjInsulationThickness
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Slot_WJ_Duct_Parallel_Paths|Slot_WJ_Duct_Parallel_Paths]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
slot water jacket insulation thickness - between duct and winding
