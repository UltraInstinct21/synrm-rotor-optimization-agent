...
parameter_name: Velocity_Multiplier_h[WJ]_Front_Endcap
...
aliases:
- Velocity_Multiplier_h[WJ]_Front_Endcap
- Velocity_Multiplier_h(WJ)_Front_Endcap
- Velocity Multiplier h WJ Front Endcap
- velocity_multiplier_h_wj_front_endcap
- velocityMultiplierHWjFrontEndcap
- velocity_multiplier_h[wj]_front_endcap
related_parameters:
...
## Summary
Motor-CAD automation parameter `Velocity_Multiplier_h[WJ]_Front_Endcap` in category `Water_Jacket_Data`.
