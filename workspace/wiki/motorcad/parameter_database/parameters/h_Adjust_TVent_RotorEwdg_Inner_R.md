...
parameter_name: h_Adjust_TVent_RotorEwdg_Inner_R
...
aliases:
- h_Adjust_TVent_RotorEwdg_Inner_R
- h Adjust T Vent Rotor Ewdg Inner R
- h_adjust_t_vent_rotor_ewdg_inner_r
- hAdjustTVentRotorEwdgInnerR
- h_adjust_tvent_rotorewdg_inner_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the EWdg Inner surface [rear]
