...
parameter_name: Spray_RadialHousing_Stationary_h_Endcap_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Endcap_R
- Spray Radial Housing Stationary h Endcap R
- spray_radial_housing_stationary_h_endcap_r
- sprayRadialHousingStationaryHEndcapR
- spray_radialhousing_stationary_h_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc over the rear endcap surface
