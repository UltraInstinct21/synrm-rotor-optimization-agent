...
parameter_name: Spray_RadialRotor_Rotational_h_Input_Housing_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_Housing_F
- Spray Radial Rotor Rotational h Input Housing F
- spray_radial_rotor_rotational_h_input_housing_f
- sprayRadialRotorRotationalHInputHousingF
- spray_radialrotor_rotational_h_input_housing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the front housing surface
