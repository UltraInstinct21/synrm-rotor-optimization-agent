...
parameter_name: Notes_TVent_EndRing_Outer_F
...
aliases:
- Notes_TVent_EndRing_Outer_F
- Notes T Vent End Ring Outer F
- notes_t_vent_end_ring_outer_f
- notesTVentEndRingOuterF
- notes_tvent_endring_outer_f
related_parameters:
...
## Summary
The TVent notes for the end ring Outer surface [front]
