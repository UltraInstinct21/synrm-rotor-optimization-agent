...
parameter_name: h_TVent_Axial_EndRing_Outer_F
...
aliases:
- h_TVent_Axial_EndRing_Outer_F
- h T Vent Axial End Ring Outer F
- h_t_vent_axial_end_ring_outer_f
- hTVentAxialEndRingOuterF
- h_tvent_axial_endring_outer_f
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the end ring Outer surface [front]
