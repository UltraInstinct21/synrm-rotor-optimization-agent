...
parameter_name: h_Adjust_TVent_EndRing_ExtBore_R
...
aliases:
- h_Adjust_TVent_EndRing_ExtBore_R
- h Adjust T Vent End Ring Ext Bore R
- h_adjust_t_vent_end_ring_ext_bore_r
- hAdjustTVentEndRingExtBoreR
- h_adjust_tvent_endring_extbore_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the end ring ExtBore surface [rear]
