...
parameter_name: Spray_AxialEndcap_Notes_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Notes_RotorCore_R
- Spray Axial Endcap Notes Rotor Core R
- spray_axial_endcap_notes_rotor_core_r
- sprayAxialEndcapNotesRotorCoreR
- spray_axialendcap_notes_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) notes for rear rotor core surface
