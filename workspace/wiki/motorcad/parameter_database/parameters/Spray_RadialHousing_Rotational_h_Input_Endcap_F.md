...
parameter_name: Spray_RadialHousing_Rotational_h_Input_Endcap_F
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_Endcap_F
- Spray Radial Housing Rotational h Input Endcap F
- spray_radial_housing_rotational_h_input_endcap_f
- sprayRadialHousingRotationalHInputEndcapF
- spray_radialhousing_rotational_h_input_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the front endcap surface
