...
parameter_name: Spray_RadialHousing_Rotational_h_Input_RotorPole_F
...
- Spray Radial Housing Rotational h Input Rotor Pole F
- spray_radial_housing_rotational_h_input_rotor_pole_f
- sprayRadialHousingRotationalHInputRotorPoleF
- spray_radialhousing_rotational_h_input_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the front rotor pole surface
