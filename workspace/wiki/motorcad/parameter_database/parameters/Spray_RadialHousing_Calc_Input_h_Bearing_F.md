...
parameter_name: Spray_RadialHousing_Calc_Input_h_Bearing_F
...
aliases:
- Spray_RadialHousing_Calc_Input_h_Bearing_F
- Spray Radial Housing Calc Input h Bearing F
- spray_radial_housing_calc_input_h_bearing_f
- sprayRadialHousingCalcInputHBearingF
- spray_radialhousing_calc_input_h_bearing_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the front bearing surface is calculated or user input  (0=Calc h, 1=Input h)
