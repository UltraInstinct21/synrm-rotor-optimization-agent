...
parameter_name: Spray_AxialEndcap_Dissipation_EWdg_Inner_F
...
aliases:
- Spray_AxialEndcap_Dissipation_EWdg_Inner_F
- Spray Axial Endcap Dissipation E Wdg Inner F
- spray_axial_endcap_dissipation_e_wdg_inner_f
- sprayAxialEndcapDissipationEWdgInnerF
- spray_axialendcap_dissipation_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the front endwinding inner surface
