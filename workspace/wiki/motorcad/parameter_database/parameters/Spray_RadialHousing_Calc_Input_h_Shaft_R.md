...
parameter_name: Spray_RadialHousing_Calc_Input_h_Shaft_R
...
aliases:
- Spray_RadialHousing_Calc_Input_h_Shaft_R
- Spray Radial Housing Calc Input h Shaft R
- spray_radial_housing_calc_input_h_shaft_r
- sprayRadialHousingCalcInputHShaftR
- spray_radialhousing_calc_input_h_shaft_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the rear shaft surface is calculated or user input  (0=Calc h, 1=Input h)
