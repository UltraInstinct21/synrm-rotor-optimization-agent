...
parameter_name: Spray_RadialRotor_Area_RotorCore_R
...
aliases:
- Spray_RadialRotor_Area_RotorCore_R
- Spray Radial Rotor Area Rotor Core R
- spray_radial_rotor_area_rotor_core_r
- sprayRadialRotorAreaRotorCoreR
- spray_radialrotor_area_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear rotor core surface sprayed area
