...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Stranded_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Stranded_EWdg_Outer_F
- Spray Axial Endcap Correlation Factor Stranded E Wdg Outer F
- spray_axial_endcap_correlation_factor_stranded_e_wdg_outer_f
- sprayAxialEndcapCorrelationFactorStrandedEWdgOuterF
- spray_axialendcap_correlationfactor_stranded_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the stranded front endwinding outer surface
