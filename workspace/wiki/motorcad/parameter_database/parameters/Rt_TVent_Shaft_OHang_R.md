...
parameter_name: Rt_TVent_Shaft_OHang_R
category: TVent_Data
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_TVent_Shaft_OHang_R
- Rt T Vent Shaft O Hang R
- rt_t_vent_shaft_o_hang_r
- rtTVentShaftOHangR
- rt_tvent_shaft_ohang_r
related_parameters:
...
## Summary
Motor-CAD automation parameter `Rt_TVent_Shaft_OHang_R` in category `TVent_Data`.
