...
parameter_name: NozzleDistance_Calc_RotorCore_R
...
aliases:
- NozzleDistance_Calc_RotorCore_R
- Nozzle Distance Calc Rotor Core R
- nozzle_distance_calc_rotor_core_r
- nozzleDistanceCalcRotorCoreR
- nozzledistance_calc_rotorcore_r
related_parameters:
...
## Summary
This is the calculated distance of nozzle to Rear Rotor Core
