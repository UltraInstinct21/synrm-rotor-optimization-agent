...
parameter_name: Spray_RadialRotor_Notes_RotorCore_R
...
aliases:
- Spray_RadialRotor_Notes_RotorCore_R
- Spray Radial Rotor Notes Rotor Core R
- spray_radial_rotor_notes_rotor_core_r
- sprayRadialRotorNotesRotorCoreR
- spray_radialrotor_notes_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) notes for rear rotor core surface
