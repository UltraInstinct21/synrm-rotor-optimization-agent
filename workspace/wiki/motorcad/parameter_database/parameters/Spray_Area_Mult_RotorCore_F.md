...
parameter_name: Spray_Area_Mult_RotorCore_F
...
aliases:
- Spray_Area_Mult_RotorCore_F
- Spray Area Mult Rotor Core F
- spray_area_mult_rotor_core_f
- sprayAreaMultRotorCoreF
- spray_area_mult_rotorcore_f
related_parameters:
...
## Summary
Area multiplier for the Rotor Core Front section subjected to Spray Cooling
