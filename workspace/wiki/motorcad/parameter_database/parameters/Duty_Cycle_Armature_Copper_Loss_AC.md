...
parameter_name: Duty_Cycle_Armature_Copper_Loss_AC
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Armature Copper Loss AC
- duty_cycle_armature_copper_loss_ac
- dutyCycleArmatureCopperLossAc
related_parameters:
...
## Summary
AC copper loss in the armature winding for each period of the duty cycle
