...
parameter_name: Material_Weight_Notes_LitzImpreg_R
...
aliases:
- Material_Weight_Notes_LitzImpreg_R
- Material Weight Notes Litz Impreg R
- material_weight_notes_litz_impreg_r
- materialWeightNotesLitzImpregR
- material_weight_notes_litzimpreg_r
related_parameters:
...
## Summary
The material notes of the Litz Bundle Impregnation Material (Rear)
