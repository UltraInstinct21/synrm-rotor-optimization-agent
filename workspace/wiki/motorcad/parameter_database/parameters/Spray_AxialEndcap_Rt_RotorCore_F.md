...
parameter_name: Spray_AxialEndcap_Rt_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Rt_RotorCore_F
- Spray Axial Endcap Rt Rotor Core F
- spray_axial_endcap_rt_rotor_core_f
- sprayAxialEndcapRtRotorCoreF
- spray_axialendcap_rt_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to front rotor core surface convective thermal resistance
