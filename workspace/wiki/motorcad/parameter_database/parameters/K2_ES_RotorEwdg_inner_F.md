...
parameter_name: K2_ES_RotorEwdg_inner_F
category: End_Space
input_output: i/p
data_type: double
units: N/A
...
aliases:
- K2_ES_RotorEwdg_inner_F
- K2 ES Rotor Ewdg inner F
- k2_es_rotor_ewdg_inner_f
- k2EsRotorEwdgInnerF
- k2_es_rotorewdg_inner_f
related_parameters:
...
## Summary
The k2 constant for end wdg inner surface [front]
