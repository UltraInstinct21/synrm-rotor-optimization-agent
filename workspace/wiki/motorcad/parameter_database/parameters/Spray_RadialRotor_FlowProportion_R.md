...
parameter_name: Spray_RadialRotor_FlowProportion_R
...
aliases:
- Spray_RadialRotor_FlowProportion_R
- Spray Radial Rotor Flow Proportion R
- spray_radial_rotor_flow_proportion_r
- sprayRadialRotorFlowProportionR
- spray_radialrotor_flowproportion_r
related_parameters:
...
## Summary
Rear Spray Cooling (Radial from Rotor) fluid flow proportion
