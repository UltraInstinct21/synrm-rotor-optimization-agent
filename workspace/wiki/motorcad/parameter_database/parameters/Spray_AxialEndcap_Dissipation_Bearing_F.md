...
parameter_name: Spray_AxialEndcap_Dissipation_Bearing_F
...
aliases:
- Spray_AxialEndcap_Dissipation_Bearing_F
- Spray Axial Endcap Dissipation Bearing F
- spray_axial_endcap_dissipation_bearing_f
- sprayAxialEndcapDissipationBearingF
- spray_axialendcap_dissipation_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the front bearing surface
