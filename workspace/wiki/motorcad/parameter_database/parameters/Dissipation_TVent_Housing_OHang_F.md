...
parameter_name: Dissipation_TVent_Housing_OHang_F
category: TVent_Data
input_output: o/p
data_type: double
units: Watts
...
aliases:
- Dissipation_TVent_Housing_OHang_F
- Dissipation T Vent Housing O Hang F
- dissipation_t_vent_housing_o_hang_f
- dissipationTVentHousingOHangF
- dissipation_tvent_housing_ohang_f
related_parameters:
...
## Summary
Motor-CAD automation parameter `Dissipation_TVent_Housing_OHang_F` in category `TVent_Data`.
