...
parameter_name: Spray_RadialHousing_CorrelationFactor_Stranded_EWdg_Outer_F
...
aliases:
- Spray_RadialHousing_CorrelationFactor_Stranded_EWdg_Outer_F
- Spray Radial Housing Correlation Factor Stranded E Wdg Outer F
- spray_radial_housing_correlation_factor_stranded_e_wdg_outer_f
- sprayRadialHousingCorrelationFactorStrandedEWdgOuterF
- spray_radialhousing_correlationfactor_stranded_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the stranded front endwinding outer surface
