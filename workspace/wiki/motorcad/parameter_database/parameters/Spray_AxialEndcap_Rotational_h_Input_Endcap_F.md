...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_Endcap_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_Endcap_F
- Spray Axial Endcap Rotational h Input Endcap F
- spray_axial_endcap_rotational_h_input_endcap_f
- sprayAxialEndcapRotationalHInputEndcapF
- spray_axialendcap_rotational_h_input_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the front endcap surface
