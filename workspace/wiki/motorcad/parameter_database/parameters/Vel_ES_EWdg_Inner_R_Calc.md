...
parameter_name: Vel_ES_EWdg_Inner_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EWdg_Inner_R_Calc
- Vel ES E Wdg Inner R Calc
- vel_es_e_wdg_inner_r_calc
- velEsEWdgInnerRCalc
- vel_es_ewdg_inner_r_calc
related_parameters:
...
## Summary
End Space Cooling -  calculated velocity for EWdg Inner surface [Rear]
