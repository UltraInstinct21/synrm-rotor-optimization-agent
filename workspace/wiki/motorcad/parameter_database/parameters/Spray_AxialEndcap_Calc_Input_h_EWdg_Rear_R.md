...
parameter_name: Spray_AxialEndcap_Calc_Input_h_EWdg_Rear_R
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_EWdg_Rear_R
- Spray Axial Endcap Calc Input h E Wdg Rear R
- spray_axial_endcap_calc_input_h_e_wdg_rear_r
- sprayAxialEndcapCalcInputHEWdgRearR
- spray_axialendcap_calc_input_h_ewdg_rear_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the rear endwinding rear surface is calculated or user input  (0=Calc h, 1=Input h)
