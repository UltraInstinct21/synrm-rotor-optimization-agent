...
parameter_name: TVent_Fluid_Kinematic_Viscosity
category: TVent_Data
input_output: o/p
data_type: double
units: m²/s
...
aliases:
- TVent_Fluid_Kinematic_Viscosity
- T Vent Fluid Kinematic Viscosity
- t_vent_fluid_kinematic_viscosity
- tVentFluidKinematicViscosity
- tvent_fluid_kinematic_viscosity
related_parameters:
...
## Summary
Motor-CAD automation parameter `TVent_Fluid_Kinematic_Viscosity` in category `TVent_Data`.
