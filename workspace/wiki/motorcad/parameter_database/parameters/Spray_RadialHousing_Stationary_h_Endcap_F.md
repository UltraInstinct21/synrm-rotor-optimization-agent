...
parameter_name: Spray_RadialHousing_Stationary_h_Endcap_F
...
aliases:
- Spray_RadialHousing_Stationary_h_Endcap_F
- Spray Radial Housing Stationary h Endcap F
- spray_radial_housing_stationary_h_endcap_f
- sprayRadialHousingStationaryHEndcapF
- spray_radialhousing_stationary_h_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc over the front endcap surface
