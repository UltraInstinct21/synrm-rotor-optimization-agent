...
parameter_name: Notes_Flow_Housing_A
category: EWdg_Spray_Cooling
input_output: i/p
data_type: OleStr
units: N/A
default_value: default = no internal flow (Internal Flow Rate Ratio = 0)
source_file: D:/SRM/Agent/workspace/wiki/raw/ActiveXParameters.xlsx
aliases:
- Notes_Flow_Housing_A
- Notes Flow Housing A
- notes_flow_housing_a
- notesFlowHousingA
related_parameters:
...
## Summary
This is the internal flow notes over active housing
...
- **Units**: N/A
- **Default Value**: default = no internal flow (Internal Flow Rate Ratio = 0)
