...
parameter_name: Spray_AxialEndcap_Notes_Endcap_F
...
aliases:
- Spray_AxialEndcap_Notes_Endcap_F
- Spray Axial Endcap Notes Endcap F
- spray_axial_endcap_notes_endcap_f
- sprayAxialEndcapNotesEndcapF
- spray_axialendcap_notes_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) notes for front endcap surface
