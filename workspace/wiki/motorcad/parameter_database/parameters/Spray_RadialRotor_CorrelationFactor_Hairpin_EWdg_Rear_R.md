...
parameter_name: Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Rear_R
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Rear_R
- Spray Radial Rotor Correlation Factor Hairpin E Wdg Rear R
- spray_radial_rotor_correlation_factor_hairpin_e_wdg_rear_r
- sprayRadialRotorCorrelationFactorHairpinEWdgRearR
- spray_radialrotor_correlationfactor_hairpin_ewdg_rear_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the hairpin rear endwinding rear surface
