...
parameter_name: Spray_RadialRotor_Stationary_h_Input_Endcap_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_Endcap_R
- Spray Radial Rotor Stationary h Input Endcap R
- spray_radial_rotor_stationary_h_input_endcap_r
- sprayRadialRotorStationaryHInputEndcapR
- spray_radialrotor_stationary_h_input_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the rear endcap surface
