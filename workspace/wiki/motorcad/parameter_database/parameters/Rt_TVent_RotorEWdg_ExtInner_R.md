...
parameter_name: Rt_TVent_RotorEWdg_ExtInner_R
...
aliases:
- Rt_TVent_RotorEWdg_ExtInner_R
- Rt T Vent Rotor E Wdg Ext Inner R
- rt_t_vent_rotor_e_wdg_ext_inner_r
- rtTVentRotorEWdgExtInnerR
- rt_tvent_rotorewdg_extinner_r
related_parameters:
...
## Summary
The thermal resistance from the ext inner surface of rear rotor endwinding to the fluid
