...
parameter_name: Spray_RadialRotor_Rotational_h_Input_EWdg_Outer_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_EWdg_Outer_F
- Spray Radial Rotor Rotational h Input E Wdg Outer F
- spray_radial_rotor_rotational_h_input_e_wdg_outer_f
- sprayRadialRotorRotationalHInputEWdgOuterF
- spray_radialrotor_rotational_h_input_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the front endwinding outer surface
