...
parameter_name: Spray_RadialHousing_NozzleDiameter_R
...
aliases:
- Spray_RadialHousing_NozzleDiameter_R
- Spray Radial Housing Nozzle Diameter R
- spray_radial_housing_nozzle_diameter_r
- sprayRadialHousingNozzleDiameterR
- spray_radialhousing_nozzlediameter_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rear nozzle diameter
