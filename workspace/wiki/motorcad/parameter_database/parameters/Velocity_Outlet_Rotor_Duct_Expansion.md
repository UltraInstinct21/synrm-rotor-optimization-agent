...
parameter_name: Velocity_Outlet_Rotor_Duct_Expansion
category: TVent_Data
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Velocity_Outlet_Rotor_Duct_Expansion
- Velocity Outlet Rotor Duct Expansion
- velocity_outlet_rotor_duct_expansion
- velocityOutletRotorDuctExpansion
related_parameters:
