...
parameter_name: ACLossModelBuildPoints_Speed_Lab
...
aliases:
- ACLossModelBuildPoints_Speed_Lab
- AC Loss Model Build Points Speed Lab
- ac_loss_model_build_points_speed_lab
- acLossModelBuildPointsSpeedLab
- aclossmodelbuildpoints_speed_lab
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ACLossModelBuildPoints_Gamma_Lab|ACLossModelBuildPoints_Gamma_Lab]]'
...
## Summary
Number of speed points in Lab full FEA AC loss model build
