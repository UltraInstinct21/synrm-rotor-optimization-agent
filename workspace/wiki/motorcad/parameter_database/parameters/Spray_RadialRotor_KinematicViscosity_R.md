...
parameter_name: Spray_RadialRotor_KinematicViscosity_R
...
aliases:
- Spray_RadialRotor_KinematicViscosity_R
- Spray Radial Rotor Kinematic Viscosity R
- spray_radial_rotor_kinematic_viscosity_r
- sprayRadialRotorKinematicViscosityR
- spray_radialrotor_kinematicviscosity_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) Rear fluid kinematic viscosity
