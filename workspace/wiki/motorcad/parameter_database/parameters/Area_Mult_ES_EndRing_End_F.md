...
parameter_name: Area_Mult_ES_EndRing_End_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_End_F
- Area Mult ES End Ring End F
- area_mult_es_end_ring_end_f
- areaMultEsEndRingEndF
- area_mult_es_endring_end_f
related_parameters:
...
## Summary
Area multiplier for the End Ring End [Front] surface for End Space Cooling
