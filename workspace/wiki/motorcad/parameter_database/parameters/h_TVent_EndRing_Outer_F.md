...
parameter_name: h_TVent_EndRing_Outer_F
...
aliases:
- h_TVent_EndRing_Outer_F
- h T Vent End Ring Outer F
- h_t_vent_end_ring_outer_f
- hTVentEndRingOuterF
- h_tvent_endring_outer_f
related_parameters:
...
## Summary
The TVent heat transfer coefficient over the end ring Outer surface [front]
