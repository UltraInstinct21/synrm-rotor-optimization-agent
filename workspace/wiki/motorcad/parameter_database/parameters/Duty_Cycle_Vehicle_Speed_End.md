...
parameter_name: Duty_Cycle_Vehicle_Speed_End
category: Transient
input_output: i/p
data_type: double
units: km/h
...
- Duty Cycle Vehicle Speed End
- duty_cycle_vehicle_speed_end
- dutyCycleVehicleSpeedEnd
related_parameters:
...
## Summary
Vehicle Speed at the end of each period of the duty cycle
