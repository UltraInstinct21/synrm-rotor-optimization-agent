...
parameter_name: h_Input_TVent_EndRing_ExtInter_F
...
aliases:
- h_Input_TVent_EndRing_ExtInter_F
- h Input T Vent End Ring Ext Inter F
- h_input_t_vent_end_ring_ext_inter_f
- hInputTVentEndRingExtInterF
- h_input_tvent_endring_extinter_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the end ring ExtInter surface [front]
