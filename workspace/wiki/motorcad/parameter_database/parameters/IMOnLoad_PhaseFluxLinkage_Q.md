...
parameter_name: IMOnLoad_PhaseFluxLinkage_Q
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- IMOnLoad_PhaseFluxLinkage_Q
- IM On Load Phase Flux Linkage Q
- im_on_load_phase_flux_linkage_q
- imOnLoadPhaseFluxLinkageQ
- imonload_phasefluxlinkage_q
related_parameters:
...
## Summary
The on load q axis flux linkage per second
