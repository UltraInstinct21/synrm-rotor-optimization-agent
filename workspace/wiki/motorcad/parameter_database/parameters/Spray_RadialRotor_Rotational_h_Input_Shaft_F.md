...
parameter_name: Spray_RadialRotor_Rotational_h_Input_Shaft_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_Shaft_F
- Spray Radial Rotor Rotational h Input Shaft F
- spray_radial_rotor_rotational_h_input_shaft_f
- sprayRadialRotorRotationalHInputShaftF
- spray_radialrotor_rotational_h_input_shaft_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the front shaft surface
