...
parameter_name: Vel_TVent_EndRing_Bore_F
...
aliases:
- Vel_TVent_EndRing_Bore_F
- Vel T Vent End Ring Bore F
- vel_t_vent_end_ring_bore_f
- velTVentEndRingBoreF
- vel_tvent_endring_bore_f
related_parameters:
...
## Summary
The TVent velocity over the end ring bore surface [front]
