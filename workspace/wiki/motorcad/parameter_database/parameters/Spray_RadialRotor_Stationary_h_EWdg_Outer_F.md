...
parameter_name: Spray_RadialRotor_Stationary_h_EWdg_Outer_F
...
aliases:
- Spray_RadialRotor_Stationary_h_EWdg_Outer_F
- Spray Radial Rotor Stationary h E Wdg Outer F
- spray_radial_rotor_stationary_h_e_wdg_outer_f
- sprayRadialRotorStationaryHEWdgOuterF
- spray_radialrotor_stationary_h_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the front endwinding outer surface
