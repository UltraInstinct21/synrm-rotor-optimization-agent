...
parameter_name: TVent_Flow_Area_Stator_Endcap_F
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- TVent_Flow_Area_Stator_Endcap_F
- T Vent Flow Area Stator Endcap F
- t_vent_flow_area_stator_endcap_f
- tVentFlowAreaStatorEndcapF
- tvent_flow_area_stator_endcap_f
related_parameters:
...
## Summary
TVent Flow Area for the Stator Endcap Front
