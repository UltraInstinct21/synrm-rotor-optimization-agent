...
parameter_name: Gap_MaterialConductivity_Plate_Magnet_R
...
aliases:
- Gap_MaterialConductivity_Plate_Magnet_R
- Gap Material Conductivity Plate Magnet R
- gap_material_conductivity_plate_magnet_r
- gapMaterialConductivityPlateMagnetR
- gap_materialconductivity_plate_magnet_r
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Rotor Plate and Magnet [R].
