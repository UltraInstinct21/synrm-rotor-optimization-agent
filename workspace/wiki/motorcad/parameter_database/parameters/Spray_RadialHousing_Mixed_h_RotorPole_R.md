...
parameter_name: Spray_RadialHousing_Mixed_h_RotorPole_R
...
aliases:
- Spray_RadialHousing_Mixed_h_RotorPole_R
- Spray Radial Housing Mixed h Rotor Pole R
- spray_radial_housing_mixed_h_rotor_pole_r
- sprayRadialHousingMixedHRotorPoleR
- spray_radialhousing_mixed_h_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the rear rotor pole surface
