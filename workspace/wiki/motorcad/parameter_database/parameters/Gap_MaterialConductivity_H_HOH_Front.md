...
parameter_name: Gap_MaterialConductivity_H_HOH_Front
...
aliases:
- Gap_MaterialConductivity_H_HOH_Front
- Gap Material Conductivity H HOH Front
- gap_material_conductivity_h_hoh_front
- gapMaterialConductivityHHohFront
- gap_materialconductivity_h_hoh_front
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Housing and Housing OHang [F].
