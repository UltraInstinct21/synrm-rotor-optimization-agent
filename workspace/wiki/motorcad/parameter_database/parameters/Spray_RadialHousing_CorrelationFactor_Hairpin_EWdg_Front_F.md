...
parameter_name: Spray_RadialHousing_CorrelationFactor_Hairpin_EWdg_Front_F
...
aliases:
- Spray_RadialHousing_CorrelationFactor_Hairpin_EWdg_Front_F
- Spray Radial Housing Correlation Factor Hairpin E Wdg Front F
- spray_radial_housing_correlation_factor_hairpin_e_wdg_front_f
- sprayRadialHousingCorrelationFactorHairpinEWdgFrontF
- spray_radialhousing_correlationfactor_hairpin_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the hairpin front endwinding front surface
