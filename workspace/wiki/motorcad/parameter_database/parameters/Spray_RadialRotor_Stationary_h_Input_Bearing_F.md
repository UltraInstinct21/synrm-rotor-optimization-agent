...
parameter_name: Spray_RadialRotor_Stationary_h_Input_Bearing_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_Bearing_F
- Spray Radial Rotor Stationary h Input Bearing F
- spray_radial_rotor_stationary_h_input_bearing_f
- sprayRadialRotorStationaryHInputBearingF
- spray_radialrotor_stationary_h_input_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the front bearing surface
