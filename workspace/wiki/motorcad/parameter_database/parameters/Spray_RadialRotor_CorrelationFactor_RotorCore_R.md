...
parameter_name: Spray_RadialRotor_CorrelationFactor_RotorCore_R
...
aliases:
- Spray_RadialRotor_CorrelationFactor_RotorCore_R
- Spray Radial Rotor Correlation Factor Rotor Core R
- spray_radial_rotor_correlation_factor_rotor_core_r
- sprayRadialRotorCorrelationFactorRotorCoreR
- spray_radialrotor_correlationfactor_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the rear rotor core surface
