...
parameter_name: Spray_RadialHousing_Stationary_h_Adjust_RotorPole_F
...
aliases:
- Spray_RadialHousing_Stationary_h_Adjust_RotorPole_F
- Spray Radial Housing Stationary h Adjust Rotor Pole F
- spray_radial_housing_stationary_h_adjust_rotor_pole_f
- sprayRadialHousingStationaryHAdjustRotorPoleF
- spray_radialhousing_stationary_h_adjust_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc adjustment over the front rotor pole surface
