...
parameter_name: Vel_Mult_ES_EWdg_Front_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EWdg_Front_F
- Vel Mult ES E Wdg Front F
- vel_mult_es_e_wdg_front_f
- velMultEsEWdgFrontF
- vel_mult_es_ewdg_front_f
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for EWdg Front surface [Front]
