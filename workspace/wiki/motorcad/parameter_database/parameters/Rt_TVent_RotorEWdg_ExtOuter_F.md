...
parameter_name: Rt_TVent_RotorEWdg_ExtOuter_F
...
aliases:
- Rt_TVent_RotorEWdg_ExtOuter_F
- Rt T Vent Rotor E Wdg Ext Outer F
- rt_t_vent_rotor_e_wdg_ext_outer_f
- rtTVentRotorEWdgExtOuterF
- rt_tvent_rotorewdg_extouter_f
related_parameters:
...
## Summary
The thermal resistance from the ext outer surface of front rotor endwinding to the fluid
