...
parameter_name: K_SyncRotorRadial_User_F
...
aliases:
- K_SyncRotorRadial_User_F
- K Sync Rotor Radial User F
- k_sync_rotor_radial_user_f
- kSyncRotorRadialUserF
- k_syncrotorradial_user_f
related_parameters:
...
## Summary
This is the user input thermal conductivity of the sync field winding [front] in the radial direction
