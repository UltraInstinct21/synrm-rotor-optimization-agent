...
parameter_name: BMax_StatorBackIron_Static
category: Magnetics
input_output: o/p
data_type: double
units: Tesla
...
aliases:
- BMax_StatorBackIron_Static
- B Max Stator Back Iron Static
- b_max_stator_back_iron_static
- bMaxStatorBackIronStatic
- bmax_statorbackiron_static
related_parameters:
...
## Summary
Maximum flux density at midpoint in the stator back iron (Initial static solution)
