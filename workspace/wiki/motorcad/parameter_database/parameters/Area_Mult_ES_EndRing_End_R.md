...
parameter_name: Area_Mult_ES_EndRing_End_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_End_R
- Area Mult ES End Ring End R
- area_mult_es_end_ring_end_r
- areaMultEsEndRingEndR
- area_mult_es_endring_end_r
related_parameters:
...
## Summary
Area multiplier for the End Ring End [Rear] surface for End Space Cooling
