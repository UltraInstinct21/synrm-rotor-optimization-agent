...
parameter_name: UseEndPointTempLimit_FieldWdg
category: Transient
input_output: i/p
data_type: boolean
units: N/A
...
aliases:
- UseEndPointTempLimit_FieldWdg
- Use End Point Temp Limit Field Wdg
- use_end_point_temp_limit_field_wdg
- useEndPointTempLimitFieldWdg
- useendpointtemplimit_fieldwdg
related_parameters:
...
- '[[motorcad/parameter_database/parameters/UseEndPointTempLimit_Magnet|UseEndPointTempLimit_Magnet]]'
- '[[motorcad/parameter_database/parameters/UseEndPointTempLimit_Bearing|UseEndPointTempLimit_Bearing]]'
- '[[motorcad/parameter_database/parameters/UseEndPointTempLimit_ArmatureWdg|UseEndPointTempLimit_ArmatureWdg]]'
- '[[motorcad/parameter_database/parameters/UseEndPointTempLimit_Commutator|UseEndPointTempLimit_Commutator]]'
- '[[motorcad/parameter_database/parameters/UseEndPointTempLimit_Brushes|UseEndPointTempLimit_Brushes]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
When set true the field winding temperature will be considered when the transient end point definition is set to temperature limit
