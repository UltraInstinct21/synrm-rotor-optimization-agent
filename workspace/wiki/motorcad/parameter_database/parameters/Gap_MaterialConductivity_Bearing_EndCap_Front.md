...
parameter_name: Gap_MaterialConductivity_Bearing_EndCap_Front
...
aliases:
- Gap_MaterialConductivity_Bearing_EndCap_Front
- Gap Material Conductivity Bearing End Cap Front
- gap_material_conductivity_bearing_end_cap_front
- gapMaterialConductivityBearingEndCapFront
- gap_materialconductivity_bearing_endcap_front
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Bearing and Endcap [F].
