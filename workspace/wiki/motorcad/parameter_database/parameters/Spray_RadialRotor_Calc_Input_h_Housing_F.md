...
parameter_name: Spray_RadialRotor_Calc_Input_h_Housing_F
...
aliases:
- Spray_RadialRotor_Calc_Input_h_Housing_F
- Spray Radial Rotor Calc Input h Housing F
- spray_radial_rotor_calc_input_h_housing_f
- sprayRadialRotorCalcInputHHousingF
- spray_radialrotor_calc_input_h_housing_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the front housing surface is calculated or user input  (0=Calc h, 1=Input h)
