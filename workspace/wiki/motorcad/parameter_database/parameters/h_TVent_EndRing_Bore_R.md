...
parameter_name: h_TVent_EndRing_Bore_R
...
aliases:
- h_TVent_EndRing_Bore_R
- h T Vent End Ring Bore R
- h_t_vent_end_ring_bore_r
- hTVentEndRingBoreR
- h_tvent_endring_bore_r
related_parameters:
...
## Summary
The TVent heat transfer coefficient over the end ring bore surface [rear]
