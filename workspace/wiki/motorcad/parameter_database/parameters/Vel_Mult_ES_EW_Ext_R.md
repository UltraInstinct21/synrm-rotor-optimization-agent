...
parameter_name: Vel_Mult_ES_EW_Ext_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EW_Ext_R
- Vel Mult ES EW Ext R
- vel_mult_es_ew_ext_r
- velMultEsEwExtR
related_parameters:
...
## Summary
End Space Cooling - air velocity multiplier for end-winding extension surface [rear]
