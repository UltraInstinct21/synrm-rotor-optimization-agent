...
parameter_name: Spray_RadialRotor_Stationary_h_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_Stationary_h_EWdg_Inner_R
- Spray Radial Rotor Stationary h E Wdg Inner R
- spray_radial_rotor_stationary_h_e_wdg_inner_r
- sprayRadialRotorStationaryHEWdgInnerR
- spray_radialrotor_stationary_h_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the rear endwinding inner surface
