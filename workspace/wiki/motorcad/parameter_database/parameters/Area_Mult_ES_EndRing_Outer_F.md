...
parameter_name: Area_Mult_ES_EndRing_Outer_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_Outer_F
- Area Mult ES End Ring Outer F
- area_mult_es_end_ring_outer_f
- areaMultEsEndRingOuterF
- area_mult_es_endring_outer_f
related_parameters:
...
## Summary
Area multiplier for the End Ring Outer [Front] surface for End Space Cooling
