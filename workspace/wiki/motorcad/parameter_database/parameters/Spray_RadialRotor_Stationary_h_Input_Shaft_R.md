...
parameter_name: Spray_RadialRotor_Stationary_h_Input_Shaft_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_Shaft_R
- Spray Radial Rotor Stationary h Input Shaft R
- spray_radial_rotor_stationary_h_input_shaft_r
- sprayRadialRotorStationaryHInputShaftR
- spray_radialrotor_stationary_h_input_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the rear shaft surface
