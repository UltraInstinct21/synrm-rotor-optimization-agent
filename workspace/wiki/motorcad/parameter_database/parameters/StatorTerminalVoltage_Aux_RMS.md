...
parameter_name: StatorTerminalVoltage_Aux_RMS
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- StatorTerminalVoltage_Aux_RMS
- Stator Terminal Voltage Aux RMS
- stator_terminal_voltage_aux_rms
- statorTerminalVoltageAuxRms
- statorterminalvoltage_aux_rms
related_parameters:
...
## Summary
The aux winding RMS stator terminal voltage
