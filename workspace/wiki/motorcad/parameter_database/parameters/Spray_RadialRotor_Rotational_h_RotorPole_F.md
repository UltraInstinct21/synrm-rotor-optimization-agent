...
parameter_name: Spray_RadialRotor_Rotational_h_RotorPole_F
...
aliases:
- Spray_RadialRotor_Rotational_h_RotorPole_F
- Spray Radial Rotor Rotational h Rotor Pole F
- spray_radial_rotor_rotational_h_rotor_pole_f
- sprayRadialRotorRotationalHRotorPoleF
- spray_radialrotor_rotational_h_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc over the front rotor pole surface
