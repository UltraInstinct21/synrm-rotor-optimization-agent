...
parameter_name: Spray_AxialEndcap_CorrelationFactor_RotorPole_F
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_RotorPole_F
- Spray Axial Endcap Correlation Factor Rotor Pole F
- spray_axial_endcap_correlation_factor_rotor_pole_f
- sprayAxialEndcapCorrelationFactorRotorPoleF
- spray_axialendcap_correlationfactor_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the front rotor pole surface
