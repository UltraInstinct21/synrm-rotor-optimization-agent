...
parameter_name: Spray_RadialHousing_Calc_Input_h_Housing_R
...
aliases:
- Spray_RadialHousing_Calc_Input_h_Housing_R
- Spray Radial Housing Calc Input h Housing R
- spray_radial_housing_calc_input_h_housing_r
- sprayRadialHousingCalcInputHHousingR
- spray_radialhousing_calc_input_h_housing_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the rear housing surface is calculated or user input  (0=Calc h, 1=Input h)
