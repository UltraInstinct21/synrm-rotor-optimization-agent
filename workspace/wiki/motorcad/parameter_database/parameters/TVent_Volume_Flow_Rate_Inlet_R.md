...
parameter_name: TVent_Volume_Flow_Rate_Inlet_R
category: TVent_Data
input_output: o/p
data_type: double
units: m³/s
...
aliases:
- TVent_Volume_Flow_Rate_Inlet_R
- T Vent Volume Flow Rate Inlet R
- t_vent_volume_flow_rate_inlet_r
- tVentVolumeFlowRateInletR
- tvent_volume_flow_rate_inlet_r
related_parameters:
...
## Summary
Working flow rate of rear inlet
