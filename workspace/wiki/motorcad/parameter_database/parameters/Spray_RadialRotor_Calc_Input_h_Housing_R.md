...
parameter_name: Spray_RadialRotor_Calc_Input_h_Housing_R
...
aliases:
- Spray_RadialRotor_Calc_Input_h_Housing_R
- Spray Radial Rotor Calc Input h Housing R
- spray_radial_rotor_calc_input_h_housing_r
- sprayRadialRotorCalcInputHHousingR
- spray_radialrotor_calc_input_h_housing_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the rear housing surface is calculated or user input  (0=Calc h, 1=Input h)
