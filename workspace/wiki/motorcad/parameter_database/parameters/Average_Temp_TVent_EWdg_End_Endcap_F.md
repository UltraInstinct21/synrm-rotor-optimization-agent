...
parameter_name: Average_Temp_TVent_EWdg_End_Endcap_F
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Average_Temp_TVent_EWdg_End_Endcap_F
- Average Temp T Vent E Wdg End Endcap F
- average_temp_t_vent_e_wdg_end_endcap_f
- averageTempTVentEWdgEndEndcapF
- average_temp_tvent_ewdg_end_endcap_f
related_parameters:
...
## Summary
Motor-CAD automation parameter `Average_Temp_TVent_EWdg_End_Endcap_F` in category `TVent_Data`.
