...
parameter_name: Spray_RadialRotor_Rt_Endcap_F
...
aliases:
- Spray_RadialRotor_Rt_Endcap_F
- Spray Radial Rotor Rt Endcap F
- spray_radial_rotor_rt_endcap_f
- sprayRadialRotorRtEndcapF
- spray_radialrotor_rt_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to front endcap surface convective thermal resistance
