...
parameter_name: Spray_AxialEndcap_Rt_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Rt_RotorPole_F
- Spray Axial Endcap Rt Rotor Pole F
- spray_axial_endcap_rt_rotor_pole_f
- sprayAxialEndcapRtRotorPoleF
- spray_axialendcap_rt_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to front rotor pole surface convective thermal resistance
