...
parameter_name: Vel_Mult_ES_EndRing_ExtBore_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EndRing_ExtBore_R
- Vel Mult ES End Ring Ext Bore R
- vel_mult_es_end_ring_ext_bore_r
- velMultEsEndRingExtBoreR
- vel_mult_es_endring_extbore_r
related_parameters:
...
## Summary
The velocity multiplier for end ring ExtBore surface [rear]
