...
parameter_name: Velocity_TVent_Endcap_R
category: TVent_Data
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Velocity_TVent_Endcap_R
- Velocity T Vent Endcap R
- velocity_t_vent_endcap_r
- velocityTVentEndcapR
- velocity_tvent_endcap_r
related_parameters:
