...
parameter_name: Vel_ES_ExtShaftOuter_R
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_ExtShaftOuter_R
- Vel ES Ext Shaft Outer R
- vel_es_ext_shaft_outer_r
- velEsExtShaftOuterR
- vel_es_extshaftouter_r
related_parameters:
...
## Summary
End Space Cooling - velocity for shaft extension outer [rear]
