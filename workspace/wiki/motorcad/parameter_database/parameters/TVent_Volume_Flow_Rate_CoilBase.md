...
parameter_name: TVent_Volume_Flow_Rate_CoilBase
...
aliases:
- TVent_Volume_Flow_Rate_CoilBase
- T Vent Volume Flow Rate Coil Base
- t_vent_volume_flow_rate_coil_base
- tVentVolumeFlowRateCoilBase
- tvent_volume_flow_rate_coilbase
related_parameters:
...
## Summary
The through ventilation flow rate over rotor coil base
