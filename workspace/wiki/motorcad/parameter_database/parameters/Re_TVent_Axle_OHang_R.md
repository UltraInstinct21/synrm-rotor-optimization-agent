...
parameter_name: Re_TVent_Axle_OHang_R
category: TVent_Data
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Re_TVent_Axle_OHang_R
- Re T Vent Axle O Hang R
- re_t_vent_axle_o_hang_r
- reTVentAxleOHangR
- re_tvent_axle_ohang_r
related_parameters:
...
## Summary
The TVent reynolds number for flow over the axle overhang rear surface
