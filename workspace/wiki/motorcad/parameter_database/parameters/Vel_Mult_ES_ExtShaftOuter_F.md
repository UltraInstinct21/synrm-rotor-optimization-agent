...
parameter_name: Vel_Mult_ES_ExtShaftOuter_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_ExtShaftOuter_F
- Vel Mult ES Ext Shaft Outer F
- vel_mult_es_ext_shaft_outer_f
- velMultEsExtShaftOuterF
- vel_mult_es_extshaftouter_f
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for shaft extension outer [front]
