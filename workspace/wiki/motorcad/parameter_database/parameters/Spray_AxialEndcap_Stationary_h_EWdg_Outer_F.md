...
parameter_name: Spray_AxialEndcap_Stationary_h_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_EWdg_Outer_F
- Spray Axial Endcap Stationary h E Wdg Outer F
- spray_axial_endcap_stationary_h_e_wdg_outer_f
- sprayAxialEndcapStationaryHEWdgOuterF
- spray_axialendcap_stationary_h_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the front endwinding outer surface
