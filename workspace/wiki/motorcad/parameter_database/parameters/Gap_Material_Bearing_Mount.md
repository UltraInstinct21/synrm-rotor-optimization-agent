...
parameter_name: Gap_Material_Bearing_Mount
...
aliases:
- Gap_Material_Bearing_Mount
- Gap Material Bearing Mount
- gap_material_bearing_mount
- gapMaterialBearingMount
related_parameters:
...
## Summary
Material in the interface gap between the Bearing and Mount [F].
