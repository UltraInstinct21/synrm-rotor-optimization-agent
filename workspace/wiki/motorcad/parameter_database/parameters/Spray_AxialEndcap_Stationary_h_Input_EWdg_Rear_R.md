...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_EWdg_Rear_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_EWdg_Rear_R
- Spray Axial Endcap Stationary h Input E Wdg Rear R
- spray_axial_endcap_stationary_h_input_e_wdg_rear_r
- sprayAxialEndcapStationaryHInputEWdgRearR
- spray_axialendcap_stationary_h_input_ewdg_rear_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the rear endwinding rear surface
