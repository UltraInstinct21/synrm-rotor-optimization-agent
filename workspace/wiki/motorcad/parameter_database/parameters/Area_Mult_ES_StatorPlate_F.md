...
parameter_name: Area_Mult_ES_StatorPlate_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_StatorPlate_F
- Area Mult ES Stator Plate F
- area_mult_es_stator_plate_f
- areaMultEsStatorPlateF
- area_mult_es_statorplate_f
related_parameters:
...
## Summary
Area multiplier for the Stator Plate [Front] surface for End Space Cooling
