...
parameter_name: Spray_AxialEndcap_Area_Mult_Endcap_F
...
aliases:
- Spray_AxialEndcap_Area_Mult_Endcap_F
- Spray Axial Endcap Area Mult Endcap F
- spray_axial_endcap_area_mult_endcap_f
- sprayAxialEndcapAreaMultEndcapF
- spray_axialendcap_area_mult_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front endcap surface area multiplier
