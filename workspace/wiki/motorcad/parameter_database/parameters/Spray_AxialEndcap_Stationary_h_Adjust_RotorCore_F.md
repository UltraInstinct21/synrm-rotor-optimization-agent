...
parameter_name: Spray_AxialEndcap_Stationary_h_Adjust_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Adjust_RotorCore_F
- Spray Axial Endcap Stationary h Adjust Rotor Core F
- spray_axial_endcap_stationary_h_adjust_rotor_core_f
- sprayAxialEndcapStationaryHAdjustRotorCoreF
- spray_axialendcap_stationary_h_adjust_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc adjustment over the front rotor core surface
