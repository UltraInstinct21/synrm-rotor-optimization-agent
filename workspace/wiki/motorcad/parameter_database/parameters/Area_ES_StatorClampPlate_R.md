...
parameter_name: Area_ES_StatorClampPlate_R
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_StatorClampPlate_R
- Area ES Stator Clamp Plate R
- area_es_stator_clamp_plate_r
- areaEsStatorClampPlateR
- area_es_statorclampplate_r
related_parameters:
...
## Summary
End Space Cooling - area for Stator Clamp Plate [Rear]
