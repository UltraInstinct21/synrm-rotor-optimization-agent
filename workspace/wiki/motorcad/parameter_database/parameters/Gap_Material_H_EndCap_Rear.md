...
parameter_name: Gap_Material_H_EndCap_Rear
...
aliases:
- Gap_Material_H_EndCap_Rear
- Gap Material H End Cap Rear
- gap_material_h_end_cap_rear
- gapMaterialHEndCapRear
- gap_material_h_endcap_rear
related_parameters:
...
## Summary
Material in the interface gap between Housing and Endcap [R].
