...
parameter_name: Calc_Input_h_TVent_Magnet_R
...
aliases:
- Calc_Input_h_TVent_Magnet_R
- Calc Input h T Vent Magnet R
- calc_input_h_t_vent_magnet_r
- calcInputHTVentMagnetR
- calc_input_h_tvent_magnet_r
related_parameters:
...
## Summary
The TVent calculated or input set value for htc from flow over the Magnet surface [rear] (0=Calc h, 1=Input h)
