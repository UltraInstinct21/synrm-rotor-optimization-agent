...
parameter_name: Spray_AxialEndcap_Area_Mult_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_Area_Mult_EWdg_Inner_R
- Spray Axial Endcap Area Mult E Wdg Inner R
- spray_axial_endcap_area_mult_e_wdg_inner_r
- sprayAxialEndcapAreaMultEWdgInnerR
- spray_axialendcap_area_mult_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear endwinding inner surface area multiplier
