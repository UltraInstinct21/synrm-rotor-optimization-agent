...
parameter_name: Spray_RadialHousing_Stationary_h_Input_RotorCore_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_RotorCore_R
- Spray Radial Housing Stationary h Input Rotor Core R
- spray_radial_housing_stationary_h_input_rotor_core_r
- sprayRadialHousingStationaryHInputRotorCoreR
- spray_radialhousing_stationary_h_input_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the rear rotor core surface
