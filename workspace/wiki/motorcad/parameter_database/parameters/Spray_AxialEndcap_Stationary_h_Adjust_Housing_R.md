...
parameter_name: Spray_AxialEndcap_Stationary_h_Adjust_Housing_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Adjust_Housing_R
- Spray Axial Endcap Stationary h Adjust Housing R
- spray_axial_endcap_stationary_h_adjust_housing_r
- sprayAxialEndcapStationaryHAdjustHousingR
- spray_axialendcap_stationary_h_adjust_housing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc adjustment over the rear housing surface
