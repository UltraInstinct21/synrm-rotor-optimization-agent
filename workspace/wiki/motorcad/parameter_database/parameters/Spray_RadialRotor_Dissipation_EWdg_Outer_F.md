...
parameter_name: Spray_RadialRotor_Dissipation_EWdg_Outer_F
...
aliases:
- Spray_RadialRotor_Dissipation_EWdg_Outer_F
- Spray Radial Rotor Dissipation E Wdg Outer F
- spray_radial_rotor_dissipation_e_wdg_outer_f
- sprayRadialRotorDissipationEWdgOuterF
- spray_radialrotor_dissipation_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the front endwinding outer surface
