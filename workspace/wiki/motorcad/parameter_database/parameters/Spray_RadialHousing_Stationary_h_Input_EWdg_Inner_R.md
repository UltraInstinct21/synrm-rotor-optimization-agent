...
parameter_name: Spray_RadialHousing_Stationary_h_Input_EWdg_Inner_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_EWdg_Inner_R
- Spray Radial Housing Stationary h Input E Wdg Inner R
- spray_radial_housing_stationary_h_input_e_wdg_inner_r
- sprayRadialHousingStationaryHInputEWdgInnerR
- spray_radialhousing_stationary_h_input_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the rear endwinding inner surface
