...
parameter_name: Magnet_Embed_Depth
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
- '[[motorcad/parameter_database/parameters/Magnet_Iron_Loss_@Ref_Speed|Magnet_Iron_Loss_@Ref_Speed]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
How far magnet is inset into the rotor lamination in an IPM motor
