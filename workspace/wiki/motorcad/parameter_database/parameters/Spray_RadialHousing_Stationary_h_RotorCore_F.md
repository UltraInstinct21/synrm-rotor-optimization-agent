...
parameter_name: Spray_RadialHousing_Stationary_h_RotorCore_F
...
aliases:
- Spray_RadialHousing_Stationary_h_RotorCore_F
- Spray Radial Housing Stationary h Rotor Core F
- spray_radial_housing_stationary_h_rotor_core_f
- sprayRadialHousingStationaryHRotorCoreF
- spray_radialhousing_stationary_h_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc over the front rotor core surface
