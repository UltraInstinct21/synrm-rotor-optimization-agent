...
parameter_name: Rt_TVent_EndRing_Outer_F
...
aliases:
- Rt_TVent_EndRing_Outer_F
- Rt T Vent End Ring Outer F
- rt_t_vent_end_ring_outer_f
- rtTVentEndRingOuterF
- rt_tvent_endring_outer_f
related_parameters:
...
## Summary
The thermal resistance from the outer surface of front rotor end ring to the fluid
