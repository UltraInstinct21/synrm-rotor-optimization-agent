...
parameter_name: Spray_RadialRotor_Dissipation_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_Dissipation_EWdg_Outer_R
- Spray Radial Rotor Dissipation E Wdg Outer R
- spray_radial_rotor_dissipation_e_wdg_outer_r
- sprayRadialRotorDissipationEWdgOuterR
- spray_radialrotor_dissipation_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the rear endwinding outer surface
