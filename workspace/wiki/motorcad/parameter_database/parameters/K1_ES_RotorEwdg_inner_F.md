...
parameter_name: K1_ES_RotorEwdg_inner_F
category: End_Space
input_output: i/p
data_type: double
units: N/A
...
aliases:
- K1_ES_RotorEwdg_inner_F
- K1 ES Rotor Ewdg inner F
- k1_es_rotor_ewdg_inner_f
- k1EsRotorEwdgInnerF
- k1_es_rotorewdg_inner_f
related_parameters:
...
## Summary
The k1 constant for end wdg inner surface [front]
