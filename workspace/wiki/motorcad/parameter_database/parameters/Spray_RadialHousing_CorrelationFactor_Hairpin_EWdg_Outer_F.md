...
parameter_name: Spray_RadialHousing_CorrelationFactor_Hairpin_EWdg_Outer_F
...
aliases:
- Spray_RadialHousing_CorrelationFactor_Hairpin_EWdg_Outer_F
- Spray Radial Housing Correlation Factor Hairpin E Wdg Outer F
- spray_radial_housing_correlation_factor_hairpin_e_wdg_outer_f
- sprayRadialHousingCorrelationFactorHairpinEWdgOuterF
- spray_radialhousing_correlationfactor_hairpin_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the hairpin front endwinding outer surface
