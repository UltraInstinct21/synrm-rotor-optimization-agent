...
parameter_name: Area_ES_EndRing_Outer_F
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_EndRing_Outer_F
- Area ES End Ring Outer F
- area_es_end_ring_outer_f
- areaEsEndRingOuterF
- area_es_endring_outer_f
related_parameters:
...
## Summary
The area of the end ring Outer surface [front]
