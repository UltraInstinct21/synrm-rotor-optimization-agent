...
parameter_name: h_Input_TVent_RotorLam_R
...
aliases:
- h_Input_TVent_RotorLam_R
- h Input T Vent Rotor Lam R
- h_input_t_vent_rotor_lam_r
- hInputTVentRotorLamR
- h_input_tvent_rotorlam_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the Rotor lam surface [rear]
