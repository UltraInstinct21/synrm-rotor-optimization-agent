...
parameter_name: h_Adjust_TVent_RotorEwdg_End_R
...
aliases:
- h_Adjust_TVent_RotorEwdg_End_R
- h Adjust T Vent Rotor Ewdg End R
- h_adjust_t_vent_rotor_ewdg_end_r
- hAdjustTVentRotorEwdgEndR
- h_adjust_tvent_rotorewdg_end_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the EWdg End surface [rear]
