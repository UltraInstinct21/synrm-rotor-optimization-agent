...
parameter_name: Spray_RadialRotor_Mixed_h_EWdg_Front_R
...
aliases:
- Spray_RadialRotor_Mixed_h_EWdg_Front_R
- Spray Radial Rotor Mixed h E Wdg Front R
- spray_radial_rotor_mixed_h_e_wdg_front_r
- sprayRadialRotorMixedHEWdgFrontR
- spray_radialrotor_mixed_h_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the rear endwinding front surface
