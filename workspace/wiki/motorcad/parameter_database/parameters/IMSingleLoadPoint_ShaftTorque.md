...
parameter_name: IMSingleLoadPoint_ShaftTorque
category: Magnetics
input_output: o/p
data_type: double
units: Nm
...
aliases:
- IMSingleLoadPoint_ShaftTorque
- IM Single Load Point Shaft Torque
- im_single_load_point_shaft_torque
- imSingleLoadPointShaftTorque
- imsingleloadpoint_shafttorque
related_parameters:
...
## Summary
Torque at shaft of machine taking into account drag losses in the single load point FEA case
