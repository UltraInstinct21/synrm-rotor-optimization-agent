...
parameter_name: Spray_RadialRotor_Area_Mult_RotorCore_R
...
aliases:
- Spray_RadialRotor_Area_Mult_RotorCore_R
- Spray Radial Rotor Area Mult Rotor Core R
- spray_radial_rotor_area_mult_rotor_core_r
- sprayRadialRotorAreaMultRotorCoreR
- spray_radialrotor_area_mult_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear rotor core surface area multiplier
