...
parameter_name: Spray_RadialRotor_Rotational_h_Input_RotorPole_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_RotorPole_F
- Spray Radial Rotor Rotational h Input Rotor Pole F
- spray_radial_rotor_rotational_h_input_rotor_pole_f
- sprayRadialRotorRotationalHInputRotorPoleF
- spray_radialrotor_rotational_h_input_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the front rotor pole surface
