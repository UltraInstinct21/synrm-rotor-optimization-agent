...
parameter_name: Spray_AxialEndcap_Dissipation_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Dissipation_RotorPole_R
- Spray Axial Endcap Dissipation Rotor Pole R
- spray_axial_endcap_dissipation_rotor_pole_r
- sprayAxialEndcapDissipationRotorPoleR
- spray_axialendcap_dissipation_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the rear rotor pole surface
