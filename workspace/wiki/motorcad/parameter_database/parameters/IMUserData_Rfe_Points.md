...
parameter_name: IMUserData_Rfe_Points
category: Magnetics
input_output: i/p
data_type: integer
units: N/A
...
aliases:
- IMUserData_Rfe_Points
- IM User Data Rfe Points
- im_user_data_rfe_points
- imUserDataRfePoints
- imuserdata_rfe_points
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IMUserData_Lm_Points|IMUserData_Lm_Points]]'
...
## Summary
Number of points for which the core loss resistance user data is defined
