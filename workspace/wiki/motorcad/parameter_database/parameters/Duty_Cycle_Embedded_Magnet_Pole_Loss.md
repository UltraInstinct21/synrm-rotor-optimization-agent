...
parameter_name: Duty_Cycle_Embedded_Magnet_Pole_Loss
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Embedded Magnet Pole Loss
- duty_cycle_embedded_magnet_pole_loss
- dutyCycleEmbeddedMagnetPoleLoss
related_parameters:
...
## Summary
Embedded magnet pole loss for each period of the duty cycle
