...
parameter_name: Gap_MaterialConductivity_StatorPlateMount_R
...
aliases:
- Gap_MaterialConductivity_StatorPlateMount_R
- Gap Material Conductivity Stator Plate Mount R
- gap_material_conductivity_stator_plate_mount_r
- gapMaterialConductivityStatorPlateMountR
- gap_materialconductivity_statorplatemount_r
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Plate and Mount [R].
