...
parameter_name: LastIMMaxRMSCurrent_SaturationCalc_Backup
category: Magnetics
input_output: i/p
data_type: double
units: Amps
...
aliases:
- LastIMMaxRMSCurrent_SaturationCalc_Backup
- Last IM Max RMS Current Saturation Calc Backup
- last_im_max_rms_current_saturation_calc_backup
- lastImMaxRmsCurrentSaturationCalcBackup
- lastimmaxrmscurrent_saturationcalc_backup
related_parameters:
...
- '[[motorcad/parameter_database/parameters/LastIMMaxRMSCurrent_SaturationCalc|LastIMMaxRMSCurrent_SaturationCalc]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The maximum RMS current used in the most recent user-initiated saturation model calculation
