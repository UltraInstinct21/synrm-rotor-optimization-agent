...
parameter_name: Spray_RadialHousing_Mixed_h_EWdg_Front_R
...
aliases:
- Spray_RadialHousing_Mixed_h_EWdg_Front_R
- Spray Radial Housing Mixed h E Wdg Front R
- spray_radial_housing_mixed_h_e_wdg_front_r
- sprayRadialHousingMixedHEWdgFrontR
- spray_radialhousing_mixed_h_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the rear endwinding front surface
