...
parameter_name: Gap_Material_H_HOH_Front
...
aliases:
- Gap_Material_H_HOH_Front
- Gap Material H HOH Front
- gap_material_h_hoh_front
- gapMaterialHHohFront
related_parameters:
...
## Summary
Material in the interface gap between the Housing and Housing OHang [F].
