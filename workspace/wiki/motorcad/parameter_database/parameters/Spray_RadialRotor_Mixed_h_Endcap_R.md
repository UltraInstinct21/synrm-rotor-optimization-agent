...
parameter_name: Spray_RadialRotor_Mixed_h_Endcap_R
...
aliases:
- Spray_RadialRotor_Mixed_h_Endcap_R
- Spray Radial Rotor Mixed h Endcap R
- spray_radial_rotor_mixed_h_endcap_r
- sprayRadialRotorMixedHEndcapR
- spray_radialrotor_mixed_h_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the rear endcap surface
