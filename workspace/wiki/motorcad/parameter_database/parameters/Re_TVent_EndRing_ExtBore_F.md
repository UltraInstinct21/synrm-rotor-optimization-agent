...
parameter_name: Re_TVent_EndRing_ExtBore_F
...
aliases:
- Re_TVent_EndRing_ExtBore_F
- Re T Vent End Ring Ext Bore F
- re_t_vent_end_ring_ext_bore_f
- reTVentEndRingExtBoreF
- re_tvent_endring_extbore_f
related_parameters:
...
## Summary
The TVent reynolds number for flow over the end ring ExtBore surface [front]
