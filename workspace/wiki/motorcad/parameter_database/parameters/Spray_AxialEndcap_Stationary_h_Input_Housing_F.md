...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_Housing_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_Housing_F
- Spray Axial Endcap Stationary h Input Housing F
- spray_axial_endcap_stationary_h_input_housing_f
- sprayAxialEndcapStationaryHInputHousingF
- spray_axialendcap_stationary_h_input_housing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the front housing surface
