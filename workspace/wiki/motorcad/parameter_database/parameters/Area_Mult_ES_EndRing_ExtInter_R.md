...
parameter_name: Area_Mult_ES_EndRing_ExtInter_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_ExtInter_R
- Area Mult ES End Ring Ext Inter R
- area_mult_es_end_ring_ext_inter_r
- areaMultEsEndRingExtInterR
- area_mult_es_endring_extinter_r
related_parameters:
...
## Summary
Area multiplier for the End Ring Extension Inter [Rear] surface for End Space Cooling
