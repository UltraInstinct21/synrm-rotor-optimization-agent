...
parameter_name: EndcapVentRefShaftSpeed_F
category: End_Space
input_output: i/p
data_type: double
units: rpm
...
aliases:
- EndcapVentRefShaftSpeed_F
- Endcap Vent Ref Shaft Speed F
- endcap_vent_ref_shaft_speed_f
- endcapVentRefShaftSpeedF
- endcapventrefshaftspeed_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/EndcapVentRefShaftSpeed_R|EndcapVentRefShaftSpeed_R]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Front Endcap vent flow shaft speed reference velocity
