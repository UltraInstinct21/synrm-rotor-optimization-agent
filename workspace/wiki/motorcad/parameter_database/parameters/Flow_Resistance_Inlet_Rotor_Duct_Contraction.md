...
parameter_name: Flow_Resistance_Inlet_Rotor_Duct_Contraction
category: TVent_Data
input_output: o/p
data_type: double
units: kg/m⁷
...
aliases:
- Flow_Resistance_Inlet_Rotor_Duct_Contraction
- Flow Resistance Inlet Rotor Duct Contraction
- flow_resistance_inlet_rotor_duct_contraction
- flowResistanceInletRotorDuctContraction
related_parameters:
