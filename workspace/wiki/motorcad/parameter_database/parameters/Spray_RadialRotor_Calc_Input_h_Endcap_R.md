...
parameter_name: Spray_RadialRotor_Calc_Input_h_Endcap_R
...
aliases:
- Spray_RadialRotor_Calc_Input_h_Endcap_R
- Spray Radial Rotor Calc Input h Endcap R
- spray_radial_rotor_calc_input_h_endcap_r
- sprayRadialRotorCalcInputHEndcapR
- spray_radialrotor_calc_input_h_endcap_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the rear endcap surface is calculated or user input  (0=Calc h, 1=Input h)
