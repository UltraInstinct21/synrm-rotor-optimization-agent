...
parameter_name: Spray_RadialRotor_Notes_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_Notes_EWdg_Outer_R
- Spray Radial Rotor Notes E Wdg Outer R
- spray_radial_rotor_notes_e_wdg_outer_r
- sprayRadialRotorNotesEWdgOuterR
- spray_radialrotor_notes_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) notes for rear endwinding outer surface
