...
parameter_name: Spray_RadialRotor_Stationary_h_Input_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_EWdg_Inner_R
- Spray Radial Rotor Stationary h Input E Wdg Inner R
- spray_radial_rotor_stationary_h_input_e_wdg_inner_r
- sprayRadialRotorStationaryHInputEWdgInnerR
- spray_radialrotor_stationary_h_input_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the rear endwinding inner surface
