...
parameter_name: K_SyncRotorTangential_User_A
...
aliases:
- K_SyncRotorTangential_User_A
- K Sync Rotor Tangential User A
- k_sync_rotor_tangential_user_a
- kSyncRotorTangentialUserA
- k_syncrotortangential_user_a
related_parameters:
...
- '[[motorcad/parameter_database/parameters/K_r_MotorLAB|K_r_MotorLAB]]'
- '[[motorcad/parameter_database/parameters/K_Radial_A|K_Radial_A]]'
- '[[motorcad/parameter_database/parameters/K_Tangential_A|K_Tangential_A]]'
- '[[motorcad/parameter_database/parameters/K_Axial_A|K_Axial_A]]'
- '[[motorcad/parameter_database/parameters/K_Radial_F|K_Radial_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This is the user input thermal conductivity of the sync field winding [active] in the tangential direction
