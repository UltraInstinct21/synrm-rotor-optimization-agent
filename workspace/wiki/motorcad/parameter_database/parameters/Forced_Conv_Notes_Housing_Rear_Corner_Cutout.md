...
parameter_name: Forced_Conv_Notes_Housing_Rear_Corner_Cutout
...
aliases:
- Forced_Conv_Notes_Housing_Rear_Corner_Cutout
- Forced Conv Notes Housing Rear Corner Cutout
- forced_conv_notes_housing_rear_corner_cutout
- forcedConvNotesHousingRearCornerCutout
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of rear housing section (corner cutout section) available for cooling to ambient
