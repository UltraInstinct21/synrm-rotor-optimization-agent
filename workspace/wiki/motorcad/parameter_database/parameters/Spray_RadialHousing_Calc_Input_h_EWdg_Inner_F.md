...
parameter_name: Spray_RadialHousing_Calc_Input_h_EWdg_Inner_F
...
aliases:
- Spray_RadialHousing_Calc_Input_h_EWdg_Inner_F
- Spray Radial Housing Calc Input h E Wdg Inner F
- spray_radial_housing_calc_input_h_e_wdg_inner_f
- sprayRadialHousingCalcInputHEWdgInnerF
- spray_radialhousing_calc_input_h_ewdg_inner_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the front endwinding inner surface is calculated or user input  (0=Calc h, 1=Input h)
