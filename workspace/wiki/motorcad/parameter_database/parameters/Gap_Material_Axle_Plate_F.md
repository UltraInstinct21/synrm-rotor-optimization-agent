...
parameter_name: Gap_Material_Axle_Plate_F
...
aliases:
- Gap_Material_Axle_Plate_F
- Gap Material Axle Plate F
- gap_material_axle_plate_f
- gapMaterialAxlePlateF
related_parameters:
...
## Summary
Material in the interface gap between the Axle and Plate [F].
