...
parameter_name: Spray_AxialEndcap_Area_Mult_Housing_F
...
aliases:
- Spray_AxialEndcap_Area_Mult_Housing_F
- Spray Axial Endcap Area Mult Housing F
- spray_axial_endcap_area_mult_housing_f
- sprayAxialEndcapAreaMultHousingF
- spray_axialendcap_area_mult_housing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front housing surface area multiplier
