...
parameter_name: ReactanceLoadSkew_Q
category: Magnetics
input_output: o/p
data_type: double
units: Ohms
...
aliases:
- ReactanceLoadSkew_Q
- Reactance Load Skew Q
- reactance_load_skew_q
- reactanceLoadSkewQ
- reactanceloadskew_q
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ReactanceLoadSkew_D|ReactanceLoadSkew_D]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The reactance in Q axis for skewed machine
