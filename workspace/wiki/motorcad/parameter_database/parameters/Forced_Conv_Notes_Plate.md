...
parameter_name: Forced_Conv_Notes_Plate
...
aliases:
- Forced_Conv_Notes_Plate
- Forced Conv Notes Plate
- forced_conv_notes_plate
- forcedConvNotesPlate
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of flange mounted plate available for cooling to ambient
