...
parameter_name: IMSlotLeakagePermeanceFactor_Rotor_Top
category: Magnetics
input_output: o/p
data_type: double
units: N/A
...
aliases:
- IMSlotLeakagePermeanceFactor_Rotor_Top
- IM Slot Leakage Permeance Factor Rotor Top
- im_slot_leakage_permeance_factor_rotor_top
- imSlotLeakagePermeanceFactorRotorTop
- imslotleakagepermeancefactor_rotor_top
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IMSlotLeakagePermeanceFactor_Stator|IMSlotLeakagePermeanceFactor_Stator]]'
- '[[motorcad/parameter_database/parameters/IMSlotLeakagePermeanceFactor_Rotor_Bottom|IMSlotLeakagePermeanceFactor_Rotor_Bottom]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The rotor slot leakage permeance factor used for calculation of the rotor leakage inductance
