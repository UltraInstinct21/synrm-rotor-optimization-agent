...
parameter_name: h_Adjust_TVent_EndRing_Outer_F
...
aliases:
- h_Adjust_TVent_EndRing_Outer_F
- h Adjust T Vent End Ring Outer F
- h_adjust_t_vent_end_ring_outer_f
- hAdjustTVentEndRingOuterF
- h_adjust_tvent_endring_outer_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the end ring Outer surface [front]
