...
parameter_name: Velocity_Multiplier_h[Wet_Rotor]_Rear_Shaft
...
aliases:
- Velocity_Multiplier_h[Wet_Rotor]_Rear_Shaft
- Velocity_Multiplier_h(Wet_Rotor)_Rear_Shaft
- Velocity Multiplier h Wet Rotor Rear Shaft
- velocity_multiplier_h_wet_rotor_rear_shaft
- velocityMultiplierHWetRotorRearShaft
- velocity_multiplier_h[wet_rotor]_rear_shaft
related_parameters:
...
## Summary
Motor-CAD automation parameter `Velocity_Multiplier_h[Wet_Rotor]_Rear_Shaft` in category `Wet_Rotor_Data`.
