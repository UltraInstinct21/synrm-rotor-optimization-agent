...
parameter_name: Vel_ES_RotorEwdg_internal_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_RotorEwdg_internal_F_Calc
- Vel ES Rotor Ewdg internal F Calc
- vel_es_rotor_ewdg_internal_f_calc
- velEsRotorEwdgInternalFCalc
- vel_es_rotorewdg_internal_f_calc
related_parameters:
...
## Summary
The calculated velocity over the end wdg internal surface [front]
