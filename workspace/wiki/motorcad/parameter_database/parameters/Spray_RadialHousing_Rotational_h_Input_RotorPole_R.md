...
parameter_name: Spray_RadialHousing_Rotational_h_Input_RotorPole_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_RotorPole_R
- Spray Radial Housing Rotational h Input Rotor Pole R
- spray_radial_housing_rotational_h_input_rotor_pole_r
- sprayRadialHousingRotationalHInputRotorPoleR
- spray_radialhousing_rotational_h_input_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the rear rotor pole surface
