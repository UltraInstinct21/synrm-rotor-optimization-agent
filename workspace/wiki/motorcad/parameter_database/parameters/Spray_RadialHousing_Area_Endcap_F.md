...
parameter_name: Spray_RadialHousing_Area_Endcap_F
...
aliases:
- Spray_RadialHousing_Area_Endcap_F
- Spray Radial Housing Area Endcap F
- spray_radial_housing_area_endcap_f
- sprayRadialHousingAreaEndcapF
- spray_radialhousing_area_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) front endcap surface sprayed area
