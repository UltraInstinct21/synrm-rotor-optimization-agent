...
parameter_name: Vel_ES_StatorClampPlate_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_StatorClampPlate_F_Calc
- Vel ES Stator Clamp Plate F Calc
- vel_es_stator_clamp_plate_f_calc
- velEsStatorClampPlateFCalc
- vel_es_statorclampplate_f_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for Stator Clamp Plate [Front]
