...
parameter_name: Gap_StatorClampPlate_StatorLam_R
...
aliases:
- Gap_StatorClampPlate_StatorLam_R
- Gap Stator Clamp Plate Stator Lam R
- gap_stator_clamp_plate_stator_lam_r
- gapStatorClampPlateStatorLamR
- gap_statorclampplate_statorlam_r
related_parameters:
...
## Summary
The effective gap between the stator clamp plate and the stator laminations [Rear]
