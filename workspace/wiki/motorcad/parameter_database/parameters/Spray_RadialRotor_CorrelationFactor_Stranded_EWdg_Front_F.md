...
parameter_name: Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Front_F
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Front_F
- Spray Radial Rotor Correlation Factor Stranded E Wdg Front F
- spray_radial_rotor_correlation_factor_stranded_e_wdg_front_f
- sprayRadialRotorCorrelationFactorStrandedEWdgFrontF
- spray_radialrotor_correlationfactor_stranded_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the stranded front endwinding front surface
