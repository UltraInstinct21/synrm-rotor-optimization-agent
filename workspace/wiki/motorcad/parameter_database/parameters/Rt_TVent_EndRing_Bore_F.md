...
parameter_name: Rt_TVent_EndRing_Bore_F
...
aliases:
- Rt_TVent_EndRing_Bore_F
- Rt T Vent End Ring Bore F
- rt_t_vent_end_ring_bore_f
- rtTVentEndRingBoreF
- rt_tvent_endring_bore_f
related_parameters:
...
## Summary
The thermal resistance from the bore surface of front rotor end ring to the fluid
