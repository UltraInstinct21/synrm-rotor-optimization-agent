...
parameter_name: IMLockedRotor_RMSVoltage_Line
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- IMLockedRotor_RMSVoltage_Line
- IM Locked Rotor RMS Voltage Line
- im_locked_rotor_rms_voltage_line
- imLockedRotorRmsVoltageLine
- imlockedrotor_rmsvoltage_line
related_parameters:
...
## Summary
The locked rotor rms line voltage
