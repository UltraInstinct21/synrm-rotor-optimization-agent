...
parameter_name: EndPointTempLimit_ArmatureWdg
category: Transient
input_output: i/p
data_type: double
units: °C
...
aliases:
- EndPointTempLimit_ArmatureWdg
- End Point Temp Limit Armature Wdg
- end_point_temp_limit_armature_wdg
- endPointTempLimitArmatureWdg
- endpointtemplimit_armaturewdg
related_parameters:
...
- '[[motorcad/parameter_database/parameters/EndPointTempLimit_Magnet|EndPointTempLimit_Magnet]]'
- '[[motorcad/parameter_database/parameters/EndPointTempLimit_Bearing|EndPointTempLimit_Bearing]]'
- '[[motorcad/parameter_database/parameters/EndPointTempLimit_FieldWdg|EndPointTempLimit_FieldWdg]]'
- '[[motorcad/parameter_database/parameters/EndPointTempLimit_Commutator|EndPointTempLimit_Commutator]]'
- '[[motorcad/parameter_database/parameters/EndPointTempLimit_Brushes|EndPointTempLimit_Brushes]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The maximum allowed temperature of the armature windings when the transient end point definition is set to temperature limit
