...
parameter_name: Spray_AxialEndcap_Calc_Input_h_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_RotorCore_F
- Spray Axial Endcap Calc Input h Rotor Core F
- spray_axial_endcap_calc_input_h_rotor_core_f
- sprayAxialEndcapCalcInputHRotorCoreF
- spray_axialendcap_calc_input_h_rotorcore_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the front rotor core surface is calculated or user input  (0=Calc h, 1=Input h)
