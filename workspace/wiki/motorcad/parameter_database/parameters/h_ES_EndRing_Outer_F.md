...
parameter_name: h_ES_EndRing_Outer_F
category: End_Space
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_ES_EndRing_Outer_F
- h ES End Ring Outer F
- h_es_end_ring_outer_f
- hEsEndRingOuterF
- h_es_endring_outer_f
related_parameters:
...
## Summary
The heat transfer coefficient over the end ring Outer surface [front]
