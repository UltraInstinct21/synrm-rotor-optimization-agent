...
parameter_name: h_Adjust_TVent_RotorLam_R
...
aliases:
- h_Adjust_TVent_RotorLam_R
- h Adjust T Vent Rotor Lam R
- h_adjust_t_vent_rotor_lam_r
- hAdjustTVentRotorLamR
- h_adjust_tvent_rotorlam_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the Rotor lam surface [rear]
