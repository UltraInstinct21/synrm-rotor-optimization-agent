...
parameter_name: h_Adjust_TVent_EndRing_End_R
...
aliases:
- h_Adjust_TVent_EndRing_End_R
- h Adjust T Vent End Ring End R
- h_adjust_t_vent_end_ring_end_r
- hAdjustTVentEndRingEndR
- h_adjust_tvent_endring_end_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the end ring End surface [rear]
