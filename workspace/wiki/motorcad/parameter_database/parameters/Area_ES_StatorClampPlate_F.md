...
parameter_name: Area_ES_StatorClampPlate_F
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_StatorClampPlate_F
- Area ES Stator Clamp Plate F
- area_es_stator_clamp_plate_f
- areaEsStatorClampPlateF
- area_es_statorclampplate_f
related_parameters:
...
## Summary
End Space Cooling - area for Stator Clamp Plate [Front]
