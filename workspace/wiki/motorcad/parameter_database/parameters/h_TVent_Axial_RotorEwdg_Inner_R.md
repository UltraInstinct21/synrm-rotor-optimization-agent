...
parameter_name: h_TVent_Axial_RotorEwdg_Inner_R
...
aliases:
- h_TVent_Axial_RotorEwdg_Inner_R
- h T Vent Axial Rotor Ewdg Inner R
- h_t_vent_axial_rotor_ewdg_inner_r
- hTVentAxialRotorEwdgInnerR
- h_tvent_axial_rotorewdg_inner_r
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the EWdg Inner surface [rear]
