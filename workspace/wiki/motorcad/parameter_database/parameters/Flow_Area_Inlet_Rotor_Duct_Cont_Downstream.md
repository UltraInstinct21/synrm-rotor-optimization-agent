...
parameter_name: Flow_Area_Inlet_Rotor_Duct_Cont_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Rotor_Duct_Cont_Downstream
- Flow Area Inlet Rotor Duct Cont Downstream
- flow_area_inlet_rotor_duct_cont_downstream
- flowAreaInletRotorDuctContDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Rotor Duct Contraction Downstream
