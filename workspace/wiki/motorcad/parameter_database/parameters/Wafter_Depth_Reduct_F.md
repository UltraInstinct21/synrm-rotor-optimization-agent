...
parameter_name: Wafter_Depth_Reduct_F
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- Wafter_Depth_Reduct_F
- Wafter Depth Reduct F
- wafter_depth_reduct_f
- wafterDepthReductF
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Wafter_Inner_Add_F|Wafter_Inner_Add_F]]'
- '[[motorcad/parameter_database/parameters/Wafter_Inner_Add_R|Wafter_Inner_Add_R]]'
- '[[motorcad/parameter_database/parameters/Wafter_Outer_Add_F|Wafter_Outer_Add_F]]'
- '[[motorcad/parameter_database/parameters/Wafter_Outer_Add_R|Wafter_Outer_Add_R]]'
- '[[motorcad/parameter_database/parameters/Wafter_Number_F|Wafter_Number_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Wafter radial depth reduction (compared to the end ring depth) [front]
