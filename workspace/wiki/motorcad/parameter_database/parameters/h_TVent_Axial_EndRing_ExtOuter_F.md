...
parameter_name: h_TVent_Axial_EndRing_ExtOuter_F
...
aliases:
- h_TVent_Axial_EndRing_ExtOuter_F
- h T Vent Axial End Ring Ext Outer F
- h_t_vent_axial_end_ring_ext_outer_f
- hTVentAxialEndRingExtOuterF
- h_tvent_axial_endring_extouter_f
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the end ring ExtOuter surface [front]
