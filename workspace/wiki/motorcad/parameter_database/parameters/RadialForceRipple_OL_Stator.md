...
parameter_name: RadialForceRipple_OL_Stator
category: Magnetics
input_output: o/p
data_type: double
units: N
...
aliases:
- RadialForceRipple_OL_Stator
- Radial Force Ripple OL Stator
- radial_force_ripple_ol_stator
- radialForceRippleOlStator
- radialforceripple_ol_stator
related_parameters:
...
- '[[motorcad/parameter_database/parameters/RadialForceRipple_OL_Rotor|RadialForceRipple_OL_Rotor]]'
- '[[motorcad/parameter_database/parameters/RadialForceRipple_OC_Stator|RadialForceRipple_OC_Stator]]'
- '[[motorcad/parameter_database/parameters/RadialForceRipple_OC_Rotor|RadialForceRipple_OC_Rotor]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The maximum peak-peak variation in stator force during the on load transient at any point in the machine
