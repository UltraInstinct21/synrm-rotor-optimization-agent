...
parameter_name: Re_Critical_TVent_EndRing_Bore_F
...
aliases:
- Re_Critical_TVent_EndRing_Bore_F
- Re Critical T Vent End Ring Bore F
- re_critical_t_vent_end_ring_bore_f
- reCriticalTVentEndRingBoreF
- re_critical_tvent_endring_bore_f
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the end ring bore surface [front]
