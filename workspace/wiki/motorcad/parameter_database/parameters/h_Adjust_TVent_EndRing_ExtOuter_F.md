...
parameter_name: h_Adjust_TVent_EndRing_ExtOuter_F
...
aliases:
- h_Adjust_TVent_EndRing_ExtOuter_F
- h Adjust T Vent End Ring Ext Outer F
- h_adjust_t_vent_end_ring_ext_outer_f
- hAdjustTVentEndRingExtOuterF
- h_adjust_tvent_endring_extouter_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the end ring ExtOuter surface [front]
