...
parameter_name: Spray_AxialEndcap_Stationary_h_Shaft_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Shaft_R
- Spray Axial Endcap Stationary h Shaft R
- spray_axial_endcap_stationary_h_shaft_r
- sprayAxialEndcapStationaryHShaftR
- spray_axialendcap_stationary_h_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the rear shaft surface
