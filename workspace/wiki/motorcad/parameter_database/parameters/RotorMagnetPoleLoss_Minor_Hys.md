...
parameter_name: RotorMagnetPoleLoss_Minor_Hys
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- RotorMagnetPoleLoss_Minor_Hys
- Rotor Magnet Pole Loss Minor Hys
- rotor_magnet_pole_loss_minor_hys
- rotorMagnetPoleLossMinorHys
- rotormagnetpoleloss_minor_hys
related_parameters:
...
## Summary
Rotor magnet pole losses from hysteresis
