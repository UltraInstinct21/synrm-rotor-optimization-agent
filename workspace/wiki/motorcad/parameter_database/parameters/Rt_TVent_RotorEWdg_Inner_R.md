...
parameter_name: Rt_TVent_RotorEWdg_Inner_R
...
aliases:
- Rt_TVent_RotorEWdg_Inner_R
- Rt T Vent Rotor E Wdg Inner R
- rt_t_vent_rotor_e_wdg_inner_r
- rtTVentRotorEWdgInnerR
- rt_tvent_rotorewdg_inner_r
related_parameters:
...
## Summary
The thermal resistance from the inner surface of rear rotor endwinding to the fluid
