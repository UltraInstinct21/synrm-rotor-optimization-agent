...
parameter_name: ArmatureConductorLengthPh_Aux
category: Magnetics
input_output: o/p
data_type: double
units: mm
...
aliases:
- ArmatureConductorLengthPh_Aux
- Armature Conductor Length Ph Aux
- armature_conductor_length_ph_aux
- armatureConductorLengthPhAux
- armatureconductorlengthph_aux
related_parameters:
...
## Summary
The length of each wire in the aux winding
