...
parameter_name: RotorDifferentialLeakageReactance_Ref
category: Magnetics
input_output: o/p
data_type: double
units: Ohms
...
aliases:
- RotorDifferentialLeakageReactance_Ref
- Rotor Differential Leakage Reactance Ref
- rotor_differential_leakage_reactance_ref
- rotorDifferentialLeakageReactanceRef
- rotordifferentialleakagereactance_ref
related_parameters:
...
## Summary
Rotor Differential Leakage Reactance
