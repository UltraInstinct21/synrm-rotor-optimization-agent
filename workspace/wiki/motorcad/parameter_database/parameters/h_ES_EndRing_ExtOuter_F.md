...
parameter_name: h_ES_EndRing_ExtOuter_F
category: End_Space
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_ES_EndRing_ExtOuter_F
- h ES End Ring Ext Outer F
- h_es_end_ring_ext_outer_f
- hEsEndRingExtOuterF
- h_es_endring_extouter_f
related_parameters:
...
## Summary
The heat transfer coefficient over the end ring ExtOuter surface [front]
