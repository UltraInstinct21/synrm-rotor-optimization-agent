...
parameter_name: Spray_AxialEndcap_Rotational_h_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_EWdg_Inner_R
- Spray Axial Endcap Rotational h E Wdg Inner R
- spray_axial_endcap_rotational_h_e_wdg_inner_r
- sprayAxialEndcapRotationalHEWdgInnerR
- spray_axialendcap_rotational_h_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc over the rear endwinding inner surface
