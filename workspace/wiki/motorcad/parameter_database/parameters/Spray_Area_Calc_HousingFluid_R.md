...
parameter_name: Spray_Area_Calc_HousingFluid_R
...
aliases:
- Spray_Area_Calc_HousingFluid_R
- Spray Area Calc Housing Fluid R
- spray_area_calc_housing_fluid_r
- sprayAreaCalcHousingFluidR
- spray_area_calc_housingfluid_r
related_parameters:
...
## Summary
Calculated Area of the Housing Rear section subjected to Spray Cooling
