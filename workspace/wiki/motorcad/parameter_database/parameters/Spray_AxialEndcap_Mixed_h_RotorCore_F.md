...
parameter_name: Spray_AxialEndcap_Mixed_h_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Mixed_h_RotorCore_F
- Spray Axial Endcap Mixed h Rotor Core F
- spray_axial_endcap_mixed_h_rotor_core_f
- sprayAxialEndcapMixedHRotorCoreF
- spray_axialendcap_mixed_h_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the front rotor core surface
