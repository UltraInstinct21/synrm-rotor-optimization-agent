...
parameter_name: Spray_RadialHousing_Stationary_h_Input_EWdg_Front_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_EWdg_Front_R
- Spray Radial Housing Stationary h Input E Wdg Front R
- spray_radial_housing_stationary_h_input_e_wdg_front_r
- sprayRadialHousingStationaryHInputEWdgFrontR
- spray_radialhousing_stationary_h_input_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the rear endwinding front surface
