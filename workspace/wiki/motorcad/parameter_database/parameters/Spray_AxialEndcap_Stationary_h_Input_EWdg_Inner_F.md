...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_EWdg_Inner_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_EWdg_Inner_F
- Spray Axial Endcap Stationary h Input E Wdg Inner F
- spray_axial_endcap_stationary_h_input_e_wdg_inner_f
- sprayAxialEndcapStationaryHInputEWdgInnerF
- spray_axialendcap_stationary_h_input_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the front endwinding inner surface
