...
parameter_name: Velocity_Multiplier_h[Wet_Rotor]_Rear_End_Winding_[Bore]
...
aliases:
- Velocity_Multiplier_h[Wet_Rotor]_Rear_End_Winding_[Bore]
- Velocity_Multiplier_h(Wet_Rotor)_Rear_End_Winding_(Bore)
- Velocity Multiplier h Wet Rotor Rear End Winding Bore
- velocity_multiplier_h_wet_rotor_rear_end_winding_bore
- velocityMultiplierHWetRotorRearEndWindingBore
- velocity_multiplier_h[wet_rotor]_rear_end_winding_[bore]
related_parameters:
...
## Summary
Motor-CAD automation parameter `Velocity_Multiplier_h[Wet_Rotor]_Rear_End_Winding_[Bore]` in category `Wet_Rotor_Data`.
