...
parameter_name: Spray_AxialEndcap_Area_Mult_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Area_Mult_RotorCore_F
- Spray Axial Endcap Area Mult Rotor Core F
- spray_axial_endcap_area_mult_rotor_core_f
- sprayAxialEndcapAreaMultRotorCoreF
- spray_axialendcap_area_mult_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front rotor core surface area multiplier
