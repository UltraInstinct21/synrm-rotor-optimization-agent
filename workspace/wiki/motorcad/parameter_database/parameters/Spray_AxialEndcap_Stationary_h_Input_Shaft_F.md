...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_Shaft_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_Shaft_F
- Spray Axial Endcap Stationary h Input Shaft F
- spray_axial_endcap_stationary_h_input_shaft_f
- sprayAxialEndcapStationaryHInputShaftF
- spray_axialendcap_stationary_h_input_shaft_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the front shaft surface
