...
parameter_name: Spray_RadialRotor_Mixed_h_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_Mixed_h_EWdg_Inner_R
- Spray Radial Rotor Mixed h E Wdg Inner R
- spray_radial_rotor_mixed_h_e_wdg_inner_r
- sprayRadialRotorMixedHEWdgInnerR
- spray_radialrotor_mixed_h_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) mixed htc over the rear endwinding inner surface
