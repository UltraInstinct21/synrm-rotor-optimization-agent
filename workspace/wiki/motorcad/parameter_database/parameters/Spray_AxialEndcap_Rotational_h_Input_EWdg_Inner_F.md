...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_EWdg_Inner_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_EWdg_Inner_F
- Spray Axial Endcap Rotational h Input E Wdg Inner F
- spray_axial_endcap_rotational_h_input_e_wdg_inner_f
- sprayAxialEndcapRotationalHInputEWdgInnerF
- spray_axialendcap_rotational_h_input_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the front endwinding inner surface
