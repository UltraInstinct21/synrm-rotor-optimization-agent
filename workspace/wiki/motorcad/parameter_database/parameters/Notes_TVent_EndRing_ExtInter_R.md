...
parameter_name: Notes_TVent_EndRing_ExtInter_R
...
aliases:
- Notes_TVent_EndRing_ExtInter_R
- Notes T Vent End Ring Ext Inter R
- notes_t_vent_end_ring_ext_inter_r
- notesTVentEndRingExtInterR
- notes_tvent_endring_extinter_r
related_parameters:
...
## Summary
The TVent notes for the end ring ExtInter surface [rear]
