...
parameter_name: Area_Mult_ES_EW_Ext_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EW_Ext_F
- Area Mult ES EW Ext F
- area_mult_es_ew_ext_f
- areaMultEsEwExtF
related_parameters:
...
## Summary
Area multiplier for the End-Winding Extension [Front] surface for End Space Cooling
