...
parameter_name: Vel_Inlet_Rotor_EWdg_Cont_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_Inlet_Rotor_EWdg_Cont_Exp_Downstream
- Vel Inlet Rotor E Wdg Cont Exp Downstream
- vel_inlet_rotor_e_wdg_cont_exp_downstream
- velInletRotorEWdgContExpDownstream
- vel_inlet_rotor_ewdg_cont_exp_downstream
related_parameters:
...
## Summary
Velocity Inlet Rotor EWdg Contraction Expansion Downstream
