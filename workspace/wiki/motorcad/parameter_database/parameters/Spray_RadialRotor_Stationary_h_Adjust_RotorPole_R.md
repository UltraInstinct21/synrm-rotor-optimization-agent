...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_RotorPole_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_RotorPole_R
- Spray Radial Rotor Stationary h Adjust Rotor Pole R
- spray_radial_rotor_stationary_h_adjust_rotor_pole_r
- sprayRadialRotorStationaryHAdjustRotorPoleR
- spray_radialrotor_stationary_h_adjust_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the rear rotor pole surface
