...
parameter_name: Forced_Conv_Notes_Housing_Front_Corner_Cutout
...
aliases:
- Forced_Conv_Notes_Housing_Front_Corner_Cutout
- Forced Conv Notes Housing Front Corner Cutout
- forced_conv_notes_housing_front_corner_cutout
- forcedConvNotesHousingFrontCornerCutout
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Forced_Conv_Notes_Housing_Front_Fin_Channel|Forced_Conv_Notes_Housing_Front_Fin_Channel]]'
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of active housing section (corner cutout section) available for cooling to ambient
