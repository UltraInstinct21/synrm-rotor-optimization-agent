...
parameter_name: EWdgLayerLength_R
...
aliases:
- EWdgLayerLength_R
- E Wdg Layer Length R
- e_wdg_layer_length_r
- eWdgLayerLengthR
- ewdglayerlength_r
related_parameters:
...
- '[[motorcad/parameter_database/parameters/EWdgLayerLength_F|EWdgLayerLength_F]]'
- '[[motorcad/parameter_database/parameters/EWdgLayerLength_F_Calc|EWdgLayerLength_F_Calc]]'
- '[[motorcad/parameter_database/parameters/EWdgLayerLength_F_Adj|EWdgLayerLength_F_Adj]]'
- '[[motorcad/parameter_database/parameters/EWdgLayerLength_R_Calc|EWdgLayerLength_R_Calc]]'
- '[[motorcad/parameter_database/parameters/EWdgLayerLength_R_Adj|EWdgLayerLength_R_Adj]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The end winding length of each winding layer [Rear]
