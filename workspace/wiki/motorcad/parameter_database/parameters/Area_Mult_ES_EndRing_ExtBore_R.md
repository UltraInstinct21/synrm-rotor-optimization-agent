...
parameter_name: Area_Mult_ES_EndRing_ExtBore_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_ExtBore_R
- Area Mult ES End Ring Ext Bore R
- area_mult_es_end_ring_ext_bore_r
- areaMultEsEndRingExtBoreR
- area_mult_es_endring_extbore_r
related_parameters:
...
## Summary
Area multiplier for the End Ring Extension Bore [Rear] surface for End Space Cooling
