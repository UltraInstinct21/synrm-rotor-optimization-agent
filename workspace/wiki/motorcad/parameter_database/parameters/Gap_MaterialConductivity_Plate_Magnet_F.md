...
parameter_name: Gap_MaterialConductivity_Plate_Magnet_F
...
aliases:
- Gap_MaterialConductivity_Plate_Magnet_F
- Gap Material Conductivity Plate Magnet F
- gap_material_conductivity_plate_magnet_f
- gapMaterialConductivityPlateMagnetF
- gap_materialconductivity_plate_magnet_f
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Rotor Plate and Magnet [F].
