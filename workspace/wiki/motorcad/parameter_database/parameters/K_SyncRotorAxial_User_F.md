...
parameter_name: K_SyncRotorAxial_User_F
...
aliases:
- K_SyncRotorAxial_User_F
- K Sync Rotor Axial User F
- k_sync_rotor_axial_user_f
- kSyncRotorAxialUserF
- k_syncrotoraxial_user_f
related_parameters:
...
## Summary
This is the user input thermal conductivity of the sync field winding [front] in the axial direction
