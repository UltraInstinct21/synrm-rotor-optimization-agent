...
parameter_name: Area_Mult_TVent_EndRing_Outer_R
...
aliases:
- Area_Mult_TVent_EndRing_Outer_R
- Area Mult T Vent End Ring Outer R
- area_mult_t_vent_end_ring_outer_r
- areaMultTVentEndRingOuterR
- area_mult_tvent_endring_outer_r
related_parameters:
