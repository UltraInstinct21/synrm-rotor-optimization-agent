...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_Bearing_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_Bearing_F
- Spray Axial Endcap Rotational h Input Bearing F
- spray_axial_endcap_rotational_h_input_bearing_f
- sprayAxialEndcapRotationalHInputBearingF
- spray_axialendcap_rotational_h_input_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the front bearing surface
