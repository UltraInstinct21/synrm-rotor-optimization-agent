...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Stranded_EWdg_Outer_R
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Stranded_EWdg_Outer_R
- Spray Axial Endcap Correlation Factor Stranded E Wdg Outer R
- spray_axial_endcap_correlation_factor_stranded_e_wdg_outer_r
- sprayAxialEndcapCorrelationFactorStrandedEWdgOuterR
- spray_axialendcap_correlationfactor_stranded_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the stranded rear endwinding outer surface
