...
parameter_name: IMOnLoad_RMSLineBackEMF_L
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- IMOnLoad_RMSLineBackEMF_L
- IM On Load RMS Line Back EMF L
- im_on_load_rms_line_back_emf_l
- imOnLoadRmsLineBackEmfL
- imonload_rmslinebackemf_l
related_parameters:
...
## Summary
The rms back emf in L equivalent circuit across all the stator flux impedances
