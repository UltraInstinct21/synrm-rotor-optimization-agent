...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_RotorCore_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_RotorCore_R
- Spray Radial Rotor Stationary h Adjust Rotor Core R
- spray_radial_rotor_stationary_h_adjust_rotor_core_r
- sprayRadialRotorStationaryHAdjustRotorCoreR
- spray_radialrotor_stationary_h_adjust_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the rear rotor core surface
