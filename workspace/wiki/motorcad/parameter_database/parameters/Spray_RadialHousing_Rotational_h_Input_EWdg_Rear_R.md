...
parameter_name: Spray_RadialHousing_Rotational_h_Input_EWdg_Rear_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_EWdg_Rear_R
- Spray Radial Housing Rotational h Input E Wdg Rear R
- spray_radial_housing_rotational_h_input_e_wdg_rear_r
- sprayRadialHousingRotationalHInputEWdgRearR
- spray_radialhousing_rotational_h_input_ewdg_rear_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the rear endwinding rear surface
