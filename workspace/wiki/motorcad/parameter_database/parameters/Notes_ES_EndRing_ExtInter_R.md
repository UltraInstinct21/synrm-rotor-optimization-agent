...
parameter_name: Notes_ES_EndRing_ExtInter_R
category: End_Space
input_output: i/p
data_type: OleStr
units: N/A
default_value: default = blocked channel (k1 = 0)
source_file: D:/SRM/Agent/workspace/wiki/raw/ActiveXParameters.xlsx
aliases:
- Notes_ES_EndRing_ExtInter_R
- Notes ES End Ring Ext Inter R
- notes_es_end_ring_ext_inter_r
- notesEsEndRingExtInterR
- notes_es_endring_extinter_r
related_parameters:
...
## Summary
The notes for the end ring ExtInter surface [rear]
...
- **Units**: N/A
- **Default Value**: default = blocked channel (k1 = 0)
