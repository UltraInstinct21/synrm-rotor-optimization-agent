...
parameter_name: Spray_RadialHousing_NozzleVelocity_R
...
aliases:
- Spray_RadialHousing_NozzleVelocity_R
- Spray Radial Housing Nozzle Velocity R
- spray_radial_housing_nozzle_velocity_r
- sprayRadialHousingNozzleVelocityR
- spray_radialhousing_nozzlevelocity_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rear nozzle velocity
