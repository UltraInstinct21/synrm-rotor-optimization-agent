...
parameter_name: Spray_AxialEndcap_Calc_Input_h_Housing_F
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_Housing_F
- Spray Axial Endcap Calc Input h Housing F
- spray_axial_endcap_calc_input_h_housing_f
- sprayAxialEndcapCalcInputHHousingF
- spray_axialendcap_calc_input_h_housing_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the front housing surface is calculated or user input  (0=Calc h, 1=Input h)
