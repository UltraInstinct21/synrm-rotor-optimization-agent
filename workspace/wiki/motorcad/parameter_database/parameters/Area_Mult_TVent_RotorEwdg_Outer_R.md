...
parameter_name: Area_Mult_TVent_RotorEwdg_Outer_R
...
aliases:
- Area_Mult_TVent_RotorEwdg_Outer_R
- Area Mult T Vent Rotor Ewdg Outer R
- area_mult_t_vent_rotor_ewdg_outer_r
- areaMultTVentRotorEwdgOuterR
- area_mult_tvent_rotorewdg_outer_r
related_parameters:
