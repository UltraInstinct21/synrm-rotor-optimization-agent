...
parameter_name: IMOnLoad_RMSStatorLeakageVoltage_L
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- IMOnLoad_RMSStatorLeakageVoltage_L
- IM On Load RMS Stator Leakage Voltage L
- im_on_load_rms_stator_leakage_voltage_l
- imOnLoadRmsStatorLeakageVoltageL
- imonload_rmsstatorleakagevoltage_l
related_parameters:
