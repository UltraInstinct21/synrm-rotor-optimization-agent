...
parameter_name: Material_Weight_Notes_LitzImpreg_T
...
aliases:
- Material_Weight_Notes_LitzImpreg_T
- Material Weight Notes Litz Impreg T
- material_weight_notes_litz_impreg_t
- materialWeightNotesLitzImpregT
- material_weight_notes_litzimpreg_t
related_parameters:
...
## Summary
The material notes of the Litz Bundle Impregnation Material (Total)
