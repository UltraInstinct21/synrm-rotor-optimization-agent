...
parameter_name: Area_ES_RotorEwdg_inner_F
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_RotorEwdg_inner_F
- Area ES Rotor Ewdg inner F
- area_es_rotor_ewdg_inner_f
- areaEsRotorEwdgInnerF
- area_es_rotorewdg_inner_f
related_parameters:
...
## Summary
The area of the end wdg inner surface [front]
