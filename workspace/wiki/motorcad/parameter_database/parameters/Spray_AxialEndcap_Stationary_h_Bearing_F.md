...
parameter_name: Spray_AxialEndcap_Stationary_h_Bearing_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Bearing_F
- Spray Axial Endcap Stationary h Bearing F
- spray_axial_endcap_stationary_h_bearing_f
- sprayAxialEndcapStationaryHBearingF
- spray_axialendcap_stationary_h_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the front bearing surface
