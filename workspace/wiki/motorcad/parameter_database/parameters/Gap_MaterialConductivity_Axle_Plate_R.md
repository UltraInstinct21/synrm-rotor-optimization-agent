...
parameter_name: Gap_MaterialConductivity_Axle_Plate_R
...
aliases:
- Gap_MaterialConductivity_Axle_Plate_R
- Gap Material Conductivity Axle Plate R
- gap_material_conductivity_axle_plate_r
- gapMaterialConductivityAxlePlateR
- gap_materialconductivity_axle_plate_r
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Axle and Plate [R].
