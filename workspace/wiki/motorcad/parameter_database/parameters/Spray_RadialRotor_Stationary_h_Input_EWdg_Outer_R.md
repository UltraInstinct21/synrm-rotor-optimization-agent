...
parameter_name: Spray_RadialRotor_Stationary_h_Input_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_EWdg_Outer_R
- Spray Radial Rotor Stationary h Input E Wdg Outer R
- spray_radial_rotor_stationary_h_input_e_wdg_outer_r
- sprayRadialRotorStationaryHInputEWdgOuterR
- spray_radialrotor_stationary_h_input_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the rear endwinding outer surface
