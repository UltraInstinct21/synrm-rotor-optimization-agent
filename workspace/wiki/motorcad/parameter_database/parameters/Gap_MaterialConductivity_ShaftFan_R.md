...
parameter_name: Gap_MaterialConductivity_ShaftFan_R
...
aliases:
- Gap_MaterialConductivity_ShaftFan_R
- Gap Material Conductivity Shaft Fan R
- gap_material_conductivity_shaft_fan_r
- gapMaterialConductivityShaftFanR
- gap_materialconductivity_shaftfan_r
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Fan and Shaft [R].
