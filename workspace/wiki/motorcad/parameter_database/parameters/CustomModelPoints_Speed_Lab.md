...
parameter_name: CustomModelPoints_Speed_Lab
...
aliases:
- CustomModelPoints_Speed_Lab
- Custom Model Points Speed Lab
- custom_model_points_speed_lab
- customModelPointsSpeedLab
- custommodelpoints_speed_lab
related_parameters:
...
## Summary
Number of speed points in Lab saturation/loss model build custom resolution array.
