...
parameter_name: UMagnetInner_ClearanceI_Array
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- UMagnetInner_ClearanceI_Array
- U Magnet Inner Clearance I Array
- u_magnet_inner_clearance_i_array
- uMagnetInnerClearanceIArray
- umagnetinner_clearancei_array
related_parameters:
...
- '[[motorcad/parameter_database/parameters/UMagnetInner_ClearanceO_Array|UMagnetInner_ClearanceO_Array]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The clearance of the U-Layer Inner magnet away from the magnet pole
