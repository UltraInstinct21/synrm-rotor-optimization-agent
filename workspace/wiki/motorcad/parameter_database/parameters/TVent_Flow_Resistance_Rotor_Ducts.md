...
parameter_name: TVent_Flow_Resistance_Rotor_Ducts
category: TVent_Data
input_output: o/p
data_type: double
units: kg/m⁷
...
aliases:
- TVent_Flow_Resistance_Rotor_Ducts
- T Vent Flow Resistance Rotor Ducts
- t_vent_flow_resistance_rotor_ducts
- tVentFlowResistanceRotorDucts
- tvent_flow_resistance_rotor_ducts
related_parameters:
...
## Summary
Flow Resistance of rotor ducts
