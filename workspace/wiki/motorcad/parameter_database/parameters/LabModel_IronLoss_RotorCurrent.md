...
parameter_name: LabModel_IronLoss_RotorCurrent
...
aliases:
- LabModel_IronLoss_RotorCurrent
- Lab Model Iron Loss Rotor Current
- lab_model_iron_loss_rotor_current
- labModelIronLossRotorCurrent
- labmodel_ironloss_rotorcurrent
related_parameters:
...
## Summary
Maximum rotor current used in Lab iron loss model build
