...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_Shaft_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_Shaft_R
- Spray Axial Endcap Stationary h Input Shaft R
- spray_axial_endcap_stationary_h_input_shaft_r
- sprayAxialEndcapStationaryHInputShaftR
- spray_axialendcap_stationary_h_input_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the rear shaft surface
