...
parameter_name: Spray_AxialEndcap_Rotational_h_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_RotorCore_R
- Spray Axial Endcap Rotational h Rotor Core R
- spray_axial_endcap_rotational_h_rotor_core_r
- sprayAxialEndcapRotationalHRotorCoreR
- spray_axialendcap_rotational_h_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc over the rear rotor core surface
