...
parameter_name: Re_TVent_EndRing_Outer_R
...
aliases:
- Re_TVent_EndRing_Outer_R
- Re T Vent End Ring Outer R
- re_t_vent_end_ring_outer_r
- reTVentEndRingOuterR
- re_tvent_endring_outer_r
related_parameters:
...
## Summary
The TVent reynolds number for flow over the end ring Outer surface [rear]
