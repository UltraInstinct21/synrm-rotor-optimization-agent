...
parameter_name: Spray_RadialHousing_Rt_RotorPole_F
...
aliases:
- Spray_RadialHousing_Rt_RotorPole_F
- Spray Radial Housing Rt Rotor Pole F
- spray_radial_housing_rt_rotor_pole_f
- sprayRadialHousingRtRotorPoleF
- spray_radialhousing_rt_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) fluid to front rotor pole surface convective thermal resistance
