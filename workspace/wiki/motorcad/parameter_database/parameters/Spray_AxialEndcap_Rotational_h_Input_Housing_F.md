...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_Housing_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_Housing_F
- Spray Axial Endcap Rotational h Input Housing F
- spray_axial_endcap_rotational_h_input_housing_f
- sprayAxialEndcapRotationalHInputHousingF
- spray_axialendcap_rotational_h_input_housing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the front housing surface
