...
parameter_name: Spray_RadialHousing_Calc_Input_h_Endcap_F
...
aliases:
- Spray_RadialHousing_Calc_Input_h_Endcap_F
- Spray Radial Housing Calc Input h Endcap F
- spray_radial_housing_calc_input_h_endcap_f
- sprayRadialHousingCalcInputHEndcapF
- spray_radialhousing_calc_input_h_endcap_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the front endcap surface is calculated or user input  (0=Calc h, 1=Input h)
