...
parameter_name: h_Adjust_TVent_RotorLam_F
...
aliases:
- h_Adjust_TVent_RotorLam_F
- h Adjust T Vent Rotor Lam F
- h_adjust_t_vent_rotor_lam_f
- hAdjustTVentRotorLamF
- h_adjust_tvent_rotorlam_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the Rotor lam surface [front]
