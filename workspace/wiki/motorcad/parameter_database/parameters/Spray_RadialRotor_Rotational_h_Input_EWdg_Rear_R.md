...
parameter_name: Spray_RadialRotor_Rotational_h_Input_EWdg_Rear_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_EWdg_Rear_R
- Spray Radial Rotor Rotational h Input E Wdg Rear R
- spray_radial_rotor_rotational_h_input_e_wdg_rear_r
- sprayRadialRotorRotationalHInputEWdgRearR
- spray_radialrotor_rotational_h_input_ewdg_rear_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the rear endwinding rear surface
