...
parameter_name: Forced_Conv_Notes_Base
...
aliases:
- Forced_Conv_Notes_Base
- Forced Conv Notes Base
- forced_conv_notes_base
- forcedConvNotesBase
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of foot mounted plate available for cooling to ambient
