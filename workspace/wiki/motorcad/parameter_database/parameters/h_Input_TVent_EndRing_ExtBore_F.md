...
parameter_name: h_Input_TVent_EndRing_ExtBore_F
...
- h Input T Vent End Ring Ext Bore F
- h_input_t_vent_end_ring_ext_bore_f
- hInputTVentEndRingExtBoreF
- h_input_tvent_endring_extbore_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the end ring ExtBore surface [front]
