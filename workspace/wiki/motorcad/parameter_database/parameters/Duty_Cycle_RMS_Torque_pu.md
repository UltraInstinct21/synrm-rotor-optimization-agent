...
parameter_name: Duty_Cycle_RMS_Torque_pu
category: Transient
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Duty_Cycle_RMS_Torque_pu
- Duty Cycle RMS Torque pu
- duty_cycle_rms_torque_pu
- dutyCycleRmsTorquePu
related_parameters:
...
## Summary
RMS value of torque (pu) from the supplied duty cycle
