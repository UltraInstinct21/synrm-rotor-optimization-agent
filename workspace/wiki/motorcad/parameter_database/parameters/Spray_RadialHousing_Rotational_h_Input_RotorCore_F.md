...
parameter_name: Spray_RadialHousing_Rotational_h_Input_RotorCore_F
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_RotorCore_F
- Spray Radial Housing Rotational h Input Rotor Core F
- spray_radial_housing_rotational_h_input_rotor_core_f
- sprayRadialHousingRotationalHInputRotorCoreF
- spray_radialhousing_rotational_h_input_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the front rotor core surface
