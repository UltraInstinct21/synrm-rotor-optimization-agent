...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_Endcap_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_Endcap_R
- Spray Axial Endcap Stationary h Input Endcap R
- spray_axial_endcap_stationary_h_input_endcap_r
- sprayAxialEndcapStationaryHInputEndcapR
- spray_axialendcap_stationary_h_input_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the rear endcap surface
