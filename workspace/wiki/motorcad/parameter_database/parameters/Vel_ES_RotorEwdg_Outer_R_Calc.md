...
parameter_name: Vel_ES_RotorEwdg_Outer_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_RotorEwdg_Outer_R_Calc
- Vel ES Rotor Ewdg Outer R Calc
- vel_es_rotor_ewdg_outer_r_calc
- velEsRotorEwdgOuterRCalc
- vel_es_rotorewdg_outer_r_calc
related_parameters:
...
## Summary
The calculated velocity over the end wdg Outer surface [rear]
