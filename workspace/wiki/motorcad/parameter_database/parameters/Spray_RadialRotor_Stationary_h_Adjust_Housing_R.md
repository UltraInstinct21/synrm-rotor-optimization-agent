...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_Housing_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_Housing_R
- Spray Radial Rotor Stationary h Adjust Housing R
- spray_radial_rotor_stationary_h_adjust_housing_r
- sprayRadialRotorStationaryHAdjustHousingR
- spray_radialrotor_stationary_h_adjust_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the rear housing surface
