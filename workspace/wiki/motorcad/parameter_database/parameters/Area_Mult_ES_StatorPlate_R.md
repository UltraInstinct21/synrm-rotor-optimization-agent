...
parameter_name: Area_Mult_ES_StatorPlate_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_StatorPlate_R
- Area Mult ES Stator Plate R
- area_mult_es_stator_plate_r
- areaMultEsStatorPlateR
- area_mult_es_statorplate_r
related_parameters:
...
## Summary
Area multiplier for the Stator Plate [Rear] surface for End Space Cooling
