...
parameter_name: Spray_AxialEndcap_Stationary_h_Housing_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Housing_R
- Spray Axial Endcap Stationary h Housing R
- spray_axial_endcap_stationary_h_housing_r
- sprayAxialEndcapStationaryHHousingR
- spray_axialendcap_stationary_h_housing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the rear housing surface
