...
parameter_name: Spray_RadialHousing_Calc_Input_h_RotorCore_F
...
aliases:
- Spray_RadialHousing_Calc_Input_h_RotorCore_F
- Spray Radial Housing Calc Input h Rotor Core F
- spray_radial_housing_calc_input_h_rotor_core_f
- sprayRadialHousingCalcInputHRotorCoreF
- spray_radialhousing_calc_input_h_rotorcore_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the front rotor core surface is calculated or user input  (0=Calc h, 1=Input h)
