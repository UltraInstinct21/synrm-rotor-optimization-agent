...
parameter_name: Forced_Conv_Notes_Housing_Active_Fin_Channel
...
aliases:
- Forced_Conv_Notes_Housing_Active_Fin_Channel
- Forced Conv Notes Housing Active Fin Channel
- forced_conv_notes_housing_active_fin_channel
- forcedConvNotesHousingActiveFinChannel
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Forced_Conv_Notes_Housing_Active_Corner_Cutout|Forced_Conv_Notes_Housing_Active_Corner_Cutout]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Notes h[fc] Housing [A] - Fin Channel
