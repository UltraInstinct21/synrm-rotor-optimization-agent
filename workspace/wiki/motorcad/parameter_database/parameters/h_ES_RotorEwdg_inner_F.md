...
parameter_name: h_ES_RotorEwdg_inner_F
category: End_Space
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_ES_RotorEwdg_inner_F
- h ES Rotor Ewdg inner F
- h_es_rotor_ewdg_inner_f
- hEsRotorEwdgInnerF
- h_es_rotorewdg_inner_f
related_parameters:
...
## Summary
The heat transfer coefficient over the end wdg inner surface [front]
