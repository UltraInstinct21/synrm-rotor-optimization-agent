...
parameter_name: Spray_AxialEndcap_Rt_EWdg_R
...
aliases:
- Spray_AxialEndcap_Rt_EWdg_R
- Spray Axial Endcap Rt E Wdg R
- spray_axial_endcap_rt_e_wdg_r
- sprayAxialEndcapRtEWdgR
- spray_axialendcap_rt_ewdg_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to rear endwinding area average convective thermal resistance
