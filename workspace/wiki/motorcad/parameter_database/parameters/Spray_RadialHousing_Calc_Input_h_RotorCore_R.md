...
parameter_name: Spray_RadialHousing_Calc_Input_h_RotorCore_R
...
aliases:
- Spray_RadialHousing_Calc_Input_h_RotorCore_R
- Spray Radial Housing Calc Input h Rotor Core R
- spray_radial_housing_calc_input_h_rotor_core_r
- sprayRadialHousingCalcInputHRotorCoreR
- spray_radialhousing_calc_input_h_rotorcore_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the rear rotor core surface is calculated or user input  (0=Calc h, 1=Input h)
