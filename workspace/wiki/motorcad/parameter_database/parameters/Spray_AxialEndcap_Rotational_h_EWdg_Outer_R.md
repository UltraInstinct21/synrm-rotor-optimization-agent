...
parameter_name: Spray_AxialEndcap_Rotational_h_EWdg_Outer_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_EWdg_Outer_R
- Spray Axial Endcap Rotational h E Wdg Outer R
- spray_axial_endcap_rotational_h_e_wdg_outer_r
- sprayAxialEndcapRotationalHEWdgOuterR
- spray_axialendcap_rotational_h_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc over the rear endwinding outer surface
