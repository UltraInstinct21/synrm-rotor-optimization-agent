...
parameter_name: Spray_AxialEndcap_CorrelationFactor_RotorPole_R
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_RotorPole_R
- Spray Axial Endcap Correlation Factor Rotor Pole R
- spray_axial_endcap_correlation_factor_rotor_pole_r
- sprayAxialEndcapCorrelationFactorRotorPoleR
- spray_axialendcap_correlationfactor_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the rear rotor pole surface
