...
parameter_name: Area_ES_ExtShaftOuter_F
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_ExtShaftOuter_F
- Area ES Ext Shaft Outer F
- area_es_ext_shaft_outer_f
- areaEsExtShaftOuterF
- area_es_extshaftouter_f
related_parameters:
...
## Summary
End Space Cooling - area for shaft extension outer [front]
