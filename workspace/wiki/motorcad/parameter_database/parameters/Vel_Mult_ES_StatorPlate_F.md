...
parameter_name: Vel_Mult_ES_StatorPlate_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_StatorPlate_F
- Vel Mult ES Stator Plate F
- vel_mult_es_stator_plate_f
- velMultEsStatorPlateF
- vel_mult_es_statorplate_f
related_parameters:
...
## Summary
End Space Cooling - velocity multiplier for stator plate [front]
