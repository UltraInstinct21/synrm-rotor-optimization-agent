...
parameter_name: Spray_RadialHousing_Mixed_h_EWdg_Inner_R
...
aliases:
- Spray_RadialHousing_Mixed_h_EWdg_Inner_R
- Spray Radial Housing Mixed h E Wdg Inner R
- spray_radial_housing_mixed_h_e_wdg_inner_r
- sprayRadialHousingMixedHEWdgInnerR
- spray_radialhousing_mixed_h_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the rear endwinding inner surface
