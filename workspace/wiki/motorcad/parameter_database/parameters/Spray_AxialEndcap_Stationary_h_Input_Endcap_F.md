...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_Endcap_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_Endcap_F
- Spray Axial Endcap Stationary h Input Endcap F
- spray_axial_endcap_stationary_h_input_endcap_f
- sprayAxialEndcapStationaryHInputEndcapF
- spray_axialendcap_stationary_h_input_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the front endcap surface
