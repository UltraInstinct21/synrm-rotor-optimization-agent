...
parameter_name: Vel_Mult_ES_RotorEwdg_Outer_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_RotorEwdg_Outer_R
- Vel Mult ES Rotor Ewdg Outer R
- vel_mult_es_rotor_ewdg_outer_r
- velMultEsRotorEwdgOuterR
- vel_mult_es_rotorewdg_outer_r
related_parameters:
...
## Summary
The velocity multiplier for end wdg Outer surface [rear]
