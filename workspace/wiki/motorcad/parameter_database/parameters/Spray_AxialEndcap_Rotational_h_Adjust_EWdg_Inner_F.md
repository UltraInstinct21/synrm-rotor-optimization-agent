...
parameter_name: Spray_AxialEndcap_Rotational_h_Adjust_EWdg_Inner_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_Adjust_EWdg_Inner_F
- Spray Axial Endcap Rotational h Adjust E Wdg Inner F
- spray_axial_endcap_rotational_h_adjust_e_wdg_inner_f
- sprayAxialEndcapRotationalHAdjustEWdgInnerF
- spray_axialendcap_rotational_h_adjust_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc adjustment over the front endwinding inner surface
