...
parameter_name: Spray_RadialHousing_Mixed_h_Endcap_F
...
aliases:
- Spray_RadialHousing_Mixed_h_Endcap_F
- Spray Radial Housing Mixed h Endcap F
- spray_radial_housing_mixed_h_endcap_f
- sprayRadialHousingMixedHEndcapF
- spray_radialhousing_mixed_h_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the front endcap surface
