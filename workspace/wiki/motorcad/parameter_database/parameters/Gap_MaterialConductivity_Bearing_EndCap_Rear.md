...
parameter_name: Gap_MaterialConductivity_Bearing_EndCap_Rear
...
aliases:
- Gap_MaterialConductivity_Bearing_EndCap_Rear
- Gap Material Conductivity Bearing End Cap Rear
- gap_material_conductivity_bearing_end_cap_rear
- gapMaterialConductivityBearingEndCapRear
- gap_materialconductivity_bearing_endcap_rear
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Bearing and Endcap [R].
