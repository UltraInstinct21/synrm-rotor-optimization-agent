...
parameter_name: Rt_TVent_EndRing_F
...
aliases:
- Rt_TVent_EndRing_F
- Rt T Vent End Ring F
- rt_t_vent_end_ring_f
- rtTVentEndRingF
- rt_tvent_endring_f
related_parameters:
...
## Summary
The thermal resistance from the surfaces of front rotor end ring to the fluid
