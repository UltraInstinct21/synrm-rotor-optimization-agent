...
parameter_name: Area_ES_RotorEwdg_Outer_F
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_RotorEwdg_Outer_F
- Area ES Rotor Ewdg Outer F
- area_es_rotor_ewdg_outer_f
- areaEsRotorEwdgOuterF
- area_es_rotorewdg_outer_f
related_parameters:
...
## Summary
The area of the end wdg Outer surface [front]
