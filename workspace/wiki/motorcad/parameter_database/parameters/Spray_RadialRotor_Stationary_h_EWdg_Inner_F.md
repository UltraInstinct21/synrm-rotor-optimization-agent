...
parameter_name: Spray_RadialRotor_Stationary_h_EWdg_Inner_F
...
aliases:
- Spray_RadialRotor_Stationary_h_EWdg_Inner_F
- Spray Radial Rotor Stationary h E Wdg Inner F
- spray_radial_rotor_stationary_h_e_wdg_inner_f
- sprayRadialRotorStationaryHEWdgInnerF
- spray_radialrotor_stationary_h_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the front endwinding inner surface
