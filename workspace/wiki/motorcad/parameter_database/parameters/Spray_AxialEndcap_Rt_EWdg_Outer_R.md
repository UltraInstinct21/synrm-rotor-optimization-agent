...
parameter_name: Spray_AxialEndcap_Rt_EWdg_Outer_R
...
aliases:
- Spray_AxialEndcap_Rt_EWdg_Outer_R
- Spray Axial Endcap Rt E Wdg Outer R
- spray_axial_endcap_rt_e_wdg_outer_r
- sprayAxialEndcapRtEWdgOuterR
- spray_axialendcap_rt_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to rear endwinding outer surface convective thermal resistance
