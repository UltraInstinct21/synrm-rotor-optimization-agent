...
parameter_name: LabModel_SleeveLoss_RotorCurrent
...
aliases:
- LabModel_SleeveLoss_RotorCurrent
- Lab Model Sleeve Loss Rotor Current
- lab_model_sleeve_loss_rotor_current
- labModelSleeveLossRotorCurrent
- labmodel_sleeveloss_rotorcurrent
related_parameters:
...
## Summary
Maximum rotor current used in Lab sleeve loss model build
