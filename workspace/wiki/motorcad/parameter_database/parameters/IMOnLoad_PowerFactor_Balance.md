...
parameter_name: IMOnLoad_PowerFactor_Balance
category: Magnetics
input_output: o/p
data_type: double
units: N/A
...
aliases:
- IMOnLoad_PowerFactor_Balance
- IM On Load Power Factor Balance
- im_on_load_power_factor_balance
- imOnLoadPowerFactorBalance
- imonload_powerfactor_balance
related_parameters:
...
## Summary
The on load power factor from the power balance
