...
parameter_name: BMax_StatorTooth_Static
category: Magnetics
input_output: o/p
data_type: double
units: Tesla
...
aliases:
- BMax_StatorTooth_Static
- B Max Stator Tooth Static
- b_max_stator_tooth_static
- bMaxStatorToothStatic
- bmax_statortooth_static
related_parameters:
...
## Summary
Maximum flux density at midpoint in the stator tooth (Initial static solution)
