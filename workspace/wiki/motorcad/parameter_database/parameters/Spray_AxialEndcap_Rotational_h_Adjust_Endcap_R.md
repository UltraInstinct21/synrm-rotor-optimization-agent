...
parameter_name: Spray_AxialEndcap_Rotational_h_Adjust_Endcap_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Adjust_Endcap_R
- Spray Axial Endcap Rotational h Adjust Endcap R
- spray_axial_endcap_rotational_h_adjust_endcap_r
- sprayAxialEndcapRotationalHAdjustEndcapR
- spray_axialendcap_rotational_h_adjust_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc adjustment over the rear endcap surface
