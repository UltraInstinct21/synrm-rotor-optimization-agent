...
parameter_name: Dissipation_TVent_EndRing_Inner_R
...
aliases:
- Dissipation_TVent_EndRing_Inner_R
- Dissipation T Vent End Ring Inner R
- dissipation_t_vent_end_ring_inner_r
- dissipationTVentEndRingInnerR
- dissipation_tvent_endring_inner_r
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Dissipation_TVent_EndRing_End_F|Dissipation_TVent_EndRing_End_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The dissipation from the inner surface of rear rotor end ring
