...
parameter_name: Gap_Axle_Plate_F_Comment
...
aliases:
- Gap_Axle_Plate_F_Comment
- Gap Axle Plate F Comment
- gap_axle_plate_f_comment
- gapAxlePlateFComment
related_parameters:
...
## Summary
Details of the interface gap between axle and cooling plate (BPMOR) [front of motor]
