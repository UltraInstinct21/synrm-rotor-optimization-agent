...
parameter_name: StatorToothLoss_Hys_Minor_OC
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- StatorToothLoss_Hys_Minor_OC
- Stator Tooth Loss Hys Minor OC
- stator_tooth_loss_hys_minor_oc
- statorToothLossHysMinorOc
- statortoothloss_hys_minor_oc
related_parameters:
...
## Summary
Stator tooth losses from hysteresis
