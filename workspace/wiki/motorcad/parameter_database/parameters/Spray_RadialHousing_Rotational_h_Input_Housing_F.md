...
parameter_name: Spray_RadialHousing_Rotational_h_Input_Housing_F
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_Housing_F
- Spray Radial Housing Rotational h Input Housing F
- spray_radial_housing_rotational_h_input_housing_f
- sprayRadialHousingRotationalHInputHousingF
- spray_radialhousing_rotational_h_input_housing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the front housing surface
