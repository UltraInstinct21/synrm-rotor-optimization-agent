...
parameter_name: h_TVent_Axial_EndRing_End_R
...
aliases:
- h_TVent_Axial_EndRing_End_R
- h T Vent Axial End Ring End R
- h_t_vent_axial_end_ring_end_r
- hTVentAxialEndRingEndR
- h_tvent_axial_endring_end_r
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the end ring End surface [rear]
