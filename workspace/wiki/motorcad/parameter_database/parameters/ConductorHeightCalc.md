...
parameter_name: ConductorHeightCalc
category: Dimensions
input_output: o/p
data_type: double
units: mm
...
aliases:
- ConductorHeightCalc
- Conductor Height Calc
- conductor_height_calc
- conductorHeightCalc
- conductorheightcalc
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ConductorSeparation|ConductorSeparation]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The calculated height of each conductor bar
