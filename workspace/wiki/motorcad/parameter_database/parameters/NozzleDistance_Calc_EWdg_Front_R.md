...
parameter_name: NozzleDistance_Calc_EWdg_Front_R
...
aliases:
- NozzleDistance_Calc_EWdg_Front_R
- Nozzle Distance Calc E Wdg Front R
- nozzle_distance_calc_e_wdg_front_r
- nozzleDistanceCalcEWdgFrontR
- nozzledistance_calc_ewdg_front_r
related_parameters:
...
- '[[motorcad/parameter_database/parameters/NozzleDistance_Calc_EWdg_Outer_F|NozzleDistance_Calc_EWdg_Outer_F]]'
- '[[motorcad/parameter_database/parameters/NozzleDistance_Adj_EWdg_Outer_F|NozzleDistance_Adj_EWdg_Outer_F]]'
- '[[motorcad/parameter_database/parameters/NozzleDistance_EWdg_Outer_F|NozzleDistance_EWdg_Outer_F]]'
- '[[motorcad/parameter_database/parameters/NozzleDistance_Calc_EWdg_Front_F|NozzleDistance_Calc_EWdg_Front_F]]'
- '[[motorcad/parameter_database/parameters/NozzleDistance_Adj_EWdg_Front_F|NozzleDistance_Adj_EWdg_Front_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This is the calculated distance of nozzle to front surface of Rear endwinding
