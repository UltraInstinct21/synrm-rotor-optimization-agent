...
parameter_name: IMOnLoad_IronLosses_Static
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- IMOnLoad_IronLosses_Static
- IM On Load Iron Losses Static
- im_on_load_iron_losses_static
- imOnLoadIronLossesStatic
- imonload_ironlosses_static
related_parameters:
...
## Summary
The on load iron losses (initial static solution)
