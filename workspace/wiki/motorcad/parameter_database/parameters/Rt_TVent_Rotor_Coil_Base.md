...
parameter_name: Rt_TVent_Rotor_Coil_Base
...
aliases:
- Rt_TVent_Rotor_Coil_Base
- Rt T Vent Rotor Coil Base
- rt_t_vent_rotor_coil_base
- rtTVentRotorCoilBase
- rt_tvent_rotor_coil_base
related_parameters:
...
## Summary
Thermal resistance from rotor fluid to coil base surface
