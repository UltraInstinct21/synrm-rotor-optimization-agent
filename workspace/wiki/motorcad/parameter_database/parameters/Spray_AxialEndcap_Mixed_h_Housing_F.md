...
parameter_name: Spray_AxialEndcap_Mixed_h_Housing_F
...
aliases:
- Spray_AxialEndcap_Mixed_h_Housing_F
- Spray Axial Endcap Mixed h Housing F
- spray_axial_endcap_mixed_h_housing_f
- sprayAxialEndcapMixedHHousingF
- spray_axialendcap_mixed_h_housing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the front housing surface
