...
parameter_name: Spray_Area_Calc_EndcapFluid_R
...
aliases:
- Spray_Area_Calc_EndcapFluid_R
- Spray Area Calc Endcap Fluid R
- spray_area_calc_endcap_fluid_r
- sprayAreaCalcEndcapFluidR
- spray_area_calc_endcapfluid_r
related_parameters:
...
## Summary
Calculated Area of the Endcap Rear section subjected to Spray Cooling
