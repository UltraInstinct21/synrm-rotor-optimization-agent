...
parameter_name: Spray_AxialEndcap_NozzleDiameter_R
...
aliases:
- Spray_AxialEndcap_NozzleDiameter_R
- Spray Axial Endcap Nozzle Diameter R
- spray_axial_endcap_nozzle_diameter_r
- sprayAxialEndcapNozzleDiameterR
- spray_axialendcap_nozzlediameter_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear nozzle diameter
