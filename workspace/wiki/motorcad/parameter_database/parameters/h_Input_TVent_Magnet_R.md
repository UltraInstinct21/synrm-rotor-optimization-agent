...
parameter_name: h_Input_TVent_Magnet_R
...
aliases:
- h_Input_TVent_Magnet_R
- h Input T Vent Magnet R
- h_input_t_vent_magnet_r
- hInputTVentMagnetR
- h_input_tvent_magnet_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the Magnet surface [rear]
