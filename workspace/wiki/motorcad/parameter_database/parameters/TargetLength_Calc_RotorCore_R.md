...
parameter_name: TargetLength_Calc_RotorCore_R
...
aliases:
- TargetLength_Calc_RotorCore_R
- Target Length Calc Rotor Core R
- target_length_calc_rotor_core_r
- targetLengthCalcRotorCoreR
- targetlength_calc_rotorcore_r
related_parameters:
...
## Summary
This is the calculated length of spray target on Rear Rotor Core
