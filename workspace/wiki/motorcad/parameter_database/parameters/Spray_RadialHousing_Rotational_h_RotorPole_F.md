...
parameter_name: Spray_RadialHousing_Rotational_h_RotorPole_F
...
aliases:
- Spray_RadialHousing_Rotational_h_RotorPole_F
- Spray Radial Housing Rotational h Rotor Pole F
- spray_radial_housing_rotational_h_rotor_pole_f
- sprayRadialHousingRotationalHRotorPoleF
- spray_radialhousing_rotational_h_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rotational htc over the front rotor pole surface
