...
parameter_name: Forced_Conv_Notes_Endcap_Rear_Radial
...
aliases:
- Forced_Conv_Notes_Endcap_Rear_Radial
- Forced Conv Notes Endcap Rear Radial
- forced_conv_notes_endcap_rear_radial
- forcedConvNotesEndcapRearRadial
related_parameters:
...
## Summary
Notes for heat transfer coefficient [Forced Convection] of rear endcap (radial section) available for cooling to ambient
