...
parameter_name: Rt_TVent_RotorEWdg_F
...
aliases:
- Rt_TVent_RotorEWdg_F
- Rt T Vent Rotor E Wdg F
- rt_t_vent_rotor_e_wdg_f
- rtTVentRotorEWdgF
- rt_tvent_rotorewdg_f
related_parameters:
...
## Summary
The thermal resistance from the surfaces of front rotor endwinding to the fluid
