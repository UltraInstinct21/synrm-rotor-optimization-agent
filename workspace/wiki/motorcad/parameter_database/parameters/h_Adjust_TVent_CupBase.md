...
parameter_name: h_Adjust_TVent_CupBase
...
aliases:
- h_Adjust_TVent_CupBase
- h Adjust T Vent Cup Base
- h_adjust_t_vent_cup_base
- hAdjustTVentCupBase
- h_adjust_tvent_cupbase
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the Cup Base
