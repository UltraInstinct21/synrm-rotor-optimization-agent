...
parameter_name: Spray_RadialRotor_CorrelationFactor_Bearing_R
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Bearing_R
- Spray Radial Rotor Correlation Factor Bearing R
- spray_radial_rotor_correlation_factor_bearing_r
- sprayRadialRotorCorrelationFactorBearingR
- spray_radialrotor_correlationfactor_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the rear bearing surface
