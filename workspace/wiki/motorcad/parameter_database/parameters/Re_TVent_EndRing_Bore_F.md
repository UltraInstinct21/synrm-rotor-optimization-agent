...
parameter_name: Re_TVent_EndRing_Bore_F
...
aliases:
- Re_TVent_EndRing_Bore_F
- Re T Vent End Ring Bore F
- re_t_vent_end_ring_bore_f
- reTVentEndRingBoreF
- re_tvent_endring_bore_f
related_parameters:
...
## Summary
The TVent reynolds number for flow over the end ring bore surface [front]
