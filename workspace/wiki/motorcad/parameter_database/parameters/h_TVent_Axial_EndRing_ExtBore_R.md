...
parameter_name: h_TVent_Axial_EndRing_ExtBore_R
...
aliases:
- h_TVent_Axial_EndRing_ExtBore_R
- h T Vent Axial End Ring Ext Bore R
- h_t_vent_axial_end_ring_ext_bore_r
- hTVentAxialEndRingExtBoreR
- h_tvent_axial_endring_extbore_r
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the end ring ExtBore surface [rear]
