...
parameter_name: TVent_Volume_Flow_Rate_Rotor_Airgap
category: TVent_Data
input_output: o/p
data_type: double
units: m³/s
...
aliases:
- TVent_Volume_Flow_Rate_Rotor_Airgap
- T Vent Volume Flow Rate Rotor Airgap
- t_vent_volume_flow_rate_rotor_airgap
- tVentVolumeFlowRateRotorAirgap
- tvent_volume_flow_rate_rotor_airgap
related_parameters:
...
## Summary
Working flow rate of rotor // airgap
