...
parameter_name: IMUserData_Lm_Points
category: Magnetics
input_output: i/p
data_type: integer
units: N/A
...
aliases:
- IMUserData_Lm_Points
- IM User Data Lm Points
- im_user_data_lm_points
- imUserDataLmPoints
- imuserdata_lm_points
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IMUserData_Lm|IMUserData_Lm]]'
- '[[motorcad/parameter_database/parameters/IMUserData_Lm_Current|IMUserData_Lm_Current]]'
- '[[motorcad/parameter_database/parameters/IMUserData_Rfe_Points|IMUserData_Rfe_Points]]'
- '[[motorcad/parameter_database/parameters/IMUserData_Load_Points|IMUserData_Load_Points]]'
- '[[motorcad/parameter_database/parameters/IMUserData_Rfe|IMUserData_Rfe]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Number of points for which the magnetizing inductance user data is defined
