...
parameter_name: PhasorRmsPhaseVoltage_Q
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
- Phasor Rms Phase Voltage Q
- phasor_rms_phase_voltage_q
- phasorRmsPhaseVoltageQ
- phasorrmsphasevoltage_q
related_parameters:
...
- '[[motorcad/parameter_database/parameters/PhasorRmsPhaseVoltage_D|PhasorRmsPhaseVoltage_D]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The rms Phase Voltage at the terminals of the machine from phasor diagram
