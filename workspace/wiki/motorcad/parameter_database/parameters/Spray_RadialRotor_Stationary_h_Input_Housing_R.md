...
parameter_name: Spray_RadialRotor_Stationary_h_Input_Housing_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_Housing_R
- Spray Radial Rotor Stationary h Input Housing R
- spray_radial_rotor_stationary_h_input_housing_r
- sprayRadialRotorStationaryHInputHousingR
- spray_radialrotor_stationary_h_input_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the rear housing surface
