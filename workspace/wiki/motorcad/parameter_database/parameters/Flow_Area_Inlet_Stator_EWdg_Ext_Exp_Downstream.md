...
parameter_name: Flow_Area_Inlet_Stator_EWdg_Ext_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Stator_EWdg_Ext_Exp_Downstream
- Flow Area Inlet Stator E Wdg Ext Exp Downstream
- flow_area_inlet_stator_e_wdg_ext_exp_downstream
- flowAreaInletStatorEWdgExtExpDownstream
- flow_area_inlet_stator_ewdg_ext_exp_downstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Stator EWdg Ext Expansion Downstream
