...
parameter_name: Spray_RadialRotor_Rt_RotorCore_F
...
aliases:
- Spray_RadialRotor_Rt_RotorCore_F
- Spray Radial Rotor Rt Rotor Core F
- spray_radial_rotor_rt_rotor_core_f
- sprayRadialRotorRtRotorCoreF
- spray_radialrotor_rt_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to front rotor core surface convective thermal resistance
