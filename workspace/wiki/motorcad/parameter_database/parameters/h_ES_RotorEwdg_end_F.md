...
parameter_name: h_ES_RotorEwdg_end_F
category: End_Space
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_ES_RotorEwdg_end_F
- h ES Rotor Ewdg end F
- h_es_rotor_ewdg_end_f
- hEsRotorEwdgEndF
- h_es_rotorewdg_end_f
related_parameters:
...
## Summary
The heat transfer coefficient over the end wdg end surface [front]
