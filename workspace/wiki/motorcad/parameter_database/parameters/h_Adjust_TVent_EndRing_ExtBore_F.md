...
parameter_name: h_Adjust_TVent_EndRing_ExtBore_F
...
aliases:
- h_Adjust_TVent_EndRing_ExtBore_F
- h Adjust T Vent End Ring Ext Bore F
- h_adjust_t_vent_end_ring_ext_bore_f
- hAdjustTVentEndRingExtBoreF
- h_adjust_tvent_endring_extbore_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the end ring ExtBore surface [front]
