...
parameter_name: Vel_Mult_TVent_EndRing_ExtInter_R
...
aliases:
- Vel_Mult_TVent_EndRing_ExtInter_R
- Vel Mult T Vent End Ring Ext Inter R
- vel_mult_t_vent_end_ring_ext_inter_r
- velMultTVentEndRingExtInterR
- vel_mult_tvent_endring_extinter_r
related_parameters:
...
## Summary
The TVent velocity multiplier over the end ring ExtInter surface [rear]
