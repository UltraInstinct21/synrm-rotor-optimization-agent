...
parameter_name: Spray_RadialHousing_Rotational_h_RotorCore_R
...
aliases:
- Spray_RadialHousing_Rotational_h_RotorCore_R
- Spray Radial Housing Rotational h Rotor Core R
- spray_radial_housing_rotational_h_rotor_core_r
- sprayRadialHousingRotationalHRotorCoreR
- spray_radialhousing_rotational_h_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) rotational htc over the rear rotor core surface
