...
parameter_name: Spray_RadialHousing_Calc_Input_h_Bearing_R
...
aliases:
- Spray_RadialHousing_Calc_Input_h_Bearing_R
- Spray Radial Housing Calc Input h Bearing R
- spray_radial_housing_calc_input_h_bearing_r
- sprayRadialHousingCalcInputHBearingR
- spray_radialhousing_calc_input_h_bearing_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the rear bearing surface is calculated or user input  (0=Calc h, 1=Input h)
