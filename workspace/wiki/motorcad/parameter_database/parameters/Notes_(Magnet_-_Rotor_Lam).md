...
parameter_name: Notes_(Magnet_-_Rotor_Lam)
...
aliases:
- Notes_(Magnet_-_Rotor_Lam)
- Notes Magnet Rotor Lam
- notes_magnet_rotor_lam
- notesMagnetRotorLam
- notes_(magnet_-_rotor_lam)
related_parameters:
...
## Summary
Notes - Interface gap between magnet and rotor lamination stack
