...
parameter_name: Spray_Area_Mult_HousingFluid_R
...
aliases:
- Spray_Area_Mult_HousingFluid_R
- Spray Area Mult Housing Fluid R
- spray_area_mult_housing_fluid_r
- sprayAreaMultHousingFluidR
- spray_area_mult_housingfluid_r
related_parameters:
...
## Summary
Area multiplier for the Housing Rear section subjected to Spray Cooling
