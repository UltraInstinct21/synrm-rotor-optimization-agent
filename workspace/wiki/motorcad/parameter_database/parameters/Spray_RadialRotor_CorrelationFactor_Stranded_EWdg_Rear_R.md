...
parameter_name: Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Rear_R
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Stranded_EWdg_Rear_R
- Spray Radial Rotor Correlation Factor Stranded E Wdg Rear R
- spray_radial_rotor_correlation_factor_stranded_e_wdg_rear_r
- sprayRadialRotorCorrelationFactorStrandedEWdgRearR
- spray_radialrotor_correlationfactor_stranded_ewdg_rear_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the stranded rear endwinding rear surface
