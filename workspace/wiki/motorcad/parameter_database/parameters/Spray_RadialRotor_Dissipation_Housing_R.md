...
parameter_name: Spray_RadialRotor_Dissipation_Housing_R
...
aliases:
- Spray_RadialRotor_Dissipation_Housing_R
- Spray Radial Rotor Dissipation Housing R
- spray_radial_rotor_dissipation_housing_r
- sprayRadialRotorDissipationHousingR
- spray_radialrotor_dissipation_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the rear housing surface
