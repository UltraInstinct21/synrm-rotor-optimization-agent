...
parameter_name: Spray_RadialRotor_Rotational_h_Adjust_EWdg_Inner_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Adjust_EWdg_Inner_F
- Spray Radial Rotor Rotational h Adjust E Wdg Inner F
- spray_radial_rotor_rotational_h_adjust_e_wdg_inner_f
- sprayRadialRotorRotationalHAdjustEWdgInnerF
- spray_radialrotor_rotational_h_adjust_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc adjustment over the front endwinding inner surface
