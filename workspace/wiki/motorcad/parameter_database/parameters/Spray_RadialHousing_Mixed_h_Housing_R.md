...
parameter_name: Spray_RadialHousing_Mixed_h_Housing_R
...
aliases:
- Spray_RadialHousing_Mixed_h_Housing_R
- Spray Radial Housing Mixed h Housing R
- spray_radial_housing_mixed_h_housing_r
- sprayRadialHousingMixedHHousingR
- spray_radialhousing_mixed_h_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the rear housing surface
