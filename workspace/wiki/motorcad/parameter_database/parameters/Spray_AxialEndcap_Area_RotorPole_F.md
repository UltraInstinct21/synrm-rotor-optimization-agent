...
parameter_name: Spray_AxialEndcap_Area_RotorPole_F
...
aliases:
- Spray_AxialEndcap_Area_RotorPole_F
- Spray Axial Endcap Area Rotor Pole F
- spray_axial_endcap_area_rotor_pole_f
- sprayAxialEndcapAreaRotorPoleF
- spray_axialendcap_area_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front rotor pole surface sprayed area
