...
parameter_name: Spray_RadialRotor_Dissipation_EWdg_Inner_R
...
aliases:
- Spray_RadialRotor_Dissipation_EWdg_Inner_R
- Spray Radial Rotor Dissipation E Wdg Inner R
- spray_radial_rotor_dissipation_e_wdg_inner_r
- sprayRadialRotorDissipationEWdgInnerR
- spray_radialrotor_dissipation_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the rear endwinding inner surface
