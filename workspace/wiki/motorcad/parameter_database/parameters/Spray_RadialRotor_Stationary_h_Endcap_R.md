...
parameter_name: Spray_RadialRotor_Stationary_h_Endcap_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Endcap_R
- Spray Radial Rotor Stationary h Endcap R
- spray_radial_rotor_stationary_h_endcap_r
- sprayRadialRotorStationaryHEndcapR
- spray_radialrotor_stationary_h_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the rear endcap surface
