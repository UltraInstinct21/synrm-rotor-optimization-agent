...
parameter_name: FEAHighlightMax_Magnetic
...
aliases:
- FEAHighlightMax_Magnetic
- FEA Highlight Max Magnetic
- fea_highlight_max_magnetic
- feaHighlightMaxMagnetic
- feahighlightmax_magnetic
related_parameters:
...
- '[[motorcad/parameter_database/parameters/FEAHighlightMax_Thermal|FEAHighlightMax_Thermal]]'
- '[[motorcad/parameter_database/parameters/FEAHighlightMax_Mechanical|FEAHighlightMax_Mechanical]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
When enabled values above range maximum are not shaded
