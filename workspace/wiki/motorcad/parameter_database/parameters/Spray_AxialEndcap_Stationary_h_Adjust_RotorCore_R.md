...
parameter_name: Spray_AxialEndcap_Stationary_h_Adjust_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Adjust_RotorCore_R
- Spray Axial Endcap Stationary h Adjust Rotor Core R
- spray_axial_endcap_stationary_h_adjust_rotor_core_r
- sprayAxialEndcapStationaryHAdjustRotorCoreR
- spray_axialendcap_stationary_h_adjust_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc adjustment over the rear rotor core surface
