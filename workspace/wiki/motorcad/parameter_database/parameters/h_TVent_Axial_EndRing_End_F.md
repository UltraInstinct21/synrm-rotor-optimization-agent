...
parameter_name: h_TVent_Axial_EndRing_End_F
...
aliases:
- h_TVent_Axial_EndRing_End_F
- h T Vent Axial End Ring End F
- h_t_vent_axial_end_ring_end_f
- hTVentAxialEndRingEndF
- h_tvent_axial_endring_end_f
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the end ring End surface [front]
