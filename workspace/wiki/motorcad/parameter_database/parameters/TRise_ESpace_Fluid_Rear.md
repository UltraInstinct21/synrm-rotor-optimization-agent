...
parameter_name: TRise_ESpace_Fluid_Rear
category: End_Space
input_output: o/p
data_type: double
units: °C
...
aliases:
- TRise_ESpace_Fluid_Rear
- T Rise E Space Fluid Rear
- t_rise_e_space_fluid_rear
- tRiseESpaceFluidRear
- trise_espace_fluid_rear
related_parameters:
...
- '[[motorcad/parameter_database/parameters/TRise_ESpace_Fluid_Front|TRise_ESpace_Fluid_Front]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Temperature rise of fluid passing through open end-shield
