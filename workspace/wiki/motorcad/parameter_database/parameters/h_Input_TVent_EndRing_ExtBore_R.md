...
parameter_name: h_Input_TVent_EndRing_ExtBore_R
...
aliases:
- h_Input_TVent_EndRing_ExtBore_R
- h Input T Vent End Ring Ext Bore R
- h_input_t_vent_end_ring_ext_bore_r
- hInputTVentEndRingExtBoreR
- h_input_tvent_endring_extbore_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the end ring ExtBore surface [rear]
