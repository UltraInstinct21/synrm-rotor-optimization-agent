...
parameter_name: Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Outer_R
- Spray Radial Rotor Correlation Factor Hairpin E Wdg Outer R
- spray_radial_rotor_correlation_factor_hairpin_e_wdg_outer_r
- sprayRadialRotorCorrelationFactorHairpinEWdgOuterR
- spray_radialrotor_correlationfactor_hairpin_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the hairpin rear endwinding outer surface
