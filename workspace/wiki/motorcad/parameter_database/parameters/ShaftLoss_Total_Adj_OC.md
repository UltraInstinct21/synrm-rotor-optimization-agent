...
parameter_name: ShaftLoss_Total_Adj_OC
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- ShaftLoss_Total_Adj_OC
- Shaft Loss Total Adj OC
- shaft_loss_total_adj_oc
- shaftLossTotalAdjOc
- shaftloss_total_adj_oc
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ShaftLoss_Hys|ShaftLoss_Hys]]'
- '[[motorcad/parameter_database/parameters/ShaftLoss_Total_Adj|ShaftLoss_Total_Adj]]'
- '[[motorcad/parameter_database/parameters/ShaftLoss_Eddy|ShaftLoss_Eddy]]'
- '[[motorcad/parameter_database/parameters/ShaftLoss_Excess|ShaftLoss_Excess]]'
- '[[motorcad/parameter_database/parameters/ShaftLoss_Total|ShaftLoss_Total]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Shaft losses adjusted to take into account build factor
