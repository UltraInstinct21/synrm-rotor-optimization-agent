...
parameter_name: Spray_AxialEndcap_Rt_Housing_F
...
aliases:
- Spray_AxialEndcap_Rt_Housing_F
- Spray Axial Endcap Rt Housing F
- spray_axial_endcap_rt_housing_f
- sprayAxialEndcapRtHousingF
- spray_axialendcap_rt_housing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to front housing surface convective thermal resistance
