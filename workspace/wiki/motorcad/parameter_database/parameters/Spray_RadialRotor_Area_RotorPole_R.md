...
parameter_name: Spray_RadialRotor_Area_RotorPole_R
...
aliases:
- Spray_RadialRotor_Area_RotorPole_R
- Spray Radial Rotor Area Rotor Pole R
- spray_radial_rotor_area_rotor_pole_r
- sprayRadialRotorAreaRotorPoleR
- spray_radialrotor_area_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear rotor pole surface sprayed area
