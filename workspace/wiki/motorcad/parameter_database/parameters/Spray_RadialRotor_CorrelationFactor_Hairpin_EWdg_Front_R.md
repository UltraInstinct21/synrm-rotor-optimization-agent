...
parameter_name: Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Front_R
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Front_R
- Spray Radial Rotor Correlation Factor Hairpin E Wdg Front R
- spray_radial_rotor_correlation_factor_hairpin_e_wdg_front_r
- sprayRadialRotorCorrelationFactorHairpinEWdgFrontR
- spray_radialrotor_correlationfactor_hairpin_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the hairpin rear endwinding front surface
