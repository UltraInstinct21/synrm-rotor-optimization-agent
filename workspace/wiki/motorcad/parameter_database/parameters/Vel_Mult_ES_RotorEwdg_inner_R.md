...
parameter_name: Vel_Mult_ES_RotorEwdg_inner_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_RotorEwdg_inner_R
- Vel Mult ES Rotor Ewdg inner R
- vel_mult_es_rotor_ewdg_inner_r
- velMultEsRotorEwdgInnerR
- vel_mult_es_rotorewdg_inner_r
related_parameters:
...
## Summary
The velocity multiplier for end wdg inner surface [rear]
