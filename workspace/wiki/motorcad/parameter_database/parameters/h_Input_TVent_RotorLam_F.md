...
parameter_name: h_Input_TVent_RotorLam_F
...
aliases:
- h_Input_TVent_RotorLam_F
- h Input T Vent Rotor Lam F
- h_input_t_vent_rotor_lam_f
- hInputTVentRotorLamF
- h_input_tvent_rotorlam_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the Rotor lam surface [front]
