...
parameter_name: Spray_RadialRotor_Area_Mult_EWdg_Front_R
...
aliases:
- Spray_RadialRotor_Area_Mult_EWdg_Front_R
- Spray Radial Rotor Area Mult E Wdg Front R
- spray_radial_rotor_area_mult_e_wdg_front_r
- sprayRadialRotorAreaMultEWdgFrontR
- spray_radialrotor_area_mult_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear endwinding front surface area multiplier
