...
parameter_name: Spray_RadialHousing_Mixed_h_EWdg_Outer_R
...
aliases:
- Spray_RadialHousing_Mixed_h_EWdg_Outer_R
- Spray Radial Housing Mixed h E Wdg Outer R
- spray_radial_housing_mixed_h_e_wdg_outer_r
- sprayRadialHousingMixedHEWdgOuterR
- spray_radialhousing_mixed_h_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) mixed htc over the rear endwinding outer surface
