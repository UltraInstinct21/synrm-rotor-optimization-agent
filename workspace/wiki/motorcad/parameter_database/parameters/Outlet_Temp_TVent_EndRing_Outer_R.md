...
parameter_name: Outlet_Temp_TVent_EndRing_Outer_R
...
aliases:
- Outlet_Temp_TVent_EndRing_Outer_R
- Outlet Temp T Vent End Ring Outer R
- outlet_temp_t_vent_end_ring_outer_r
- outletTempTVentEndRingOuterR
- outlet_temp_tvent_endring_outer_r
related_parameters:
...
## Summary
The TVent outlet temperature from the outer surface of the endring [rear]
