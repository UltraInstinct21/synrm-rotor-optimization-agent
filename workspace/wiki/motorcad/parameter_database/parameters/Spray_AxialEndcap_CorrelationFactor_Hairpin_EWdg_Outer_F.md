...
parameter_name: Spray_AxialEndcap_CorrelationFactor_Hairpin_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_CorrelationFactor_Hairpin_EWdg_Outer_F
- Spray Axial Endcap Correlation Factor Hairpin E Wdg Outer F
- spray_axial_endcap_correlation_factor_hairpin_e_wdg_outer_f
- sprayAxialEndcapCorrelationFactorHairpinEWdgOuterF
- spray_axialendcap_correlationfactor_hairpin_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) correlation factor for the hairpin front endwinding outer surface
