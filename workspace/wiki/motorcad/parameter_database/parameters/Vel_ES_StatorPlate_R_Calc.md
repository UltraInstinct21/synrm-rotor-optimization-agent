...
parameter_name: Vel_ES_StatorPlate_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_StatorPlate_R_Calc
- Vel ES Stator Plate R Calc
- vel_es_stator_plate_r_calc
- velEsStatorPlateRCalc
- vel_es_statorplate_r_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for stator plate [rear]
