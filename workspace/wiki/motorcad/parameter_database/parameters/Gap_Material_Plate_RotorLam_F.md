...
parameter_name: Gap_Material_Plate_RotorLam_F
...
aliases:
- Gap_Material_Plate_RotorLam_F
- Gap Material Plate Rotor Lam F
- gap_material_plate_rotor_lam_f
- gapMaterialPlateRotorLamF
- gap_material_plate_rotorlam_f
related_parameters:
...
## Summary
Material in the interface gap between the Rotor Plate and Rotor Lam [F].
