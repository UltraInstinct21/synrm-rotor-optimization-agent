...
parameter_name: Spray_RadialHousing_Calc_Input_h_RotorPole_F
...
aliases:
- Spray_RadialHousing_Calc_Input_h_RotorPole_F
- Spray Radial Housing Calc Input h Rotor Pole F
- spray_radial_housing_calc_input_h_rotor_pole_f
- sprayRadialHousingCalcInputHRotorPoleF
- spray_radialhousing_calc_input_h_rotorpole_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the front rotor pole surface is calculated or user input  (0=Calc h, 1=Input h)
