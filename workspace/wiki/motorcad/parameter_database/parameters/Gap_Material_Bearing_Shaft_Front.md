...
parameter_name: Gap_Material_Bearing_Shaft_Front
...
aliases:
- Gap_Material_Bearing_Shaft_Front
- Gap Material Bearing Shaft Front
- gap_material_bearing_shaft_front
- gapMaterialBearingShaftFront
related_parameters:
...
## Summary
Material in the interface gap between the Bearing and Shaft [F].
