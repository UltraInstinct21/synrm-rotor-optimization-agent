...
parameter_name: h_TVent_EndRing_End_R
...
aliases:
- h_TVent_EndRing_End_R
- h T Vent End Ring End R
- h_t_vent_end_ring_end_r
- hTVentEndRingEndR
- h_tvent_endring_end_r
related_parameters:
...
## Summary
The TVent heat transfer coefficient over the end ring End surface [rear]
