...
parameter_name: Flow_Area_Outlet_Stator_Duct_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Stator_Duct_Exp_Downstream
- Flow Area Outlet Stator Duct Exp Downstream
- flow_area_outlet_stator_duct_exp_downstream
- flowAreaOutletStatorDuctExpDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Stator Duct Expansion Downstream
