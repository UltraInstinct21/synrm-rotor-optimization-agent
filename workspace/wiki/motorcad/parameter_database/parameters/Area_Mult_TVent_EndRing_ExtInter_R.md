...
parameter_name: Area_Mult_TVent_EndRing_ExtInter_R
...
aliases:
- Area_Mult_TVent_EndRing_ExtInter_R
- Area Mult T Vent End Ring Ext Inter R
- area_mult_t_vent_end_ring_ext_inter_r
- areaMultTVentEndRingExtInterR
- area_mult_tvent_endring_extinter_r
related_parameters:
...
## Summary
The area multiplier for endring extension inner surface
