...
parameter_name: Vel_ES_StatorClampPlate_R
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_StatorClampPlate_R
- Vel ES Stator Clamp Plate R
- vel_es_stator_clamp_plate_r
- velEsStatorClampPlateR
- vel_es_statorclampplate_r
related_parameters:
...
## Summary
End Space Cooling - velocity for Stator Clamp Plate [Rear]
