...
parameter_name: Spray_AxialEndcap_Calc_Input_h_EWdg_Outer_F
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_EWdg_Outer_F
- Spray Axial Endcap Calc Input h E Wdg Outer F
- spray_axial_endcap_calc_input_h_e_wdg_outer_f
- sprayAxialEndcapCalcInputHEWdgOuterF
- spray_axialendcap_calc_input_h_ewdg_outer_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the front endwinding outer surface is calculated or user input  (0=Calc h, 1=Input h)
