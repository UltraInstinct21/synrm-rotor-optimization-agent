...
parameter_name: PlateLength_Lower_Endcap_F
...
aliases:
- PlateLength_Lower_Endcap_F
- Plate Length Lower Endcap F
- plate_length_lower_endcap_f
- plateLengthLowerEndcapF
- platelength_lower_endcap_f
related_parameters:
...
## Summary
The spray cooling lower plate length for the front endcap
