...
parameter_name: Spray_AxialEndcap_Stationary_h_Adjust_Endcap_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Adjust_Endcap_R
- Spray Axial Endcap Stationary h Adjust Endcap R
- spray_axial_endcap_stationary_h_adjust_endcap_r
- sprayAxialEndcapStationaryHAdjustEndcapR
- spray_axialendcap_stationary_h_adjust_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc adjustment over the rear endcap surface
