...
parameter_name: Area_TVent_RotorLam_R
...
aliases:
- Area_TVent_RotorLam_R
- Area T Vent Rotor Lam R
- area_t_vent_rotor_lam_r
- areaTVentRotorLamR
- area_tvent_rotorlam_r
related_parameters:
...
## Summary
Surface area of the Rotor [Rear] for Through Ventilation
