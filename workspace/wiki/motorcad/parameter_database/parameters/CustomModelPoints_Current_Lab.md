...
parameter_name: CustomModelPoints_Current_Lab
...
aliases:
- CustomModelPoints_Current_Lab
- Custom Model Points Current Lab
- custom_model_points_current_lab
- customModelPointsCurrentLab
- custommodelpoints_current_lab
related_parameters:
...
- '[[motorcad/parameter_database/parameters/CustomModelPoints_Array_Current_Lab|CustomModelPoints_Array_Current_Lab]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Number of current points in Lab saturation/loss model build custom resolution array.
