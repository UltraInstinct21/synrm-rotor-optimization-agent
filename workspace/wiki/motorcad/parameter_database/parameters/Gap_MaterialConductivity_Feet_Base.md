...
parameter_name: Gap_MaterialConductivity_Feet_Base
...
aliases:
- Gap_MaterialConductivity_Feet_Base
- Gap Material Conductivity Feet Base
- gap_material_conductivity_feet_base
- gapMaterialConductivityFeetBase
- gap_materialconductivity_feet_base
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Feet and Base.
