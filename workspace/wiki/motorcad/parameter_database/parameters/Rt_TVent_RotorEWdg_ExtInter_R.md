...
parameter_name: Rt_TVent_RotorEWdg_ExtInter_R
...
aliases:
- Rt_TVent_RotorEWdg_ExtInter_R
- Rt T Vent Rotor E Wdg Ext Inter R
- rt_t_vent_rotor_e_wdg_ext_inter_r
- rtTVentRotorEWdgExtInterR
- rt_tvent_rotorewdg_extinter_r
related_parameters:
...
## Summary
The thermal resistance from the ext inter surface of rear rotor endwinding to the fluid
