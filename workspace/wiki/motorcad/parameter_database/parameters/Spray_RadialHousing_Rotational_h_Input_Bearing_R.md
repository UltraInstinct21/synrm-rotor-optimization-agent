...
parameter_name: Spray_RadialHousing_Rotational_h_Input_Bearing_R
...
aliases:
- Spray_RadialHousing_Rotational_h_Input_Bearing_R
- Spray Radial Housing Rotational h Input Bearing R
- spray_radial_housing_rotational_h_input_bearing_r
- sprayRadialHousingRotationalHInputBearingR
- spray_radialhousing_rotational_h_input_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input rotational htc over the rear bearing surface
