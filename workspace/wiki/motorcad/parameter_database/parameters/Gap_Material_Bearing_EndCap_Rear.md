...
parameter_name: Gap_Material_Bearing_EndCap_Rear
...
aliases:
- Gap_Material_Bearing_EndCap_Rear
- Gap Material Bearing End Cap Rear
- gap_material_bearing_end_cap_rear
- gapMaterialBearingEndCapRear
- gap_material_bearing_endcap_rear
related_parameters:
...
## Summary
Material in the interface gap between the Bearing and Endcap [R].
