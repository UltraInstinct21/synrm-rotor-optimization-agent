...
parameter_name: Spray_Area_Calc_EndcapFluid_F
...
aliases:
- Spray_Area_Calc_EndcapFluid_F
- Spray Area Calc Endcap Fluid F
- spray_area_calc_endcap_fluid_f
- sprayAreaCalcEndcapFluidF
- spray_area_calc_endcapfluid_f
related_parameters:
...
## Summary
Calculated Area of the Endcap Front section subjected to Spray Cooling
