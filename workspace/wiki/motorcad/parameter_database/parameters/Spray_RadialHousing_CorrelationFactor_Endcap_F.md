...
parameter_name: Spray_RadialHousing_CorrelationFactor_Endcap_F
...
aliases:
- Spray_RadialHousing_CorrelationFactor_Endcap_F
- Spray Radial Housing Correlation Factor Endcap F
- spray_radial_housing_correlation_factor_endcap_f
- sprayRadialHousingCorrelationFactorEndcapF
- spray_radialhousing_correlationfactor_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the front endcap surface
