...
parameter_name: RotorToothLoss_Total_Static_Adj
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- RotorToothLoss_Total_Static_Adj
- Rotor Tooth Loss Total Static Adj
- rotor_tooth_loss_total_static_adj
- rotorToothLossTotalStaticAdj
- rotortoothloss_total_static_adj
related_parameters:
