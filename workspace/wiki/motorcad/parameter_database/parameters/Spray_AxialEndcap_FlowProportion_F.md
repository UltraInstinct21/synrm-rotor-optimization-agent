...
parameter_name: Spray_AxialEndcap_FlowProportion_F
...
aliases:
- Spray_AxialEndcap_FlowProportion_F
- Spray Axial Endcap Flow Proportion F
- spray_axial_endcap_flow_proportion_f
- sprayAxialEndcapFlowProportionF
- spray_axialendcap_flowproportion_f
related_parameters:
...
## Summary
Front Spray Cooling (Axial from Endcap) fluid flow proportion
