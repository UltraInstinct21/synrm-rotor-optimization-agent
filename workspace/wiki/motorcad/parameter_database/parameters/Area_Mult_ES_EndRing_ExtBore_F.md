...
parameter_name: Area_Mult_ES_EndRing_ExtBore_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EndRing_ExtBore_F
- Area Mult ES End Ring Ext Bore F
- area_mult_es_end_ring_ext_bore_f
- areaMultEsEndRingExtBoreF
- area_mult_es_endring_extbore_f
related_parameters:
...
## Summary
Area multiplier for the End Ring Extension Bore [Front] surface for End Space Cooling
