...
parameter_name: Spray_RadialHousing_Stationary_h_Bearing_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Bearing_R
- Spray Radial Housing Stationary h Bearing R
- spray_radial_housing_stationary_h_bearing_r
- sprayRadialHousingStationaryHBearingR
- spray_radialhousing_stationary_h_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc over the rear bearing surface
