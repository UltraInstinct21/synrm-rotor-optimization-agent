...
parameter_name: Spray_AxialEndcap_Mixed_h_Shaft_R
...
aliases:
- Spray_AxialEndcap_Mixed_h_Shaft_R
- Spray Axial Endcap Mixed h Shaft R
- spray_axial_endcap_mixed_h_shaft_r
- sprayAxialEndcapMixedHShaftR
- spray_axialendcap_mixed_h_shaft_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the rear shaft surface
