...
parameter_name: Spray_RadialRotor_Notes_RotorCore_F
...
aliases:
- Spray_RadialRotor_Notes_RotorCore_F
- Spray Radial Rotor Notes Rotor Core F
- spray_radial_rotor_notes_rotor_core_f
- sprayRadialRotorNotesRotorCoreF
- spray_radialrotor_notes_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) notes for front rotor core surface
