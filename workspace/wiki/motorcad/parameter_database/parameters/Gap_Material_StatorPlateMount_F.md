...
parameter_name: Gap_Material_StatorPlateMount_F
...
aliases:
- Gap_Material_StatorPlateMount_F
- Gap Material Stator Plate Mount F
- gap_material_stator_plate_mount_f
- gapMaterialStatorPlateMountF
- gap_material_statorplatemount_f
related_parameters:
...
## Summary
Material in the interface gap between the Plate and Mount [F].
