...
parameter_name: h_TVent_Axial_EndRing_ExtInter_F
...
aliases:
- h_TVent_Axial_EndRing_ExtInter_F
- h T Vent Axial End Ring Ext Inter F
- h_t_vent_axial_end_ring_ext_inter_f
- hTVentAxialEndRingExtInterF
- h_tvent_axial_endring_extinter_f
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the end ring ExtInter surface [front]
