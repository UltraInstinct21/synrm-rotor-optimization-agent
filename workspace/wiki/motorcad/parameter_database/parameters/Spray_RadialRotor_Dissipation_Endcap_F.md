...
parameter_name: Spray_RadialRotor_Dissipation_Endcap_F
...
aliases:
- Spray_RadialRotor_Dissipation_Endcap_F
- Spray Radial Rotor Dissipation Endcap F
- spray_radial_rotor_dissipation_endcap_f
- sprayRadialRotorDissipationEndcapF
- spray_radialrotor_dissipation_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the front endcap surface
