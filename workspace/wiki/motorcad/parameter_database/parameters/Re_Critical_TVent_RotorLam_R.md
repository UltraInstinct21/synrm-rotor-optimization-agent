...
parameter_name: Re_Critical_TVent_RotorLam_R
...
aliases:
- Re_Critical_TVent_RotorLam_R
- Re Critical T Vent Rotor Lam R
- re_critical_t_vent_rotor_lam_r
- reCriticalTVentRotorLamR
- re_critical_tvent_rotorlam_r
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the Rotor lam surface [rear]
