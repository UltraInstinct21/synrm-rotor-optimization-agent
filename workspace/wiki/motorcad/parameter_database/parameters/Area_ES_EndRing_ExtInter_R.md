...
parameter_name: Area_ES_EndRing_ExtInter_R
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_ES_EndRing_ExtInter_R
- Area ES End Ring Ext Inter R
- area_es_end_ring_ext_inter_r
- areaEsEndRingExtInterR
- area_es_endring_extinter_r
related_parameters:
...
## Summary
The area of the end ring ExtInter surface [rear]
