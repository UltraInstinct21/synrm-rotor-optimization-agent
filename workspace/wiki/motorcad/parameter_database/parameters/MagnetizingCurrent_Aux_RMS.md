...
parameter_name: MagnetizingCurrent_Aux_RMS
category: Magnetics
input_output: o/p
data_type: double
units: Amps
...
aliases:
- MagnetizingCurrent_Aux_RMS
- Magnetizing Current Aux RMS
- magnetizing_current_aux_rms
- magnetizingCurrentAuxRms
- magnetizingcurrent_aux_rms
related_parameters:
...
## Summary
The on load aux winding RMS magnetizing current
