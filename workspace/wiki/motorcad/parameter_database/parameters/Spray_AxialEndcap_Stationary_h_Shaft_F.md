...
parameter_name: Spray_AxialEndcap_Stationary_h_Shaft_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Shaft_F
- Spray Axial Endcap Stationary h Shaft F
- spray_axial_endcap_stationary_h_shaft_f
- sprayAxialEndcapStationaryHShaftF
- spray_axialendcap_stationary_h_shaft_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the front shaft surface
