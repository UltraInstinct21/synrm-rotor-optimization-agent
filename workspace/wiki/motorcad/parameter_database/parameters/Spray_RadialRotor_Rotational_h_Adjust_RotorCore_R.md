...
parameter_name: Spray_RadialRotor_Rotational_h_Adjust_RotorCore_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Adjust_RotorCore_R
- Spray Radial Rotor Rotational h Adjust Rotor Core R
- spray_radial_rotor_rotational_h_adjust_rotor_core_r
- sprayRadialRotorRotationalHAdjustRotorCoreR
- spray_radialrotor_rotational_h_adjust_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rotational htc adjustment over the rear rotor core surface
