...
parameter_name: Spray_RadialRotor_Area_Mult_Bearing_R
...
aliases:
- Spray_RadialRotor_Area_Mult_Bearing_R
- Spray Radial Rotor Area Mult Bearing R
- spray_radial_rotor_area_mult_bearing_r
- sprayRadialRotorAreaMultBearingR
- spray_radialrotor_area_mult_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear bearing surface area multiplier
