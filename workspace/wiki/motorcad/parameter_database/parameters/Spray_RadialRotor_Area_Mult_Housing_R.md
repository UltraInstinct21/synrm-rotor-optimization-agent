...
parameter_name: Spray_RadialRotor_Area_Mult_Housing_R
...
aliases:
- Spray_RadialRotor_Area_Mult_Housing_R
- Spray Radial Rotor Area Mult Housing R
- spray_radial_rotor_area_mult_housing_r
- sprayRadialRotorAreaMultHousingR
- spray_radialrotor_area_mult_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear housing surface area multiplier
