...
parameter_name: Spray_RadialRotor_Stationary_h_Bearing_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Bearing_R
- Spray Radial Rotor Stationary h Bearing R
- spray_radial_rotor_stationary_h_bearing_r
- sprayRadialRotorStationaryHBearingR
- spray_radialrotor_stationary_h_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc over the rear bearing surface
