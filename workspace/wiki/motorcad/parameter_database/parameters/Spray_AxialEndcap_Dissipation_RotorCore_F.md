...
parameter_name: Spray_AxialEndcap_Dissipation_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Dissipation_RotorCore_F
- Spray Axial Endcap Dissipation Rotor Core F
- spray_axial_endcap_dissipation_rotor_core_f
- sprayAxialEndcapDissipationRotorCoreF
- spray_axialendcap_dissipation_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the front rotor core surface
