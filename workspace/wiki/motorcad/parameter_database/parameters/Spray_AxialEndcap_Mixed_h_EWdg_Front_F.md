...
parameter_name: Spray_AxialEndcap_Mixed_h_EWdg_Front_F
...
aliases:
- Spray_AxialEndcap_Mixed_h_EWdg_Front_F
- Spray Axial Endcap Mixed h E Wdg Front F
- spray_axial_endcap_mixed_h_e_wdg_front_f
- sprayAxialEndcapMixedHEWdgFrontF
- spray_axialendcap_mixed_h_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the front endwinding front surface
