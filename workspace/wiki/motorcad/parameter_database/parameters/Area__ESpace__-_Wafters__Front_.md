...
parameter_name: Area_[ESpace]_-_Wafters_[Front]
category: End_Space
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Area_[ESpace]_-_Wafters_[Front]
- Area_(ESpace)_-_Wafters_(Front)
- Area E Space Wafters Front
- area_e_space_wafters_front
- areaESpaceWaftersFront
- area_[espace]_-_wafters_[front]
related_parameters:
...
## Summary
Motor-CAD automation parameter `Area_[ESpace]_-_Wafters_[Front]` in category `End_Space`.
