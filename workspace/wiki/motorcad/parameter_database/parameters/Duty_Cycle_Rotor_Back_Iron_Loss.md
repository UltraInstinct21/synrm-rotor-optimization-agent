...
parameter_name: Duty_Cycle_Rotor_Back_Iron_Loss
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Rotor Back Iron Loss
- duty_cycle_rotor_back_iron_loss
- dutyCycleRotorBackIronLoss
related_parameters:
...
## Summary
Rotor back iron loss for each period of the duty cycle
