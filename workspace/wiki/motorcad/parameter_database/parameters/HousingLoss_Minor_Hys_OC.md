...
parameter_name: HousingLoss_Minor_Hys_OC
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- HousingLoss_Minor_Hys_OC
- Housing Loss Minor Hys OC
- housing_loss_minor_hys_oc
- housingLossMinorHysOc
- housingloss_minor_hys_oc
related_parameters:
...
## Summary
Housing losses from minor loops hysteresis
