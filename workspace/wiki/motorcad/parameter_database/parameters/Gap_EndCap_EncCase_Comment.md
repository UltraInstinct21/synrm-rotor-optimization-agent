...
parameter_name: Gap_EndCap_EncCase_Comment
...
aliases:
- Gap_EndCap_EncCase_Comment
- Gap End Cap Enc Case Comment
- gap_end_cap_enc_case_comment
- gapEndCapEncCaseComment
- gap_endcap_enccase_comment
related_parameters:
...
## Summary
Details of the interface gap between endcap and encoder case
