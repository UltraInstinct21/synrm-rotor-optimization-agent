...
parameter_name: TVent_Flow_Area_Winding_Ext_R
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- TVent_Flow_Area_Winding_Ext_R
- T Vent Flow Area Winding Ext R
- t_vent_flow_area_winding_ext_r
- tVentFlowAreaWindingExtR
- tvent_flow_area_winding_ext_r
related_parameters:
...
## Summary
TVent Flow Area for the Winding Extension Rear
