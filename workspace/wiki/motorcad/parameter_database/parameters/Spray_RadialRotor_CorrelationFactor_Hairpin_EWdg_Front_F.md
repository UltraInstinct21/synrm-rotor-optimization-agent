...
parameter_name: Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Front_F
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Hairpin_EWdg_Front_F
- Spray Radial Rotor Correlation Factor Hairpin E Wdg Front F
- spray_radial_rotor_correlation_factor_hairpin_e_wdg_front_f
- sprayRadialRotorCorrelationFactorHairpinEWdgFrontF
- spray_radialrotor_correlationfactor_hairpin_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the hairpin front endwinding front surface
