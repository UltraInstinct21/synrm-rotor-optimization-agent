...
parameter_name: Spray_RadialRotor_Rotational_h_Input_RotorCore_R
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_RotorCore_R
- Spray Radial Rotor Rotational h Input Rotor Core R
- spray_radial_rotor_rotational_h_input_rotor_core_r
- sprayRadialRotorRotationalHInputRotorCoreR
- spray_radialrotor_rotational_h_input_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the rear rotor core surface
