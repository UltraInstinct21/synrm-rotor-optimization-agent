...
parameter_name: Spray_RadialRotor_Rt_RotorPole_F
...
aliases:
- Spray_RadialRotor_Rt_RotorPole_F
- Spray Radial Rotor Rt Rotor Pole F
- spray_radial_rotor_rt_rotor_pole_f
- sprayRadialRotorRtRotorPoleF
- spray_radialrotor_rt_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to front rotor pole surface convective thermal resistance
