...
parameter_name: Area_Calc_ES_StatorClampPlate_R
category: End_Space
input_output: o/p
data_type: double
units: N/A
...
aliases:
- Area_Calc_ES_StatorClampPlate_R
- Area Calc ES Stator Clamp Plate R
- area_calc_es_stator_clamp_plate_r
- areaCalcEsStatorClampPlateR
- area_calc_es_statorclampplate_r
related_parameters:
...
## Summary
Calculated area of the Stator Clamp Plate [Rear] surface for End Space Cooling
