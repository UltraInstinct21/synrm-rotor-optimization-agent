...
parameter_name: Vel_Mult_ES_EndRing_ExtOuter_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_EndRing_ExtOuter_R
- Vel Mult ES End Ring Ext Outer R
- vel_mult_es_end_ring_ext_outer_r
- velMultEsEndRingExtOuterR
- vel_mult_es_endring_extouter_r
related_parameters:
...
## Summary
The velocity multiplier for end ring ExtOuter surface [rear]
