...
parameter_name: EndRing_Extension_F
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- EndRing_Extension_F
- End Ring Extension F
- end_ring_extension_f
- endRingExtensionF
- endring_extension_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/EndRing_Extension_R|EndRing_Extension_R]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Extension of rotor bars from rotor lam before meet the front rotor end ring
