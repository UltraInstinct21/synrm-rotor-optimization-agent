...
parameter_name: Spray_AxialEndcap_Calc_Input_h_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_Calc_Input_h_EWdg_Inner_R
- Spray Axial Endcap Calc Input h E Wdg Inner R
- spray_axial_endcap_calc_input_h_e_wdg_inner_r
- sprayAxialEndcapCalcInputHEWdgInnerR
- spray_axialendcap_calc_input_h_ewdg_inner_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Axial from Endcap) htc over the rear endwinding inner surface is calculated or user input  (0=Calc h, 1=Input h)
