...
parameter_name: Spray_AxialEndcap_Stationary_h_Adjust_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Stationary_h_Adjust_RotorPole_R
- Spray Axial Endcap Stationary h Adjust Rotor Pole R
- spray_axial_endcap_stationary_h_adjust_rotor_pole_r
- sprayAxialEndcapStationaryHAdjustRotorPoleR
- spray_axialendcap_stationary_h_adjust_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc adjustment over the rear rotor pole surface
