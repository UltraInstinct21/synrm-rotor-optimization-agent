...
parameter_name: Spray_AxialEndcap_Mixed_h_RotorCore_R
...
aliases:
- Spray_AxialEndcap_Mixed_h_RotorCore_R
- Spray Axial Endcap Mixed h Rotor Core R
- spray_axial_endcap_mixed_h_rotor_core_r
- sprayAxialEndcapMixedHRotorCoreR
- spray_axialendcap_mixed_h_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the rear rotor core surface
