...
parameter_name: Vel_ES_EWdg_Rear_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EWdg_Rear_R_Calc
- Vel ES E Wdg Rear R Calc
- vel_es_e_wdg_rear_r_calc
- velEsEWdgRearRCalc
- vel_es_ewdg_rear_r_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for EWdg Rear surface [Rear]
