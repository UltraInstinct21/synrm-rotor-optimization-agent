...
parameter_name: Spray_AxialEndcap_Area_Mult_EWdg_Front_R
...
aliases:
- Spray_AxialEndcap_Area_Mult_EWdg_Front_R
- Spray Axial Endcap Area Mult E Wdg Front R
- spray_axial_endcap_area_mult_e_wdg_front_r
- sprayAxialEndcapAreaMultEWdgFrontR
- spray_axialendcap_area_mult_ewdg_front_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear endwinding front surface area multiplier
