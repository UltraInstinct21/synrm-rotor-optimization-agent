...
parameter_name: Spray_AxialEndcap_Rotational_h_Input_EWdg_Outer_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_Input_EWdg_Outer_R
- Spray Axial Endcap Rotational h Input E Wdg Outer R
- spray_axial_endcap_rotational_h_input_e_wdg_outer_r
- sprayAxialEndcapRotationalHInputEWdgOuterR
- spray_axialendcap_rotational_h_input_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input rotational htc over the rear endwinding outer surface
