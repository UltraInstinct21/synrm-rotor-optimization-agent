...
parameter_name: Spray_RadialHousing_Stationary_h_Input_RotorPole_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_RotorPole_R
- Spray Radial Housing Stationary h Input Rotor Pole R
- spray_radial_housing_stationary_h_input_rotor_pole_r
- sprayRadialHousingStationaryHInputRotorPoleR
- spray_radialhousing_stationary_h_input_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the rear rotor pole surface
