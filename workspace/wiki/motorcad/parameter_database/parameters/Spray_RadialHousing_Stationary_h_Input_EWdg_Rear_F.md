...
parameter_name: Spray_RadialHousing_Stationary_h_Input_EWdg_Rear_F
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_EWdg_Rear_F
- Spray Radial Housing Stationary h Input E Wdg Rear F
- spray_radial_housing_stationary_h_input_e_wdg_rear_f
- sprayRadialHousingStationaryHInputEWdgRearF
- spray_radialhousing_stationary_h_input_ewdg_rear_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the front endwinding rear surface
