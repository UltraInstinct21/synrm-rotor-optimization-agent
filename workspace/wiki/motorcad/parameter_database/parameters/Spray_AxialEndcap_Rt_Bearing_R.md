...
parameter_name: Spray_AxialEndcap_Rt_Bearing_R
...
aliases:
- Spray_AxialEndcap_Rt_Bearing_R
- Spray Axial Endcap Rt Bearing R
- spray_axial_endcap_rt_bearing_r
- sprayAxialEndcapRtBearingR
- spray_axialendcap_rt_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to rear bearing surface convective thermal resistance
