...
parameter_name: Spray_RadialRotor_Rt_EWdg_R
...
aliases:
- Spray_RadialRotor_Rt_EWdg_R
- Spray Radial Rotor Rt E Wdg R
- spray_radial_rotor_rt_e_wdg_r
- sprayRadialRotorRtEWdgR
- spray_radialrotor_rt_ewdg_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to rear endwinding area average convective thermal resistance
