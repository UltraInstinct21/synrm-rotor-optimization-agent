...
parameter_name: Spray_RadialRotor_Calc_Input_h_Endcap_F
...
aliases:
- Spray_RadialRotor_Calc_Input_h_Endcap_F
- Spray Radial Rotor Calc Input h Endcap F
- spray_radial_rotor_calc_input_h_endcap_f
- sprayRadialRotorCalcInputHEndcapF
- spray_radialrotor_calc_input_h_endcap_f
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the front endcap surface is calculated or user input  (0=Calc h, 1=Input h)
