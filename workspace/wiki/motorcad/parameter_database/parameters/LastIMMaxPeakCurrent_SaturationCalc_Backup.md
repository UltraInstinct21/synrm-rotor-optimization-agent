...
parameter_name: LastIMMaxPeakCurrent_SaturationCalc_Backup
category: Magnetics
input_output: i/p
data_type: double
units: Amps
...
aliases:
- LastIMMaxPeakCurrent_SaturationCalc_Backup
- Last IM Max Peak Current Saturation Calc Backup
- last_im_max_peak_current_saturation_calc_backup
- lastImMaxPeakCurrentSaturationCalcBackup
- lastimmaxpeakcurrent_saturationcalc_backup
related_parameters:
...
- '[[motorcad/parameter_database/parameters/LastIMMaxPeakCurrent_SaturationCalc|LastIMMaxPeakCurrent_SaturationCalc]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The maximum peak current used in the most recent user-initiated saturation model calculation
