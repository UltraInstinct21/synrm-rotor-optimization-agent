...
parameter_name: Sync_IterationsInAverage_Lab
...
aliases:
- Sync_IterationsInAverage_Lab
- Sync Iterations In Average Lab
- sync_iterations_in_average_lab
- syncIterationsInAverageLab
- sync_iterationsinaverage_lab
related_parameters:
...
## Summary
Number of iteration steps over which the average is taken in convergence loop in Lab Sync calculations
