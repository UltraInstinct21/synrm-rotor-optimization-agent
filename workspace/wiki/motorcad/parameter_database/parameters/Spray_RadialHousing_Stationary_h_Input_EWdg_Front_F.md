...
parameter_name: Spray_RadialHousing_Stationary_h_Input_EWdg_Front_F
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_EWdg_Front_F
- Spray Radial Housing Stationary h Input E Wdg Front F
- spray_radial_housing_stationary_h_input_e_wdg_front_f
- sprayRadialHousingStationaryHInputEWdgFrontF
- spray_radialhousing_stationary_h_input_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the front endwinding front surface
