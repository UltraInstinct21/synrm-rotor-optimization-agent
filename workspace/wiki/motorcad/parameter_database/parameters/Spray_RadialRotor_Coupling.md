...
parameter_name: Spray_RadialRotor_Coupling
...
aliases:
- Spray_RadialRotor_Coupling
- Spray Radial Rotor Coupling
- spray_radial_rotor_coupling
- sprayRadialRotorCoupling
- spray_radialrotor_coupling
related_parameters:
...
## Summary
Specifies the source of fluid flow for Radial (from Rotor) spray cooling
