...
parameter_name: RotorLoss_Eddy_Adj_OC
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- RotorLoss_Eddy_Adj_OC
- Rotor Loss Eddy Adj OC
- rotor_loss_eddy_adj_oc
- rotorLossEddyAdjOc
- rotorloss_eddy_adj_oc
related_parameters:
...
- '[[motorcad/parameter_database/parameters/RotorLoss_Fundamental_Hys|RotorLoss_Fundamental_Hys]]'
...
## Summary
Rotor iron losses from eddy currents (adjusted for build factor)
