...
parameter_name: Spray_RadialRotor_CorrelationFactor_Housing_R
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Housing_R
- Spray Radial Rotor Correlation Factor Housing R
- spray_radial_rotor_correlation_factor_housing_r
- sprayRadialRotorCorrelationFactorHousingR
- spray_radialrotor_correlationfactor_housing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the rear housing surface
