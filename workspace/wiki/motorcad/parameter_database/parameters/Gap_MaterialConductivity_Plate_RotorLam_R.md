...
parameter_name: Gap_MaterialConductivity_Plate_RotorLam_R
...
aliases:
- Gap_MaterialConductivity_Plate_RotorLam_R
- Gap Material Conductivity Plate Rotor Lam R
- gap_material_conductivity_plate_rotor_lam_r
- gapMaterialConductivityPlateRotorLamR
- gap_materialconductivity_plate_rotorlam_r
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Rotor Plate and Rotor Lam [R].
