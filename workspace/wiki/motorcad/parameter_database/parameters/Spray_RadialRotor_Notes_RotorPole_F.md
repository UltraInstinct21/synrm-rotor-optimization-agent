...
parameter_name: Spray_RadialRotor_Notes_RotorPole_F
...
aliases:
- Spray_RadialRotor_Notes_RotorPole_F
- Spray Radial Rotor Notes Rotor Pole F
- spray_radial_rotor_notes_rotor_pole_f
- sprayRadialRotorNotesRotorPoleF
- spray_radialrotor_notes_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) notes for front rotor pole surface
