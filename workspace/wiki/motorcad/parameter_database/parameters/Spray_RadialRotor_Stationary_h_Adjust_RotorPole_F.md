...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_RotorPole_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_RotorPole_F
- Spray Radial Rotor Stationary h Adjust Rotor Pole F
- spray_radial_rotor_stationary_h_adjust_rotor_pole_f
- sprayRadialRotorStationaryHAdjustRotorPoleF
- spray_radialrotor_stationary_h_adjust_rotorpole_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the front rotor pole surface
