...
parameter_name: Vel_ES_EndRing_ExtOuter_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_ExtOuter_F_Calc
- Vel ES End Ring Ext Outer F Calc
- vel_es_end_ring_ext_outer_f_calc
- velEsEndRingExtOuterFCalc
- vel_es_endring_extouter_f_calc
related_parameters:
...
## Summary
The calculated velocity over the end ring ExtOuter surface [front]
