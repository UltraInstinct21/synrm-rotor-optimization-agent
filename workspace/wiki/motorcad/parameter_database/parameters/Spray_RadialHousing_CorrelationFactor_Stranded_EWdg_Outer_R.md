...
parameter_name: Spray_RadialHousing_CorrelationFactor_Stranded_EWdg_Outer_R
...
aliases:
- Spray_RadialHousing_CorrelationFactor_Stranded_EWdg_Outer_R
- Spray Radial Housing Correlation Factor Stranded E Wdg Outer R
- spray_radial_housing_correlation_factor_stranded_e_wdg_outer_r
- sprayRadialHousingCorrelationFactorStrandedEWdgOuterR
- spray_radialhousing_correlationfactor_stranded_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) correlation factor for the stranded rear endwinding outer surface
