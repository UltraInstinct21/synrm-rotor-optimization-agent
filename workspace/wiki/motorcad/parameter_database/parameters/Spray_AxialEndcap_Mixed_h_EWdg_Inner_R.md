...
parameter_name: Spray_AxialEndcap_Mixed_h_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_Mixed_h_EWdg_Inner_R
- Spray Axial Endcap Mixed h E Wdg Inner R
- spray_axial_endcap_mixed_h_e_wdg_inner_r
- sprayAxialEndcapMixedHEWdgInnerR
- spray_axialendcap_mixed_h_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) mixed htc over the rear endwinding inner surface
