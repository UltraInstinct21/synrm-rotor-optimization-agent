...
parameter_name: Spray_RadialRotor_Rt_Housing_F
...
aliases:
- Spray_RadialRotor_Rt_Housing_F
- Spray Radial Rotor Rt Housing F
- spray_radial_rotor_rt_housing_f
- sprayRadialRotorRtHousingF
- spray_radialrotor_rt_housing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to front housing surface convective thermal resistance
