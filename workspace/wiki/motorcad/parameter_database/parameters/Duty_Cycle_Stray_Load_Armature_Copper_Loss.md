...
parameter_name: Duty_Cycle_Stray_Load_Armature_Copper_Loss
category: Transient
input_output: i/p
data_type: double
units: Watts
...
- Duty Cycle Stray Load Armature Copper Loss
- duty_cycle_stray_load_armature_copper_loss
- dutyCycleStrayLoadArmatureCopperLoss
related_parameters:
...
## Summary
Stray load loss in the armature winding for each period of the duty cycle
