...
parameter_name: Spray_RadialRotor_CorrelationFactor_Shaft_F
...
aliases:
- Spray_RadialRotor_CorrelationFactor_Shaft_F
- Spray Radial Rotor Correlation Factor Shaft F
- spray_radial_rotor_correlation_factor_shaft_f
- sprayRadialRotorCorrelationFactorShaftF
- spray_radialrotor_correlationfactor_shaft_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) correlation factor for the front shaft surface
