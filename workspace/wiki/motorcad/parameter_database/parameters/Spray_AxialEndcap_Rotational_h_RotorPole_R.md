...
parameter_name: Spray_AxialEndcap_Rotational_h_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Rotational_h_RotorPole_R
- Spray Axial Endcap Rotational h Rotor Pole R
- spray_axial_endcap_rotational_h_rotor_pole_r
- sprayAxialEndcapRotationalHRotorPoleR
- spray_axialendcap_rotational_h_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc over the rear rotor pole surface
