...
parameter_name: StatorToothLoss_Exc_Static_PerSlice
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- StatorToothLoss_Exc_Static_PerSlice
- Stator Tooth Loss Exc Static Per Slice
- stator_tooth_loss_exc_static_per_slice
- statorToothLossExcStaticPerSlice
- statortoothloss_exc_static_perslice
related_parameters:
...
## Summary
Stator tooth excess losses (per slice)
