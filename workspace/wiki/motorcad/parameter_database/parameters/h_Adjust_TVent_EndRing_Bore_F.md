...
parameter_name: h_Adjust_TVent_EndRing_Bore_F
...
aliases:
- h_Adjust_TVent_EndRing_Bore_F
- h Adjust T Vent End Ring Bore F
- h_adjust_t_vent_end_ring_bore_f
- hAdjustTVentEndRingBoreF
- h_adjust_tvent_endring_bore_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the end ring bore surface [front]
