...
parameter_name: Spray_RadialHousing_Stationary_h_Adjust_EWdg_Outer_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Adjust_EWdg_Outer_R
- Spray Radial Housing Stationary h Adjust E Wdg Outer R
- spray_radial_housing_stationary_h_adjust_e_wdg_outer_r
- sprayRadialHousingStationaryHAdjustEWdgOuterR
- spray_radialhousing_stationary_h_adjust_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc adjustment over the rear endwinding outer surface
