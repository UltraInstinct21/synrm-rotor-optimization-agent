...
parameter_name: Spray_AxialEndcap_Dissipation_Endcap_R
...
aliases:
- Spray_AxialEndcap_Dissipation_Endcap_R
- Spray Axial Endcap Dissipation Endcap R
- spray_axial_endcap_dissipation_endcap_r
- sprayAxialEndcapDissipationEndcapR
- spray_axialendcap_dissipation_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the rear endcap surface
