...
parameter_name: h_TVent_EndRing_ExtInter_F
...
aliases:
- h_TVent_EndRing_ExtInter_F
- h T Vent End Ring Ext Inter F
- h_t_vent_end_ring_ext_inter_f
- hTVentEndRingExtInterF
- h_tvent_endring_extinter_f
related_parameters:
...
## Summary
The TVent heat transfer coefficient over the end ring ExtInter surface [front]
