...
parameter_name: Spray_AxialEndcap_Rt_Endcap_R
...
aliases:
- Spray_AxialEndcap_Rt_Endcap_R
- Spray Axial Endcap Rt Endcap R
- spray_axial_endcap_rt_endcap_r
- sprayAxialEndcapRtEndcapR
- spray_axialendcap_rt_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to rear endcap surface convective thermal resistance
