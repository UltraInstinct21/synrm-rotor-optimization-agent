...
parameter_name: Spray_RadialRotor_Calc_Input_h_EWdg_Front_R
...
aliases:
- Spray_RadialRotor_Calc_Input_h_EWdg_Front_R
- Spray Radial Rotor Calc Input h E Wdg Front R
- spray_radial_rotor_calc_input_h_e_wdg_front_r
- sprayRadialRotorCalcInputHEWdgFrontR
- spray_radialrotor_calc_input_h_ewdg_front_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Rotor) htc over the rear endwinding front surface is calculated or user input  (0=Calc h, 1=Input h)
