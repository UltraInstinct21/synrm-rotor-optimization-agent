...
parameter_name: Vel_ES_EndRing_ExtInter_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EndRing_ExtInter_R_Calc
- Vel ES End Ring Ext Inter R Calc
- vel_es_end_ring_ext_inter_r_calc
- velEsEndRingExtInterRCalc
- vel_es_endring_extinter_r_calc
related_parameters:
...
## Summary
The calculated velocity over the end ring ExtInter surface [rear]
