...
parameter_name: RotorBackIronLoss_Hys_Static
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- RotorBackIronLoss_Hys_Static
- Rotor Back Iron Loss Hys Static
- rotor_back_iron_loss_hys_static
- rotorBackIronLossHysStatic
- rotorbackironloss_hys_static
related_parameters:
