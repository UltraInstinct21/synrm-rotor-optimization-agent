...
parameter_name: Dissipation_TVent_Shaft_OHang_R
category: TVent_Data
input_output: o/p
data_type: double
units: Watts
...
aliases:
- Dissipation_TVent_Shaft_OHang_R
- Dissipation T Vent Shaft O Hang R
- dissipation_t_vent_shaft_o_hang_r
- dissipationTVentShaftOHangR
- dissipation_tvent_shaft_ohang_r
related_parameters:
...
## Summary
Motor-CAD automation parameter `Dissipation_TVent_Shaft_OHang_R` in category `TVent_Data`.
