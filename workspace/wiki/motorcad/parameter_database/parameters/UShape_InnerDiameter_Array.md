...
parameter_name: UShape_InnerDiameter_Array
category: Dimensions
input_output: i/p
data_type: double
units: mm
...
aliases:
- UShape_InnerDiameter_Array
- U Shape Inner Diameter Array
- u_shape_inner_diameter_array
- uShapeInnerDiameterArray
- ushape_innerdiameter_array
related_parameters:
...
- '[[motorcad/parameter_database/parameters/UShape_WebThickness_Array|UShape_WebThickness_Array]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The inner diameter of the U layer
