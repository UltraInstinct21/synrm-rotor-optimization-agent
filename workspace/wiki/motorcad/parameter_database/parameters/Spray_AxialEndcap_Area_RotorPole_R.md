...
parameter_name: Spray_AxialEndcap_Area_RotorPole_R
...
aliases:
- Spray_AxialEndcap_Area_RotorPole_R
- Spray Axial Endcap Area Rotor Pole R
- spray_axial_endcap_area_rotor_pole_r
- sprayAxialEndcapAreaRotorPoleR
- spray_axialendcap_area_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear rotor pole surface sprayed area
