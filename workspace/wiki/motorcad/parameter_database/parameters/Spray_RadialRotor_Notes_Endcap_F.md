...
parameter_name: Spray_RadialRotor_Notes_Endcap_F
...
aliases:
- Spray_RadialRotor_Notes_Endcap_F
- Spray Radial Rotor Notes Endcap F
- spray_radial_rotor_notes_endcap_f
- sprayRadialRotorNotesEndcapF
- spray_radialrotor_notes_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) notes for front endcap surface
