...
parameter_name: Gap_Material_StatorClampPlate_Housing_R
...
aliases:
- Gap_Material_StatorClampPlate_Housing_R
- Gap Material Stator Clamp Plate Housing R
- gap_material_stator_clamp_plate_housing_r
- gapMaterialStatorClampPlateHousingR
- gap_material_statorclampplate_housing_r
related_parameters:
...
## Summary
Material in the interface gap between the Stator Plate and Housing [R].
