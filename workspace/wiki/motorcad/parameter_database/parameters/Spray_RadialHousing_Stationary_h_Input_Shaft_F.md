...
parameter_name: Spray_RadialHousing_Stationary_h_Input_Shaft_F
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_Shaft_F
- Spray Radial Housing Stationary h Input Shaft F
- spray_radial_housing_stationary_h_input_shaft_f
- sprayRadialHousingStationaryHInputShaftF
- spray_radialhousing_stationary_h_input_shaft_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the front shaft surface
