...
parameter_name: Area_Mult_ES_ExtShaftEnd_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_ExtShaftEnd_F
- Area Mult ES Ext Shaft End F
- area_mult_es_ext_shaft_end_f
- areaMultEsExtShaftEndF
- area_mult_es_extshaftend_f
related_parameters:
...
## Summary
Area multiplier for the Shaft Extension End [Front] surface for End Space Cooling
