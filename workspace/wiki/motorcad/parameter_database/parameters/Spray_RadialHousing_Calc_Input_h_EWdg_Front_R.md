...
parameter_name: Spray_RadialHousing_Calc_Input_h_EWdg_Front_R
...
aliases:
- Spray_RadialHousing_Calc_Input_h_EWdg_Front_R
- Spray Radial Housing Calc Input h E Wdg Front R
- spray_radial_housing_calc_input_h_e_wdg_front_r
- sprayRadialHousingCalcInputHEWdgFrontR
- spray_radialhousing_calc_input_h_ewdg_front_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the rear endwinding front surface is calculated or user input  (0=Calc h, 1=Input h)
