...
parameter_name: Flow_Area_Inlet_Rotor_EWdg_Cont_Exp_Upstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Rotor_EWdg_Cont_Exp_Upstream
- Flow Area Inlet Rotor E Wdg Cont Exp Upstream
- flow_area_inlet_rotor_e_wdg_cont_exp_upstream
- flowAreaInletRotorEWdgContExpUpstream
- flow_area_inlet_rotor_ewdg_cont_exp_upstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Rotor EWdg Contraction Expansion Upstream
