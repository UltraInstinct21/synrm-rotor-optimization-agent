...
parameter_name: TVent_SlotWJ_Connection
...
aliases:
- TVent_SlotWJ_Connection
- T Vent Slot WJ Connection
- t_vent_slot_wj_connection
- tVentSlotWjConnection
- tvent_slotwj_connection
related_parameters:
...
## Summary
When selected the TVent airgap and slot water jacket paths are in parallel
