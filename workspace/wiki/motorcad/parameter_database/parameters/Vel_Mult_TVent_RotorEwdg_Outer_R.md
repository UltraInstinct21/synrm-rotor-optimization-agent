...
parameter_name: Vel_Mult_TVent_RotorEwdg_Outer_R
...
aliases:
- Vel_Mult_TVent_RotorEwdg_Outer_R
- Vel Mult T Vent Rotor Ewdg Outer R
- vel_mult_t_vent_rotor_ewdg_outer_r
- velMultTVentRotorEwdgOuterR
- vel_mult_tvent_rotorewdg_outer_r
related_parameters:
...
## Summary
The TVent velocity multiplier over the EWdg Outer surface [rear]
