...
parameter_name: Outlet_Temp_TVent_EWdg_Outer_Housing_R
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Outlet_Temp_TVent_EWdg_Outer_Housing_R
- Outlet Temp T Vent E Wdg Outer Housing R
- outlet_temp_t_vent_e_wdg_outer_housing_r
- outletTempTVentEWdgOuterHousingR
- outlet_temp_tvent_ewdg_outer_housing_r
related_parameters:
...
## Summary
Motor-CAD automation parameter `Outlet_Temp_TVent_EWdg_Outer_Housing_R` in category `TVent_Data`.
