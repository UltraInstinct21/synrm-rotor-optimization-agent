...
parameter_name: h_TVent_Axial_EndRing_ExtInter_R
...
aliases:
- h_TVent_Axial_EndRing_ExtInter_R
- h T Vent Axial End Ring Ext Inter R
- h_t_vent_axial_end_ring_ext_inter_r
- hTVentAxialEndRingExtInterR
- h_tvent_axial_endring_extinter_r
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the end ring ExtInter surface [rear]
