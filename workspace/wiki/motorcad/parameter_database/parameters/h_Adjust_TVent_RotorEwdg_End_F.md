...
parameter_name: h_Adjust_TVent_RotorEwdg_End_F
...
aliases:
- h_Adjust_TVent_RotorEwdg_End_F
- h Adjust T Vent Rotor Ewdg End F
- h_adjust_t_vent_rotor_ewdg_end_f
- hAdjustTVentRotorEwdgEndF
- h_adjust_tvent_rotorewdg_end_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the EWdg End surface [front]
