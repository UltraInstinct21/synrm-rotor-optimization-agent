...
parameter_name: Spray_AxialEndcap_Dissipation_Housing_F
...
aliases:
- Spray_AxialEndcap_Dissipation_Housing_F
- Spray Axial Endcap Dissipation Housing F
- spray_axial_endcap_dissipation_housing_f
- sprayAxialEndcapDissipationHousingF
- spray_axialendcap_dissipation_housing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the front housing surface
