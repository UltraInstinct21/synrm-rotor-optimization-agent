...
parameter_name: Gap_MaterialConductivity_H_EndCap_Front
...
aliases:
- Gap_MaterialConductivity_H_EndCap_Front
- Gap Material Conductivity H End Cap Front
- gap_material_conductivity_h_end_cap_front
- gapMaterialConductivityHEndCapFront
- gap_materialconductivity_h_endcap_front
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between Housing and Endcap [F].
