...
parameter_name: Vel_ES_RotorEwdg_inner_F
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_RotorEwdg_inner_F
- Vel ES Rotor Ewdg inner F
- vel_es_rotor_ewdg_inner_f
- velEsRotorEwdgInnerF
- vel_es_rotorewdg_inner_f
related_parameters:
...
## Summary
The velocity over the end wdg inner surface [front]
