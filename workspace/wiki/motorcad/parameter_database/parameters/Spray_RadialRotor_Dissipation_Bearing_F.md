...
parameter_name: Spray_RadialRotor_Dissipation_Bearing_F
...
aliases:
- Spray_RadialRotor_Dissipation_Bearing_F
- Spray Radial Rotor Dissipation Bearing F
- spray_radial_rotor_dissipation_bearing_f
- sprayRadialRotorDissipationBearingF
- spray_radialrotor_dissipation_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the front bearing surface
