...
parameter_name: Spray_AxialEndcap_Area_Mult_Bearing_F
...
aliases:
- Spray_AxialEndcap_Area_Mult_Bearing_F
- Spray Axial Endcap Area Mult Bearing F
- spray_axial_endcap_area_mult_bearing_f
- sprayAxialEndcapAreaMultBearingF
- spray_axialendcap_area_mult_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) front bearing surface area multiplier
