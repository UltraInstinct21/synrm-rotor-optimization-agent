...
parameter_name: TVent_Airgap_Outlet_Temperature
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- TVent_Airgap_Outlet_Temperature
- T Vent Airgap Outlet Temperature
- t_vent_airgap_outlet_temperature
- tVentAirgapOutletTemperature
- tvent_airgap_outlet_temperature
related_parameters:
...
## Summary
Motor-CAD automation parameter `TVent_Airgap_Outlet_Temperature` in category `TVent_Data`.
