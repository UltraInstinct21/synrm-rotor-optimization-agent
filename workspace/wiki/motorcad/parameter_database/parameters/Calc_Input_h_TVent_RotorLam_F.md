...
parameter_name: Calc_Input_h_TVent_RotorLam_F
...
aliases:
- Calc_Input_h_TVent_RotorLam_F
- Calc Input h T Vent Rotor Lam F
- calc_input_h_t_vent_rotor_lam_f
- calcInputHTVentRotorLamF
- calc_input_h_tvent_rotorlam_f
related_parameters:
...
## Summary
The TVent calculated or input set value for htc from flow over the Rotor lam surface [front] (0=Calc h, 1=Input h)
