...
parameter_name: Spray_RadialRotor_NozzleNumber_F
...
aliases:
- Spray_RadialRotor_NozzleNumber_F
- Spray Radial Rotor Nozzle Number F
- spray_radial_rotor_nozzle_number_f
- sprayRadialRotorNozzleNumberF
- spray_radialrotor_nozzlenumber_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) front nozzle number
