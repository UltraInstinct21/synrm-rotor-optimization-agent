...
parameter_name: ModelBuildPoints_Current_Lab
...
- Model Build Points Current Lab
- model_build_points_current_lab
- modelBuildPointsCurrentLab
- modelbuildpoints_current_lab
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ModelBuildPoints_Gamma_Lab|ModelBuildPoints_Gamma_Lab]]'
...
## Summary
Number of current points in Lab saturation/loss model build
