...
parameter_name: Re_TVent_EndRing_Bore_R
...
aliases:
- Re_TVent_EndRing_Bore_R
- Re T Vent End Ring Bore R
- re_t_vent_end_ring_bore_r
- reTVentEndRingBoreR
- re_tvent_endring_bore_r
related_parameters:
...
## Summary
The TVent reynolds number for flow over the end ring bore surface [rear]
