...
parameter_name: Spray_RadialHousing_Stationary_h_Input_EWdg_Outer_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Input_EWdg_Outer_R
- Spray Radial Housing Stationary h Input E Wdg Outer R
- spray_radial_housing_stationary_h_input_e_wdg_outer_r
- sprayRadialHousingStationaryHInputEWdgOuterR
- spray_radialhousing_stationary_h_input_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) user input stationary htc over the rear endwinding outer surface
