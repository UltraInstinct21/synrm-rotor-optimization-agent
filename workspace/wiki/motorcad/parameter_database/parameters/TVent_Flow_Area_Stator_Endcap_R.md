...
parameter_name: TVent_Flow_Area_Stator_Endcap_R
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- TVent_Flow_Area_Stator_Endcap_R
- T Vent Flow Area Stator Endcap R
- t_vent_flow_area_stator_endcap_r
- tVentFlowAreaStatorEndcapR
- tvent_flow_area_stator_endcap_r
related_parameters:
...
## Summary
TVent Flow Area for the Stator Endcap Rear
