...
parameter_name: Flow_Area_Outlet_Exit_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Outlet_Exit_Downstream
- Flow Area Outlet Exit Downstream
- flow_area_outlet_exit_downstream
- flowAreaOutletExitDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Outlet Exit Downstream
