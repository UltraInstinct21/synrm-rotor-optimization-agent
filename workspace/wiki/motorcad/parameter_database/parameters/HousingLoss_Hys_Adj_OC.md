...
parameter_name: HousingLoss_Hys_Adj_OC
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- HousingLoss_Hys_Adj_OC
- Housing Loss Hys Adj OC
- housing_loss_hys_adj_oc
- housingLossHysAdjOc
- housingloss_hys_adj_oc
related_parameters:
...
## Summary
Housing losses from hysteresis (adjusted for build factor)
