...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_EWdg_Front_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_EWdg_Front_F
- Spray Axial Endcap Stationary h Input E Wdg Front F
- spray_axial_endcap_stationary_h_input_e_wdg_front_f
- sprayAxialEndcapStationaryHInputEWdgFrontF
- spray_axialendcap_stationary_h_input_ewdg_front_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the front endwinding front surface
