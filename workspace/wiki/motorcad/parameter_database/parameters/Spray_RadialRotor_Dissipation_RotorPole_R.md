...
parameter_name: Spray_RadialRotor_Dissipation_RotorPole_R
...
aliases:
- Spray_RadialRotor_Dissipation_RotorPole_R
- Spray Radial Rotor Dissipation Rotor Pole R
- spray_radial_rotor_dissipation_rotor_pole_r
- sprayRadialRotorDissipationRotorPoleR
- spray_radialrotor_dissipation_rotorpole_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) thermal dissipation from the rear rotor pole surface
