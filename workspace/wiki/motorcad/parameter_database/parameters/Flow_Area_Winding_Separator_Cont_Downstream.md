...
parameter_name: Flow_Area_Winding_Separator_Cont_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Winding_Separator_Cont_Downstream
- Flow Area Winding Separator Cont Downstream
- flow_area_winding_separator_cont_downstream
- flowAreaWindingSeparatorContDownstream
related_parameters:
...
## Summary
TVent Flow Area for the Winding Separator Contraction Downstream
