...
parameter_name: Rt_TVent_Housing_OHang_R
category: TVent_Data
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_TVent_Housing_OHang_R
- Rt T Vent Housing O Hang R
- rt_t_vent_housing_o_hang_r
- rtTVentHousingOHangR
- rt_tvent_housing_ohang_r
related_parameters:
...
## Summary
Motor-CAD automation parameter `Rt_TVent_Housing_OHang_R` in category `TVent_Data`.
