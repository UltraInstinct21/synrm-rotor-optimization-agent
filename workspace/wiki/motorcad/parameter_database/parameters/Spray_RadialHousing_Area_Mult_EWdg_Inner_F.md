...
parameter_name: Spray_RadialHousing_Area_Mult_EWdg_Inner_F
...
aliases:
- Spray_RadialHousing_Area_Mult_EWdg_Inner_F
- Spray Radial Housing Area Mult E Wdg Inner F
- spray_radial_housing_area_mult_e_wdg_inner_f
- sprayRadialHousingAreaMultEWdgInnerF
- spray_radialhousing_area_mult_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) front endwinding inner surface area multiplier
