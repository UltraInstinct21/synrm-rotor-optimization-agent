...
parameter_name: Spray_AxialEndcap_Dissipation_EWdg_Inner_R
...
aliases:
- Spray_AxialEndcap_Dissipation_EWdg_Inner_R
- Spray Axial Endcap Dissipation E Wdg Inner R
- spray_axial_endcap_dissipation_e_wdg_inner_r
- sprayAxialEndcapDissipationEWdgInnerR
- spray_axialendcap_dissipation_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) thermal dissipation from the rear endwinding inner surface
