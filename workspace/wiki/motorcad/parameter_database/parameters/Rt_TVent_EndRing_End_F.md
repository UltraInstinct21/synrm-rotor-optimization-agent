...
parameter_name: Rt_TVent_EndRing_End_F
...
aliases:
- Rt_TVent_EndRing_End_F
- Rt T Vent End Ring End F
- rt_t_vent_end_ring_end_f
- rtTVentEndRingEndF
- rt_tvent_endring_end_f
related_parameters:
...
## Summary
The thermal resistance from the end surface of front rotor end ring to the fluid
