...
parameter_name: h_ES_RotorEwdg_end_R
category: End_Space
input_output: o/p
data_type: double
units: W/m²/°C
...
aliases:
- h_ES_RotorEwdg_end_R
- h ES Rotor Ewdg end R
- h_es_rotor_ewdg_end_r
- hEsRotorEwdgEndR
- h_es_rotorewdg_end_r
related_parameters:
...
## Summary
The heat transfer coefficient over the end wdg end surface [rear]
