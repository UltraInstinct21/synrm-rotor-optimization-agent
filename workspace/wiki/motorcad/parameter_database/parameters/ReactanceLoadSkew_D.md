...
parameter_name: ReactanceLoadSkew_D
category: Magnetics
input_output: o/p
data_type: double
units: Ohms
...
aliases:
- ReactanceLoadSkew_D
- Reactance Load Skew D
- reactance_load_skew_d
- reactanceLoadSkewD
- reactanceloadskew_d
related_parameters:
...
- '[[motorcad/parameter_database/parameters/ReactanceLoadSkew_Q|ReactanceLoadSkew_Q]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The reactance in D axis for skewed machine
