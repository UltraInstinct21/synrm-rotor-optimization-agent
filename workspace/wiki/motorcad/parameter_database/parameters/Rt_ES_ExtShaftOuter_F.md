...
parameter_name: Rt_ES_ExtShaftOuter_F
category: End_Space
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_ES_ExtShaftOuter_F
- Rt ES Ext Shaft Outer F
- rt_es_ext_shaft_outer_f
- rtEsExtShaftOuterF
- rt_es_extshaftouter_f
related_parameters:
...
## Summary
The thermal resistance between the ambient and shaft extension outer [front]
