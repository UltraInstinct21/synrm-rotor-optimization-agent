...
parameter_name: h_Adjust_TVent_RotorEwdg_Outer_R
...
aliases:
- h_Adjust_TVent_RotorEwdg_Outer_R
- h Adjust T Vent Rotor Ewdg Outer R
- h_adjust_t_vent_rotor_ewdg_outer_r
- hAdjustTVentRotorEwdgOuterR
- h_adjust_tvent_rotorewdg_outer_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient adjustment (user input) over the EWdg Outer surface [rear]
