...
parameter_name: Area_Mult_ES_RotorEwdg_Outer_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_RotorEwdg_Outer_R
- Area Mult ES Rotor Ewdg Outer R
- area_mult_es_rotor_ewdg_outer_r
- areaMultEsRotorEwdgOuterR
- area_mult_es_rotorewdg_outer_r
related_parameters:
...
## Summary
Area multiplier for the Rotor End-Winding Outer [Rear] surface for End Space Cooling
