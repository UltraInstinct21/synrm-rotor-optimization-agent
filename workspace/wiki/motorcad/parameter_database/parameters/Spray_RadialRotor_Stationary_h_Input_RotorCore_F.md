...
parameter_name: Spray_RadialRotor_Stationary_h_Input_RotorCore_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_RotorCore_F
- Spray Radial Rotor Stationary h Input Rotor Core F
- spray_radial_rotor_stationary_h_input_rotor_core_f
- sprayRadialRotorStationaryHInputRotorCoreF
- spray_radialrotor_stationary_h_input_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the front rotor core surface
