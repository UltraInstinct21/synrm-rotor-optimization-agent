...
parameter_name: TVent_Flow_Resistance_Inlet_R
category: TVent_Data
input_output: o/p
data_type: double
units: kg/m⁷
...
aliases:
- TVent_Flow_Resistance_Inlet_R
- T Vent Flow Resistance Inlet R
- t_vent_flow_resistance_inlet_r
- tVentFlowResistanceInletR
- tvent_flow_resistance_inlet_r
related_parameters:
