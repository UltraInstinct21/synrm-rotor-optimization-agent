...
parameter_name: StatorToothLoss_Total_Adj_OC
category: Magnetics
input_output: o/p
data_type: double
units: Watts
...
aliases:
- StatorToothLoss_Total_Adj_OC
- Stator Tooth Loss Total Adj OC
- stator_tooth_loss_total_adj_oc
- statorToothLossTotalAdjOc
- statortoothloss_total_adj_oc
related_parameters:
...
## Summary
Stator tooth losses adjusted to take into account build factor
