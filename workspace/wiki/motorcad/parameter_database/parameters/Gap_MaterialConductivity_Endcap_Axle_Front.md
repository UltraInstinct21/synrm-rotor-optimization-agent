...
parameter_name: Gap_MaterialConductivity_Endcap_Axle_Front
...
aliases:
- Gap_MaterialConductivity_Endcap_Axle_Front
- Gap Material Conductivity Endcap Axle Front
- gap_material_conductivity_endcap_axle_front
- gapMaterialConductivityEndcapAxleFront
- gap_materialconductivity_endcap_axle_front
related_parameters:
...
## Summary
Conductivity of the material in the interface gap between the Endcap and Axle [F].
