...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_Bearing_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_Bearing_F
- Spray Axial Endcap Stationary h Input Bearing F
- spray_axial_endcap_stationary_h_input_bearing_f
- sprayAxialEndcapStationaryHInputBearingF
- spray_axialendcap_stationary_h_input_bearing_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the front bearing surface
