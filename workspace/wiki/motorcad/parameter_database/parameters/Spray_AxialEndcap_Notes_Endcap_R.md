...
parameter_name: Spray_AxialEndcap_Notes_Endcap_R
...
aliases:
- Spray_AxialEndcap_Notes_Endcap_R
- Spray Axial Endcap Notes Endcap R
- spray_axial_endcap_notes_endcap_r
- sprayAxialEndcapNotesEndcapR
- spray_axialendcap_notes_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) notes for rear endcap surface
