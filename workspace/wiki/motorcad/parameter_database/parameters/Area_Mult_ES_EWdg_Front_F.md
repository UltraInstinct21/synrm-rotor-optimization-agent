...
parameter_name: Area_Mult_ES_EWdg_Front_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_EWdg_Front_F
- Area Mult ES E Wdg Front F
- area_mult_es_e_wdg_front_f
- areaMultEsEWdgFrontF
- area_mult_es_ewdg_front_f
related_parameters:
...
## Summary
Area multiplier for the End-Winding Front [Rear] surfaces for End Space Cooling
