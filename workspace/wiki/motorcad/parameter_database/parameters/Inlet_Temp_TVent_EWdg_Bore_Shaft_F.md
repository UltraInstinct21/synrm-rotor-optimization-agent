...
parameter_name: Inlet_Temp_TVent_EWdg_Bore_Shaft_F
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Inlet_Temp_TVent_EWdg_Bore_Shaft_F
- Inlet Temp T Vent E Wdg Bore Shaft F
- inlet_temp_t_vent_e_wdg_bore_shaft_f
- inletTempTVentEWdgBoreShaftF
- inlet_temp_tvent_ewdg_bore_shaft_f
related_parameters:
...
## Summary
Motor-CAD automation parameter `Inlet_Temp_TVent_EWdg_Bore_Shaft_F` in category `TVent_Data`.
