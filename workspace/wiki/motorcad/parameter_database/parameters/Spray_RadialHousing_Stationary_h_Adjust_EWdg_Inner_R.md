...
parameter_name: Spray_RadialHousing_Stationary_h_Adjust_EWdg_Inner_R
...
aliases:
- Spray_RadialHousing_Stationary_h_Adjust_EWdg_Inner_R
- Spray Radial Housing Stationary h Adjust E Wdg Inner R
- spray_radial_housing_stationary_h_adjust_e_wdg_inner_r
- sprayRadialHousingStationaryHAdjustEWdgInnerR
- spray_radialhousing_stationary_h_adjust_ewdg_inner_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) stationary htc adjustment over the rear endwinding inner surface
