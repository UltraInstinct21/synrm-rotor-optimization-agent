...
parameter_name: Fixed_Axle_F_Temperature
...
aliases:
- Fixed_Axle_F_Temperature
- Fixed Axle F Temperature
- fixed_axle_f_temperature
- fixedAxleFTemperature
related_parameters:
...
## Summary
Fix Axle[F] temperature at set value (by injecting power into plate)
