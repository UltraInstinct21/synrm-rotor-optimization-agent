...
parameter_name: Area_TVent_EndRing_ExtBore_R
...
aliases:
- Area_TVent_EndRing_ExtBore_R
- Area T Vent End Ring Ext Bore R
- area_t_vent_end_ring_ext_bore_r
- areaTVentEndRingExtBoreR
- area_tvent_endring_extbore_r
related_parameters:
...
## Summary
Surface area of the EndRing ExtBore [Rear] for Through Ventilation
