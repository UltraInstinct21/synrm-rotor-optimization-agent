...
parameter_name: Spray_RadialRotor_Rotational_h_Input_RotorCore_F
...
aliases:
- Spray_RadialRotor_Rotational_h_Input_RotorCore_F
- Spray Radial Rotor Rotational h Input Rotor Core F
- spray_radial_rotor_rotational_h_input_rotor_core_f
- sprayRadialRotorRotationalHInputRotorCoreF
- spray_radialrotor_rotational_h_input_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input rotational htc over the front rotor core surface
