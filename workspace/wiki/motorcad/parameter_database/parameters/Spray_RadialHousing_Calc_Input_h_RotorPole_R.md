...
parameter_name: Spray_RadialHousing_Calc_Input_h_RotorPole_R
...
aliases:
- Spray_RadialHousing_Calc_Input_h_RotorPole_R
- Spray Radial Housing Calc Input h Rotor Pole R
- spray_radial_housing_calc_input_h_rotor_pole_r
- sprayRadialHousingCalcInputHRotorPoleR
- spray_radialhousing_calc_input_h_rotorpole_r
related_parameters:
...
## Summary
Determines whether the Spray Cooling (Radial from Housing) htc over the rear rotor pole surface is calculated or user input  (0=Calc h, 1=Input h)
