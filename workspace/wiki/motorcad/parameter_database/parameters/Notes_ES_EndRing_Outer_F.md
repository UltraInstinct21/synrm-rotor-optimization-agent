...
parameter_name: Notes_ES_EndRing_Outer_F
category: End_Space
input_output: i/p
data_type: OleStr
units: N/A
...
aliases:
- Notes_ES_EndRing_Outer_F
- Notes ES End Ring Outer F
- notes_es_end_ring_outer_f
- notesEsEndRingOuterF
- notes_es_endring_outer_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Notes_ES_EndRing_ExtBore_F|Notes_ES_EndRing_ExtBore_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The notes for the end ring Outer surface [front]
