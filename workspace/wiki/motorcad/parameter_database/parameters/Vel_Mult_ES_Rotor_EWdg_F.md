...
parameter_name: Vel_Mult_ES_Rotor_EWdg_F
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Vel_Mult_ES_Rotor_EWdg_F
- Vel Mult ES Rotor E Wdg F
- vel_mult_es_rotor_e_wdg_f
- velMultEsRotorEWdgF
- vel_mult_es_rotor_ewdg_f
related_parameters:
...
## Summary
The velocity multiplier for rotor endwinding surface [front]
