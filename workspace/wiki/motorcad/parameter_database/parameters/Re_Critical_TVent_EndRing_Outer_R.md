...
parameter_name: Re_Critical_TVent_EndRing_Outer_R
...
aliases:
- Re_Critical_TVent_EndRing_Outer_R
- Re Critical T Vent End Ring Outer R
- re_critical_t_vent_end_ring_outer_r
- reCriticalTVentEndRingOuterR
- re_critical_tvent_endring_outer_r
related_parameters:
...
## Summary
The TVent critical reynolds number for flow over the end ring Outer surface [rear]
