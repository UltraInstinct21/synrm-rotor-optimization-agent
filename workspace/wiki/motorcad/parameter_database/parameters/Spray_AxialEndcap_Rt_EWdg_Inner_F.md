...
parameter_name: Spray_AxialEndcap_Rt_EWdg_Inner_F
...
aliases:
- Spray_AxialEndcap_Rt_EWdg_Inner_F
- Spray Axial Endcap Rt E Wdg Inner F
- spray_axial_endcap_rt_e_wdg_inner_f
- sprayAxialEndcapRtEWdgInnerF
- spray_axialendcap_rt_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) fluid to front endwinding inner surface convective thermal resistance
