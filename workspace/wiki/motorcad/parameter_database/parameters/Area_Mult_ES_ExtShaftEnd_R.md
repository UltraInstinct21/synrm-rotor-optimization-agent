...
parameter_name: Area_Mult_ES_ExtShaftEnd_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_ExtShaftEnd_R
- Area Mult ES Ext Shaft End R
- area_mult_es_ext_shaft_end_r
- areaMultEsExtShaftEndR
- area_mult_es_extshaftend_r
related_parameters:
...
## Summary
Area multiplier for the Shaft Extension End [Rear] surface for End Space Cooling
