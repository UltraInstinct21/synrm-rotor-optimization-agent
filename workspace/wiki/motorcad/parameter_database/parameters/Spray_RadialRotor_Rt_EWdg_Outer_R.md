...
parameter_name: Spray_RadialRotor_Rt_EWdg_Outer_R
...
aliases:
- Spray_RadialRotor_Rt_EWdg_Outer_R
- Spray Radial Rotor Rt E Wdg Outer R
- spray_radial_rotor_rt_e_wdg_outer_r
- sprayRadialRotorRtEWdgOuterR
- spray_radialrotor_rt_ewdg_outer_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to rear endwinding outer surface convective thermal resistance
