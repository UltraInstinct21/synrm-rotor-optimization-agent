...
parameter_name: Spray_AxialEndcap_Stationary_h_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_RotorCore_F
- Spray Axial Endcap Stationary h Rotor Core F
- spray_axial_endcap_stationary_h_rotor_core_f
- sprayAxialEndcapStationaryHRotorCoreF
- spray_axialendcap_stationary_h_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the front rotor core surface
