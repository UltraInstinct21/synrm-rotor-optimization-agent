...
parameter_name: Spray_AxialEndcap_Area_Mult_Housing_R
...
aliases:
- Spray_AxialEndcap_Area_Mult_Housing_R
- Spray Axial Endcap Area Mult Housing R
- spray_axial_endcap_area_mult_housing_r
- sprayAxialEndcapAreaMultHousingR
- spray_axialendcap_area_mult_housing_r
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rear housing surface area multiplier
