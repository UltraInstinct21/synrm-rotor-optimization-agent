...
parameter_name: h_TVent_Axial_EndRing_Bore_R
...
aliases:
- h_TVent_Axial_EndRing_Bore_R
- h T Vent Axial End Ring Bore R
- h_t_vent_axial_end_ring_bore_r
- hTVentAxialEndRingBoreR
- h_tvent_axial_endring_bore_r
related_parameters:
...
## Summary
The TVent axial flow heat transfer coefficient over the end ring bore surface [rear]
