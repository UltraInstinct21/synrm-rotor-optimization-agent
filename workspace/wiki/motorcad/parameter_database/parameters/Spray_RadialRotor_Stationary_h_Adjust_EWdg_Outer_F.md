...
parameter_name: Spray_RadialRotor_Stationary_h_Adjust_EWdg_Outer_F
...
aliases:
- Spray_RadialRotor_Stationary_h_Adjust_EWdg_Outer_F
- Spray Radial Rotor Stationary h Adjust E Wdg Outer F
- spray_radial_rotor_stationary_h_adjust_e_wdg_outer_f
- sprayRadialRotorStationaryHAdjustEWdgOuterF
- spray_radialrotor_stationary_h_adjust_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) stationary htc adjustment over the front endwinding outer surface
