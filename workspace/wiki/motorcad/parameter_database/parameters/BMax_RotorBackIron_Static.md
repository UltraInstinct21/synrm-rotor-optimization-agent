...
parameter_name: BMax_RotorBackIron_Static
category: Magnetics
input_output: o/p
data_type: double
units: Tesla
...
aliases:
- BMax_RotorBackIron_Static
- B Max Rotor Back Iron Static
- b_max_rotor_back_iron_static
- bMaxRotorBackIronStatic
- bmax_rotorbackiron_static
related_parameters:
...
## Summary
Maximum flux density at midpoint in the rotor back iron (Initial static solution)
