...
parameter_name: Spray_AxialEndcap_Stationary_h_Input_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_Input_RotorCore_F
- Spray Axial Endcap Stationary h Input Rotor Core F
- spray_axial_endcap_stationary_h_input_rotor_core_f
- sprayAxialEndcapStationaryHInputRotorCoreF
- spray_axialendcap_stationary_h_input_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) user input stationary htc over the front rotor core surface
