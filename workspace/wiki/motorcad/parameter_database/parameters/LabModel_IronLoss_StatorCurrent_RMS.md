...
parameter_name: LabModel_IronLoss_StatorCurrent_RMS
...
- Lab Model Iron Loss Stator Current RMS
- lab_model_iron_loss_stator_current_rms
- labModelIronLossStatorCurrentRms
- labmodel_ironloss_statorcurrent_rms
related_parameters:
...
## Summary
Maximum stator current used in Lab iron loss model build (rms)
