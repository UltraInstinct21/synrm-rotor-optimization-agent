...
parameter_name: Flow_Area_Inlet_Rotor_EWdg_Bore_Exp_Downstream
category: TVent_Data
input_output: o/p
data_type: double
units: mm²
...
aliases:
- Flow_Area_Inlet_Rotor_EWdg_Bore_Exp_Downstream
- Flow Area Inlet Rotor E Wdg Bore Exp Downstream
- flow_area_inlet_rotor_e_wdg_bore_exp_downstream
- flowAreaInletRotorEWdgBoreExpDownstream
- flow_area_inlet_rotor_ewdg_bore_exp_downstream
related_parameters:
...
## Summary
TVent Flow Area for the Inlet Rotor EWdg Bore Expansion Downstream
