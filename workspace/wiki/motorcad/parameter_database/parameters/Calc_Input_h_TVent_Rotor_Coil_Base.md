...
parameter_name: Calc_Input_h_TVent_Rotor_Coil_Base
...
aliases:
- Calc_Input_h_TVent_Rotor_Coil_Base
- Calc Input h T Vent Rotor Coil Base
- calc_input_h_t_vent_rotor_coil_base
- calcInputHTVentRotorCoilBase
- calc_input_h_tvent_rotor_coil_base
related_parameters:
