...
parameter_name: Duty_Cycle_DC_Bus_Voltage_Definition
category: Transient
input_output: i/p
data_type: integer
units: N/A
...
aliases:
- Duty_Cycle_DC_Bus_Voltage_Definition
- Duty Cycle DC Bus Voltage Definition
- duty_cycle_dc_bus_voltage_definition
- dutyCycleDcBusVoltageDefinition
related_parameters:
...
- '[[motorcad/parameter_database/parameters/Duty_Cycle_Number_Points|Duty_Cycle_Number_Points]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
Defines whether the DC bus voltage is fixed or variable during the duty cycle.
