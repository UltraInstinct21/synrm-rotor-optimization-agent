...
parameter_name: Spray_RadialRotor_Area_Endcap_F
...
aliases:
- Spray_RadialRotor_Area_Endcap_F
- Spray Radial Rotor Area Endcap F
- spray_radial_rotor_area_endcap_f
- sprayRadialRotorAreaEndcapF
- spray_radialrotor_area_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) front endcap surface sprayed area
