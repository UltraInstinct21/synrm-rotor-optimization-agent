...
parameter_name: Spray_AxialEndcap_Stationary_h_EWdg_Inner_F
...
aliases:
- Spray_AxialEndcap_Stationary_h_EWdg_Inner_F
- Spray Axial Endcap Stationary h E Wdg Inner F
- spray_axial_endcap_stationary_h_e_wdg_inner_f
- sprayAxialEndcapStationaryHEWdgInnerF
- spray_axialendcap_stationary_h_ewdg_inner_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) stationary htc over the front endwinding inner surface
