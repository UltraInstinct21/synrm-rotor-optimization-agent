...
parameter_name: Area_Mult_ES_DividerWedge_R
category: End_Space
input_output: i/p
data_type: double
units: p.u.
...
aliases:
- Area_Mult_ES_DividerWedge_R
- Area Mult ES Divider Wedge R
- area_mult_es_divider_wedge_r
- areaMultEsDividerWedgeR
- area_mult_es_dividerwedge_r
related_parameters:
...
## Summary
Area multiplier for the Air Divider/Wedge [Rear] surface for End Space Cooling
