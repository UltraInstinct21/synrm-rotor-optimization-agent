...
parameter_name: Average_Temp_TVent_EWdg_Bore_Shaft_F
category: TVent_Data
input_output: o/p
data_type: double
units: °C
...
aliases:
- Average_Temp_TVent_EWdg_Bore_Shaft_F
- Average Temp T Vent E Wdg Bore Shaft F
- average_temp_t_vent_e_wdg_bore_shaft_f
- averageTempTVentEWdgBoreShaftF
- average_temp_tvent_ewdg_bore_shaft_f
related_parameters:
...
## Summary
Motor-CAD automation parameter `Average_Temp_TVent_EWdg_Bore_Shaft_F` in category `TVent_Data`.
