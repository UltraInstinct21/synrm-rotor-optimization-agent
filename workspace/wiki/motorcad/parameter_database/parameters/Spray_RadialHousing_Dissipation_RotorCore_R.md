...
parameter_name: Spray_RadialHousing_Dissipation_RotorCore_R
...
aliases:
- Spray_RadialHousing_Dissipation_RotorCore_R
- Spray Radial Housing Dissipation Rotor Core R
- spray_radial_housing_dissipation_rotor_core_r
- sprayRadialHousingDissipationRotorCoreR
- spray_radialhousing_dissipation_rotorcore_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) thermal dissipation from the rear rotor core surface
