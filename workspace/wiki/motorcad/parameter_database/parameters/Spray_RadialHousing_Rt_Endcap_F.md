...
parameter_name: Spray_RadialHousing_Rt_Endcap_F
...
aliases:
- Spray_RadialHousing_Rt_Endcap_F
- Spray Radial Housing Rt Endcap F
- spray_radial_housing_rt_endcap_f
- sprayRadialHousingRtEndcapF
- spray_radialhousing_rt_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) fluid to front endcap surface convective thermal resistance
