...
parameter_name: Vel_ES_ExtShaftOuter_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_ExtShaftOuter_F_Calc
- Vel ES Ext Shaft Outer F Calc
- vel_es_ext_shaft_outer_f_calc
- velEsExtShaftOuterFCalc
- vel_es_extshaftouter_f_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for shaft extension outer [front]
