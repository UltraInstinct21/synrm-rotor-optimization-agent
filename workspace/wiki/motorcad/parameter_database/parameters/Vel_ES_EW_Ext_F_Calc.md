...
parameter_name: Vel_ES_EW_Ext_F_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_EW_Ext_F_Calc
- Vel ES EW Ext F Calc
- vel_es_ew_ext_f_calc
- velEsEwExtFCalc
related_parameters:
...
## Summary
End Space Cooling - calculated air velocity end-winding extension surface [front]
