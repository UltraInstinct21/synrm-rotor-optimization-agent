...
parameter_name: Spray_RadialRotor_Area_Endcap_R
...
aliases:
- Spray_RadialRotor_Area_Endcap_R
- Spray Radial Rotor Area Endcap R
- spray_radial_rotor_area_endcap_r
- sprayRadialRotorAreaEndcapR
- spray_radialrotor_area_endcap_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) rear endcap surface sprayed area
