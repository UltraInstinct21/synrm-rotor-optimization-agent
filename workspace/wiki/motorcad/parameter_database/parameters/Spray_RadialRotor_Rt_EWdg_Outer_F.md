...
parameter_name: Spray_RadialRotor_Rt_EWdg_Outer_F
...
aliases:
- Spray_RadialRotor_Rt_EWdg_Outer_F
- Spray Radial Rotor Rt E Wdg Outer F
- spray_radial_rotor_rt_e_wdg_outer_f
- sprayRadialRotorRtEWdgOuterF
- spray_radialrotor_rt_ewdg_outer_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) fluid to front endwinding outer surface convective thermal resistance
