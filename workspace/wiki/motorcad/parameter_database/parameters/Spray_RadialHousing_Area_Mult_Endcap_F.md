...
parameter_name: Spray_RadialHousing_Area_Mult_Endcap_F
...
aliases:
- Spray_RadialHousing_Area_Mult_Endcap_F
- Spray Radial Housing Area Mult Endcap F
- spray_radial_housing_area_mult_endcap_f
- sprayRadialHousingAreaMultEndcapF
- spray_radialhousing_area_mult_endcap_f
related_parameters:
...
## Summary
Spray Cooling (Radial from Housing) front endcap surface area multiplier
