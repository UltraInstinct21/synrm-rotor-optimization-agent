...
parameter_name: h_Input_TVent_EndRing_End_F
...
aliases:
- h_Input_TVent_EndRing_End_F
- h Input T Vent End Ring End F
- h_input_t_vent_end_ring_end_f
- hInputTVentEndRingEndF
- h_input_tvent_endring_end_f
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the end ring End surface [front]
