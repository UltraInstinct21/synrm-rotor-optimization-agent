...
parameter_name: TargetLength_Adj_EWdg_Inner_F
...
aliases:
- TargetLength_Adj_EWdg_Inner_F
- Target Length Adj E Wdg Inner F
- target_length_adj_e_wdg_inner_f
- targetLengthAdjEWdgInnerF
- targetlength_adj_ewdg_inner_f
related_parameters:
...
- '[[motorcad/parameter_database/parameters/TargetLength_Calc_EWdg_Outer_F|TargetLength_Calc_EWdg_Outer_F]]'
- '[[motorcad/parameter_database/parameters/TargetLength_Adj_EWdg_Outer_F|TargetLength_Adj_EWdg_Outer_F]]'
- '[[motorcad/parameter_database/parameters/TargetLength_EWdg_Outer_F|TargetLength_EWdg_Outer_F]]'
- '[[motorcad/parameter_database/parameters/TargetLength_Calc_EWdg_Front_F|TargetLength_Calc_EWdg_Front_F]]'
- '[[motorcad/parameter_database/parameters/TargetLength_Adj_EWdg_Front_F|TargetLength_Adj_EWdg_Front_F]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
This is the adjustment to the length of spray target on inner surface of front endwinding
