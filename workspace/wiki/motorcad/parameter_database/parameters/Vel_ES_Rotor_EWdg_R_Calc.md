...
parameter_name: Vel_ES_Rotor_EWdg_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_Rotor_EWdg_R_Calc
- Vel ES Rotor E Wdg R Calc
- vel_es_rotor_e_wdg_r_calc
- velEsRotorEWdgRCalc
- vel_es_rotor_ewdg_r_calc
related_parameters:
...
## Summary
The calculated velocity over the rotor endwinding surface [rear]
