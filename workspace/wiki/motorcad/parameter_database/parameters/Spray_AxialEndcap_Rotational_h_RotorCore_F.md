...
parameter_name: Spray_AxialEndcap_Rotational_h_RotorCore_F
...
aliases:
- Spray_AxialEndcap_Rotational_h_RotorCore_F
- Spray Axial Endcap Rotational h Rotor Core F
- spray_axial_endcap_rotational_h_rotor_core_f
- sprayAxialEndcapRotationalHRotorCoreF
- spray_axialendcap_rotational_h_rotorcore_f
related_parameters:
...
## Summary
Spray Cooling (Axial from Endcap) rotational htc over the front rotor core surface
