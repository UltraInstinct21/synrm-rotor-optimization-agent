...
parameter_name: Rt_TVent_Housing_OHang_F
category: TVent_Data
input_output: o/p
data_type: double
units: °C/W
...
aliases:
- Rt_TVent_Housing_OHang_F
- Rt T Vent Housing O Hang F
- rt_t_vent_housing_o_hang_f
- rtTVentHousingOHangF
- rt_tvent_housing_ohang_f
related_parameters:
...
## Summary
Motor-CAD automation parameter `Rt_TVent_Housing_OHang_F` in category `TVent_Data`.
