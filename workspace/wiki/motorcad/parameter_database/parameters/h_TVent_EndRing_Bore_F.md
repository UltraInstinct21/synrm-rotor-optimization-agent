...
parameter_name: h_TVent_EndRing_Bore_F
...
aliases:
- h_TVent_EndRing_Bore_F
- h T Vent End Ring Bore F
- h_t_vent_end_ring_bore_f
- hTVentEndRingBoreF
- h_tvent_endring_bore_f
related_parameters:
...
## Summary
The TVent heat transfer coefficient over the end ring bore surface [front]
