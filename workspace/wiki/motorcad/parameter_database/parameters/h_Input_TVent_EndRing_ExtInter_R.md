...
parameter_name: h_Input_TVent_EndRing_ExtInter_R
...
- h Input T Vent End Ring Ext Inter R
- h_input_t_vent_end_ring_ext_inter_r
- hInputTVentEndRingExtInterR
- h_input_tvent_endring_extinter_r
related_parameters:
...
## Summary
The TVent flow heat transfer coefficient (user input) over the end ring ExtInter surface [rear]
