...
parameter_name: Spray_RadialRotor_Stationary_h_Input_Bearing_R
...
aliases:
- Spray_RadialRotor_Stationary_h_Input_Bearing_R
- Spray Radial Rotor Stationary h Input Bearing R
- spray_radial_rotor_stationary_h_input_bearing_r
- sprayRadialRotorStationaryHInputBearingR
- spray_radialrotor_stationary_h_input_bearing_r
related_parameters:
...
## Summary
Spray Cooling (Radial from Rotor) user input stationary htc over the rear bearing surface
