...
parameter_name: NozzleDistance_Adj_RotorCore_R
...
aliases:
- NozzleDistance_Adj_RotorCore_R
- Nozzle Distance Adj Rotor Core R
- nozzle_distance_adj_rotor_core_r
- nozzleDistanceAdjRotorCoreR
- nozzledistance_adj_rotorcore_r
related_parameters:
...
## Summary
This is the adjustment to distance of nozzle to Rear Rotor Core
