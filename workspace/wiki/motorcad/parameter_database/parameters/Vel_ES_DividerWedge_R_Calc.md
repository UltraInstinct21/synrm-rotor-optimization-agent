...
parameter_name: Vel_ES_DividerWedge_R_Calc
category: End_Space
input_output: o/p
data_type: double
units: m/s
...
aliases:
- Vel_ES_DividerWedge_R_Calc
- Vel ES Divider Wedge R Calc
- vel_es_divider_wedge_r_calc
- velEsDividerWedgeRCalc
- vel_es_dividerwedge_r_calc
related_parameters:
...
## Summary
End Space Cooling - calculated velocity for Divider/Wedge [rear]
