...
parameter_name: IMOnLoad_RMSPhaseBackEMF_T
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- IMOnLoad_RMSPhaseBackEMF_T
- IM On Load RMS Phase Back EMF T
- im_on_load_rms_phase_back_emf_t
- imOnLoadRmsPhaseBackEmfT
- imonload_rmsphasebackemf_t
related_parameters:
...
- '[[motorcad/parameter_database/parameters/IMOnLoad_IronLosses_Static|IMOnLoad_IronLosses_Static]]'
related_workflows: []
related_concepts: []
confidence: Verified
---
...
## Summary
The rms back emf in T equivalent circuit across the magnetizing reactance
