...
parameter_name: StatorVoltage_Aux_RMS
category: Magnetics
input_output: o/p
data_type: double
units: Volts
...
aliases:
- StatorVoltage_Aux_RMS
- Stator Voltage Aux RMS
- stator_voltage_aux_rms
- statorVoltageAuxRms
- statorvoltage_aux_rms
related_parameters:
...
## Summary
The RMS voltage across the aux winding excluding start/run circuit
