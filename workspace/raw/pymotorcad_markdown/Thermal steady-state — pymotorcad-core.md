...
We will update the resistance between nodes with the following equation: resistance = (0.01 × ambient\_temp) + 1 This function is called when "Run" is pressed
...
<span id="page-1-0"></span>Created using [Sphinx](https://www.sphinx-doc.org/) 8.1.3.
